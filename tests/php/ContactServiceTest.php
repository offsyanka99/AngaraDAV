...
if (function_exists('imagecreatetruecolor') && function_exists('imagejpeg')) {
    ...
    echo "SKIP GD resize tests (GD not available)\n";
}

// JPEG is accepted even without GD (php -S / CLI without php-gd).
$tinyJpeg = base64_decode(
    '',
    true
);
assert_true(is_string($tinyJpeg) && strncmp($tinyJpeg, "\xFF\xD8", 2) === 0, 'tiny jpeg fixture');
$passthru = $svc->processPhotoInput(base64_encode($tinyJpeg), true);
assert_true(strncmp($passthru, "\xFF\xD8", 2) === 0, 'JPEG accepted without requiring GD');
