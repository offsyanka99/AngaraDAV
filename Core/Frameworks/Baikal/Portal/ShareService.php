...
class ShareService {
    ...
    public function updateEvent(string $username, int $instanceId, string $uri, array $fields): array {
        ...
        if ($targetInstanceId === $instanceId) {
            ...
            $this->notifyCalendarPush($username, $instanceId, $sourceCalId);
        ...
        $this->notifyCalendarPush($username, $instanceId, $sourceCalId);
        $this->notifyCalendarPush($username, $targetInstanceId, $targetCalId);
     ...
     * @param array{0: int, 1: int} $calId
     */
    private function notifyCalendarPush(string $username, int $instanceId, array $calId): void {
        try {
            $meta = $this->getCalendarMeta($username, $instanceId);
            $uri = (string) ($meta['uri'] ?? '');
            if ($uri === '') {
