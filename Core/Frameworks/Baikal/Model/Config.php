...
abstract class Config {
    ...
    function writable() {
        $path = PROJECT_PATH_CONFIG . "configuration.yaml";
    ...
    /**
     * Atomically write the full configuration.yaml document.
     *
    ...
    public static function writeConfigFile(array $config): void {
        ...
        if ($yaml === '' || $yaml === false) {
            throw new \RuntimeException('Failed to serialize configuration.yaml');
        }
