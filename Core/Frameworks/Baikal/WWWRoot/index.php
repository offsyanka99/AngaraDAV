...
if (!file_exists(PROJECT_PATH_ROOT . 'vendor/')) {
    exit('<h1>Incomplete installation</h1><p>AngaraDAV dependencies have not been installed. You may have downloaded an incomplete source archive.</p><p>To install dependencies manually, execute "<strong>composer install</strong>" in the AngaraDAV root folder.</p>');
}
...
# Bootstrapping AngaraDAV compatibility framework
...
$oPage->setTitle("AngaraDAV server");
