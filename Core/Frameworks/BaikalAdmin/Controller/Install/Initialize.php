...
class Initialize extends \Flake\Core\Controller {
    ...
    function execute() {
        ...
        if (!file_exists(PROJECT_PATH_SPECIFIC) || !is_dir(PROJECT_PATH_SPECIFIC) || !is_writable(PROJECT_PATH_SPECIFIC) || !file_exists(PROJECT_PATH_CONFIG) || !is_dir(PROJECT_PATH_CONFIG) || !is_writable(PROJECT_PATH_CONFIG)) {
            ...
            $message .= "<p>In order to work properly, AngaraDAV needs write permissions in the <strong>Specific/</strong> and <strong>config/</strong> folders.</p>";
        ...
        if ($this->oForm->submitted()) {
            ...
            if ($this->oForm->persisted()) {
                ...
                # Default: PDO::SQLite or PDO::pgsql ?
    ...
    function render() {
        ...
        #$sMessage = "<p>AngaraDAV is now configured. You may <a class='btn btn-success' href='" . PROJECT_URI . "admin/'>Access the AngaraDAV admin</a></p>";
        #$sForm = "";
        } else {
            $sMessage = "";
