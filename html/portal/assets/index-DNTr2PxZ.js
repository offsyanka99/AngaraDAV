    ...
    <div class="stack user-settings-form">
      <fieldset class="user-settings-fieldset">
        ...
        <label class="check-row" data-action="set-theme" data-theme="dark">
          <input type="radio" name="theme" value="dark" ${n===`dark`?`checked`:``} />
          Dark
        </label>
        <label class="check-row" data-action="set-theme" data-theme="light">
          <input type="radio" name="theme" value="light" ${n===`light`?`checked`:``} />
          Light
        </label>
      </fieldset>
      <fieldset class="user-settings-fieldset">
        ...
        <label>Day starts at
          <select name="dayStartHour">${x(t.dayStartHour)}</select>
        </label>
        <label>Day ends at
          <select name="dayEndHour">${x(t.dayEndHour)}</select>
        </label>
...
`);d=n.pop()??``;for(let e of n){let t=e.trim();t&&p(t)}}d.trim()&&p(d.trim());let m=Math.round((typeof performance<`u`?performance.now():Date.now())-a);if(f.error)throw f.error.status===401?(C.debug(`api ← POST ${e} stream 401 (${m}ms)`,f.error.message),be(e,f.error.message)):C.warn(`api ← POST ${e} stream error (${m}ms)`,f.error.message),new w(f.error.message,f.error.status);if(!f.final)throw C.error(`api ← POST ${e} stream incomplete (${m}ms)`,{sawProgress:f.sawProgress}),new w(f.sawProgress?`Import stopped before finishing (server crash, out of memory, or gateway timeout). On TrueNAS, set memory limit to at least 1G, pull latest image, and recreate the app.`:`Import failed to start on the server. Check container logs and that you are on the latest image.`,500);return C.info(`api ← POST ${e} stream done (${m}ms)`),ve(e),f.final}var Ce={adminPing:()=>T(`/admin/ping`),adminDashboard:()=>T(`/admin/dashboard`),adminCapabilities:()=>T(`/admin/capabilities`),adminUsers:()=>T(`/admin/users`),adminUser:e=>T(`/admin/users/${encodeURIComponent(e)}`),adminCreateUser:e=>T(`/admin/users`,{method:`POST`,body:JSON.stringify(e)}),adminUpdateUser:(e,t)=>T(`/admin/users/${encodeURIComponent(e)}`,{method:`PATCH`,body:JSON.stringify(t)}),adminDeleteUser:(e,t=!0)=>T(`/admin/users/${encodeURIComponent(e)}`,{method:`DELETE`,body:JSON.stringify({confirm:t})}),adminUserCalendars:e=>T(`/admin/users/${encodeURIComponent(e)}/calendars`),adminCreateUserCalendar:(e,t)=>T(`/admin/users/${encodeURIComponent(e)}/calendars`,{method:`POST`,body:JSON.stringify(t)}),adminUpdateUserCalendar:(e,t,n)=>T(`/admin/users/${encodeURIComponent(e)}/calendars/${t}`,{method:`PATCH`,body:JSON.stringify(n)}),adminDeleteUserCalendar:(e,t,n=!0)=>T(`/admin/users/${encodeURIComponent(e)}/calendars/${t}`,{method:`DELETE`,body:JSON.stringify({confirm:n})}),adminUserAddressBooks:e=>T(`/admin/users/${encodeURIComponent(e)}/addressbooks`),adminCreateUserAddressBook:(e,t)=>T(`/admin/users/${encodeURIComponent(e)}/addressbooks`,{method:`POST`,body:JSON.stringify(t)}),adminUpdateUserAddressBook:(e,t,n)=>T(`/admin/users/${encodeURIComponent(e)}/addressbooks/${t}`,{method:`PATCH`,body:JSON.stringify(n)}),adminDeleteUserAddressBook:(e,t,n=!0,r=!1)=>T(`/admin/users/${encodeURIComponent(e)}/addressbooks/${t}`,{method:`DELETE`,body:JSON.stringify({confirm:n,force:r})}),adminSystemSettings:()=>T(`/admin/settings/system`),adminUpdateSystemSettings:e=>T(`/admin/settings/system`,{method:`PATCH`,body:JSON.stringify(e)}),adminResetToDefault:(e=!0,t=``)=>T(`/admin/settings/reset-to-default`,{method:`POST`,body:JSON.stringify({confirm:e,password:t})}),adminDatabaseSettings:()=>T(`/admin/settings/database`),adminTestDatabaseConnection:e=>T(`/admin/settings/database/test`,{method:`POST`,body:JSON.stringify(e)}),adminUpdateDatabaseSettings:e=>T(`/admin/settings/database`,{method:`PATCH`,body:JSON.stringify(e)}),me:async()=>{let e=await T(`/me`);return me(e.csrfToken||e.user?.csrfToken||``),e},login:async(e,t)=>{let n=await T(`/login`,{method:`POST`,body:JSON.stringify({username:e,password:t})});return me(n.user?.csrfToken),n},logout:async()=>{try{return await T(`/logout`,{method:`POST`})}finally{me(``)}}},we={calendars:()=>T(`/calendars`),createCalendar:e=>T(`/calendars`,{method:`POST`,body:JSON.stringify(e)}),holidayCountries:()=>T(`/holidays/countries`),updateCalendar:(e,t)=>T(`/calendars/${e}`,{method:`PATCH`,body:JSON.stringify(t)}),deleteCalendar:e=>T(`/calendars/${e}`,{method:`DELETE`}),calendarEvents:(e,t,n)=>T(`/calendars/${e}/events?${new URLSearchParams({from:t,to:n}).toString()}`),getEvent:(e,t)=>T(`/calendars/${e}/events/${E(t)}`),createEvent:(e,t)=>T(`/calendars/${e}/events`,{method:`POST`,body:JSON.stringify(t)}),updateEvent:(e,t,n)=>T(`/calendars/${e}/events/${E(t)}`,{method:`PATCH`,body:JSON.stringify(n)}),deleteEvent:(e,t)=>T(`/calendars/${e}/events/${E(t)}`,{method:`DELETE`}),exportCalendar:async e=>{let t=await fetch(`/api/calendars/${e}/export`,{credentials:`same-origin`});if(!t.ok){let e=`Export failed (${t.status})`;try{let n=await t.json();n.error&&(e=n.error)}catch{}throw new w(e,t.status)}let n=t.headers.get(`Content-Disposition`)||``,r=/filename="([^"]+)"/i.exec(n)?.[1]||`calendar-${e}.ics`;return{blob:await t.blob(),filename:r}},importCalendar:(e,t,n)=>Se(`/calendars/${e}/import`,t,`text/calendar; charset=utf-8`,n),directory:()=>T(`/directory`),shares:e=>T(`/calendars/${e}/shares`),share:(e,t,n)=>T(`/calendars/${e}/shares`,{method:`POST`,body:JSON.stringify({username:t,access:n})}),revoke:(e,t)=>T(`/calendars/${e}/shares`,{method:`DELETE`,body:JSON.stringify({href:t})})},Te={addressbooks:()=>T(`/addressbooks`),createAddressBook:e=>T(`/addressbooks`,{method:`POST`,body:JSON.stringify(e)}),updateAddressBook:(e,t)=>T(`/addressbooks/${e}`,{method:`PATCH`,body:JSON.stringify(t)}),deleteAddressBook:(e,t=!1)=>T(`/addressbooks/${e}`,{method:`DELETE`,body:JSON.stringify({force:t})}),exportAddressBook:async e=>{let t=await fetch(`/api/addressbooks/${e}/export`,{credentials:`same-origin`});if(!t.ok){let e=`Export failed (${t.status})`;try{let n=await t.json();n.error&&(e=n.error)}catch{}throw new w(e,t.status)}let n=t.headers.get(`Content-Disposition`)||``,r=/filename="([^"]+)"/i.exec(n)?.[1]||`contacts-${e}.vcf`;return{blob:await t.blob(),filename:r}},importAddressBook:(e,t,n)=>Se(`/addressbooks/${e}/import`,t,`text/vcard; charset=utf-8`,n),contacts:(e,t=``)=>T(`/addressbooks/${e}/contacts${t.trim()?`?q=${encodeURIComponent(t.trim())}`:``}`),getContact:(e,t)=>T(`/addressbooks/${e}/contacts/${E(t)}`),createContact:(e,t)=>T(`/addressbooks/${e}/contacts`,{method:`POST`,body:JSON.stringify(t)}),updateContact:(e,t,n)=>T(`/addressbooks/${e}/contacts/${E(t)}`,{method:`PATCH`,body:JSON.stringify(n)}),deleteContact:(e,t)=>T(`/addressbooks/${e}/contacts/${E(t)}`,{method:`DELETE`}),exportContact:async(e,t)=>{let n=await fetch(`/api/addressbooks/${e}/contacts/${E(t)}/export`,{credentials:`same-origin`});if(!n.ok){let e=`Export failed (${n.status})`;try{let t=await n.json();t.error&&(e=t.error)}catch{}throw new w(e,n.status)}let r=n.headers.get(`Content-Disposition`)||``,i=/filename="([^"]+)"/i.exec(r)?.[1]||`contact.vcf`;return{blob:await n.blob(),filename:i}},contactPhotoUrl:(e,t)=>`/api/addressbooks/${e}/contacts/${E(t)}/photo`,bulkContacts:(e,t)=>T(`/addressbooks/${e}/contacts/bulk`,{method:`POST`,body:JSON.stringify(t)}),exportContacts:async(e,t)=>{let n=await T(`/addressbooks/${e}/contacts/export`,{method:`POST`,body:JSON.stringify({uris:t})});return{blob:new Blob([n.vcf],{type:`text/vcard;charset=utf-8`}),filename:n.filename||`contacts.vcf`}}},Ee={filesStatus:()=>T(`/files`),filesList:(e=``)=>{let t=new URLSearchParams;return e&&t.set(`path`,e),T(`/files/entries${t.toString()?`?${t}`:``}`)},filesMkdir:(e,t)=>T(`/files/mkdir`,{method:`POST`,body:JSON.stringify({path:e,name:t})}),filesUpload:(e,t,n={})=>{let r=new URLSearchParams;e&&r.set(`path`,e),r.set(`name`,t.name),n.replace&&r.set(`replace`,`1`);let i=new FormData;i.append(`file`,t,t.name),e&&i.append(`path`,e);let a=typeof performance<`u`?performance.now():Date.now();return C.debug(`api → POST /files/upload path=${e||`/`} name=${t.name} size=${t.size}`),new Promise((e,o)=>{let s=new XMLHttpRequest;s.open(`POST`,`/api/files/upload?${r}`),s.withCredentials=!0;let c=he();c&&s.setRequestHeader(`X-CSRF-Token`,c),n.onProgress&&(s.upload.onprogress=e=>{e.lengthComputable?n.onProgress?.(e.loaded,e.total):n.onProgress?.(e.loaded,t.size||e.loaded)}),s.onload=()=>{let t=Math.round((typeof performance<`u`?performance.now():Date.now())-a),n=null,r=s.responseText||``;if(r)try{n=JSON.parse(r)}catch{n={error:r}}let i=s.status;if(i<200||i>=300){let e=`Upload failed (${i||0})`;n&&typeof n==`object`&&n&&`error`in n&&typeof n.error==`string`&&(e=n.error),i===401?(C.debug(`api ← POST /files/upload 401 (${t}ms)`,e),be(`/files/upload`,e)):i>=500?C.error(`api ← POST /files/upload ${i} (${t}ms)`,e):C.warn(`api ← POST /files/upload ${i} (${t}ms)`,e),o(new w(e,i||0));return}C.info(`api ← POST /files/upload 200 (${t}ms)`),ve(`/files/upload`),e(n)},s.onerror=()=>{let e=Math.round((typeof performance<`u`?performance.now():Date.now())-a);C.error(`api ← POST /files/upload network error (${e}ms)`),o(new w(`Upload failed (network error)`,0))},s.onabort=()=>{o(new w(`Upload cancelled`,0))},s.send(i)})},filesDownloadUrl:(e,t)=>{let n=new URLSearchParams;return n.set(`path`,e),t?.inline&&n.set(`inline`,`1`),`/api/files/download?${n}`},filesGetBlob:(e,t)=>{let n=new URLSearchParams;return n.set(`path`,e),t?.inline&&n.set(`inline`,`1`),xe(`/files/download?${n}`)},filesDelete:e=>T(`/files/entry`,{method:`DELETE`,body:JSON.stringify({path:e})}),filesRename:(e,t)=>T(`/files/rename`,{method:`POST`,body:JSON.stringify({path:e,newName:t})}),filesMove:(e,t,n)=>T(`/files/move`,{method:`POST`,body:JSON.stringify({from:e,to:t,newName:n})}),filesCopy:(e,t={})=>T(`/files/copy`,{method:`POST`,body:JSON.stringify({path:e,to:t.to,newName:t.newName})}),filesBulk:(e,t)=>T(`/files/bulk`,{method:`POST`,body:JSON.stringify({op:e,paths:t})})},De={tasks:(e={})=>{let t=new URLSearchParams;return e.q&&t.set(`q`,e.q),e.sort&&t.set(`sort`,e.sort),e.order&&t.set(`order`,e.order),T(`/tasks${t.toString()?`?${t}`:``}`)},createTask:e=>T(`/tasks`,{method:`POST`,body:JSON.stringify(e)}),updateTask:(e,t,n)=>T(`/tasks/${e}/${E(t)}`,{method:`PATCH`,body:JSON.stringify(n)}),deleteTask:(e,t)=>T(`/tasks/${e}/${E(t)}`,{method:`DELETE`}),bulkTasks:e=>T(`/tasks/bulk`,{method:`POST`,body:JSON.stringify(e)}),notes:(e={})=>{let t=new URLSearchParams;return e.q&&t.set(`q`,e.q),e.sort&&t.set(`sort`,e.sort),e.order&&t.set(`order`,e.order),T(`/notes${t.toString()?`?${t}`:``}`)},createNote:e=>T(`/notes`,{method:`POST`,body:JSON.stringify(e)}),updateNote:(e,t,n)=>T(`/notes/${e}/${E(t)}`,{method:`PATCH`,body:JSON.stringify(n)}),deleteNote:(e,t)=>T(`/notes/${e}/${E(t)}`,{method:`DELETE`}),bulkNotes:e=>T(`/notes/bulk`,{method:`POST`,body:JSON.stringify(e)})},D={ui:()=>T(`/ui`),installStatus:async()=>{let e=await T(`/install/status`);return e&&typeof e==`object`&&`data`in e&&e.data?e.data:e},...Ce,...we,...Te,...De,...Ee},Oe=`angaradav-portal-tab`,ke=`angaradav-portal-admin-page`,Ae=`angaradav-portal-cal-selection`,je=`2.3.3`;function Me(e){let t=(e||`2.3.3`).trim(),n=t.indexOf(`+`);return n<=0?{version:t||`2.3.3`,build:``}:{version:t.slice(0,n),build:t.slice(n+1)}}var Ne=`https://github.com/offsyanka99/AngaraDAV/tree/main/docs`;function Pe(e){let t=new Date;return{user:null,flash:null,activeTab:e.activeTab,adminPage:e.adminPage,adminDashboard:null,adminDashboardLoading:!1,adminDashboardError:null,adminCapabilities:null,adminCapabilitiesError:null,adminUsers:[],adminUsersLoading:!1,adminUsersError:null,adminUsersQuery:``,adminSelectedUsername:e.adminSelectedUsername,adminUserDetail:null,adminUserDetailLoading:!1,adminUserDetailError:null,adminUserCreateOpen:!1,adminUserEditOpen:!1,adminUserDeleteUsername:null,adminUserDeleteConfirmChecked:!1,adminUserCalendars:[],adminUserAddressBooks:[],adminUserResourcesLoading:!1,adminCalModal:null,adminCalEditId:null,adminAbModal:null,adminAbEditId:null,adminResourceDelete:null,adminSystemSettings:null,adminSystemSettingsLoading:!1,adminSystemSettingsError:null,adminResetModalOpen:!1,adminResetConfirmChecked:!1,adminResetPassword:``,adminDatabaseSettings:null,adminDatabaseSettingsLoading:!1,adminDatabaseSettingsError:null,adminDbFormBackend:`sqlite`,adminDbConfirmOpen:!1,adminDbConfirmText:``,adminDbPendingBody:null,userMenuOpen:!1,userMenuDocClick:null,userSettings:y(),userSettingsOpen:!1,calendars:[],directory:[],holidayCountries:[],selectedId:null,selectedIds:[],calendarSelectionSeeded:!1,listKeyboardFocus:!1,shares:[],installGate:null,calModalOpen:!1,createCalModalOpen:!1,deleteConfirmId:null,deleteAbConfirmId:null,monthCursor:{y:t.getFullYear(),m:t.getMonth()},calView:`month`,calFocusDay:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`,eventSearch:``,eventSearchFocus:!1,monthEvents:[],monthEventsLoading:!1,eventModalOpen:!1,editingEvent:null,creatingEvent:!1,eventDtPicker:null,bulkDueValue:``,monthExpandDay:null,addressBooks:[],selectedAbId:null,contacts:[],contactSearch:``,selectedContactUri:null,editingContact:null,creatingContact:!1,contactModalOpen:!1,abModalOpen:!1,photoPreview:null,photoBase64Pending:null,removePhotoPending:!1,busy:!1,importProgress:null,importElapsedTimer:null,filesUploadProgress:null,filesUploadElapsedTimer:null,filesUploadMenuOpen:!1,filesUploadMenuDocClick:null,filesUploadDropActive:!1,filesDropDepth:0,escapeBound:!1,portalEventsBound:!1,portalUi:{timeFormat:`auto`,weekStart:`auto`,logLevel:`off`,services:null},searchTimer:null,sessionIdleSeconds:900,sessionIdleTimer:null,appVersion:je,handlingSessionExpiry:!1,suppressErrorFlashAfterExpiry:!1,tasks:[],notes:[],taskCalendars:[],noteCalendars:[],taskSearch:``,noteSearch:``,taskSort:`due`,taskOrder:`asc`,noteSort:`dtstart`,noteOrder:`desc`,selectedTaskKey:null,selectedNoteKey:null,editingTask:null,editingNote:null,creatingTask:!1,creatingNote:!1,checkedTaskKeys:[],checkedNoteKeys:[],checkedContactUris:[],filesStatus:null,filesPath:``,filesEntries:[],filesLoading:!1,filesRenamePath:null,filesDeletePaths:null,filesTransfer:null,filesTransferDest:``,filesTreeChildren:{},filesTreeExpanded:[],filesMkdirOpen:!1,filesSearch:``,filesSearchFocus:!1,filesSort:`name`,filesOrder:`asc`,filesTypeFilter:`all`,checkedFilePaths:[],filesItemMenu:null,filesItemMenuDocClick:null,filesItemMenuWinClose:null,filesPreview:null,filesPreviewSeq:0,filesUploadConflict:null,confirmDelete:null,dtPickerDocClick:null}}function Fe(e,t,n){e.suppressErrorFlashAfterExpiry&&t===`error`||(t!==`error`&&(e.suppressErrorFlashAfterExpiry=!1),e.flash={type:t,message:n})}function Ie(e){e.flash=null,e.suppressErrorFlashAfterExpiry=!1}function Le(e){return e.flash?t(e.flash.type,e.flash.message,{dismissible:!0}):``}function Re(e){return!!(e.user?.isAdmin||e.user?.role===`Admin`)}function ze(e){return Re(e)?e.adminCapabilities===null||e.adminCapabilities.uiEnabled!==!1:!1}function Be(e,t){if(!t)return;let n=(t.timeFormat||`auto`).toLowerCase(),r=(t.weekStart||`auto`).toLowerCase(),i=e.portalUi.services,a=i;if(t.services&&typeof t.services==`object`){let e=i??{caldav:!0,carddav:!0,tasks:!0,notes:!0,files:!0},n=t.services;a={caldav:typeof n.caldav==`boolean`?n.caldav:e.caldav,carddav:typeof n.carddav==`boolean`?n.carddav:e.carddav,tasks:typeof n.tasks==`boolean`?n.tasks:e.tasks,notes:typeof n.notes==`boolean`?n.notes:e.notes,files:typeof n.files==`boolean`?n.files:e.files}}e.portalUi={timeFormat:n===`12h`||n===`24h`?n:`auto`,weekStart:r===`monday`||r===`sunday`?r:`auto`,logLevel:t.logLevel||`off`,services:a},se(e.portalUi.logLevel),typeof t.sessionIdleSeconds==`number`&&Number.isFinite(t.sessionIdleSeconds)&&t.sessionIdleSeconds>0&&(e.sessionIdleSeconds=Math.floor(t.sessionIdleSeconds)),typeof t.version==`string`&&t.version.trim()!==``&&(e.appVersion=t.version.trim())}function O(e,t){if(t===`admin`)return!0;let n=e.portalUi.services;if(!n)return!0;switch(t){case`calendars`:return n.caldav;case`contacts`:return n.carddav;case`tasks`:return n.tasks;case`notes`:return n.notes;case`files`:return n.files;default:return!0}}function Ve(e){for(let t of[`calendars`,`contacts`,`tasks`,`notes`,`files`])if(O(e,t))return t;return`calendars`}function He(e){e.sessionIdleTimer!==null&&(clearTimeout(e.sessionIdleTimer),e.sessionIdleTimer=null)}function Ue(e,t){if(He(e),!e.user)return;let n=Math.max(30,e.sessionIdleSeconds)*1e3;e.sessionIdleTimer=setTimeout(()=>{e.sessionIdleTimer=null,t(`Your session timed out. Please sign in again.`)},n)}function We(e,t){He(e),t.stopImportElapsedTimer(),e.importProgress=null,e.filesUploadProgress=null,t.stopFilesUploadElapsedTimer(),e.filesUploadMenuOpen=!1,t.unbindFilesUploadMenuOutside(),e.filesUploadDropActive=!1,e.user=null,e.calendars=[],e.shares=[],e.selectedId=null,e.selectedIds=[],e.calendarSelectionSeeded=!1,e.listKeyboardFocus=!1,e.directory=[],e.addressBooks=[],e.selectedAbId=null,e.contacts=[],e.selectedContactUri=null,e.editingContact=null,e.creatingContact=!1,e.contactModalOpen=!1,e.abModalOpen=!1,e.createCalModalOpen=!1,e.calModalOpen=!1,e.deleteConfirmId=null,e.deleteAbConfirmId=null,e.eventModalOpen=!1,e.userSettingsOpen=!1,e.editingEvent=null,e.creatingEvent=!1,e.monthEvents=[],e.calView=`month`,e.eventSearch=``,e.eventSearchFocus=!1;{let t=new Date;e.calFocusDay=`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`,e.monthCursor={y:t.getFullYear(),m:t.getMonth()}}if(e.tasks=[],e.notes=[],e.taskCalendars=[],e.noteCalendars=[],e.selectedTaskKey=null,e.selectedNoteKey=null,e.editingTask=null,e.editingNote=null,e.creatingTask=!1,e.creatingNote=!1,e.checkedTaskKeys=[],e.checkedNoteKeys=[],e.checkedContactUris=[],e.filesStatus=null,e.filesPath=``,e.filesEntries=[],e.filesLoading=!1,e.filesRenamePath=null,e.filesDeletePaths=null,t.resetFilesTransferTree(),e.filesMkdirOpen=!1,e.filesSearch=``,e.filesSearchFocus=!1,e.filesSort=`name`,e.filesOrder=`asc`,e.filesTypeFilter=`all`,e.filesItemMenu=null,e.filesItemMenuDocClick&&=(document.removeEventListener(`click`,e.filesItemMenuDocClick,!0),null),e.filesItemMenuWinClose&&=(window.removeEventListener(`resize`,e.filesItemMenuWinClose),null),e.filesPreview?.objectUrl)try{URL.revokeObjectURL(e.filesPreview.objectUrl)}catch{}e.filesPreview=null,e.filesPreviewSeq+=1,e.filesUploadMenuOpen=!1,t.unbindFilesUploadMenuOutside(),e.filesUploadDropActive=!1,e.filesUploadConflict=null,e.confirmDelete=null,e.dtPickerDocClick=null,e.checkedFilePaths=[],e.photoPreview=null,e.photoBase64Pending=null,e.removePhotoPending=!1,e.busy=!1,e.userMenuOpen=!1,e.adminDashboard=null,e.adminDashboardLoading=!1,e.adminDashboardError=null,e.adminCapabilities=null,e.adminCapabilitiesError=null,e.adminUsers=[],e.adminUsersLoading=!1,e.adminUsersError=null,e.adminUsersQuery=``,e.adminSelectedUsername=null,e.adminUserDetail=null,e.adminUserDetailLoading=!1,e.adminUserDetailError=null,e.adminUserCreateOpen=!1,e.adminUserEditOpen=!1,e.adminUserDeleteUsername=null,e.adminUserDeleteConfirmChecked=!1,e.adminUserCalendars=[],e.adminUserAddressBooks=[],e.adminUserResourcesLoading=!1,e.adminCalModal=null,e.adminCalEditId=null,e.adminAbModal=null,e.adminAbEditId=null,e.adminResourceDelete=null,e.adminSystemSettings=null,e.adminSystemSettingsLoading=!1,e.adminSystemSettingsError=null,e.adminResetModalOpen=!1,e.adminResetConfirmChecked=!1,e.adminResetPassword=``,e.adminDatabaseSettings=null,e.adminDatabaseSettingsLoading=!1,e.adminDatabaseSettingsError=null,e.adminDbFormBackend=`sqlite`,e.adminDbConfirmOpen=!1,e.adminDbConfirmText=``,e.adminDbPendingBody=null,t.unbindUserMenuOutside()}function Ge(e,t){if(!e.handlingSessionExpiry){if(!e.user){He(e);return}e.handlingSessionExpiry=!0;try{C.event(`session.expired`),t.clearSession(),e.suppressErrorFlashAfterExpiry=!0,e.flash={type:`info`,message:t.message&&t.message.trim()?t.message:`Your session timed out. Please sign in again.`},t.render()}finally{e.handlingSessionExpiry=!1}}}function Ke(e,t){let n=String(t.step||``);n===`upgrade`||n===`initialize`||n===`permissions`||n===`database`?(e.installGate={step:n,message:t.message||(n===`upgrade`?`Complete the upgrade wizard before signing in.`:`Complete setup before signing in.`),installUrl:t.installUrl||`/portal/install/`,productVersion:t.productVersion,configuredVersion:t.configuredVersion??null},typeof t.productVersion==`string`&&t.productVersion.trim()!==``&&(e.appVersion=t.productVersion.trim())):e.installGate=null}function qe(e,t){if(!(t instanceof w)||t.status!==503)return!1;let n=typeof t.payload.code==`string`?t.payload.code:``;return n!==`upgrade_required`&&n!==`not_configured`&&n!==`admin_password_missing`?!1:(e.installGate={step:n===`upgrade_required`?`upgrade`:`initialize`,message:t.message,installUrl:typeof t.payload.installUrl==`string`?t.payload.installUrl:`/portal/install/`,productVersion:typeof t.payload.productVersion==`string`?t.payload.productVersion:void 0,configuredVersion:typeof t.payload.configuredVersion==`string`?t.payload.configuredVersion:null},e.installGate.productVersion&&(e.appVersion=e.installGate.productVersion),!0)}async function Je(e){let{state:t}=e;if(t.activeTab===`admin`&&Re(t)&&ze(t))try{t.adminPage===`overview`&&e.adminPageMeta(`overview`)?.available!==!1?await e.loadAdminDashboard():t.adminPage===`users`&&e.adminPageMeta(`users`)?.available!==!1?(await e.loadAdminUsers(),t.adminSelectedUsername&&(await e.loadAdminUserDetail(t.adminSelectedUsername),await e.loadAdminUserResources(t.adminSelectedUsername))):t.adminPage===`settings`&&e.adminPageMeta(`settings`)?.available!==!1?await e.loadAdminSystemSettings():t.adminPage===`database`&&e.adminPageMeta(`database`)?.available!==!1&&await e.loadAdminDatabaseSettings()}catch(e){C.warn(`admin page load`,e instanceof Error?e.message:e)}}async function Ye(e){let{state:t}=e;C.event(`bootstrap.start`),ge(t=>{e.handleSessionExpired(/timed\s*out|session expired/i.test(t)?t:`Your session timed out. Please sign in again.`)}),_e(()=>{Ue(t,t=>e.handleSessionExpired(t))});try{Ke(t,await D.installStatus())}catch(e){C.debug(`bootstrap: /api/install/status failed`,e instanceof Error?e.message:e)}try{let e=await D.ui();Be(t,e.ui),typeof e.version==`string`&&e.version.trim()!==``?t.appVersion=e.version.trim():e.ui&&typeof e.ui.version==`string`&&e.ui.version.trim()!==``&&(t.appVersion=e.ui.version.trim())}catch(e){C.debug(`bootstrap: /api/ui failed`,e instanceof Error?e.message:e),qe(t,e)}if(t.installGate&&t.installGate.step!==`done`&&t.installGate.step!==`locked`){e.clearPortalSessionState(),C.event(`bootstrap.installGate`,{step:t.installGate.step}),e.render();return}try{let n=await D.me();if(!n.user)e.clearPortalSessionState(),Be(t,n.ui),typeof n.version==`string`&&n.version.trim()!==``&&(t.appVersion=n.version.trim()),C.event(`bootstrap.anonymous`);else{if(t.user=n.user,t.userSettings=b(t.user.username),Be(t,n.ui),typeof n.version==`string`&&n.version.trim()!==``&&(t.appVersion=n.version.trim()),C.event(`bootstrap.session`,{username:t.user?.username??null}),Ue(t,t=>e.handleSessionExpired(t)),Re(t))try{await e.loadAdminCapabilities()}catch(e){C.warn(`admin.capabilities bootstrap`,e instanceof Error?e.message:e)}e.normalizeActiveTab(),e.persistTab(t.activeTab,t.adminPage),await e.loadHome(),await Je(e)}}catch(n){n instanceof w&&n.status===401?(e.clearPortalSessionState(),C.event(`bootstrap.anonymous`)):(C.error(`bootstrap failed`,n instanceof Error?n.message:n),Fe(t,`error`,n instanceof Error?n.message:`Failed to load`))}e.render()}async function Xe(e,t){let{state:n}=t,r=new FormData(e),i=String(r.get(`username`)??``),a=String(r.get(`password`)??``);n.busy=!0,t.clearFlash(),t.render(),C.event(`login.attempt`,{username:i});try{let e=await D.login(i,a);if(n.user=e.user,n.userSettings=b(n.user?.username??i),Be(n,e.ui),C.event(`login.ok`,{username:n.user?.username??i}),Ue(n,e=>t.handleSessionExpired(e)),Re(n))try{await t.loadAdminCapabilities()}catch(e){C.warn(`admin.capabilities login`,e instanceof Error?e.message:e)}t.normalizeActiveTab(),t.persistTab(n.activeTab,n.adminPage),await t.loadHome(),await Je(t),t.setFlash(`success`,`Signed in`)}catch(e){C.warn(`login.failed`,e instanceof Error?e.message:e),t.setFlash(`error`,e instanceof Error?e.message:`Login failed`)}finally{n.busy=!1,t.render()}}function Ze(t,n,r){let i=n.installGate,a=i&&(i.step===`upgrade`||i.step===`initialize`||i.step===`permissions`||i.step===`database`),o=i?.installUrl||`/portal/install/`,s=``;if(a&&i){let t=i.step===`upgrade`?`Server upgrade required`:`Setup incomplete`,n=i.step===`upgrade`&&(i.configuredVersion||i.productVersion)?`<p class="muted small" style="margin:0.5rem 0 0">Configured <span class="mono">${e(String(i.configuredVersion||`—`))}</span>
      ...
      </div>`,{auth:!0})}function Qe(e){let t=e.querySelector(`.contacts-table-wrap`),n=e.querySelector(`.contacts-ab-list`),r=e.querySelector(`.calendars-owned-list`),i=e.querySelector(`.files-table-wrap`);return{windowX:window.scrollX,windowY:window.scrollY,tableTop:t?.scrollTop??null,abListTop:n?.scrollTop??null,calListTop:r?.scrollTop??null,filesTableTop:i?.scrollTop??null}}function $e(e,t){requestAnimationFrame(()=>{requestAnimationFrame(()=>{if(window.scrollTo(t.windowX,t.windowY),t.tableTop!==null){let n=e.querySelector(`.contacts-table-wrap`);n&&(n.scrollTop=t.tableTop)}if(t.abListTop!==null){let n=e.querySelector(`.contacts-ab-list`);n&&(n.scrollTop=t.abListTop)}if(t.calListTop!==null){let n=e.querySelector(`.calendars-owned-list`);n&&(n.scrollTop=t.calListTop)}if(t.filesTableTop!==null){let n=e.querySelector(`.files-table-wrap`);n&&(n.scrollTop=t.filesTableTop)}})})}var et=`hummersoft@mailbox.org`,tt=`AngaraDAV`,nt=`https://github.com/offsyanka99/AngaraDAV`;function rt(t){let{version:n,build:r}=Me(t.appVersion),i=r||`—`;return`
    <div class="info-modal" id="about-modal" hidden role="dialog" aria-modal="true" aria-labelledby="about-modal-title">
      ...
      <div class="info-modal-card about-modal-card">
        ...
        <div class="about-modal-body">
          ...
          <p class="about-name">${e(tt)}</p>
          <dl class="about-meta">
            <div><dt>Version</dt><dd class="mono">${e(n)}</dd></div>
            <div><dt>Build</dt><dd class="mono">${e(i)}</dd></div>
            <div><dt>Contact</dt><dd><a href="mailto:${e(et)}">${e(et)}</a></dd></div>
            <div><dt>GitHub</dt><dd><a href="${e(nt)}" target="_blank" rel="noopener noreferrer">${e(nt.replace(/^https:\/\//,``))}</a></dd></div>
          </dl>
        </div>
    ...
    </div>`}function it(e){let t=e.querySelector(`#about-modal`);t&&(t.hidden=!1,document.body.classList.add(`info-modal-open`),t.querySelector(`.info-modal-close`)?.focus())}function at(e){let t=e.querySelector(`#about-modal`);if(!t)return;t.hidden=!0;let n=e.querySelector(`#info-modal`);(!n||n.hidden)&&document.body.classList.remove(`info-modal-open`)}function ot(e){let t=e.querySelector(`#about-modal`);return!!t&&!t.hidden}function st(t,n,r={}){let i=!!t.user&&t.activeTab===`admin`&&Re(t)&&ze(t),a=`
      <img class="brand-logo" src="/logo.png" width="28" height="28" alt="" aria-hidden="true" />
      <span class="brand-text">Angara<span class="brand-dav">DAV</span><span class="brand-sep" aria-hidden="true"> · </span><span class="${i?`brand-portal brand-portal-admin`:`brand-portal brand-portal-user`}">${e(i?`Administration Portal`:`User Portal`)}</span></span>`,o=t.user?e(t.user.displayname||t.user.username):``,s=ze(t)?`<button type="button" class="user-menu-item${t.activeTab===`admin`?` is-active`:``}" role="menuitem" data-action="tab" data-tab="admin">
              Administration
      ...
      ${p}`}function ct(e){e.userMenuDocClick&&=(document.removeEventListener(`click`,e.userMenuDocClick,!0),null)}function lt(e,t){ct(e),e.userMenuDocClick=n=>{n.target?.closest?.(`.user-menu`)||(e.userMenuOpen=!1,ct(e),t())};let n=e.userMenuDocClick;setTimeout(()=>{e.userMenuOpen&&e.userMenuDocClick===n&&document.addEventListener(`click`,n,!0)},0)}function ut(e){e.dtPickerDocClick&&=(document.removeEventListener(`click`,e.dtPickerDocClick,!0),null)}function dt(e,t){if(ut(e),!e.eventDtPicker)return;e.dtPickerDocClick=n=>{let r=n.target;r?.closest?.(`.dt-field.is-open, .dt-popover, [data-dt-popover]`)||r?.closest?.(`[data-action="dt-open"]`)||(e.eventDtPicker=null,ut(e),t())};let n=e.dtPickerDocClick;setTimeout(()=>{e.eventDtPicker&&e.dtPickerDocClick===n&&document.addEventListener(`click`,n,!0)},0)}function ft(e,t){return!t||e.includes(t)?e:[t]}function pt(e,t){let n=new Map(e.map(e=>[e.path,e])),r=[];for(let e of t){let t=n.get(e);t&&r.push(t)}let i=r.filter(e=>e.type===`file`),a=r.length;return{count:a,heading:a>1?`${a} items`:null,showDownload:i.length>0,downloadItems:i.map(e=>({path:e.path,name:e.name})),renameEnabled:a===1,renamePath:a===1?r[0].path:null,renameName:a===1?r[0].name:null}}function mt(e){return!!(e.busy||e.filesRenamePath||e.filesDeletePaths||e.filesTransfer||e.filesMkdirOpen||e.filesPreview||e.filesUploadConflict||e.filesUploadProgress)}function k(e){gt(e),e.state.filesItemMenu=null}function ht(e,t,n){!t||mt(e.state)||e.state.filesEntries.some(e=>e.path===t)&&(e.state.checkedFilePaths=ft(e.state.checkedFilePaths,t),e.state.filesItemMenu={path:t,x:n.x,y:n.y,origin:n.origin},e.state.filesUploadMenuOpen=!1,e.render())}function gt(e){e.state.filesItemMenuDocClick&&(document.removeEventListener(`click`,e.state.filesItemMenuDocClick,!0),e.state.filesItemMenuDocClick=null),e.state.filesItemMenuWinClose&&(window.removeEventListener(`resize`,e.state.filesItemMenuWinClose),e.state.filesItemMenuWinClose=null)}function _t(e){gt(e),e.state.filesItemMenuDocClick=t=>{let n=t.target;n?.closest?.(`#files-item-menu`)||n?.closest?.(`[data-action="files-item-menu-toggle"]`)||(k(e),e.render())};let t=e.state.filesItemMenuDocClick;setTimeout(()=>{e.state.filesItemMenu&&e.state.filesItemMenuDocClick===t&&document.addEventListener(`click`,t,!0)},0),e.state.filesItemMenuWinClose=()=>{e.state.filesItemMenu&&(k(e),e.render())},window.addEventListener(`resize`,e.state.filesItemMenuWinClose)}function vt(e){let t=e.root.querySelector(`#files-item-menu`);if(!t||!e.state.filesItemMenu)return;yt(e),requestAnimationFrame(()=>yt(e));let n=e.root.querySelector(`.files-table-wrap`),r=e.state.filesItemMenuWinClose;n&&r&&n.addEventListener(`scroll`,r,{passive:!0});let i=[...t.querySelectorAll(`[role="menuitem"]:not([disabled])`)];e.state.filesItemMenu.origin===`button`&&i.length>0&&!t.contains(document.activeElement)&&i[0].focus(),t.addEventListener(`keydown`,e=>{if(e.key!==`ArrowDown`&&e.key!==`ArrowUp`&&e.key!==`Home`&&e.key!==`End`)return;let n=[...t.querySelectorAll(`[role="menuitem"]:not([disabled])`)];if(n.length===0)return;e.preventDefault();let r=document.activeElement,i=r?n.indexOf(r):-1,a=0;e.key===`ArrowDown`?a=i<0?0:(i+1)%n.length:e.key===`ArrowUp`?a=i<0?n.length-1:(i-1+n.length)%n.length:e.key===`End`&&(a=n.length-1),n[a]?.focus()})}function yt(e){let t=e.root.querySelector(`#files-item-menu`),n=e.state.filesItemMenu;if(!t||!n)return;let r=n.x,i=n.y;if(n.origin===`button`){let t=e.root.querySelector(`.files-row-menu-btn[data-path="${CSS.escape(n.path)}"]`);if(t){let e=t.getBoundingClientRect();r=e.right,i=e.bottom+4}}t.style.left=`${r}px`,t.style.top=`${i}px`;let a=t.getBoundingClientRect(),o=n.origin===`button`?r-a.width:r,s=i;o+a.width>window.innerWidth-8&&(o=window.innerWidth-8-a.width),o<8&&(o=8),s+a.height>window.innerHeight-8&&(s=i-a.height-(n.origin===`button`?8:0)),s<8&&(s=8),t.style.left=`${Math.round(o)}px`,t.style.top=`${Math.round(s)}px`}function bt(t){let n=t.state.filesItemMenu;if(!n)return``;let r=pt(t.state.filesEntries,t.state.checkedFilePaths);if(r.count===0)return``;let i=t.state.busy?`disabled`:``,a=r.showDownload?`<button type="button" class="files-item-menu-item" role="menuitem"
    ...
    <button type="button" class="files-item-menu-item is-danger" role="menuitem"
  ...
  </div>`}function xt(e){e.forEach((e,t)=>{window.setTimeout(()=>{let t=document.createElement(`a`);t.href=D.filesDownloadUrl(e.path),t.download=e.name,t.rel=`noopener`,document.body.appendChild(t),t.click(),t.remove(),C.event(`files.download`,{path:e.path,via:`selection`})},t*100)})}async function A(e){e.state.filesLoading=!0;try{C.debug(`loadFiles`,{path:e.state.filesPath});let[t,n]=await Promise.all([D.filesStatus(),D.filesList(e.state.filesPath).catch(t=>{if(t instanceof w&&(t.status===503||t.status===404))return{path:e.state.filesPath,entries:[]};throw t})]);if(e.state.filesStatus=t,t.ready){e.state.filesPath=n.path,e.state.filesEntries=n.entries;let t=new Set(e.state.filesEntries.map(e=>e.path));e.state.checkedFilePaths=e.state.checkedFilePaths.filter(e=>t.has(e)),e.state.filesItemMenu&&!t.has(e.state.filesItemMenu.path)&&k(e)}else e.state.filesEntries=[],e.state.checkedFilePaths=[],k(e);C.event(`loadFiles`,{path:e.state.filesPath,count:e.state.filesEntries.length,enabled:t.enabled,ready:t.ready})}finally{e.state.filesLoading=!1}}function St(...e){return e.map(e=>e.replace(/\\/g,`/`).replace(/^\/+|\/+$/g,``)).filter(Boolean).join(`/`)}function Ct(e){let t=e.replace(/\\/g,`/`).split(`/`).filter(Boolean);return t[t.length-1]||e}function wt(e,t,n){for(let e of n)if(e&&(t===e||t.startsWith(`${e}/`)))return!0;return!1}function j(e){e.state.filesTransfer=null,e.state.filesTransferDest=``,e.state.filesTreeChildren={},e.state.filesTreeExpanded=[]}async function Tt(e,t,n){if(n.length===0)return;e.state.filesTransfer={op:t,paths:[...n]},e.state.filesTransferDest=e.state.filesPath,e.state.filesTreeChildren={};let r=new Set([``]);if(e.state.filesPath){let t=e.state.filesPath.split(`/`).filter(Boolean),n=``;for(let e of t)n=n?`${n}/${e}`:e,r.add(n)}e.state.filesTreeExpanded=[...r],e.state.filesRenamePath=null,e.state.filesDeletePaths=null,e.state.filesMkdirOpen=!1,e.state.filesUploadMenuOpen=!1,e.state.filesUploadMenuDocClick&&(document.removeEventListener(`click`,e.state.filesUploadMenuDocClick,!0),e.state.filesUploadMenuDocClick=null),k(e),e.clearFlash(),e.render(),await Promise.all([...r].map(t=>Et(e,t)))}async function Et(e,t){let n=e.state.filesTreeChildren[t];if(!(n&&n!==`error`)){e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:`loading`},e.render();try{let n=(await D.filesList(t)).entries.filter(e=>e.type===`dir`).slice().sort((e,t)=>e.name.localeCompare(t.name,void 0,{sensitivity:`base`}));if(!e.state.filesTransfer)return;e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:n}}catch(n){if(!e.state.filesTransfer)return;e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:`error`},C.warn(`files.tree`,{path:t||`/`,error:n instanceof Error?n.message:String(n)})}e.render()}}function Dt(t){if(!t.state.filesTransfer)return``;let n=t.state.filesTransfer.paths,r=[],i=(a,o)=>{let s=t.state.filesTransferDest===a,c=wt(t,a,n),l=t.state.filesTreeExpanded.includes(a),u=t.state.filesTreeChildren[a],d=Array.isArray(u),f=a===``||u===`loading`||u===`error`||!d||u.length>0,p=a===``?`Home`:Ct(a),m=c?`Cannot use a selected item (or a folder inside it) as the destination`:a===``?`File home host.root`:a,h=l?`▾`:`▸`;if(r.push(`<div class="files-tree-row${s?` is-selected`:``}${c?` is-blocked`:``}" style="--depth:${o}" role="treeitem" aria-selected="${s}" aria-expanded="${l}" aria-disabled="${c}">
      ...
      <button type="button" class="files-tree-select${s?` is-selected`:``}" data-action="files-tree-select" data-path="${e(a)}"
        ...
        </div>`);return}if(d){for(let e of u)i(e.path,o+1);u.length===0&&a===``&&r.push(`<div class="files-tree-status muted small" style="--depth:${o+1}">No subfolders yet — destination will be Home.</div>`)}}};return i(``,0),`<div class="files-folder-tree" role="tree" aria-label="Destination folder">${r.join(``)}</div>`}async function Ot(e,t){if(!e.state.filesTransfer||e.state.filesTransfer.paths.length===0)return;let n=new FormData(t),r=(e.state.filesTransferDest||String(n.get(`toPath`)??``)).trim().replace(/^\/+|\/+$/g,``),i=String(n.get(`newName`)??``).trim(),a=e.state.filesTransfer.op,o=[...e.state.filesTransfer.paths],s=o.length>1;if(wt(e,r,o)){e.setFlash(`error`,`Choose a different destination folder`),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();let c=0,l=[];try{for(let e of o)try{if(a===`copy`){let t=Ct(e),n=s||!i||i===t?void 0:i,a=await D.filesCopy(e,{to:r,newName:n});C.event(`files.copy`,{path:e,to:a.entry.path})}else{let t=Ct(e),n=s||!i||i===t?void 0:i;await D.filesMove(e,r,n),C.event(`files.move`,{path:e,to:r})}c+=1}catch(t){l.push(`${Ct(e)}: ${t instanceof Error?t.message:`failed`}`)}j(e),e.state.checkedFilePaths=[],await A(e);let t=a===`copy`?`Copied`:`Moved`;c>0&&l.length===0?e.setFlash(`success`,c===1?`${t} 1 item`:`${t} ${c} items`):c>0?e.setFlash(`info`,`${t} ${c}; ${l.length} failed. ${l[0]}`):e.setFlash(`error`,l[0]||`${a===`copy`?`Copy`:`Move`} failed`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Operation failed`)}finally{e.state.busy=!1,e.render()}}function kt(...e){return e.map(e=>e.replace(/\\/g,`/`).replace(/^\/+|\/+$/g,``)).filter(Boolean).join(`/`)}function At(e){if(!e||typeof e!=`object`)return!1;let t=e.name;return t===`AbortError`||t===`NotAllowedError`}function jt(e,t=!0){return Array.from(e).map(e=>({file:e,relativePath:(e.webkitRelativePath||``).replace(/\\/g,`/`).replace(/^\/+/,``)||e.name||e.name}))}function Mt(e){return new Promise((t,n)=>{let r=[],i=()=>{e.readEntries(e=>{if(!e.length){t(r);return}r.push(...e),i()},e=>n(e))};i()})}function Nt(e){return new Promise((t,n)=>{e.file(t,n)})}async function Pt(e,t){let n=kt(t,e.name);if(e.isFile)return[{file:await Nt(e),relativePath:n||e.name}];if(e.isDirectory){let t=await Mt(e.createReader());if(t.length===0)return[{file:null,relativePath:n,isEmptyDir:!0}];let r=[];for(let e of t)r.push(...await Pt(e,n));return r}return[]}async function*Ft(e){let t=e;if(typeof t.values==`function`){for await(let e of t.values())yield e;return}if(typeof t.entries==`function`)for await(let[,e]of t.entries())yield e}async function It(e,t){let n=kt(t,e.name),r=[],i=0;for await(let t of Ft(e))if(i+=1,t.kind===`file`){let e=await t.getFile();r.push({file:e,relativePath:kt(n,t.name)||e.name})}else t.kind===`directory`&&r.push(...await It(t,n));return i===0&&r.push({file:null,relativePath:n,isEmptyDir:!0}),r}async function Lt(){let e=window;if(typeof e.showOpenFilePicker!=`function`)return{kind:`fallback`};try{let t=await e.showOpenFilePicker({multiple:!0});if(!t||t.length===0)return{kind:`cancel`};let n=[];for(let e of t){let t=await e.getFile();n.push({file:t,relativePath:t.name})}return{kind:`items`,items:n}}catch(e){return At(e)?{kind:`cancel`}:{kind:`fallback`}}}async function Rt(){let e=window;if(typeof e.showDirectoryPicker!=`function`)return{kind:`fallback`};try{let t=await It(await e.showDirectoryPicker({mode:`read`}),``);return t.length===0?{kind:`cancel`}:{kind:`items`,items:t}}catch(e){return At(e)?{kind:`cancel`}:{kind:`fallback`}}}function zt(e){return e.replace(/\\/g,`/`).replace(/^\/+/,``).replace(/\/+$/,``)}function Bt(e){let t=e.files?Array.from(e.files):[],n=[],r=[],i=e.items?Array.from(e.items):[];for(let e of i){if(e.kind!==`file`)continue;let t=e;typeof t.getAsFileSystemHandle==`function`?n.push(t.getAsFileSystemHandle().catch(()=>null)):n.push(Promise.resolve(null));let i=null;if(typeof t.webkitGetAsEntry==`function`)try{i=t.webkitGetAsEntry()}catch{i=null}r.push(i)}return{handlePromises:n,entries:r,files:t}}async function Vt(e){let t=[],n=await Promise.all(e.handlePromises);for(let r=0;r<Math.max(n.length,e.entries.length);r++){let i=n[r]??null;if(i)try{if(i.kind===`file`){let e=await i.getFile();t.push({file:e,relativePath:e.name})}else i.kind===`directory`&&t.push(...await It(i,``));continue}catch{}let a=e.entries[r];if(a)try{t.push(...await Pt(a,``))}catch{}}let r=jt(e.files,!0),i=new Map;for(let e of r){let t=zt(e.relativePath||e.file?.name||``);t&&i.set(t,e)}for(let e of t){let t=zt(e.relativePath||e.file?.name||``);t&&i.set(t,e)}return Array.from(i.values())}function Ht(e){if(!e)return!1;if(e.types&&typeof e.types.includes==`function`)return e.types.includes(`Files`);try{for(let t=0;t<e.types.length;t++)if(e.types[t]===`Files`)return!0}catch{}return!1}function Ut(e,t=80){let n=String(e??``).replace(/\s+/g,` `).trim();return n?n.length>t?`${n.slice(0,t-1)}…`:n:``}function M(e,t,n){let r=Ut(t);return r?`${e} “${r}” ${n}`:`${e} ${n}`}function Wt(e){return Ut(e.displayname||e.fullname)||[e.firstname,e.lastname].map(e=>String(e??``).trim()).filter(Boolean).join(` `)||`Unnamed contact`}function Gt(e){if(!e)return`—`;try{let t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString(void 0,{year:`numeric`,month:`short`,day:`numeric`,hour:`2-digit`,minute:`2-digit`})}catch{return e}}function Kt(e){return!Number.isFinite(e)||e<0?``:e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(1)} MB`}function N(e){let t=Math.max(0,Math.floor(e)),n=Math.floor(t/60),r=t%60;return n>0?`${n}m ${r}s`:`${r}s`}function P(e){return!Number.isFinite(e)||e<0?`—`:e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:e<1073741824?`${(e/1048576).toFixed(1)} MB`:`${(e/1073741824).toFixed(2)} GB`}function qt(e){if(!e)return`—`;try{return new Date(e*1e3).toLocaleString()}catch{return`—`}}function F(t,n,r,i,a,o=``){let s=r===n,c=s?i===`asc`?` ▲`:` ▼`:``;return`<th class="${`sortable-th${s?` is-sorted`:``}${o?` `+o:``}`}" data-action="sort-${a}" data-sort="${e(n)}" role="columnheader" tabindex="0">${e(t)}${c}</th>`}var Jt=new Set([`docx`,`xlsx`,`pptx`,`odt`,`ods`,`odp`,`doc`,`xls`,`ppt`]),Yt=new Set([`jpg`,`jpeg`,`jfif`,`png`,`gif`,`webp`,`bmp`,`avif`,`ico`,`heic`,`heif`]),Xt=new Set([`mp3`,`wav`,`ogg`,`oga`,`flac`,`aac`,`m4a`,`opus`,`weba`]),Zt=new Set([`mp4`,`m4v`,`webm`,`ogv`,`mov`]),Qt=new Set(`txt.md.markdown.rst.csv.tsv.json.jsonc.xml.yml.yaml.html.htm.xhtml.js.mjs.cjs.ts.tsx.jsx.css.scss.less.php.py.rb.go.rs.java.c.h.cpp.hpp.cs.sh.bash.zsh.sql.log.ini.conf.cfg.env.toml.diff.patch.vue.svelte.svg.rss.atom.ics.vcf.eml.nfo.rtf.tex.lua.kt.swift.pl.pm`.split(`.`));function $t(e){let t=e.split(/[/\\]/).pop()||e,n=t.lastIndexOf(`.`);return n<=0?``:t.slice(n+1).toLowerCase()}function en(e){let t=$t(e);return Yt.has(t)?`image`:t===`pdf`?`pdf`:Xt.has(t)?`audio`:Zt.has(t)?`video`:Jt.has(t)?`office`:Qt.has(t)?`text`:`unsupported`}function tn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function nn(e){return e.replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`).replace(/&quot;/g,`"`).replace(/&apos;/g,`'`).replace(/&#(\d+);/g,(e,t)=>String.fromCharCode(Number(t))).replace(/&#x([0-9a-fA-F]+);/g,(e,t)=>String.fromCharCode(parseInt(t,16)))}function rn(e,t){let n=[],r=new RegExp(t.source,t.flags.includes(`g`)?t.flags:`${t.flags}g`),i;for(;i=r.exec(e);)n.push(i[1]??i[0]);return n}function I(e,t){let n=RegExp(`<(?:[\\w.-]+:)?${t}\\b[^>]*>[\\s\\S]*?</(?:[\\w.-]+:)?${t}>`,`gi`);return e.match(n)??[]}function L(e,t){return rn(e,RegExp(`<(?:[\\w.-]+:)?${t}\\b[^>]*>([\\s\\S]*?)</(?:[\\w.-]+:)?${t}>`,`gi`)).map(e=>nn(e.replace(/<[^>]+>/g,``)))}function an(e){let t=I(e,`p`);if(t.length===0){let t=L(e,`t`).join(` `).trim();return t?`<p>${tn(t)}</p>`:``}let n=[];for(let e of t){let t=I(e,`r`),r=[],i=t.length?t:[e];for(let e of i){let t=L(e,`t`).join(``);if(!t)continue;let n=tn(t);(/<(?:[\w.-]+:)?b\b/i.test(e)||/w:val="true"[^>]*w:b|w:b\s*\/>/i.test(e))&&(n=`<strong>${n}</strong>`),/<(?:[\w.-]+:)?i\b/i.test(e)&&(n=`<em>${n}</em>`),r.push(n)}n.push(`<p>${r.join(``)||`&nbsp;`}</p>`)}let r=I(e,`tbl`);for(let e of r){let t=I(e,`tr`).map(e=>`<tr>${I(e,`tc`).map(e=>`<td>${tn(L(e,`t`).join(` `))}</td>`).join(``)}</tr>`).join(``);t&&n.push(`<table class="files-preview-sheet">${t}</table>`)}return n.join(``)}function on(e,t){let n=e?L(e,`t`):[],r=I(t,`row`);return r.length===0?``:`<table class="files-preview-sheet">${r.map(e=>`<tr>${I(e,`c`).map(e=>{let t=/\bt="s"/.test(e),r=(L(e,`v`)[0]??L(e,`t`)[0]??``).trim(),i=r;if(t){let e=Number(r);i=Number.isFinite(e)&&n[e]!==void 0?n[e]:r}return`<td>${tn(i)}</td>`}).join(``)}</tr>`).join(``)}</table>`}function sn(e){return e.map((e,t)=>{let n=L(e,`t`).map(e=>e.trim()).filter(Boolean).map(e=>`<p>${tn(e)}</p>`).join(``)||`<p class="muted">(empty slide)</p>`;return`<section class="files-preview-slide"><h3>Slide ${t+1}</h3>${n}</section>`}).join(``)}function cn(e){let t=I(e,`p`);return t.length===0?L(e,`p`).map(e=>`<p>${tn(e)}</p>`).join(``):t.map(e=>`<p>${tn(nn(e.replace(/<[^>]+>/g,` `)).replace(/\s+/g,` `).trim())||`&nbsp;`}</p>`).join(``)}function ln(e,t){return e.getUint16(t,!0)}function un(e,t){return e.getUint32(t,!0)}async function dn(e){if(typeof DecompressionStream>`u`)throw Error(`Deflate is not available in this browser`);let t=new DecompressionStream(`deflate-raw`),n=new Blob([e]).stream().pipeThrough(t),r=await new Response(n).arrayBuffer();return new Uint8Array(r)}async function fn(e){let t=new Uint8Array(e),n=new DataView(e),r=-1,i=Math.max(0,t.length-22-65535);for(let e=t.length-22;e>=i;e--)if(un(n,e)===101010256){r=e;break}if(r<0)throw Error(`Not a ZIP file`);let a=ln(n,r+10),o=un(n,r+16),s=new Map,c=new TextDecoder(`utf-8`);for(let e=0;e<a;e++){if(un(n,o)!==33639248)throw Error(`Bad ZIP directory`);let e=ln(n,o+10),r=un(n,o+20),i=ln(n,o+28),a=ln(n,o+30),l=ln(n,o+32),u=un(n,o+42),d=c.decode(t.subarray(o+46,o+46+i)).replace(/\\/g,`/`);if(o+=46+i+a+l,!d||d.endsWith(`/`))continue;let f=ln(n,u+26),p=ln(n,u+28),m=u+30+f+p,h=t.subarray(m,m+r);e===0?s.set(d,h.slice()):e===8&&s.set(d,await dn(h))}return s}function pn(e,t){let n=e.get(t);return n?new TextDecoder(`utf-8`).decode(n):null}var mn=20971520;async function hn(e,t){let n=$t(e);if(n===`doc`||n===`xls`||n===`ppt`)throw Error(`Older binary Office files (.doc / .xls / .ppt) cannot be previewed. Download to open them.`);if(t.size>mn)throw Error(`This document is too large to preview. Download it instead.`);let r=await fn(await t.arrayBuffer());if(n===`docx`){let e=pn(r,`word/document.xml`);if(!e)throw Error(`This Word file has no document.xml`);let t=an(e);if(!t)throw Error(`No readable text in this Word file`);return t}if(n===`xlsx`){let e=[...r.keys()].filter(e=>/^xl\/worksheets\/sheet\d+\.xml$/i.test(e)).sort((e,t)=>e.localeCompare(t,void 0,{numeric:!0}))[0],t=e?pn(r,e):null;if(!t)throw Error(`This spreadsheet has no worksheet`);let n=on(pn(r,`xl/sharedStrings.xml`),t);if(!n)throw Error(`No readable cells in this spreadsheet`);return n}if(n===`pptx`){let e=[...r.keys()].filter(e=>/^ppt\/slides\/slide\d+\.xml$/i.test(e)).sort((e,t)=>e.localeCompare(t,void 0,{numeric:!0})).map(e=>pn(r,e)).filter(e=>!!e);if(e.length===0)throw Error(`This presentation has no slides`);return sn(e)}if(n===`odt`||n===`ods`||n===`odp`){let e=pn(r,`content.xml`);if(!e)throw Error(`This OpenDocument file has no content.xml`);let t=cn(e);if(!t)throw Error(`No readable text in this document`);return t}throw Error(`This Office file type cannot be previewed`)}var gn=2097152,_n=52428800;function vn(e){let t=e.filesPreview;if(t?.objectUrl)try{URL.revokeObjectURL(t.objectUrl)}catch{}e.filesPreviewSeq+=1,e.filesPreview=null}function R(e){vn(e.state)}async function yn(e,t){let n=e.state.filesEntries.find(e=>e.path===t);if(!n||n.type!==`file`)return;R(e),e.state.filesRenamePath=null,e.state.filesDeletePaths=null,j(e),e.state.filesMkdirOpen=!1,e.state.filesUploadMenuOpen=!1,k(e);let r=en(n.name),i=e.state.filesPreviewSeq+1;e.state.filesPreviewSeq=i;let a={path:n.path,name:n.name,size:n.size,kind:r,status:`loading`,objectUrl:null,text:null,html:null,truncated:!1,error:null};if(r!==`text`&&r!==`pdf`&&r!==`office`){e.state.filesPreview={...a,status:`ready`},C.event(`files.preview`,{path:n.path,kind:r}),e.render();return}e.state.filesPreview=a,e.render();try{if(r===`pdf`&&n.size>_n){if(e.state.filesPreviewSeq!==i)return;e.state.filesPreview={...a,status:`error`,error:`This PDF is too large to preview (${P(n.size)}). Download it instead.`},e.render();return}let{blob:t}=await D.filesGetBlob(n.path,{inline:!0});if(e.state.filesPreviewSeq!==i)return;if(r===`office`){let r=await hn(n.name,t);if(e.state.filesPreviewSeq!==i)return;e.state.filesPreview={...a,status:`ready`,html:r}}else if(r===`pdf`){let n=t.type&&t.type.toLowerCase().includes(`pdf`)?t:new Blob([t],{type:`application/pdf`});e.state.filesPreview={...a,status:`ready`,objectUrl:URL.createObjectURL(n)}}else{let n=t.size>gn,r=await(n?t.slice(0,gn):t).text();if(e.state.filesPreviewSeq!==i)return;e.state.filesPreview={...a,status:`ready`,text:r,truncated:n}}C.event(`files.preview`,{path:n.path,kind:r})}catch(t){if(e.state.filesPreviewSeq!==i)return;e.state.filesPreview={...a,status:`error`,error:t instanceof Error?t.message:`Could not open file`}}e.render()}function bn(t){let n=t.state.filesPreview;if(!n)return``;let r;return r=n.status===`loading`?`<p class="muted" style="margin:0">Loading preview…</p>`:n.status===`error`?`<p class="flash flash-error" style="margin:0">${e(n.error||`Could not open file`)}</p>`:n.kind===`image`?`<div class="files-preview-media">
    ...
    <div class="info-modal" id="info-modal" hidden role="dialog" aria-modal="true" aria-labelledby="info-modal-title">
    ...
    </div>`}var Un=new Set([`zip`,`tar`,`gz`,`tgz`,`bz2`,`7z`,`rar`,`xz`]),Wn=[{value:`all`,label:`All types`},{value:`folder`,label:`Folders`},{value:`file`,label:`Files`},{value:`image`,label:`Images`},{value:`document`,label:`Documents`},{value:`audio`,label:`Audio`},{value:`video`,label:`Video`},{value:`archive`,label:`Archives`},{value:`other`,label:`Other`}];function Gn(e){if(e.type===`dir`)return`folder`;let t=en(e.name);return t===`image`?`image`:t===`pdf`||t===`office`||t===`text`?`document`:t===`audio`?`audio`:t===`video`?`video`:Un.has($t(e.name))?`archive`:`other`}function Kn(e,t){return t===`all`?!0:t===`file`?e.type===`file`:Gn(e)===t}function qn(e,t){let n=t.search.trim().toLowerCase(),r=e.filter(e=>!(!Kn(e,t.type)||n&&!e.name.toLowerCase().includes(n))),i=t.order===`desc`?-1:1;return r=r.slice().sort((e,n)=>t.sort===`name`?e.type===n.type?i*e.name.localeCompare(n.name,void 0,{sensitivity:`base`}):e.type===`dir`?-1:1:t.sort===`size`?e.type===n.type?e.size===n.size?e.name.localeCompare(n.name,void 0,{sensitivity:`base`}):i*(e.size-n.size):e.type===`dir`?1:-1:e.mtime===n.mtime?e.name.localeCompare(n.name,void 0,{sensitivity:`base`}):i*(e.mtime-n.mtime)),r}function Jn(t,n){let r=n?n.split(`/`).filter(Boolean):[],i=``,a=[`<button type="button" class="files-crumb" data-action="files-nav" data-path="" ${t.state.busy?`disabled`:``}>Home</button>`];for(let n of r){i=i?`${i}/${n}`:n;let r=i;a.push(`<span class="files-crumb-sep" aria-hidden="true">/</span>`),a.push(`<button type="button" class="files-crumb" data-action="files-nav" data-path="${e(r)}" ${t.state.busy?`disabled`:``}>${e(n)}</button>`)}return`<nav class="files-breadcrumb" aria-label="Folder path">${a.join(``)}</nav>`}function Yn(t){let n=t.state.filesStatus;if(!n)return`<div class="card"><p class="muted">${t.state.filesLoading||t.state.busy?`Loading…`:`Unable to load file storage status.`}</p></div>`;if(!n.enabled)return`<div class="portal-grid portal-grid-files">
      <section class="card">
        ${B(`Files`,`files`,`h1`)}
      ...
      <section class="card">
        ...
        <p class="muted small">DAV path: <span class="mono">${e(n.davPath)}</span></p>
              ...
              <td class="files-col-mtime hide-sm">${e(qt(n.mtime))}</td>
        ...
        <input type="file" data-action="files-upload-pick-folder" ${t.state.busy?`disabled`:``}
          multiple webkitdirectory directory hidden />`,S=Wn.map(n=>`<option value="${e(n.value)}" ${t.state.filesTypeFilter===n.value?`selected`:``}>${e(n.label)}</option>`).join(``),re=`<div class="files-filter-bar">
    ...
    ${ee}
    ${b}
  </div>`}async function Xn(e,t){let n=new FormData(t),r=String(n.get(`path`)??``),i=String(n.get(`newName`)??``).trim();if(!r||!i){e.setFlash(`error`,`Name is required`),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{await D.filesRename(r,i),C.event(`files.rename`,{path:r,newName:i}),e.state.filesRenamePath=null,await A(e),e.setFlash(`success`,`Renamed to “${i}”`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Rename failed`)}finally{e.state.busy=!1,e.render()}}async function Zn(e,t){let n=new FormData(t),r=String(n.get(`name`)??``).trim();if(!r){e.setFlash(`error`,`Folder name is required`),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{await D.filesMkdir(e.state.filesPath,r),C.event(`files.mkdir`,{path:e.state.filesPath,name:r}),e.state.filesMkdirOpen=!1,await A(e),e.setFlash(`success`,`Created folder “${r}”`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Could not create folder`)}finally{e.state.busy=!1,e.render()}}async function Qn(e,t,n,r){let{state:i}=e;if(t===`files-upload-menu-toggle`)return i.busy||i.filesUploadProgress?!0:(i.filesUploadMenuOpen=!i.filesUploadMenuOpen,i.filesUploadMenuOpen&&(i.filesRenamePath=null,i.filesDeletePaths=null,j(e),i.filesMkdirOpen=!1,k(e)),e.render(),!0);if(t===`files-item-menu-toggle`){r.stopPropagation();let t=n.dataset.path??``;if(!t||mt(i))return!0;if(i.filesItemMenu?.path===t)return k(e),e.render(),!0;let a=n.getBoundingClientRect();return ht(e,t,{x:a.right,y:a.bottom+4,origin:`button`}),!0}if(t===`sort-file`){let t=n.dataset.sort||``;return t!==`name`&&t!==`size`&&t!==`mtime`||(i.filesSort===t?i.filesOrder=i.filesOrder===`asc`?`desc`:`asc`:(i.filesSort=t,i.filesOrder=t===`name`?`asc`:`desc`),e.render(),!0)}if(t===`files-type-filter`){let t=n.value;return i.filesTypeFilter=t===`folder`||t===`file`||t===`image`||t===`document`||t===`audio`||t===`video`||t===`archive`||t===`other`?t:`all`,e.render(),!0}if(t===`files-clear-selection`)return i.checkedFilePaths=[],k(e),e.render(),!0;if(t===`files-upload-files`)return An(e,`files`),!0;if(t===`files-upload-folder`)return An(e,`folder`),!0;if(t===`files-nav`){i.filesPath=n.dataset.path??``,i.filesRenamePath=null,i.filesDeletePaths=null,i.filesTransfer=null,i.filesMkdirOpen=!1,R(e),k(e),i.checkedFilePaths=[],i.busy=!0,e.clearFlash(),e.render();try{await A(e)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Failed to open folder`)}finally{i.busy=!1,e.render()}return!0}if(t===`files-toggle`){r.stopPropagation();let t=n.dataset.path??``;return!t||(n.checked?i.checkedFilePaths.includes(t)||(i.checkedFilePaths=[...i.checkedFilePaths,t]):i.checkedFilePaths=i.checkedFilePaths.filter(e=>e!==t),i.filesItemMenu&&!i.checkedFilePaths.includes(i.filesItemMenu.path)&&k(e),e.render(),!0)}if(t===`files-select-all`){r.stopPropagation();let t=n.checked,a=qn(i.filesEntries,{search:i.filesSearch,type:i.filesTypeFilter,sort:i.filesSort,order:i.filesOrder});return i.checkedFilePaths=t?a.map(e=>e.path):[],i.filesItemMenu&&!i.checkedFilePaths.includes(i.filesItemMenu.path)&&k(e),e.render(),!0}if(t===`files-copy`){let t=n.dataset.path??``;return!t||(R(e),k(e),Tt(e,`copy`,[t]),!0)}if(t===`files-move`){let t=n.dataset.path??``;return!t||(R(e),k(e),Tt(e,`move`,[t]),!0)}if(t===`files-bulk-copy`)return i.checkedFilePaths.length===0||(R(e),k(e),Tt(e,`copy`,[...i.checkedFilePaths]),!0);if(t===`files-bulk-move`)return i.checkedFilePaths.length===0||(R(e),k(e),Tt(e,`move`,[...i.checkedFilePaths]),!0);if(t===`files-bulk-download`){let t=pt(i.filesEntries,i.checkedFilePaths);return t.downloadItems.length===0||(k(e),xt(t.downloadItems),e.render(),!0)}if(t===`files-tree-select`){if(r.preventDefault(),r.stopPropagation(),!i.filesTransfer)return!0;let t=n.dataset.path??``;return wt(e,t,i.filesTransfer.paths)?!0:(i.filesTransferDest=t,e.render(),!0)}if(t===`files-tree-toggle`||t===`files-tree-retry`){if(r.preventDefault(),r.stopPropagation(),!i.filesTransfer)return!0;let a=n.dataset.path??``;if(t===`files-tree-retry`){let t={...i.filesTreeChildren};return delete t[a],i.filesTreeChildren=t,i.filesTreeExpanded.includes(a)||(i.filesTreeExpanded=[...i.filesTreeExpanded,a]),Et(e,a),!0}return i.filesTreeExpanded.includes(a)?(i.filesTreeExpanded=i.filesTreeExpanded.filter(e=>e!==a),e.render()):(i.filesTreeExpanded=[...i.filesTreeExpanded,a],Et(e,a)),!0}if(t===`files-transfer-close`)return j(e),e.render(),!0;if(t===`files-bulk-delete`)return i.checkedFilePaths.length===0||(i.filesDeletePaths=[...i.checkedFilePaths],i.filesRenamePath=null,j(e),R(e),k(e),e.render(),!0);if(t===`files-refresh`){k(e),i.busy=!0,e.clearFlash(),e.render();try{await A(e),e.setFlash(`success`,`Refreshed`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Refresh failed`)}finally{i.busy=!1,e.render()}return!0}if(t===`files-mkdir`)return i.filesMkdirOpen=!0,i.filesUploadMenuOpen=!1,z(e),i.filesUploadDropActive=!1,i.filesRenamePath=null,i.filesDeletePaths=null,j(e),R(e),k(e),e.clearFlash(),e.render(),!0;if(t===`files-mkdir-close`)return i.filesMkdirOpen=!1,e.render(),!0;if(t===`files-rename-open`){let t=n.dataset.path||(i.checkedFilePaths.length===1?i.checkedFilePaths[0]:``);return!t||(i.filesRenamePath=t,i.filesDeletePaths=null,j(e),i.filesUploadMenuOpen=!1,z(e),R(e),k(e),e.render(),!0)}if(t===`files-rename-close`)return i.filesRenamePath=null,e.render(),!0;if(t===`files-delete-open`){let t=n.dataset.path??``;return i.filesDeletePaths=t?[t]:null,i.filesRenamePath=null,j(e),i.filesUploadMenuOpen=!1,z(e),R(e),k(e),e.render(),!0}if(t===`files-delete-close`)return i.filesDeletePaths=null,e.render(),!0;if(t===`files-delete-confirm`){let t=i.filesDeletePaths?[...i.filesDeletePaths]:[];if(t.length===0)return!0;i.busy=!0,e.clearFlash(),e.render();try{if(t.length===1)await D.filesDelete(t[0]),C.event(`files.delete`,{path:t[0]}),e.setFlash(`success`,`Deleted`);else{let n=await D.filesBulk(`delete`,t);C.event(`files.bulk-delete`,{ok:n.ok,failed:n.failed}),n.failed===0?e.setFlash(`success`,n.ok===1?`Deleted 1 item`:`Deleted ${n.ok} items`):n.ok>0?e.setFlash(`info`,`Deleted ${n.ok}; ${n.failed} failed. ${n.errors[0]||``}`):e.setFlash(`error`,n.errors[0]||`Delete failed`)}i.filesDeletePaths=null,i.checkedFilePaths=[],await A(e)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Delete failed`)}finally{i.busy=!1,e.render()}return!0}if(t===`files-download`)return C.event(`files.download`,{path:n.getAttribute(`href`)??``}),!0;if(t===`files-preview-open`){let t=n.dataset.path??``;return t&&yn(e,t),!0}if(t===`files-preview-close`)return R(e),e.render(),!0;if(t===`files-preview-download`){let e=i.filesPreview;if(!e)return!0;let t=document.createElement(`a`);return t.href=D.filesDownloadUrl(e.path),t.download=e.name,t.rel=`noopener`,document.body.appendChild(t),t.click(),t.remove(),C.event(`files.download`,{path:e.path,via:`preview`}),!0}return t===`close-files-upload-progress`?(i.filesUploadProgress&&(i.filesUploadProgress.phase===`done`||i.filesUploadProgress.phase===`error`)&&wn(e),!0):t===`files-upload-conflict-cancel`?(Ln(e,`cancel`),!0):t===`files-upload-conflict-skip`?(Ln(e,`skip`),!0):t===`files-upload-conflict-overwrite`&&(Ln(e,`overwrite`),!0)}function $n(e){let{root:t}=e;t.querySelectorAll(`input[data-action="files-select-all"][data-indeterminate="1"]`).forEach(e=>{e.indeterminate=!0}),gt(e),e.state.filesItemMenu&&(t.querySelector(`#files-item-menu`)?(_t(e),vt(e)):e.state.filesItemMenu=null)}function er(e){return e===`overview`||e===`users`||e===`settings`||e===`database`?e:null}function V(e,t){let n=e.state.adminCapabilities?.pages;return n?n.find(e=>e.id===t)??null:null}function tr(e,t){switch(t){case`full`:return`Full`;case`read-only`:return`Read-only`;case`coming-soon`:return`Coming soon`;case`deferred`:return`Unavailable`;default:return t}}function nr(e,t){return t===`full`||t===`read-only`?`badge-ok`:t===`deferred`?`badge-off`:`badge-soon`}function rr(t){let n=[`overview`,`settings`,`users`,`database`],r={overview:`Overview`,settings:`System settings`,users:`Users`,database:`Database`},i=t.state.adminCapabilities?.pages,a=new Map;if(i)for(let e of i)er(e.id)&&a.set(e.id,e);return n.map(n=>{let i=a.get(n),o=i?.label||r[n],s=i?.status??(n===`overview`?`read-only`:`full`),c=i?.available===!1;return`<button type="button" role="tab" class="tab-btn${t.state.adminPage===n?` is-active`:``}${c?` is-gated`:``}"
          data-action="admin-page" data-admin-page="${n}"
          aria-selected="${t.state.adminPage===n}"
          title="${e(o)}${c?` — `+tr(t,s):``}">
          ${e(o)}
        </button>`}).join(``)}function ir(t,n){let r=V(t,n),i=r?.status??`coming-soon`,a=r?.label??n,o=r?.summary||`This area is not available in portal Administration yet.`,s=tr(t,i);return`<section class="card admin-coming-soon-card">
    <div class="admin-coming-soon-head">
      <span class="badge ${nr(t,i)}">${e(s)}</span>
      <h2 class="admin-coming-soon-title">${e(a)}</h2>
    </div>
    <p class="muted">${e(o)}</p>
  </section>`}function ar(t,n,r,i){return`<div class="admin-stat-card">
    ...
    with role <span class="badge badge-admin">Admin</span>.
    ...
    </section>`;else if(t.state.adminDashboard){let o=t.state.adminDashboard,s=o.services,c=o.links??{},l=n?`<span class="badge ${nr(t,n.status)}">${e(tr(t,n.status))}</span>`:``,u=o.version?e(o.version):`—`,d=o.git?e(o.git):``;i=`
          ...
          <div>
            ...
            <div class="admin-service-table-wrap">
              <table class="admin-kv-table">
                <tbody>
                  <tr><td>Administration</td><td>${sr(t,s.administration!==!1&&s.webAdmin!==!1)}</td></tr>
                  <tr><td>CalDAV</td><td>${sr(t,!!s.caldav)}</td></tr>
                  <tr><td>CardDAV</td><td>${sr(t,!!s.carddav)}</td></tr>
                  <tr><td>Files</td><td>${sr(t,!!s.files)}</td></tr>
                  <tr><td>Tasks</td><td>${sr(t,!!s.tasks)}</td></tr>
                  <tr><td>Notes</td><td>${sr(t,!!s.notes)}</td></tr>
                  <tr><td>Push</td><td>${sr(t,!!s.push)}</td></tr>
                </tbody>
              </table>
            </div>
          </div>
      ...
      <section class="card admin-stats-card">
        ...
        <div class="admin-stat-grid">
          ${ar(t,`Registered users`,f,`Users`)}
          ${ar(t,`Calendars`,p,`CalDAV`)}
          ${ar(t,`Events`,m,`CalDAV`)}
          ${ar(t,`Address books`,h,`CardDAV`)}
          ${ar(t,`Contacts`,g,`CardDAV`)}
        </div>
        <div class="admin-service-row">
          ${or(t,s.administration!==!1&&s.webAdmin!==!1,`Administration`)}
          ${or(t,!!s.caldav,`CalDAV`)}
          ${or(t,!!s.carddav,`CardDAV`)}
          ${or(t,!!s.files,`Files`)}
          ${or(t,!!s.tasks,`Tasks`)}
          ${or(t,!!s.notes,`Notes`)}
          ${or(t,!!s.push,`Push`)}
    ...
    ${a}`}function hr(e){let t=e.state.adminUsersQuery.trim().toLowerCase();return t?e.state.adminUsers.filter(e=>e.username.toLowerCase().includes(t)||(e.displayname||``).toLowerCase().includes(t)||(e.email||``).toLowerCase().includes(t)):e.state.adminUsers}function gr(e){return e.state.adminUserCreateOpen?a({id:`admin-user-create-modal`,title:`Add user`,titleId:`admin-user-create-title`,closeAction:`admin-user-create-close`,size:`sm`,form:!0,formAttrs:`data-form="admin-user-create"`,body:`
  ...
  ${c}${l}${u}`}function br(t){let n=V(t,`users`);if(n&&n.available===!1)return ir(t,`users`);let r=hr(t),i=t.state.adminUsersLoading&&t.state.adminUsers.length===0?`<tr><td colspan="4" class="muted admin-table-empty">Loading users…</td></tr>`:r.length===0?`<tr><td colspan="4" class="muted admin-table-empty">${t.state.adminUsersError?e(t.state.adminUsersError):t.state.adminUsersQuery.trim()?`No users match this filter.`:`No users found.`}</td></tr>`:r.map(n=>`<tr class="contact-table-row${t.state.adminSelectedUsername&&t.state.adminSelectedUsername.toLowerCase()===n.username.toLowerCase()?` is-selected`:``}" data-action="admin-user-view" data-username="${e(n.username)}" tabindex="0" role="button">
    ...
    <section class="card">
      <div class="section-header">
        ${B(`Users`,`admin-users`)}
        <div class="section-actions">
          ${n?`<span class="badge ${nr(t,n.status)}">${e(tr(t,n.status))}</span>`:``}
    ...
    ${gr(t)}
    ${_r(t)}
    ${vr(t)}`}async function xr(e,t){let n=new FormData(t),r=String(n.get(`username`)??``).trim(),i=String(n.get(`displayname`)??``).trim(),a=String(n.get(`email`)??``).trim(),o=String(n.get(`password`)??``),s=String(n.get(`passwordConfirm`)??``);if(!r||!i||!a||!o){e.setFlash(`error`,`Username, display name, email, and password are required`),e.render();return}if(o!==s){e.setFlash(`error`,`Password confirmation does not match`),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{let t=await D.adminCreateUser({username:r,displayname:i,email:a,password:o,passwordConfirm:s});C.event(`admin.user.create`,{username:t.user.username}),e.state.adminUserCreateOpen=!1,e.state.adminSelectedUsername=t.user.username,e.state.adminUserDetail=t.user,e.persistTab(`admin`,`users`,t.user.username),await ur(e),e.setFlash(`success`,`Created user “${t.user.username}”`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Create failed`)}finally{e.state.busy=!1,e.render()}}async function Sr(e,t){let n=new FormData(t),r=String(n.get(`username`)??``).trim(),i=String(n.get(`displayname`)??``).trim(),a=String(n.get(`email`)??``).trim(),o=String(n.get(`password`)??``),s=String(n.get(`passwordConfirm`)??``);if(!r){e.setFlash(`error`,`Username is required`),e.render();return}if(!i||!a){e.setFlash(`error`,`Display name and email are required`),e.render();return}if(o!==``||s!==``){if(o===``||s===``){e.setFlash(`error`,`Password and confirmation are required to change password`),e.render();return}if(o!==s){e.setFlash(`error`,`Password confirmation does not match`),e.render();return}}e.state.busy=!0,e.clearFlash(),e.render();try{let t={displayname:i,email:a};o!==``&&(t.password=o,t.passwordConfirm=s);let n=await D.adminUpdateUser(r,t);C.event(`admin.user.update`,{username:n.user.username,passwordChanged:o!==``}),e.state.adminUserEditOpen=!1,e.state.adminUserDetail=n.user,e.state.adminSelectedUsername=n.user.username,await ur(e),e.setFlash(`success`,o===``?`Updated “${n.user.username}”`:`Updated “${n.user.username}” (password changed)`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Update failed`)}finally{e.state.busy=!1,e.render()}}async function Cr(e,t){if(!e.state.adminSelectedUsername)return;let n=e.state.adminSelectedUsername,r=new FormData(t),i=String(r.get(`displayname`)??``).trim(),a=String(r.get(`description`)??``).trim(),o=String(r.get(`calendarcolor`)??``).trim(),s=t.querySelector(`input[name="todos"]`)?.checked??!1,c=t.querySelector(`input[name="notes"]`)?.checked??!1;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.adminCalModal===`create`){let t=String(r.get(`uri`)??``).trim().toLowerCase();await D.adminCreateUserCalendar(n,{uri:t,displayname:i,description:a,calendarcolor:o||void 0,todos:s,notes:c}),e.setFlash(`success`,`Created calendar “${i}”`)}else{let t=Number(r.get(`instanceId`));await D.adminUpdateUserCalendar(n,t,{displayname:i,description:a,calendarcolor:o,todos:s,notes:c}),e.setFlash(`success`,`Updated calendar “${i}”`)}e.state.adminCalModal=null,e.state.adminCalEditId=null,await dr(e,n),await H(e,n)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Save failed`)}finally{e.state.busy=!1,e.render()}}async function wr(e,t){if(!e.state.adminSelectedUsername)return;let n=e.state.adminSelectedUsername,r=new FormData(t),i=String(r.get(`displayname`)??``).trim(),a=String(r.get(`description`)??``).trim();e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.adminAbModal===`create`){let t=String(r.get(`uri`)??``).trim().toLowerCase();await D.adminCreateUserAddressBook(n,{uri:t,displayname:i,description:a}),e.setFlash(`success`,`Created address book “${i}”`)}else{let t=Number(r.get(`id`));await D.adminUpdateUserAddressBook(n,t,{displayname:i,description:a}),e.setFlash(`success`,`Updated address book “${i}”`)}e.state.adminAbModal=null,e.state.adminAbEditId=null,await dr(e,n),await H(e,n)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Save failed`)}finally{e.state.busy=!1,e.render()}}var Tr=`UTC.Africa/Cairo.Africa/Johannesburg.America/Anchorage.America/Argentina/Buenos_Aires.America/Chicago.America/Denver.America/Edmonton.America/Halifax.America/Los_Angeles.America/Mexico_City.America/New_York.America/Sao_Paulo.America/Toronto.America/Vancouver.Asia/Dubai.Asia/Hong_Kong.Asia/Jerusalem.Asia/Kolkata.Asia/Seoul.Asia/Shanghai.Asia/Singapore.Asia/Tokyo.Australia/Melbourne.Australia/Sydney.Europe/Amsterdam.Europe/Berlin.Europe/London.Europe/Madrid.Europe/Moscow.Europe/Paris.Europe/Rome.Europe/Warsaw.Pacific/Auckland.Pacific/Honolulu`.split(`.`),Er=null;function Dr(){if(Er)return Er;try{let e=Intl;if(typeof e.supportedValuesOf==`function`){let t=e.supportedValuesOf(`timeZone`);if(Array.isArray(t)&&t.length>0)return Er=[...t].sort((e,t)=>e.localeCompare(t)),Er}}catch{}return Er=[...Tr],Er}function Or(e){let t=e||`UTC`,n=Dr(),r=n.includes(t),i=n.map(e=>`<option value="${kr(e)}" ${e===t?`selected`:``}>${Ar(e)}</option>`);return!r&&t&&i.unshift(`<option value="${kr(t)}" selected>${Ar(t)}</option>`),i.join(``)}function kr(e){return e.replace(/&/g,`&amp;`).replace(/"/g,`&quot;`).replace(/</g,`&lt;`)}function Ar(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function jr(t){let n=V(t,`settings`);if(n&&n.available===!1)return ir(t,`settings`);if(t.state.adminSystemSettingsLoading&&!t.state.adminSystemSettings)return`<section class="card"><p class="muted">Loading system settings…</p></section>`;if(t.state.adminSystemSettingsError&&!t.state.adminSystemSettings)return`<section class="card">
    ...
    ${Mr(t)}`}function Mr(t){return t.state.adminResetModalOpen?a({id:`admin-reset-modal`,title:`Reset to Default`,titleId:`admin-reset-title`,closeAction:`admin-reset-close`,size:`sm`,body:`
    ...
    ${Rr(t)}`}function Rr(t){if(!t.state.adminDbConfirmOpen)return``;let n=t.state.adminDbConfirmText.trim()===`CONFIRM`;return a({id:`admin-db-confirm-modal`,title:`Confirm database change`,titleId:`admin-db-confirm-title`,closeAction:`admin-db-confirm-close`,size:`sm`,body:`
        ...
        </label>`,footer:[{label:`Cancel`,action:`admin-db-confirm-close`,variant:`ghost`,disabled:t.state.busy},{label:`Save database settings`,action:`admin-db-confirm-save`,variant:`danger`,disabled:t.state.busy||!n}]})}async function zr(e,t,n={}){if(!e.userIsAdmin()){await e.activateTab(`calendars`,n);return}e.state.activeTab=`admin`,e.state.adminPage=t,t===`users`?n.username!==void 0&&(e.state.adminSelectedUsername=n.username,n.username||(e.state.adminUserDetail=null,e.state.adminUserDetailError=null)):(e.state.adminSelectedUsername=null,e.state.adminUserDetail=null,e.state.adminUserDetailError=null),e.state.userMenuOpen=!1,e.persistTab(`admin`,t,e.state.adminSelectedUsername),C.event(`tab`,{tab:`admin`,adminPage:t,user:e.state.adminSelectedUsername}),n.clearFlash!==!1&&e.clearFlash(),e.state.busy=!0,e.render();try{if(await cr(e),!e.adminUiEnabled()){e.state.activeTab=`calendars`,e.persistTab(`calendars`),e.setFlash(`info`,`Portal Administration UI is disabled.`);return}let n=V(e,t);t===`overview`&&n?.available!==!1?await lr(e):t===`users`&&n?.available!==!1?(await ur(e),e.state.adminSelectedUsername&&(await H(e,e.state.adminSelectedUsername),await dr(e,e.state.adminSelectedUsername))):t===`settings`&&n?.available!==!1?await fr(e):t===`database`&&n?.available!==!1&&await pr(e)}catch(t){C.warn(`admin page load failed`,t instanceof Error?t.message:t),e.setFlash(`error`,t instanceof Error?t.message:`Failed to load`)}finally{e.state.busy=!1,e.render()}}function Br(e){return e.userIsAdmin()?e.adminUiEnabled()?e.state.adminPage===`users`?br(e):e.state.adminPage===`settings`?jr(e):e.state.adminPage===`database`?Lr(e):mr(e):`<section class="card admin-coming-soon-card">
        <div class="admin-coming-soon-head">
    ...
    </div>`}function di(e=document){e.querySelectorAll(`.dt-field.is-open`).forEach(e=>{let t=e.querySelector(`.dt-trigger`),n=e.querySelector(`.dt-popover`);if(!t||!n)return;let r=t.getBoundingClientRect();n.style.position=`fixed`,n.style.visibility=`hidden`,n.style.top=`0`,n.style.left=`0`;let i=n.offsetWidth||320,a=n.offsetHeight||300,o=r.bottom+6;o+a>window.innerHeight-8&&(o=Math.max(8,r.top-a-6));let s=r.left;s+i>window.innerWidth-8&&(s=Math.max(8,window.innerWidth-i-8)),s<8&&(s=8),n.style.top=`${Math.round(o)}px`,n.style.left=`${Math.round(s)}px`,n.style.right=`auto`,n.style.visibility=`visible`,n.style.zIndex=`200`})}function fi(e,t){let n=t.summary||`(No title)`;if(t.allDay||/^\d{4}-\d{2}-\d{2}$/.test(t.start))return n;let r=new Date(t.start);return Number.isNaN(r.getTime())?n:`${r.toLocaleTimeString(void 0,e.timeFormatOpts())} ${n}`}function pi(e,t,n){return new Date(t,n,1).toLocaleString(void 0,{month:`long`,year:`numeric`})}function mi(e){return Ur(e.state.calFocusDay)??new Date}function hi(e){let t=e.state.eventSearch.trim().toLowerCase();return t?e.state.monthEvents.filter(e=>(e.summary||``).toLowerCase().includes(t)):e.state.monthEvents}function gi(e){let t=e.localeWeekStart(),n=mi(e);if(e.state.calView===`week`){let e=qr(n,t);return{from:e.from,to:e.to}}if(e.state.calView===`agenda`){let e=Wr(n,34);return{from:U(n),to:U(e)}}let r=e.state.monthCursor.y,i=e.state.monthCursor.m,a=new Date(r,i,1),o=new Date(r,i+1,0);return{from:U(a),to:U(o)}}function _i(e){return e.allDay||/^\d{4}-\d{2}-\d{2}$/.test(e.start)?Ur(e.start.slice(0,10))??new Date(NaN):new Date(e.start)}function vi(e){return e.getHours()*60+e.getMinutes()}function yi(e){return e===`month`||e===`week`||e===`agenda`?e:null}function bi(e){return`${Ae}:${e}`}function xi(e){if(!e)return null;try{let t=localStorage.getItem(bi(e));if(t==null||t===``)return null;let n=JSON.parse(t);if(!n||typeof n!=`object`)return null;let r=n,i=[];Array.isArray(r.ids)&&(i=r.ids.map(e=>Number(e)).filter(e=>Number.isFinite(e)&&e>0).map(e=>Math.floor(e)));let a=null;if(r.selectedId===null||r.selectedId===void 0)a=null;else{let e=Number(r.selectedId);a=Number.isFinite(e)&&e>0?Math.floor(e):null}let o=yi(r.view)??void 0;return{ids:i,selectedId:a,view:o}}catch{return null}}function Si(e){let t=e.user?.username;if(t)try{let n={ids:e.selectedIds.slice(),selectedId:e.selectedId,view:yi(e.calView)??`month`};localStorage.setItem(bi(t),JSON.stringify(n))}catch{}}async function Ci(e,t){let n=await D.shares(t);e.state.shares=n.shares}function wi(e){let t=e.state.calendars.filter(e=>e.canShare);return t.length===0?null:t.find(e=>{let t=e.uri.toLowerCase(),n=e.displayname.toLowerCase();return t==="default"||n==="default"||n===`default calendar`})??t[0]??null}async function Ti(e){let t=e.state.selectedIds.filter(t=>e.state.calendars.some(e=>e.id===t));if(t.length===0){e.state.monthEvents=[];return}let{from:n,to:r}=gi(e);e.state.monthEventsLoading=!0,C.debug(`loadMonthEvents`,{selectedIds:t,from:n,to:r});try{let i=(await Promise.all(t.map(async e=>(await D.calendarEvents(e,n,r)).events.map(t=>({...t,instanceId:e}))))).flat();i.sort((e,t)=>{let n=e.start||``,r=t.start||``;return n===r?(e.summary||``).localeCompare(t.summary||``):n<r?-1:1}),e.state.monthEvents=i,C.event(`monthEvents.loaded`,{calendarIds:t,count:e.state.monthEvents.length,from:n,to:r})}catch(t){e.state.monthEvents=[],C.warn(`loadMonthEvents failed`,t instanceof Error?t.message:t)}finally{e.state.monthEventsLoading=!1}}function Ei(e,t){let n=e.state.calendars.find(e=>e.id===t);return n?.color?n.color.length>=7?n.color.slice(0,7):n.color:`#3B82F6`}function Di(e,t){e.state.selectedIds.includes(t)?(e.state.selectedIds=e.state.selectedIds.filter(e=>e!==t),e.state.selectedId===t&&(e.state.selectedId=e.state.selectedIds[0]??null)):(e.state.selectedIds=[...e.state.selectedIds,t],e.state.selectedId=t),Si(e.state)}function Oi(t){let n=t.state.calendars.filter(e=>t.state.selectedIds.includes(e.id)),r=n.length===0?`No calendar selected`:n.length===1?n[0].displayname:`${n.length} calendars`,i=n.slice(0,6).map(t=>`<span class="cal-swatch" style="background:${e(t.color&&t.color.length>=7?t.color.slice(0,7):t.color||`#3B82F6`)};margin-top:0" title="${e(t.displayname)}"></span>`).join(``),a=n.length===0?t.state.calendars.length===0?`<p class="muted small month-empty-hint">No calendars yet — create one on the left, or wait for someone to share with you.</p>`:``:t.state.monthEventsLoading?`<p class="muted small month-empty-hint">Loading events…</p>`:``,o=t.state.calView,s=mi(t),c,l,u;if(o===`week`){let e=qr(s,t.localeWeekStart());c=Jr(e.days[0],e.days[6]),l=`Previous week`,u=`Next week`}else o===`agenda`?(c=`Agenda · ${Jr(s,new Date(s.getFullYear(),s.getMonth(),s.getDate()+34))}`,l=`Previous period`,u=`Next period`):(c=pi(t,t.state.monthCursor.y,t.state.monthCursor.m),l=`Previous month`,u=`Next month`);let d=[{id:`month`,label:`Month`},{id:`week`,label:`Week`},{id:`agenda`,label:`Agenda`}].map(e=>`<button type="button" class="btn btn-ghost btn-small cal-view-btn${o===e.id?` is-active`:``}" data-action="cal-view" data-view="${e.id}" ${t.state.busy?`disabled`:``}>${e.label}</button>`).join(``);return{calName:r,swatches:i,emptyHint:a,toolbar:`<div class="month-cal-toolbar">
    ...
    </div>`}}function ki(t){let n=Oi(t),r=mi(t),i=hi(t),a=new Map;for(let e of i)for(let t of Xr(e)){let n=a.get(t)??[];n.push(e),a.set(t,n)}let o=U(new Date),s=[];for(let n=0;n<35;n++){let i=Wr(r,n),c=U(i),l=a.get(c)??[];if(l.length===0)continue;let u=i.toLocaleString(void 0,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}),d=l.map(n=>{let r=n.instanceId,i=fi(t,n),a=Ei(t,r),o=t.state.calendars.find(e=>e.id===r)?.displayname||``;return`<button type="button" class="agenda-event" title="${e(o?`${i} · ${o}`:i)}" style="--ev-color:${e(a)}"
  ...
  </section>`}var Ai=40;function ji(t,n,r){let i=n.instanceId,a=fi(t,n),o=Ei(t,i),s=t.state.calendars.find(e=>e.id===i)?.displayname||``,c=s?`${a} · ${s}`:a,l=0,u=Ai;if(!n.allDay&&!/^\d{4}-\d{2}-\d{2}$/.test(n.start)){let e=_i(n);U(e)===r&&(l=vi(e)/60*Ai);let t=n.end&&!/^\d{4}-\d{2}-\d{2}$/.test(n.end)?new Date(n.end):null;if(t&&!Number.isNaN(t.getTime())){let n=U(e)===r?vi(e):0,i=U(t)===r?vi(t):1440;u=Math.max(18,(i-n)/60*Ai)}}let d=n.allDay||/^\d{4}-\d{2}-\d{2}$/.test(n.start)?`--ev-color:${e(o)}`:`--ev-color:${e(o)};top:${l}px;height:${u}px`;return`<button type="button" class="week-event${n.allDay?``:` is-timed`}" title="${e(c)}"
      style="${d}"
      data-action="open-event" data-instance="${i}" data-uri="${e(n.uri)}" ${t.state.busy?`disabled`:``}>${e(a)}</button>`}function Mi(t){let n=Oi(t),{days:r}=qr(mi(t),t.localeWeekStart()),i=U(new Date),a=hi(t),o=new Map;for(let e of a)for(let t of Xr(e)){let n=o.get(t)??[];n.push(e),o.set(t,n)}let s=t.state.userSettings.dayStartHour,c=t.state.userSettings.dayEndHour,l=Array.from({length:24},(n,r)=>{let i=new Date(2024,0,1,r).toLocaleTimeString(void 0,t.timeFormatOpts());return`<div class="week-hour-label${r>=s&&r<c?` is-workhour`:``}" style="height:${Ai}px">${e(i)}</div>`}).join(``),u=(()=>{let e=t.state.selectedId===null?null:t.state.calendars.find(e=>e.id===t.state.selectedId)??null;return!!(e&&!e.readOnly&&(e.canShare||e.access===`readwrite`))})(),d=[],f=[],p=[];for(let n of r){let r=U(n),a=r===i,l=o.get(r)??[],m=l.filter(e=>e.allDay||/^\d{4}-\d{2}-\d{2}$/.test(e.start)),h=l.filter(e=>!e.allDay&&!/^\d{4}-\d{2}-\d{2}$/.test(e.start)),g=m.map(e=>ji(t,e,r)).join(``),_=h.map(e=>ji(t,e,r)).join(``),v=n.toLocaleString(void 0,{weekday:`short`,month:`short`,day:`numeric`});d.push(`<div class="week-day-head${a?` is-today`:``}"${u?` data-action="new-event-day" data-day="${e(r)}" role="button" tabindex="0" title="Add event on ${e(r)}"`:``}>${e(v)}</div>`),f.push(`<div class="week-allday${a?` is-today`:``}">${g||`<span class="week-allday-empty"></span>`}</div>`);let y=u?`<div class="week-slots">${Array.from({length:24},(n,i)=>{let a=String(i).padStart(2,`0`);return`<button type="button" class="week-slot" data-action="new-event-slot" data-day="${e(r)}" data-hour="${i}" title="Add event at ${e(r)} ${a}:00" ${t.state.busy?`disabled`:``}></button>`}).join(``)}</div>`:``,ee=c>s?`<div class="week-workday" aria-hidden="true"></div>`:``;p.push(`<div class="week-timed${a?` is-today`:``}${u?` is-clickable`:``}" style="height:960px">${ee}${y}${_}</div>`)}return`<section class="card month-cal-card week-cal-card">
    ${n.toolbar}
    ${n.emptyHint}
    <div class="week-wrap" style="--week-hour:${Ai}px;--day-start-h:${s};--day-end-h:${c}">
  ...
  </section>`}function Ii(){return{freq:``,interval:1,until:null,count:null,byDay:[],endMode:`never`}}function Li(e){return e.endMode===`until`||e.endMode===`count`||e.endMode===`never`?e.endMode:e.until?`until`:e.count?`count`:`never`}function Ri(e){let t=String(e.get(`repeatFreq`)??``).trim().toUpperCase();if(!t)return{freq:``,interval:1,until:null,count:null,byDay:[],endMode:`never`};let n=Math.max(1,Math.min(99,Number(e.get(`repeatInterval`)??1)||1)),r=String(e.get(`repeatEndMode`)??`never`),i=r===`until`||r===`count`?r:`never`,a=null,o=null;if(i===`until`){let t=String(e.get(`repeatUntil`)??``).trim();a=t?t.slice(0,10):null}else if(i===`count`){let t=Number(e.get(`repeatCount`)??0);o=Number.isFinite(t)&&t>0?Math.min(999,Math.round(t)):10}let s=e.getAll(`repeatByDay`).map(e=>String(e).toUpperCase()).filter(Boolean);return{freq:t,interval:n,until:a,count:o,byDay:s,endMode:i}}function zi(t){if(!t.state.eventModalOpen||!t.state.editingEvent)return``;let n=t.state.editingEvent,r=n.repeat??Ii(),i=(r.freq||``).toUpperCase(),a=t.state.calendars.filter(e=>e.canShare||e.access===`readwrite`),o=t.state.calendars.filter(e=>e.id===n.instanceId?!0:e.readOnly?!1:e.canShare||e.access===`readwrite`).map(t=>`<option value="${t.id}" ${t.id===n.instanceId?`selected`:``}>${e(t.displayname)}</option>`).join(``),s=n.readOnly||!n.canWrite,c,l;if(n.allDay)c=Zr(n.start),l=Zr(n.end);else{let e=n.start||``,t=n.end||``;if(/^\d{4}-\d{2}-\d{2}$/.test(e)){let n=si(e,t||null);c=n.start,l=n.end||``}else c=li(n.start),l=li(n.end)}let u=[{code:`MO`,label:`Mon`},{code:`TU`,label:`Tue`},{code:`WE`,label:`Wed`},{code:`TH`,label:`Thu`},{code:`FR`,label:`Fri`},{code:`SA`,label:`Sat`},{code:`SU`,label:`Sun`}],d=new Set((r.byDay||[]).map(e=>e.toUpperCase())),f=Li(r),p=!!i&&f===`until`,m=r.until||(f===`until`?Zr(n.start)||U(new Date):``);return`<div class="cal-modal" id="event-edit-modal" role="dialog" aria-modal="true" aria-labelledby="event-modal-title">
    ...
    <div class="cal-modal-card">
      ...
      <p class="muted small">Large imports can time out; try again — already-imported items update faster.</p>`;let d=o?`<p class="muted small" style="margin:0">Please wait…</p>`:i([{label:`Close`,action:`close-import-progress`,variant:`primary`}]);return a({title:c,titleId:`import-progress-title`,closeAction:`close-import-progress`,size:`sm`,className:`import-progress-modal`,cardClassName:`import-progress-card`,rootAttrs:`data-import-progress`,hideClose:o,lockBackdrop:o,body:u,footer:d})}function Xi(e,t,n){return new Promise((e,r)=>{let i=new FileReader;i.onprogress=e=>{e.lengthComputable&&e.total>0?n(Math.min(100,Math.round(e.loaded/e.total*100))):n(null)},i.onload=()=>e(String(i.result??``)),i.onerror=()=>r(i.error??Error(`Failed to read file`)),i.readAsText(t)})}async function Zi(e,t){if(e.state.selectedId===null)return;let n=t.files?.[0];t.value=``,n&&(e.state.calModalOpen=!0,await $i(e,e.state.selectedId,n,{keepEditModalOpen:!0}))}async function Qi(e,t){let n=t.files?.[0];if(t.value=``,!n)return;let r=e.root.querySelector(`[data-form="create-cal"]`),i=r?new FormData(r):new FormData,a=i.get(`holidays`)===`on`,o=i.get(`readOnly`)===`on`;if(a){e.setFlash(`error`,`Turn off “Holidays calendar” to import a .ics file into a new calendar.`),e.state.createCalModalOpen=!0,e.render();return}if(o){e.setFlash(`error`,`Turn off “Read-only” before importing — import cannot write to a read-only calendar.`),e.state.createCalModalOpen=!0,e.render();return}let s=String(i.get(`displayname`)??``).trim();s||=n.name.replace(/\.ics$/i,``).trim()||`Imported calendar`;let c=String(i.get(`description`)??``),l=String(i.get(`color`)??``).trim();e.state.busy=!0,e.clearFlash(),e.state.createCalModalOpen=!0,e.render();try{let t=await D.createCalendar({displayname:s,description:c,color:l,readOnly:!1});e.state.selectedId=t.calendar.id,e.state.createCalModalOpen=!1,await e.loadHome(),e.setFlash(`success`,`Created “${t.calendar.displayname}” — importing…`),await $i(e,t.calendar.id,n,{keepEditModalOpen:!1,successPrefix:`Calendar “${t.calendar.displayname}” created. `})}catch(t){let n=t instanceof Error?t.message:`Create or import failed`;e.state.createCalModalOpen=!0,e.setFlash(`error`,n),e.state.busy=!1,e.render()}}async function $i(e,t,n,r={}){e.state.busy=!0,e.clearFlash(),G(e),e.state.importProgress={kind:`calendar`,fileName:n.name,fileSizeLabel:Kt(n.size),phase:`reading`,readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},Wi(e),e.render();try{let i=await Xi(e,n,t=>{if(!e.state.importProgress||e.state.importProgress.phase!==`reading`)return;e.state.importProgress={...e.state.importProgress,readPercent:t};let n=e.root.querySelector(`.import-progress-bar`),r=e.root.querySelector(`[data-import-status-line]`);n&&t!==null&&(n.classList.remove(`is-indeterminate`),n.style.width=`${t}%`),r&&t!==null&&(r.textContent=`Reading file… ${t}%`)});Gi(e,`uploading`,{readPercent:100}),Gi(e,`processing`,{processPercent:0}),C.event(`import.calendar.start`,{file:n.name,bytes:n.size,calId:t});let a=await D.importCalendar(t,i,t=>{qi(e,t)}),o=e.formatImportResult(a);e.state.selectedId===t&&await Ti(e),G(e),Gi(e,`done`,{ok:!0,resultMessage:`${o} (from “${n.name}”)`}),e.setFlash(`success`,`${r.successPrefix||``}Import finished for “${n.name}”: ${o}.`)}catch(t){let n=t instanceof Error?t.message:`Import failed`;G(e),Gi(e,`error`,{ok:!1,resultMessage:n}),e.setFlash(`error`,n)}finally{r.keepEditModalOpen&&(e.state.calModalOpen=!0),e.state.busy=!1,e.render()}}async function ea(e,t){if(e.state.selectedId===null)return;let n=new FormData(t),r=String(n.get(`username`)??``).trim(),i=String(n.get(`access`)??`read`);if(!r){e.setFlash(`error`,`Select a user to share with`),e.render();return}e.state.calModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.render();try{await D.share(e.state.selectedId,r,i),await Ci(e,e.state.selectedId),e.setFlash(`success`,`Shared with ${r}`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Share failed`)}finally{e.state.busy=!1,e.render()}}async function ta(e,t){if(!e.state.editingEvent||!e.state.editingEvent.canWrite)return;let n=new FormData(t),r=String(n.get(`summary`)??``).trim(),i=String(n.get(`description`)??``).trim(),a=String(n.get(`location`)??``).trim(),o=n.get(`allDay`)===`on`,s=String(n.get(`start`)??``).trim(),c=String(n.get(`end`)??``).trim(),l=Number(n.get(`instanceId`))||e.state.editingEvent.instanceId,u=Ri(n);if(!r){e.setFlash(`error`,`Title is required`),e.render();return}if(!s){e.setFlash(`error`,`Start is required`),e.render();return}let d,f;if(o)d=s.slice(0,10),f=c?c.slice(0,10):d;else if(/^\d{4}-\d{2}-\d{2}$/.test(s)){let e=si(s,c||null);d=new Date(e.start).toISOString(),f=e.end?new Date(e.end).toISOString():null}else d=new Date(s).toISOString(),f=c?new Date(c).toISOString():null;let p=e.state.editingEvent.instanceId,m=e.state.editingEvent.uri,h=e.state.creatingEvent;e.state.busy=!0,e.clearFlash(),e.state.eventModalOpen=!0,e.render(),C.event(h?`event.create`:`event.update`,{instanceId:l,uri:h?null:m,allDay:o,summary:r});try{let t={summary:r,description:i,location:a,allDay:o,start:d,end:f,instanceId:l,repeat:u},n=h?await D.createEvent(l,t):await D.updateEvent(p,m,t);(e.state.selectedId===null||n.event.instanceId!==e.state.selectedId)&&(e.state.selectedId=n.event.instanceId),await Ti(e),e.state.eventModalOpen=!1,e.state.editingEvent=null,e.state.creatingEvent=!1,e.state.eventDtPicker=null,C.event(h?`event.created`:`event.saved`,{uri:n.event.uri,instanceId:n.event.instanceId}),e.setFlash(`success`,M(`Event`,n.event.summary||r,h?`created`:`saved`))}catch(t){C.warn(`event.save failed`,t instanceof Error?t.message:t),e.setFlash(`error`,t instanceof Error?t.message:`Save failed`)}finally{e.state.busy=!1,e.render()}}async function na(e,t){if(e.state.selectedId===null)return;let n=new FormData(t),r=String(n.get(`displayname`)??``).trim(),i=String(n.get(`description`)??``),a=String(n.get(`color`)??``).trim();e.state.busy=!0,e.clearFlash(),e.render();try{let t=await D.updateCalendar(e.state.selectedId,{displayname:r,description:i,color:a});e.state.calModalOpen=!0,await e.loadHome(),e.state.selectedId=t.calendar.id,await Ci(e,e.state.selectedId),await Ti(e),e.setFlash(`success`,`Calendar updated`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Update failed`)}finally{e.state.busy=!1,e.render()}}async function ra(e,t){let n=new FormData(t),r=String(n.get(`displayname`)??``).trim(),i=String(n.get(`description`)??``),a=String(n.get(`color`)??``).trim(),o=n.get(`holidays`)===`on`,s=String(n.get(`holidayCountry`)??``).trim(),c=n.get(`readOnly`)===`on`;if(e.state.createCalModalOpen=!0,o&&!s){e.setFlash(`error`,`Select a country for the holidays calendar`),e.render();return}if(!o&&!r){e.setFlash(`error`,`Display name is required`),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{let t=await D.createCalendar({displayname:r,description:i,color:a,holidays:o,holidayCountry:o?s:void 0,readOnly:c});e.state.selectedId=t.calendar.id,e.state.selectedIds.includes(t.calendar.id)||(e.state.selectedIds=[...e.state.selectedIds,t.calendar.id]),e.state.createCalModalOpen=!1,await e.loadHome();let n=`Created “${t.calendar.displayname}”`,l=t.holidayImport??t.calendar.holidayImport;l&&(n+=`. Holidays imported: ${e.formatImportResult(l)}.`),c&&(n+=` Calendar is read-only.`),e.setFlash(`success`,n)}catch(t){e.state.createCalModalOpen=!0,e.setFlash(`error`,t instanceof Error?t.message:`Create failed`)}finally{e.state.busy=!1,e.render()}}function ia(e){let t=e.root.querySelector(`[data-form="create-cal"]`);if(!t)return;let n=t.querySelector(`input[name="holidays"]`),r=t.querySelector(`#holidays-country-wrap`),i=t.querySelector(`input[name="displayname"]`),a=t.querySelector(`input[name="readOnly"]`);if(!n||!r)return;let o=n.checked;r.hidden=!o,i&&(i.required=!o,o&&!i.value.trim()?i.placeholder=`Auto: Holidays (XX)`:o||(i.placeholder=`Work`)),o&&a&&(a.checked=!0)}function aa(e){ia(e)}function oa(t){let{state:n}=t,r=n.calendars.filter(e=>e.canShare),i=n.calendars.filter(e=>!e.canShare),s=n.calendars.find(e=>e.id===n.selectedId)??null,c=r.map(r=>{let i=n.selectedIds.includes(r.id),a=i?` is-selected`:``,o=r.id===n.selectedId?` is-primary`:``,s=r.color?`<span class="cal-swatch" style="background:${e(r.color)}"></span>`:`<span class="cal-swatch cal-swatch-empty"></span>`,c=t.accessBadge(r.access)+(r.readOnly?`<span class="badge">read-only</span>`:``)+(r.holidaysCountry?`<span class="badge badge-admin">holidays ${e(r.holidaysCountry)}</span>`:``);return`<div class="cal-row${a}${o}" data-action="select-cal" data-id="${r.id}" role="button" tabindex="0" title="Toggle on the month grid">
    ...
    ${t.actionsHtml}
  </div>`}var fa=new Set([`P`,`BR`,`STRONG`,`B`,`EM`,`I`,`U`,`UL`,`OL`,`LI`,`H2`,`H3`,`A`,`BLOCKQUOTE`,`DIV`,`SPAN`]);function pa(e){return/<[a-z][\s\S]*>/i.test(e)}function ma(e){return e.replace(/<\/(p|div|h2|h3|li|blockquote)>/gi,`
`).replace(/<br\s*\/?>/gi,`
`).replace(/<[^>]+>/g,` `).replace(/&nbsp;/g,` `).replace(/&amp;/g,`&`).replace(/&lt;/g,`<`).replace(/&gt;/g,`>`).replace(/&quot;/g,`"`).replace(/\s+\n/g,`
`).replace(/[ \t]+/g,` `).replace(/\n{3,}/g,`

`).trim()}function ha(e){if(!e)return``;if(!pa(e))return e;if(typeof DOMParser>`u`)return e.replace(/<script[\s\S]*?<\/script>/gi,``).replace(/on\w+\s*=/gi,``);let t=new DOMParser().parseFromString(`<div id="n">${e}</div>`,`text/html`).getElementById(`n`);if(!t)return``;let n=e=>{let t=[...e.childNodes];for(let e of t)if(e.nodeType===1){let t=e,r=t.tagName;if(!fa.has(r)){let e=t.parentNode;if(e){for(;t.firstChild;)e.insertBefore(t.firstChild,t);e.removeChild(t)}continue}for(let e of[...t.attributes]){let n=e.name.toLowerCase();if(n.startsWith(`on`)||n===`style`)t.removeAttribute(e.name);else if(r===`A`&&n===`href`){let n=e.value.trim();/^(https?:|mailto:|#)/i.test(n)||t.removeAttribute(`href`)}else(r!==`A`||n!==`href`&&n!==`target`&&n!==`rel`)&&t.removeAttribute(e.name)}r===`A`&&(t.setAttribute(`rel`,`noopener noreferrer`),t.setAttribute(`target`,`_blank`)),n(t)}else e.nodeType!==3&&e.parentNode?.removeChild(e)};return n(t),t.innerHTML}function ga(t,n){let r=ha(t);return`<div class="note-editor">
      ...
      <textarea name="description" hidden>${e(t)}</textarea>
            ...
            <button type="button" class="btn btn-small btn-danger" data-action="note-bulk-delete" ${t.state.busy||r===0?`disabled`:``}>Delete</button>`}):`<button type="button" class="btn btn-primary" data-action="new-note" ${t.state.busy||t.state.noteCalendars.length===0?`disabled`:``}>Add note</button>`,c=t.state.notes.length===0?`<tr class="contacts-empty-row"><td colspan="4" class="muted">${t.state.noteSearch?`No notes match your search.`:`No notes yet. Add one below.`}</td></tr>`:t.state.notes.map(n=>{let r=q(n.instanceId,n.uri),i=!t.state.creatingNote&&r===t.state.selectedNoteKey?` is-selected`:``,a=t.state.checkedNoteKeys.includes(r),o=n.canWrite&&!n.readOnly,s=ma(n.description||``).replace(/\s+/g,` `).slice(0,80);return`<tr class="contact-table-row${i}${a?` is-checked`:``}" data-action="select-note" data-instance="${n.instanceId}" data-uri="${e(n.uri)}" tabindex="0" role="button">
              ...
              <td class="col-note-date muted small">${e(Gt(n.dtstart))}</td>
          ...
          <form class="stack" data-form="note" style="margin-top:1rem">
            ...
            ${t.renderPortalDateTimeField({field:`dtstart`,name:`dtstart`,label:`Date`,value:li(l.dtstart),dateOnly:!1,disabled:!!(l.readOnly&&!t.state.creatingNote),allowClear:!0})}
            <label>Body
              ${ga(l.description,!!(l.readOnly&&!t.state.creatingNote))}
            </label>
            <div class="form-actions-row">
    ...
    <section class="stack items-edit-panel">
      ${d}
              ...
              <td class="col-task-due muted small">${e(Gt(r.due))}</td>
              <td class="col-task-cal muted small">${e(r.calendarName)}</td>
              <td class="col-task-pct muted small">${r.percent?e(String(r.percent))+`%`:`—`}</td>
            </tr>`}).join(``),l=(n,r)=>`<button type="button" class="btn btn-small bulk-apply-btn" data-action="${n}"
      title="${e(r)}" aria-label="${e(r)}" ${t.state.busy||s===0?`disabled`:``}><svg class="bulk-apply-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true" focusable="false">
    <path d="M3.5 8.5 6.5 11.5 12.5 4.5" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
  </svg></button>`,u=t.state.checkedTaskKeys.length-s,d=t.state.checkedTaskKeys.length>0,f=d?da({count:s,extra:u>0?`(${u} read-only skipped)`:void 0,busy:t.state.busy,clearAction:`bulk-task-clear`,actionsHtml:`<button type="button" class="btn btn-small btn-danger" data-action="bulk-task-delete" ${t.state.busy||s===0?`disabled`:``}>Delete</button>`}):`<button type="button" class="btn btn-primary" data-action="new-task" ${t.state.busy||t.state.taskCalendars.length===0?`disabled`:``}>Add task</button>`,p=d?`<div class="task-bulk-fields" role="group" aria-label="Edit selected tasks">
        <div class="bulk-group">
          <label class="bulk-field">Status
            <select id="bulk-task-status" ${t.state.busy||s===0?`disabled`:``}>
              <option value="">—</option>
          ...
          ${l(`bulk-task-status`,`Apply status`)}
        </div>
        <div class="bulk-group bulk-group-due">
          ${t.renderPortalDateTimeField({field:`bulk-due`,name:`bulkDue`,label:`Due`,value:t.state.bulkDueValue,dateOnly:!1,disabled:t.state.busy||s===0,allowClear:!0})}
          ${l(`bulk-task-due`,`Apply due`)}
          <button type="button" class="btn btn-small btn-ghost" data-action="bulk-task-clear-due" ${t.state.busy||s===0?`disabled`:``} title="Clear due date">Clear due</button>
        </div>
        <div class="bulk-group">
          <label class="bulk-field bulk-field-pct">%
            <input type="number" id="bulk-task-percent" min="0" max="100" placeholder="0–100" ${t.state.busy||s===0?`disabled`:``} />
          </label>
          ${l(`bulk-task-percent`,`Apply %`)}
        </div>
      </div>`:``,m=t.state.editingTask,h=t.state.taskCalendars.map(t=>`<option value="${t.id}" ${m&&m.instanceId===t.id?`selected`:``}>${e(t.displayname)}</option>`).join(``),g=m?`<div class="card">
          ${B(t.state.creatingTask?m.parentUid?`New subtask`:`New task`:`Edit task`,`tasks`)}
          <form class="stack" data-form="task" style="margin-top:1rem">
            ${t.state.creatingTask?`<label>Calendar
                  ...
                  </label>`:`<p class="muted small">Calendar: <strong>${e(m.calendarName)}</strong>${m.readOnly?` · read-only`:``}</p>`}
            <label>Title
              <input type="text" name="summary" required maxlength="500" value="${e(m.summary)}" ${m.readOnly&&!t.state.creatingTask?`readonly`:``} />
            </label>
            <label>Description
              <textarea name="description" rows="4" maxlength="20000" ${m.readOnly&&!t.state.creatingTask?`readonly`:``}>${e(m.description)}</textarea>
            </label>
            <label>Parent task
              <select name="parentUid" ${m.readOnly&&!t.state.creatingTask?`disabled`:``}>
                ${Da(t,m,t.state.creatingTask)}
              </select>
              <span class="muted small">Subtasks must use a parent on the same calendar (CalDAV RELATED-TO).</span>
            </label>
            <div class="form-grid form-grid-2">
              <label>Status
                <select name="status" ${m.readOnly&&!t.state.creatingTask?`disabled`:``}>
                  ${[`NEEDS-ACTION`,`IN-PROCESS`,`COMPLETED`,`CANCELLED`].map(t=>`<option value="${t}" ${m.status===t?`selected`:``}>${e(n(t))}</option>`).join(``)}
                </select>
              </label>
              ${t.renderPortalDateTimeField({field:`due`,name:`due`,label:`Due`,value:li(m.due),dateOnly:!1,disabled:!!(m.readOnly&&!t.state.creatingTask),allowClear:!0})}
            </div>
            <div class="form-grid form-grid-2">
              <label>Priority (0–9)
                <input type="number" name="priority" min="0" max="9" value="${e(String(m.priority||0))}" ${m.readOnly&&!t.state.creatingTask?`readonly`:``} />
              </label>
              <label>% complete
                <input type="number" name="percent" min="0" max="100" value="${e(String(m.percent||0))}" ${m.readOnly&&!t.state.creatingTask?`readonly`:``} />
              </label>
            </div>
            <div class="form-actions-row">
              ${t.state.creatingTask||m.canWrite?`<button type="submit" class="btn btn-primary" ${t.state.busy?`disabled`:``}>${t.state.creatingTask?`Create task`:`Save task`}</button>`:``}
              ${!t.state.creatingTask&&m.canWrite?`<button type="button" class="btn btn-ghost" data-action="new-subtask" ${t.state.busy?`disabled`:``}>Add subtask</button>
    ...
    <section class="stack items-edit-panel">
  ...
  </div>`}function Aa(e,t){if(!e.state.editingTask)return;let n=new FormData(t),r=String(n.get(`due`)??``).trim(),i=n.get(`instanceId`),a=i!==null&&String(i)!==``?Number(i):e.state.editingTask.instanceId,o=String(n.get(`parentUid`)??``).trim();e.state.editingTask={...e.state.editingTask,instanceId:Number.isFinite(a)&&a>0?a:e.state.editingTask.instanceId,summary:String(n.get(`summary`)??e.state.editingTask.summary),description:String(n.get(`description`)??e.state.editingTask.description),status:String(n.get(`status`)??e.state.editingTask.status),due:r?new Date(r).toISOString():null,priority:Number(n.get(`priority`)??e.state.editingTask.priority??0),percent:Number(n.get(`percent`)??e.state.editingTask.percent??0),parentUid:o===``?null:o}}async function ja(e,t){let n=Oa(e);if(n.length===0){e.setFlash(`error`,`No writable tasks selected`),e.render();return}let r=n.map(e=>({instanceId:e.instanceId,uri:e.uri}));if(t===`bulk-task-delete`){e.state.busy=!0,e.clearFlash(),e.render();try{let t=await D.bulkTasks({op:`delete`,items:r});e.state.checkedTaskKeys=[],e.state.selectedTaskKey&&n.some(t=>q(t.instanceId,t.uri)===e.state.selectedTaskKey)&&(e.state.selectedTaskKey=null,e.state.editingTask=null,e.state.creatingTask=!1),await wa(e),t.failed>0?e.setFlash(`error`,`Deleted ${t.ok}, failed ${t.failed}${t.errors[0]?`: ${t.errors[0]}`:``}`):e.setFlash(`success`,`Deleted ${t.ok} task${t.ok===1?``:`s`}`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Bulk delete failed`)}finally{e.state.busy=!1,e.render()}return}let i={};if(t===`bulk-task-status`){let t=e.root.querySelector(`#bulk-task-status`)?.value?.trim()??``;if(!t){e.setFlash(`error`,`Choose a status to apply`),e.render();return}i={status:t}}else if(t===`bulk-task-due`){let t=e.state.bulkDueValue.trim();if(!t){e.setFlash(`error`,`Choose a due date to apply`),e.render();return}let n=/^\d{4}-\d{2}-\d{2}$/.test(t)?new Date(t+`T00:00:00`):new Date((t.length,t));if(Number.isNaN(n.getTime())){e.setFlash(`error`,`Invalid due date`),e.render();return}i={due:n.toISOString()}}else if(t===`bulk-task-clear-due`)i={due:null};else if(t===`bulk-task-percent`){let t=e.root.querySelector(`#bulk-task-percent`)?.value?.trim()??``;if(t===``){e.setFlash(`error`,`Enter a percent complete (0–100)`),e.render();return}let n=Number(t);if(!Number.isFinite(n)||n<0||n>100){e.setFlash(`error`,`Percent must be between 0 and 100`),e.render();return}i={percent:Math.round(n)}}e.state.busy=!0,e.clearFlash(),e.render();try{let n=await D.bulkTasks({op:`update`,items:r,fields:i});if(await wa(e),e.state.editingTask&&!e.state.creatingTask){let t=q(e.state.editingTask.instanceId,e.state.editingTask.uri),n=e.state.tasks.find(e=>q(e.instanceId,e.uri)===t);n&&(e.state.editingTask={...n})}let a=t===`bulk-task-status`?`status`:t===`bulk-task-due`||t===`bulk-task-clear-due`?`due date`:`percent`;n.failed>0?e.setFlash(`error`,`Updated ${a} on ${n.ok}, failed ${n.failed}${n.errors[0]?`: ${n.errors[0]}`:``}`):e.setFlash(`success`,`Updated ${a} on ${n.ok} task${n.ok===1?``:`s`}`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Bulk update failed`)}finally{e.state.busy=!1,e.render()}}async function Ma(e,t){let n=new FormData(t),r=String(n.get(`summary`)??``).trim(),i=String(n.get(`description`)??``).trim(),a=String(n.get(`status`)??`NEEDS-ACTION`),o=String(n.get(`due`)??``).trim(),s=o?new Date(o).toISOString():null,c=Number(n.get(`priority`)??0),l=Number(n.get(`percent`)??0),u=String(n.get(`parentUid`)??``).trim(),d=u===``?null:u;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.creatingTask){let t=Number(n.get(`instanceId`));if(!Number.isFinite(t)||t<=0)throw Error(`Select a calendar`);let o=await D.createTask({instanceId:t,summary:r,description:i,status:a,due:s,priority:c,percent:l,parentUid:d});e.state.creatingTask=!1,e.state.selectedTaskKey=q(o.task.instanceId,o.task.uri),e.state.editingTask=o.task,e.setFlash(`success`,M(d?`Subtask`:`Task`,o.task.summary||r,`created`))}else if(e.state.editingTask){let t=await D.updateTask(e.state.editingTask.instanceId,e.state.editingTask.uri,{summary:r,description:i,status:a,due:s,priority:c,percent:l,parentUid:d});e.state.editingTask=t.task,e.state.selectedTaskKey=q(t.task.instanceId,t.task.uri),e.setFlash(`success`,M(`Task`,t.task.summary||r,`saved`))}await wa(e)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Save failed`)}finally{e.state.busy=!1,e.render()}}async function Na(e,t,n,r){let{state:i,render:a,setFlash:o,clearFlash:s}=e;if(t===`sort-task`){let t=n.dataset.sort||``;if(!t)return!0;i.taskSort===t?i.taskOrder=i.taskOrder===`asc`?`desc`:`asc`:(i.taskSort=t,i.taskOrder=t===`due`||t===`summary`?`asc`:`desc`),i.busy=!0,a();try{await e.loadTasks()}catch(e){o(`error`,e instanceof Error?e.message:`Sort failed`)}finally{i.busy=!1,a()}return!0}if(t===`select-task`){if(r.target.closest(`[data-stop-row], .task-check`))return!0;let t=Number(n.dataset.instance),o=n.dataset.uri??``;if(!Number.isFinite(t)||!o)return!0;let c=i.tasks.find(e=>e.instanceId===t&&e.uri===o)??null;return i.creatingTask=!1,i.selectedTaskKey=e.itemKey(t,o),i.editingTask=c?{...c}:null,s(),a(),!0}if(t===`task-check`){r.preventDefault(),r.stopPropagation();let t=Number(n.dataset.instance),o=n.dataset.uri??``;if(!Number.isFinite(t)||!o)return!0;let s=e.itemKey(t,o),c=i.tasks.find(t=>e.itemKey(t.instanceId,t.uri)===s);return!c||!c.canWrite||c.readOnly?!0:(i.checkedTaskKeys=i.checkedTaskKeys.includes(s)?i.checkedTaskKeys.filter(e=>e!==s):[...i.checkedTaskKeys,s],a(),!0)}if(t===`task-select-all`){r.preventDefault();let t=i.tasks.filter(e=>e.canWrite&&!e.readOnly);return i.checkedTaskKeys=t.length>0&&t.every(t=>i.checkedTaskKeys.includes(e.itemKey(t.instanceId,t.uri)))?[]:t.map(t=>e.itemKey(t.instanceId,t.uri)),a(),!0}if(t===`bulk-task-clear`)return i.checkedTaskKeys=[],a(),!0;if(t===`bulk-task-status`||t===`bulk-task-due`||t===`bulk-task-clear-due`||t===`bulk-task-percent`||t===`bulk-task-delete`){if(t===`bulk-task-delete`){let e=i.checkedTaskKeys.length;return e===0?(o(`error`,`No tasks selected`),a(),!0):(i.confirmDelete={scope:`bulk-task`,title:e===1?`Delete task`:`Delete ${e} tasks`,message:e===1?`Delete the selected task?`:`Delete ${e} selected tasks?`,detail:`CalDAV clients will sync the removal. This cannot be undone.`,count:e},a(),!0)}return e.runBulkTaskAction(t),!0}if(t===`new-task`)return i.creatingTask=!0,i.selectedTaskKey=null,i.editingTask={uri:``,instanceId:i.taskCalendars[0]?.id??0,calendarId:0,calendarName:``,calendarUri:``,uid:``,parentUid:null,summary:``,description:``,status:`NEEDS-ACTION`,due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},s(),a(),!0;if(t===`new-subtask`){if(!i.editingTask||i.creatingTask||!i.editingTask.uid||!i.editingTask.canWrite)return!0;let e=i.editingTask;return i.creatingTask=!0,i.selectedTaskKey=null,i.editingTask={uri:``,instanceId:e.instanceId,calendarId:e.calendarId,calendarName:e.calendarName,calendarUri:e.calendarUri,uid:``,parentUid:e.uid,summary:``,description:``,status:`NEEDS-ACTION`,due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},s(),a(),!0}return t===`cancel-task`?(i.creatingTask=!1,i.editingTask=null,i.selectedTaskKey=null,a(),!0):t===`delete-task`?!i.editingTask||i.creatingTask?!0:(i.confirmDelete={scope:`task`,title:`Delete task`,message:`Delete “${String(i.editingTask.summary||`this task`).trim()||`this task`}”?`,detail:`CalDAV clients will sync the removal. This cannot be undone.`},a(),!0):!1}async function Pa(e,t){let n=await D.contacts(t,e.state.contactSearch);e.state.contacts=n.contacts;let r=new Set(n.contacts.map(e=>e.uri));e.state.checkedContactUris=e.state.checkedContactUris.filter(e=>r.has(e)),e.state.selectedContactUri!==null&&!e.state.contacts.some(t=>t.uri===e.state.selectedContactUri)&&(e.state.selectedContactUri=null,e.state.creatingContact||(e.state.editingContact=null,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1))}async function Fa(e,t){if(e.state.selectedAbId===null)return;let n=await D.getContact(e.state.selectedAbId,t);e.state.selectedContactUri=t,e.state.creatingContact=!1;let r=n.contact;e.state.editingContact={...r,emails:Array.isArray(r.emails)?r.emails:[],phones:Array.isArray(r.phones)?r.phones:[],custom:Array.isArray(r.custom)?r.custom:[],address:r.address??La(e),birthday:r.birthday??null},e.state.photoPreview=r.photoDataUri??(r.hasPhoto&&e.state.selectedAbId!==null?`${D.contactPhotoUrl(e.state.selectedAbId,t)}?t=${Date.now()}`:null),e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.contactModalOpen=!0}function Ia(e){e.state.creatingContact=!0,e.state.selectedContactUri=null,e.state.contactModalOpen=!0,e.state.editingContact={uri:``,displayname:``,firstname:``,lastname:``,fullname:``,org:``,title:``,emails:[``],phones:[{type:`cell`,value:``}],address:{street:``,city:``,region:``,postal:``,country:``},birthday:null,url:``,note:``,custom:[],hasPhoto:!1,photoDataUri:null},e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1}function La(e){return{street:``,city:``,region:``,postal:``,country:``}}function Ra(e,t){return new Promise((e,n)=>{let r=new FileReader;r.onload=()=>{let t=String(r.result??``),n=t.indexOf(`,`);e(n>=0?t.slice(n+1):t)},r.onerror=()=>n(Error(`Failed to read photo file`)),r.readAsDataURL(t)})}async function za(e,t){let n=t.files?.[0];if(t.value=``,n){if(n.size>2621440){e.setFlash(`error`,`Photo is too large (max ~2 MB)`),e.render();return}try{let t=await Ra(e,n);e.state.photoBase64Pending=t,e.state.photoPreview=`data:${n.type||`image/jpeg`};base64,${t}`,e.state.removePhotoPending=!1,e.render()}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Failed to read photo`),e.render()}}}async function Ba(e,t){if(e.state.selectedAbId===null)return;let n=t.files?.[0];if(t.value=``,!n)return;let r=e.state.selectedAbId;e.state.abModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.stopImportElapsedTimer(),e.state.importProgress={kind:`contacts`,fileName:n.name,fileSizeLabel:Kt(n.size),phase:`reading`,readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},e.startImportElapsedTimer(),e.render();try{let t=await e.readFileTextWithProgress(n,t=>{if(!e.state.importProgress||e.state.importProgress.phase!==`reading`)return;e.state.importProgress={...e.state.importProgress,readPercent:t};let n=e.root.querySelector(`.import-progress-bar`),r=e.root.querySelector(`[data-import-status-line]`);n&&t!==null&&(n.classList.remove(`is-indeterminate`),n.style.width=`${t}%`),r&&t!==null&&(r.textContent=`Reading file… ${t}%`)});e.setImportPhase(`uploading`,{readPercent:100}),e.setImportPhase(`processing`,{processPercent:0}),C.event(`import.contacts.start`,{file:n.name,bytes:n.size,abId:r});let i=await D.importAddressBook(r,t,t=>{e.applyServerImportProgress(t)}),a=e.formatImportResult(i);await e.loadHome(),e.state.selectedAbId===r&&await Pa(e,r),e.stopImportElapsedTimer(),e.setImportPhase(`done`,{ok:!0,resultMessage:`${a} (from “${n.name}”)`}),e.setFlash(`success`,`Import finished for “${n.name}”: ${a}.`)}catch(t){let n=t instanceof Error?t.message:`Import failed`;e.stopImportElapsedTimer(),e.setImportPhase(`error`,{ok:!1,resultMessage:n}),e.setFlash(`error`,n)}finally{e.state.busy=!1,e.render()}}async function Va(e,t){if(e.state.selectedAbId===null)return;let n=[...e.state.checkedContactUris];if(n.length===0){e.setFlash(`error`,`No contacts selected`),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{let r=await D.bulkContacts(e.state.selectedAbId,{op:t,uris:n}),i=new Set(n);t===`delete`&&(e.state.checkedContactUris=[],e.state.selectedContactUri&&i.has(e.state.selectedContactUri)&&(e.state.selectedContactUri=null,e.state.editingContact=null,e.state.creatingContact=!1,e.state.contactModalOpen=!1)),await Pa(e,e.state.selectedAbId),await e.loadHome(),r.failed>0?e.setFlash(`error`,`${t===`copy`?`Copied`:`Deleted`} ${r.ok}, failed ${r.failed}${r.errors[0]?`: ${r.errors[0]}`:``}`):e.setFlash(`success`,t===`copy`?`Copied ${r.ok} contact${r.ok===1?``:`s`}`:`Deleted ${r.ok} contact${r.ok===1?``:`s`}`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Bulk action failed`)}finally{e.state.busy=!1,e.render()}}async function Ha(e,t){if(e.state.selectedAbId===null)return;let n=ca(e,t),r=Wt(n);e.state.busy=!0,e.clearFlash(),e.state.contactModalOpen=!0,e.render();try{if(e.state.creatingContact){let t=await D.createContact(e.state.selectedAbId,n);e.state.creatingContact=!1,e.state.selectedContactUri=t.contact.uri,e.state.editingContact=null,e.state.contactModalOpen=!1,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.eventDtPicker=null,e.setFlash(`success`,M(`Contact`,Wt(t.contact)||r,`created`))}else if(e.state.selectedContactUri){let t=await D.updateContact(e.state.selectedAbId,e.state.selectedContactUri,n);e.state.selectedContactUri=t.contact.uri,e.state.editingContact=null,e.state.contactModalOpen=!1,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.eventDtPicker=null,e.setFlash(`success`,M(`Contact`,Wt(t.contact)||r,`saved`))}try{await e.loadHome()}catch(t){if(console.error(t),e.state.selectedAbId!==null)try{await Pa(e,e.state.selectedAbId)}catch{}}}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Save failed`)}finally{e.state.busy=!1,e.render()}}async function Ua(e,t){let n=new FormData(t),r=String(n.get(`displayname`)??``).trim(),i=String(n.get(`description`)??``).trim();if(r){e.state.busy=!0,e.clearFlash(),e.render();try{let t=await D.createAddressBook({displayname:r,description:i});e.state.selectedAbId=t.addressbook.id,e.state.selectedContactUri=null,e.state.editingContact=null,e.state.creatingContact=!1,e.state.contactSearch=``,await e.loadHome(),e.setFlash(`success`,`Address book “${t.addressbook.displayname}” created`)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Create failed`)}finally{e.state.busy=!1,e.render()}}}async function Wa(e,t){if(e.state.selectedAbId===null)return;let n=new FormData(t),r=String(n.get(`displayname`)??``).trim(),i=String(n.get(`description`)??``).trim();e.state.abModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.render();try{await D.updateAddressBook(e.state.selectedAbId,{displayname:r,description:i}),await e.loadHome(),e.setFlash(`success`,M(`Address book`,r,`updated`))}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Update failed`)}finally{e.state.busy=!1,e.render()}}function Ga(t){let{state:n}=t,r=n.addressBooks.map(t=>`<div class="cal-row${t.id===n.selectedAbId?` is-selected`:``}" data-action="select-ab" data-id="${t.id}" role="button" tabindex="0">
      ...
      </div>`).join(``),i=n.addressBooks.find(e=>e.id===n.selectedAbId)??null,s=n.checkedContactUris.length,c=n.contacts.length>0&&n.contacts.every(e=>n.checkedContactUris.includes(e.uri)),l=s>0&&!c,u=s>0?da({count:s,busy:n.busy,clearAction:`contact-clear-selection`,actionsHtml:`
    ...
    ${ee}`}async function Ka(e,t,n,r){let{state:i,root:a,render:o,setFlash:s,clearFlash:c}=e;if(t===`select-ab`){let t=Number(n.dataset.id);if(!Number.isFinite(t))return!0;i.selectedAbId=t,i.abModalOpen=!1,i.selectedContactUri=null,i.editingContact=null,i.creatingContact=!1,i.contactModalOpen=!1,i.contactSearch=``,i.contacts=[],i.checkedContactUris=[],i.photoPreview=null,i.photoBase64Pending=null,i.removePhotoPending=!1,c(),i.busy=!0,o();try{await e.loadContacts(t)}catch(e){s(`error`,e instanceof Error?e.message:`Failed to load contacts`)}finally{i.busy=!1,o()}return!0}if(t===`edit-ab`){r.stopPropagation();let t=Number(n.dataset.id);if(!Number.isFinite(t)||!i.addressBooks.find(e=>e.id===t))return!0;let a=i.selectedAbId!==t;i.selectedAbId=t,i.abModalOpen=!0,i.contactModalOpen=!1,c(),a&&(i.selectedContactUri=null,i.editingContact=null,i.creatingContact=!1,i.contactSearch=``,i.contacts=[],i.checkedContactUris=[],i.photoPreview=null,i.photoBase64Pending=null,i.removePhotoPending=!1),i.busy=!0,o();try{a&&await e.loadContacts(t)}catch(e){s(`error`,e instanceof Error?e.message:`Failed to open address book`)}finally{i.busy=!1,o()}return!0}if(t===`close-ab-modal`)return i.abModalOpen=!1,o(),!0;if(t===`contact-check`){r.preventDefault(),r.stopPropagation();let e=n.dataset.uri??``;return!e||(i.checkedContactUris=i.checkedContactUris.includes(e)?i.checkedContactUris.filter(t=>t!==e):[...i.checkedContactUris,e],o(),!0)}if(t===`contact-select-all`)return r.preventDefault(),i.checkedContactUris=i.contacts.length>0&&i.contacts.every(e=>i.checkedContactUris.includes(e.uri))?[]:i.contacts.map(e=>e.uri),o(),!0;if(t===`contact-clear-selection`)return i.checkedContactUris=[],o(),!0;if(t===`contact-bulk-copy`)return await Va(e.contactsHost,`copy`),!0;if(t===`contact-bulk-delete`){let e=i.checkedContactUris.length;return e===0?(s(`error`,`No contacts selected`),o(),!0):(i.confirmDelete={scope:`bulk-contact`,title:e===1?`Delete contact`:`Delete ${e} contacts`,message:e===1?`Delete the selected contact?`:`Delete ${e} selected contacts?`,detail:`CardDAV clients will sync the removal. This cannot be undone.`},o(),!0)}if(t===`contact-bulk-export`){let t=[...i.checkedContactUris];if(i.selectedAbId===null||t.length===0)return s(`error`,`No contacts selected`),o(),!0;i.busy=!0,c(),o();try{let{blob:n,filename:r}=await D.exportContacts(i.selectedAbId,t),a=await e.saveBlobAsFile(n,r);a===`cancelled`?s(`info`,`Export cancelled`):a===`saved`?s(`success`,`Saved ${r}`):s(`success`,`Download started: ${r}`)}catch(e){s(`error`,e instanceof Error?e.message:`Export failed`)}finally{i.busy=!1,o()}return!0}if(t===`select-contact`){if(r.target.closest(`[data-stop-row], .row-check`))return!0;let t=n.dataset.uri??``;if(!t)return!0;c();try{await e.openContact(t)}catch(e){s(`error`,e instanceof Error?e.message:`Failed to load contact`)}return o(),!0}if(t===`new-contact`)return i.selectedAbId===null||(e.startNewContact(),c(),o(),!0);if(t===`cancel-contact`||t===`close-contact-modal`)return i.creatingContact=!1,i.contactModalOpen=!1,i.editingContact=null,i.selectedContactUri=null,i.photoPreview=null,i.photoBase64Pending=null,i.removePhotoPending=!1,i.eventDtPicker=null,c(),o(),!0;if(t===`add-email`||t===`add-phone`||t===`add-custom`)return!i.editingContact||(sa(e.contactsHost),Array.isArray(i.editingContact.emails)||(i.editingContact.emails=[``]),Array.isArray(i.editingContact.phones)||(i.editingContact.phones=[{type:`cell`,value:``}]),Array.isArray(i.editingContact.custom)||(i.editingContact.custom=[]),t===`add-email`?i.editingContact.emails.length<10&&i.editingContact.emails.push(``):t===`add-phone`?i.editingContact.phones.length<10&&i.editingContact.phones.push({type:`other`,value:``}):i.editingContact.custom.length<30&&i.editingContact.custom.push({label:``,value:``}),o(),!0);if(t===`remove-email`){if(!i.editingContact)return!0;sa(e.contactsHost);let t=Number(n.dataset.idx);if(!Number.isFinite(t))return!0;let r=Array.isArray(i.editingContact.emails)?i.editingContact.emails:[``];return i.editingContact.emails=r.filter((e,n)=>n!==t),i.editingContact.emails.length===0&&(i.editingContact.emails=[``]),o(),!0}if(t===`remove-phone`){if(!i.editingContact)return!0;sa(e.contactsHost);let t=Number(n.dataset.idx);if(!Number.isFinite(t))return!0;let r=Array.isArray(i.editingContact.phones)?i.editingContact.phones:[{type:`cell`,value:``}];return i.editingContact.phones=r.filter((e,n)=>n!==t),i.editingContact.phones.length===0&&(i.editingContact.phones=[{type:`cell`,value:``}]),o(),!0}if(t===`remove-custom`){if(!i.editingContact)return!0;sa(e.contactsHost);let t=Number(n.dataset.idx);return!Number.isFinite(t)||(i.editingContact.custom=(Array.isArray(i.editingContact.custom)?i.editingContact.custom:[]).filter((e,n)=>n!==t),o(),!0)}if(t===`remove-photo`)return i.photoPreview=null,i.photoBase64Pending=null,i.removePhotoPending=!0,i.editingContact&&(i.editingContact.hasPhoto=!1),o(),!0;if(t===`delete-contact`)return i.selectedAbId===null||!i.selectedContactUri||(i.confirmDelete={scope:`contact`,title:`Delete contact`,message:`Delete “${String(i.editingContact?.fullname||i.editingContact?.displayname||`this contact`).trim()||`this contact`}”?`,detail:`CardDAV clients will sync the removal. This cannot be undone.`},o(),!0);if(t===`delete-ab`){r.stopPropagation();let e=Number(n.dataset.id??i.selectedAbId);return!Number.isFinite(e)||!i.addressBooks.find(t=>t.id===e)||(i.deleteAbConfirmId=e,i.abModalOpen=!1,i.contactModalOpen=!1,c(),o(),!0)}if(t===`cancel-delete-ab`)return i.deleteAbConfirmId=null,o(),!0;if(t===`confirm-delete-ab`){let t=Number(n.dataset.id),r=a.querySelector(`#delete-ab-confirm`);if(!Number.isFinite(t)||!r?.checked)return!0;let l=i.addressBooks.find(e=>e.id===t);if(!l)return!0;let u=(l.cardCount??0)>0;i.busy=!0,c(),o();try{await D.deleteAddressBook(t,u),i.selectedAbId===t&&(i.selectedAbId=null,i.contacts=[],i.editingContact=null,i.selectedContactUri=null,i.creatingContact=!1),i.deleteAbConfirmId=null,i.abModalOpen=!1,i.contactModalOpen=!1,await e.loadHome(),i.selectedAbId===null&&i.addressBooks.length>0&&(i.selectedAbId=i.addressBooks[0].id,await e.loadContacts(i.selectedAbId)),s(`success`,`Address book deleted`)}catch(e){s(`error`,e instanceof Error?e.message:`Delete failed`)}finally{i.busy=!1,o()}return!0}if(t===`export-ab`){r.stopPropagation();let t=n.dataset.id,a=t!==void 0&&t!==``?Number(t):i.selectedAbId;if(a===null||Number.isNaN(a))return!0;i.busy=!0,c(),o();try{let{blob:t,filename:n}=await D.exportAddressBook(a),r=await e.saveBlobAsFile(t,n);r===`cancelled`?s(`info`,`Export cancelled`):r===`saved`?s(`success`,`Saved ${n}`):s(`success`,`Download started: ${n}`)}catch(e){s(`error`,e instanceof Error?e.message:`Export failed`)}finally{i.busy=!1,o()}return!0}if(t===`export-contact`){if(i.selectedAbId===null||!i.selectedContactUri||i.creatingContact)return!0;i.contactModalOpen=!0,i.busy=!0,c(),o();try{let{blob:t,filename:n}=await D.exportContact(i.selectedAbId,i.selectedContactUri),r=await e.saveBlobAsFile(t,n);r===`cancelled`?s(`info`,`Export cancelled`):r===`saved`?s(`success`,`Saved ${n}`):s(`success`,`Download started: ${n}`)}catch(e){s(`error`,e instanceof Error?e.message:`Export failed`)}finally{i.busy=!1,o()}return!0}return!1}function qa(e){return e===`calendars`||e===`contacts`||e===`tasks`||e===`notes`||e===`files`||e===`admin`?e:null}function Ja(e){return e===`overview`||e===`users`||e===`settings`||e===`database`?e:null}function Ya(){let e=(typeof location<`u`?location.hash:``).replace(/^#/,``).split(/[?&]/)[0].replace(/^\/+/,``);if(!e)return{tab:null,adminPage:null,adminUsername:null};if(e===`admin`||e.startsWith(`admin/`)){let t=e.split(`/`).filter(Boolean),n=Ja(t[1]??`overview`)??`overview`,r=null;if(n===`users`&&t[2])try{r=decodeURIComponent(t[2])}catch{r=t[2]}return{tab:`admin`,adminPage:n,adminUsername:r}}return{tab:qa(e),adminPage:null,adminUsername:null}}function Xa(){let e=Ya().tab;if(e)return e;try{let e=qa(sessionStorage.getItem(Oe));if(e)return e}catch{}return`calendars`}function Za(){let e=Ya().adminPage;if(e)return e;try{let e=Ja(sessionStorage.getItem(ke));if(e)return e}catch{}return`overview`}function Qa(e,t=null){return e===`overview`?`#admin`:e===`users`&&t?`#admin/users/${encodeURIComponent(t)}`:`#admin/${e}`}function $a(e,t=`overview`,n=null){try{sessionStorage.setItem(Oe,e),e===`admin`&&sessionStorage.setItem(ke,t)}catch{}if(typeof history>`u`||typeof location>`u`)return;let r=e===`admin`?Qa(t,n):`#${e}`;location.hash!==r&&history.replaceState(null,``,`${location.pathname}${location.search}${r}`)}function eo(t){return t===`readwrite`?`<span class="badge badge-admin">full access</span>`:t===`read`?`<span class="badge">read-only</span>`:t===`owner`?`<span class="badge badge-ok">owner</span>`:`<span class="badge">${e(t)}</span>`}function to(e){let t=[`${e.imported} new`,`${e.updated} updated`];return e.skipped>0&&t.push(`${e.skipped} skipped`),t.join(`, `)}function no(t){let n=t.confirmDelete;if(!n)return``;let r=n.detail?`<p class="muted small" style="margin:0.75rem 0 0">${e(n.detail)}</p>`:``;return a({id:`portal-confirm-delete-modal`,title:n.title,titleId:`portal-confirm-delete-title`,closeAction:`confirm-delete-cancel`,size:`sm`,body:`<p style="margin:0">${e(n.message)}</p>${r}`,footer:[{label:`Cancel`,action:`confirm-delete-cancel`,variant:`ghost`,disabled:t.busy},{label:`Delete`,action:`confirm-delete-ok`,variant:`danger`,disabled:t.busy}]})}function ro(e){e.confirmDelete=null}var io=`portal-page`,ao=`portal-overlays`;function oo(e){let t=e.querySelector(`#${io}`),n=e.querySelector(`#${ao}`);return(!t||!n)&&(e.replaceChildren(),t=document.createElement(`div`),t.id=io,n=document.createElement(`div`),n.id=ao,e.append(t,n)),{page:t,overlays:n}}function so(e){let t=e.filesPreview,n=t?[t.path,t.status,t.kind,t.objectUrl??``,t.truncated?`1`:`0`,String((t.text??``).length),t.error??``].join(`|`):``,r=e.filesUploadProgress,i=r?[r.phase,r.completedFiles,r.failedFiles,r.bytesSent,r.currentName].join(`|`):``,a=e.importProgress;return`p:${n};u:${i};i:${a?[a.phase,a.readPercent??``,a.processPercent??``,a.processCurrent,a.ok??``].join(`|`):``};c:${e.confirmDelete?e.confirmDelete.scope:``}`}function co(e){return`${Hn()}
      ...
      ${bn(e.filesHost)}`}function lo(e,t,n){e.dataset.overlayKey===n&&e.childElementCount>0||(e.dataset.overlayKey=n,e.innerHTML=t)}function uo(e,t,n){if(!O(e,t))return``;let r=e.activeTab===t;return`<button type="button" role="tab" class="tab-btn${r?` is-active`:``}"
          ...
          ${uo(t,`calendars`,`Calendar`)}
          ${uo(t,`contacts`,`Contacts`)}
          ${uo(t,`tasks`,`Tasks`)}
          ${uo(t,`notes`,`Notes`)}
          ${uo(t,`files`,`Files`)}
          <button type="button" class="info-btn tab-info" data-action="info"
  ...
  </div>`}function mo(e){let{state:t,render:n}=e;e.unbindUserMenuOutside(),t.userMenuOpen&&e.bindUserMenuOutside(),ut(t),t.eventDtPicker&&dt(t,n),e.unbindFilesUploadMenuOutside(),t.filesUploadMenuOpen&&e.bindFilesUploadMenuOutside(),$n(e.filesHost),e.root.querySelectorAll(`input[data-indeterminate="1"]`).forEach(e=>{e.indeterminate=!0}),_a(e.notesHost),e.bindHolidaysToggle(),_o(e),go(e.root),ho(e)}function ho(e){let{state:t,root:n}=e,r=t.filesSearchFocus&&t.activeTab===`files`?`input[data-action="files-search"]`:t.eventSearchFocus&&t.activeTab===`calendars`?`input[data-action="event-search"]`:null;if(!r)return;let i=n.querySelector(r);if(!i)return;i.focus({preventScroll:!0});let a=i.value.length;try{i.setSelectionRange(a,a)}catch{}t.filesSearchFocus=!1,t.eventSearchFocus=!1}function go(e){let t=e.querySelector(`.cal-modal[data-focus-trap]`);if(!t)return;let n=document.activeElement;if(n&&t.contains(n))return;let r=e.querySelector(`#portal-page`);n&&r?.contains(n)||t.querySelector(`button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex='-1'])`)?.focus()}function _o(e){let{state:t,root:n}=e;if(!t.listKeyboardFocus||t.activeTab!==`contacts`&&t.activeTab!==`tasks`&&t.activeTab!==`notes`)return;let r=document.activeElement;if(r&&n.contains(r)&&r.matches(`input:not([type=checkbox]), textarea, select, [contenteditable='true']`)&&!r.closest(`tr.contact-table-row[data-action]`)||r?.closest?.(`tr.contact-table-row[data-action]`))return;let i=null;if(t.activeTab===`contacts`&&t.selectedContactUri)i=n.querySelector(`tr[data-action="select-contact"][data-uri="${CSS.escape(t.selectedContactUri)}"]`);else if(t.activeTab===`tasks`&&t.selectedTaskKey){let e=t.selectedTaskKey.indexOf(`|`);if(e>0){let r=t.selectedTaskKey.slice(0,e),a=t.selectedTaskKey.slice(e+1);i=n.querySelector(`tr[data-action="select-task"][data-instance="${CSS.escape(r)}"][data-uri="${CSS.escape(a)}"]`)}}else if(t.activeTab===`notes`&&t.selectedNoteKey){let e=t.selectedNoteKey.indexOf(`|`);if(e>0){let r=t.selectedNoteKey.slice(0,e),a=t.selectedNoteKey.slice(e+1);i=n.querySelector(`tr[data-action="select-note"][data-instance="${CSS.escape(r)}"][data-uri="${CSS.escape(a)}"]`)}}if(!i){let e=t.activeTab===`contacts`?`select-contact`:t.activeTab===`tasks`?`select-task`:`select-note`;i=n.querySelector(`tr.contact-table-row[data-action="${e}"]`)}i&&i.focus({preventScroll:!0})}async function vo(e,t,n,r){let{state:i,render:a,clearFlash:o,setFlash:s}=e;if(t===`confirm-delete-cancel`)return ro(i),a(),!0;if(t===`confirm-delete-ok`){let t=i.confirmDelete;if(!t)return a(),!0;let n=t.scope;if(ro(i),n===`event`){if(!i.editingEvent||!i.editingEvent.canWrite||i.creatingEvent)return a(),!0;let t=i.editingEvent.instanceId,n=i.editingEvent.uri;i.busy=!0,o(),a();try{await D.deleteEvent(t,n),i.eventModalOpen=!1,i.editingEvent=null,await e.loadMonthEvents(),s(`success`,`Event deleted`)}catch(e){s(`error`,e instanceof Error?e.message:`Delete failed`)}finally{i.busy=!1,a()}return!0}if(n===`task`){if(!i.editingTask||i.creatingTask)return a(),!0;i.busy=!0,o(),a();try{await D.deleteTask(i.editingTask.instanceId,i.editingTask.uri),i.selectedTaskKey=null,i.editingTask=null,await e.loadTasks(),s(`success`,`Task deleted`)}catch(e){s(`error`,e instanceof Error?e.message:`Delete failed`)}finally{i.busy=!1,a()}return!0}if(n===`note`){if(!i.editingNote||i.creatingNote)return a(),!0;i.busy=!0,o(),a();try{await D.deleteNote(i.editingNote.instanceId,i.editingNote.uri),i.selectedNoteKey=null,i.editingNote=null,await e.loadNotes(),s(`success`,`Note deleted`)}catch(e){s(`error`,e instanceof Error?e.message:`Delete failed`)}finally{i.busy=!1,a()}return!0}if(n===`contact`){if(i.selectedAbId===null||!i.selectedContactUri)return a(),!0;i.busy=!0,o(),i.contactModalOpen=!0,a();try{await D.deleteContact(i.selectedAbId,i.selectedContactUri),i.selectedContactUri=null,i.editingContact=null,i.creatingContact=!1,i.contactModalOpen=!1,i.eventDtPicker=null,i.photoPreview=null,await e.loadHome(),s(`success`,`Contact deleted`)}catch(e){s(`error`,e instanceof Error?e.message:`Delete failed`)}finally{i.busy=!1,a()}return!0}if(n===`bulk-task`)return await e.runBulkTaskAction(`bulk-task-delete`),!0;if(n===`bulk-note`)return await xa(e.notesHost,`delete`),!0;if(n===`bulk-contact`)return await Va(e.contactsHost,`delete`),!0;if(n===`revoke-share`){let n=t.href??``;if(!n||i.selectedId===null)return a(),!0;i.calModalOpen=!0,i.busy=!0,o(),a();try{await D.revoke(i.selectedId,n),await e.loadShares(i.selectedId),s(`success`,`Share revoked`)}catch(e){s(`error`,e instanceof Error?e.message:`Revoke failed`)}finally{i.busy=!1,a()}return!0}return a(),!0}if(t===`close-import-progress`)return i.importProgress&&(i.importProgress.phase===`done`||i.importProgress.phase===`error`)&&e.closeImportProgress(),!0;if(t===`logout`){i.busy=!0,C.event(`logout`);try{await D.logout()}catch{}return e.clearPortalSessionState(),o(),a(),!0}if(t===`info`){let t=n.dataset.info??``;return e.openInfoModal(t),!0}if(t===`info-close`)return e.closeInfoModal(),!0;if(t===`about-open`)return r.preventDefault(),it(e.root),!0;if(t===`about-close`)return r.preventDefault(),at(e.root),!0;if(t===`flash-close`)return o(),a(),!0;if(t===`user-settings-open`)return i.userMenuOpen=!1,i.userSettingsOpen=!0,a(),!0;if(t===`user-settings-close`)return S(i),a(),!0;if(t===`set-theme`){let e=c(n.dataset.theme);if(e){if(f(e),i.userSettingsOpen)return!0;a()}return!0}if(t===`user-menu-toggle`)return r.stopPropagation(),i.userMenuOpen=!i.userMenuOpen,a(),!0;if(t===`user-menu-close`)return i.userMenuOpen&&(i.userMenuOpen=!1,a()),!0;if(t===`tab`){let t=qa(n.dataset.tab);return t&&(t===`admin`&&(i.adminPage=`overview`),await e.activateTab(t)),!0}return!1}async function yo(e,t){let n=t.target.closest(`[data-action]`);if(!n)return;let r=n.dataset.action;r&&(C.debug(`action:${r}`,{id:n.dataset.id,tab:n.dataset.tab,uri:n.dataset.uri}),!await vo(e,r,n,t)&&(r.startsWith(`admin-`)&&await Hr(e.adminHost,r,n,t)||(r.startsWith(`files-`)||r===`sort-file`||r===`close-files-upload-progress`)&&await Qn(e.filesHost,r,n,t)||await la(e,r,n,t)||await Na(e,r,n,t)||await Ca(e,r,n,t)||await Ka(e,r,n,t)))}var bo=new WeakMap;function xo(e){if(bo.has(e.root)){C.debug(`portalEvents: already bound for root`);return}bo.set(e.root,!0),e.state.portalEventsBound=!0,e.state.escapeBound=!0;let{root:t}=e;t.addEventListener(`click`,t=>So(e,t)),t.addEventListener(`contextmenu`,t=>Co(e,t)),t.addEventListener(`submit`,t=>wo(e,t)),t.addEventListener(`change`,t=>To(e,t)),t.addEventListener(`input`,t=>Eo(e,t)),t.addEventListener(`keydown`,t=>jo(e,t)),document.addEventListener(`keydown`,t=>Ro(e,t)),t.addEventListener(`dragenter`,t=>Mo(e,`enter`,t)),t.addEventListener(`dragover`,t=>Mo(e,`over`,t)),t.addEventListener(`dragleave`,t=>Mo(e,`leave`,t)),t.addEventListener(`drop`,t=>Mo(e,`drop`,t)),t.addEventListener(`error`,t=>Fo(e,t),!0),C.event(`portalEvents.registered`)}function So(e,t){let n=t.target?.closest?.(`[data-action]`);if(!n||!e.root.contains(n))return;let r=n.dataset.action??``;(r===`info`||r===`info-close`||r===`about-open`||r===`about-close`||r===`user-settings-open`||r===`user-settings-close`)&&(t.preventDefault(),t.stopPropagation()),(r===`dt-set-month`||r===`dt-set-year`)&&t.stopPropagation(),(r===`select-contact`||r===`select-task`||r===`select-note`)&&(e.state.listKeyboardFocus=!0),C.debug(`portalEvents.click`,{action:r}),yo(e,t)}function Co(e,t){let n=t.target;if(!n||!e.root.contains(n))return;if(n.closest(`#files-item-menu`)){t.preventDefault();return}let r=n.closest(`tr.files-row`);if(!r||!e.root.contains(r))return;let i=r.dataset.path??``;!i||mt(e.state)||(t.preventDefault(),ht(e.filesHost,i,{x:t.clientX,y:t.clientY,origin:`context`}))}function wo(e,t){let n=t.target?.closest?.(`form[data-form]`);if(!n||!e.root.contains(n))return;let r=n.dataset.form??``;if(r)switch(t.preventDefault(),C.debug(`portalEvents.submit`,{form:r}),r){case`login`:e.onLogin(n);return;case`share`:e.onShare(n);return;case`edit-event`:e.onSaveEvent(n);return;case`edit-cal`:e.onEditCal(n);return;case`create-cal`:e.onCreateCal(n);return;case`contact`:e.onSaveContact(n);return;case`create-ab`:e.onCreateAb(n);return;case`edit-ab`:e.onEditAb(n);return;case`task`:e.onSaveTask(n);return;case`note`:e.onSaveNote(n);return;case`files-rename`:Xn(e.filesHost,n);return;case`files-transfer`:Ot(e.filesHost,n);return;case`files-mkdir`:Zn(e.filesHost,n);return;case`admin-user-create`:xr(e.adminHost,n);return;case`admin-user-edit`:Sr(e.adminHost,n);return;case`admin-cal`:Cr(e.adminHost,n);return;case`admin-ab`:wr(e.adminHost,n);return;case`admin-settings`:Nr(e.adminHost,n);return;case`admin-database`:Fr(e.adminHost,n);return;case`user-settings`:{let t=ne(n);if(`error`in t){e.setFlash(`error`,t.error),e.render();return}ee(t,e.state.user?.username??null),e.state.userSettings=t,e.state.userSettingsOpen=!1,f(t.theme),e.clearFlash(),e.render();return}default:C.debug(`portalEvents.submit.unknown`,{form:r})}}function To(e,t){let n=t.target;if(!n||!e.root.contains(n))return;let{state:r,root:i,render:a}=e,o=n.closest(`[data-action]`)?.dataset.action??``;if(o===`dt-set-month`||o===`dt-set-year`){t.stopPropagation(),C.debug(`portalEvents.change`,{action:o}),yo(e,t);return}if(o===`admin-db-backend`&&n instanceof HTMLSelectElement){r.adminDbFormBackend=n.value===`pgsql`?`pgsql`:`sqlite`,a();return}if(o===`files-upload-pick-files`&&n instanceof HTMLInputElement){Bn(e.filesHost,n,!1);return}if(o===`files-upload-pick-folder`&&n instanceof HTMLInputElement){Bn(e.filesHost,n,!0);return}if(o===`files-type-filter`){C.debug(`portalEvents.change`,{action:o}),yo(e,t);return}if(o===`import-cal`&&n instanceof HTMLInputElement){Zi(e.calendarsHost,n);return}if(o===`import-create-cal`&&n instanceof HTMLInputElement){Qi(e.calendarsHost,n);return}if(o===`import-ab`&&n instanceof HTMLInputElement){e.calendarsHost.onImportContacts(n);return}if(o===`contact-photo`&&n instanceof HTMLInputElement){za(e.contactsHost,n);return}if(n instanceof HTMLInputElement&&n.id===`delete-cal-confirm`){let e=i.querySelector(`#delete-cal-submit`);e&&(e.disabled=!n.checked||r.busy);return}if(n instanceof HTMLInputElement&&n.id===`delete-ab-confirm`){let e=i.querySelector(`#delete-ab-submit`);e&&(e.disabled=!n.checked||r.busy);return}if(n instanceof HTMLSelectElement&&(n.name===`repeatFreq`||n.name===`repeatEndMode`)){let e=n.closest(`[data-form="edit-event"]`);if(e&&r.editingEvent){let t=new FormData(e);r.editingEvent={...r.editingEvent,repeat:Ri(t),hasRrule:!!String(t.get(`repeatFreq`)??``).trim()},a()}return}if(n instanceof HTMLSelectElement&&n.name===`instanceId`){let t=n.closest(`[data-form="task"]`);if(t&&r.creatingTask&&r.editingTask){let i=Number(n.value);if(!Number.isFinite(i)||i<=0)return;e.syncEditingTaskFromForm(t);let o=r.editingTask.parentUid;r.editingTask={...r.editingTask,instanceId:i,parentUid:o&&r.tasks.some(e=>e.uid===o&&e.instanceId===i)?o:null},a();return}let i=n.closest(`[data-form="note"]`);if(i&&r.creatingNote&&r.editingNote){let t=Number(n.value);if(!Number.isFinite(t)||t<=0)return;e.syncEditingNoteFromForm(i),r.editingNote={...r.editingNote,instanceId:t},a();return}}if(n instanceof HTMLInputElement&&n.name===`holidays`&&n.closest(`[data-form="create-cal"]`)){ia(e.calendarsHost);return}if(n instanceof HTMLInputElement&&n.name===`color`){let e=n.closest(`form`)?.querySelector(`input[name="color_picker"]`);if(e){let t=n.value.trim();t&&!t.startsWith(`#`)&&(t=`#${t}`),/^#[0-9A-Fa-f]{6}/.test(t)&&(e.value=t.slice(0,7),n.value=t.toUpperCase())}return}}function Eo(e,t){let n=t.target;if(!n||!e.root.contains(n))return;let{state:r,root:i,render:a,setFlash:o}=e;if(n instanceof HTMLInputElement&&n.name===`color_picker`){let e=n.closest(`form`)?.querySelector(`input[name="color"]`);e&&(e.value=n.value.toUpperCase());return}let s=n.closest(`[data-action]`)?.dataset.action??``;if(s===`contact-search`&&n instanceof HTMLInputElement){r.listKeyboardFocus=!1,r.searchTimer&&clearTimeout(r.searchTimer);let t=n.value;r.searchTimer=setTimeout(()=>{r.contactSearch=t,(async()=>{try{r.selectedAbId!==null&&await e.loadContacts(r.selectedAbId),a()}catch(e){o(`error`,e instanceof Error?e.message:`Search failed`),a()}})()},250);return}if(s===`task-search`&&n instanceof HTMLInputElement){r.listKeyboardFocus=!1,r.searchTimer&&clearTimeout(r.searchTimer);let t=n.value;r.searchTimer=setTimeout(()=>{r.taskSearch=t,(async()=>{try{await e.loadTasks(),a()}catch(e){o(`error`,e instanceof Error?e.message:`Search failed`),a()}})()},250);return}if(s===`files-search`&&n instanceof HTMLInputElement){r.searchTimer&&clearTimeout(r.searchTimer);let e=n.value;r.searchTimer=setTimeout(()=>{r.filesSearch=e,r.filesSearchFocus=!0,a()},150);return}if(s===`event-search`&&n instanceof HTMLInputElement){r.searchTimer&&clearTimeout(r.searchTimer);let e=n.value;r.searchTimer=setTimeout(()=>{r.eventSearch=e,r.eventSearchFocus=!0,a()},150);return}if(s===`note-search`&&n instanceof HTMLInputElement){r.listKeyboardFocus=!1,r.searchTimer&&clearTimeout(r.searchTimer);let t=n.value;r.searchTimer=setTimeout(()=>{r.noteSearch=t,(async()=>{try{await e.loadNotes(),a()}catch(e){o(`error`,e instanceof Error?e.message:`Search failed`),a()}})()},250);return}if(s===`admin-db-confirm-input`&&n instanceof HTMLInputElement){r.adminDbConfirmText=n.value;let e=i.querySelector(`[data-action="admin-db-confirm-save"]`);e&&(e.disabled=r.busy||r.adminDbConfirmText.trim()!==`CONFIRM`);return}if(s===`admin-reset-password`&&n instanceof HTMLInputElement){r.adminResetPassword=n.value;let e=i.querySelector(`[data-action="admin-reset-confirm"]`);e&&(e.disabled=r.busy||!r.adminResetConfirmChecked||r.adminResetPassword.trim()===``);return}}var Do=`tr.contact-table-row[data-action="select-contact"], tr.contact-table-row[data-action="select-task"], tr.contact-table-row[data-action="select-note"]`,Oo=`tr.contact-table-row[data-action], .cal-row[data-action], .month-cell[data-action]`;function ko(e){let{state:t,root:n}=e,r=``;if(t.activeTab===`contacts`)r=`select-contact`;else if(t.activeTab===`tasks`)r=`select-task`;else if(t.activeTab===`notes`)r=`select-note`;else return[];return Array.from(n.querySelectorAll(`tr.contact-table-row[data-action="${r}"]`))}function Ao(e){e.focus({preventScroll:!1}),e.scrollIntoView({block:`nearest`})}function jo(e,t){let n=t.target;if(!n||!e.root.contains(n))return;if((t.key===`ContextMenu`||t.key===`F10`&&t.shiftKey)&&e.state.activeTab===`files`){let r=n.closest(`tr.files-row`);if(r&&e.root.contains(r)){let n=r.dataset.path??``;if(n){t.preventDefault();let i=(r.querySelector(`.files-row-menu-btn`)??r).getBoundingClientRect();ht(e.filesHost,n,{x:i.right,y:i.bottom+4,origin:`button`});return}}}let r=e.state.activeTab,i=r===`contacts`||r===`tasks`||r===`notes`,a=n instanceof HTMLInputElement&&(n.dataset.action===`contact-search`||n.dataset.action===`task-search`||n.dataset.action===`note-search`);if(!a&&n.closest(`button, a, input, select, textarea, [contenteditable=true]`)&&!n.matches(Oo)&&!n.matches(Do))return;if(i&&(t.key===`ArrowDown`||t.key===`ArrowUp`||t.key===`Home`||t.key===`End`)){let r=ko(e);if(r.length===0)return;let i=n.closest(Do);if(e.state.listKeyboardFocus=!0,t.preventDefault(),!i||a){t.key===`ArrowDown`||t.key===`Home`?Ao(r[0]):Ao(r[r.length-1]);return}let o=r.indexOf(i);if(o<0)return;if(t.key===`Home`){Ao(r[0]);return}if(t.key===`End`){Ao(r[r.length-1]);return}let s=t.key===`ArrowDown`?r[o+1]:r[o-1];s&&Ao(s);return}if(t.key!==`Enter`&&t.key!==` `)return;let o=n.closest(Oo);!o||!e.root.contains(o)||t.target!==o&&t.target.closest(`button, a, input, select, textarea`)||(t.preventDefault(),(o.dataset.action===`select-contact`||o.dataset.action===`select-task`||o.dataset.action===`select-note`)&&(e.state.listKeyboardFocus=!0),C.debug(`portalEvents.keydown.row`,{action:o.dataset.action,key:t.key}),o.click())}function Mo(e,t,n){let{state:r,root:i}=e;if(r.activeTab!==`files`||r.busy||r.filesUploadProgress||!Ht(n.dataTransfer))return;let a=n.target?.closest?.(`[data-files-drop-target]`);if(!a||!i.contains(a)){if(t===`leave`&&r.filesDropDepth>0){let t=n.relatedTarget;t&&t instanceof Node&&i.querySelector(`[data-files-drop-target]`)?.contains(t)||(r.filesDropDepth=0,Po(e))}return}if(t===`enter`){n.preventDefault(),n.stopPropagation(),r.filesDropDepth+=1,No(e,a,!0);return}if(t===`over`){n.preventDefault(),n.stopPropagation(),n.dataTransfer&&(n.dataTransfer.dropEffect=`copy`),No(e,a,!0);return}if(t===`leave`){n.preventDefault(),n.stopPropagation();let t=n.relatedTarget;if(t&&a.contains(t))return;r.filesDropDepth=Math.max(0,r.filesDropDepth-1),r.filesDropDepth===0&&No(e,a,!1);return}n.preventDefault(),n.stopPropagation(),r.filesDropDepth=0,No(e,a,!1);let o=n.dataTransfer;if(!o||r.busy||r.filesUploadProgress)return;r.filesUploadMenuOpen=!1,e.unbindFilesUploadMenuOutside(),k(e.filesHost);let s=Bt(o);C.event(`files.drop.snapshot`,{handles:s.handlePromises.length,entries:s.entries.filter(Boolean).length,files:s.files.length}),(async()=>{try{let t=await Vt(s);if(C.event(`files.drop.items`,{count:t.length,sample:t.slice(0,8).map(e=>e.relativePath)}),t.length===0){e.setFlash(`info`,`Nothing to upload from that drop`),e.render();return}await Rn(e.filesHost,t)}catch(t){e.setFlash(`error`,t instanceof Error?t.message:`Drop failed`),e.render()}})()}function No(e,t,n){if(e.state.filesUploadDropActive===n){t.classList.toggle(`is-dragover`,n);return}e.state.filesUploadDropActive=n,t.classList.toggle(`is-dragover`,n)}function Po(e){e.state.filesUploadDropActive=!1,e.root.querySelectorAll(`[data-files-drop-target].is-dragover`).forEach(e=>{e.classList.remove(`is-dragover`)})}function Fo(e,t){let n=t.target;if(!(n instanceof HTMLImageElement)||!n.classList.contains(`contact-avatar`)||!n.dataset.avatarFallback||!n.isConnected)return;let r=n.dataset.avatarFallback||`?`,i=document.createElement(`span`);i.className=`contact-avatar contact-avatar-fallback`,i.setAttribute(`aria-hidden`,`true`),i.textContent=r,n.replaceWith(i)}var Io=`a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])`;function Lo(e,t){if(t.key!==`Tab`)return;let n=e.querySelector(`.cal-modal[data-focus-trap]`);if(!n)return;let r=[...n.querySelectorAll(Io)].filter(e=>e.offsetParent!==null||e===document.activeElement);if(r.length===0)return;let i=r[0],a=r[r.length-1],o=document.activeElement;!t.shiftKey&&o===a?(t.preventDefault(),i.focus()):t.shiftKey&&(o===i||!n.contains(o))&&(t.preventDefault(),a.focus())}function Ro(e,t){if(Lo(e.root,t),t.key!==`Escape`)return;let{state:n,render:r}=e;if(n.importProgress&&(n.importProgress.phase===`done`||n.importProgress.phase===`error`)){e.closeImportProgress();return}if(n.importProgress)return;if(n.filesUploadProgress&&(n.filesUploadProgress.phase===`done`||n.filesUploadProgress.phase===`error`)){e.closeFilesUploadProgress();return}if(n.filesUploadProgress)return;if(n.filesUploadMenuOpen){n.filesUploadMenuOpen=!1,e.unbindFilesUploadMenuOutside(),r();return}if(n.filesItemMenu){k(e.filesHost),r();return}if(n.userMenuOpen){n.userMenuOpen=!1,e.unbindUserMenuOutside(),r();return}if(n.filesUploadConflict!==null){Ln(e.filesHost,`cancel`);return}if(n.filesPreview!==null){R(e.filesHost),r();return}if(n.filesRenamePath!==null||n.filesDeletePaths!==null||n.filesTransfer!==null||n.filesMkdirOpen){n.filesRenamePath=null,n.filesDeletePaths=null,e.resetFilesTransferTree(),n.filesMkdirOpen=!1,r();return}if(n.confirmDelete){n.confirmDelete=null,r();return}if(n.userSettingsOpen){S(n),r();return}if(ot(e.root)){at(e.root);return}let i=e.root.querySelector(`#info-modal`);if(i&&!i.hidden){e.closeInfoModal();return}if(n.eventDtPicker){n.eventDtPicker=null,ut(n),r();return}if(n.eventModalOpen){n.eventModalOpen=!1,n.editingEvent=null,n.creatingEvent=!1,n.eventDtPicker=null,r();return}if(n.contactModalOpen){n.contactModalOpen=!1,n.editingContact=null,n.creatingContact=!1,n.photoPreview=null,n.photoBase64Pending=null,n.removePhotoPending=!1,r();return}if(n.abModalOpen){n.abModalOpen=!1,r();return}if(n.calModalOpen||n.createCalModalOpen||n.deleteConfirmId!==null||n.deleteAbConfirmId!==null){n.calModalOpen=!1,n.createCalModalOpen=!1,n.deleteConfirmId=null,n.deleteAbConfirmId=null,r();return}if(n.adminUserCreateOpen||n.adminUserEditOpen||n.adminUserDeleteUsername!==null){n.adminUserCreateOpen=!1,n.adminUserEditOpen=!1,n.adminUserDeleteUsername=null,r();return}if(n.adminResetModalOpen){n.adminResetModalOpen=!1,r();return}if(n.adminDbConfirmOpen){n.adminDbConfirmOpen=!1,n.adminDbConfirmText=``,n.adminDbPendingBody=null,r();return}(n.adminCalModal!==null||n.adminAbModal!==null||n.adminResourceDelete!==null)&&(n.adminCalModal=null,n.adminAbModal=null,n.adminResourceDelete=null,r())}function zo(e){let{state:t}=e;if(t.activeTab===`admin`&&(!e.userIsAdmin()||!e.adminUiEnabled())){t.activeTab=Ve(t),t.adminPage=`overview`,e.persistTab(t.activeTab);return}t.activeTab!==`admin`&&!O(t,t.activeTab)&&(t.activeTab=Ve(t),e.persistTab(t.activeTab))}async function Bo(e,t,n={}){return zr(e.adminHost,t,n)}async function Vo(e,t,n={}){let{state:r,render:i,setFlash:a,clearFlash:o}=e;if(t===`admin`&&(!e.userIsAdmin()||!e.adminUiEnabled())&&(e.userIsAdmin()&&r.adminCapabilities&&!r.adminCapabilities.uiEnabled&&a(`info`,`Portal Administration UI is disabled (portal_admin_ui_enabled).`),t=Ve(r)),t!==`admin`&&!O(r,t)&&(a(`info`,`That section is disabled in system settings.`),t=Ve(r)),t!==`files`&&k(e.filesHost),t===`admin`){await e.activateAdminPage(r.adminPage||`overview`,{...n,username:r.adminPage===`users`?r.adminSelectedUsername:null});return}r.activeTab=t,r.userMenuOpen=!1,r.listKeyboardFocus=!1,e.persistTab(t),C.event(`tab`,{tab:t}),t!==`calendars`&&(r.calModalOpen=!1,r.deleteConfirmId=null),t!==`contacts`&&(r.deleteAbConfirmId=null),n.clearFlash!==!1&&o(),r.busy=!0,i();try{t===`contacts`&&r.selectedAbId!==null?await e.loadContacts(r.selectedAbId):t===`calendars`?await e.loadMonthEvents():t===`tasks`?await wa(e.tasksHost):t===`notes`?await ua(e.notesHost):t===`files`&&await A(e.filesHost)}catch(e){C.warn(`tab load failed`,e instanceof Error?e.message:e),a(`error`,e instanceof Error?e.message:`Failed to load`)}finally{r.busy=!1,i()}}async function Ho(e){let{state:t}=e;C.debug(`loadHome`);let[n,r,i]=await Promise.all([D.calendars(),D.directory().catch(()=>({users:[]})),D.addressbooks()]);if(t.calendars=n.calendars,t.directory=r.users,t.addressBooks=i.addressbooks,C.event(`loadHome`,{calendars:t.calendars.length,addressBooks:t.addressBooks.length,directory:t.directory.length}),t.holidayCountries.length===0)try{t.holidayCountries=(await D.holidayCountries()).countries}catch{t.holidayCountries=[]}if(t.selectedIds=t.selectedIds.filter(e=>t.calendars.some(t=>t.id===e)),t.selectedId!==null&&!t.calendars.some(e=>e.id===t.selectedId)&&(t.selectedId=null,t.shares=[],t.calModalOpen=!1,t.deleteConfirmId=null),!t.calendarSelectionSeeded&&t.selectedIds.length===0){let n=xi(t.user?.username);if(n){n.view&&(t.calView=n.view);let e=n.ids.filter(e=>t.calendars.some(t=>t.id===e));t.selectedIds=e,t.selectedId=n.selectedId!==null&&t.calendars.some(e=>e.id===n.selectedId)?n.selectedId:e[0]??null,t.calendarSelectionSeeded=!0,C.debug(`loadHome.calSelection.restored`,{count:e.length,selectedId:t.selectedId,view:t.calView})}else{let n=e.pickDefaultCalendar();n?(t.selectedIds=[n.id],t.selectedId=n.id):t.calendars.length>0&&(t.selectedIds=[t.calendars[0].id],t.selectedId=t.calendars[0].id),t.calendarSelectionSeeded=!0}}else t.selectedIds.length===0?t.selectedId=null:t.calendarSelectionSeeded=!0;t.selectedId===null&&t.selectedIds.length>0&&(t.selectedId=t.selectedIds[0]),Si(t),t.selectedId!==null&&t.calModalOpen?await e.loadShares(t.selectedId):t.selectedId!==null&&(t.shares=[]),t.activeTab===`calendars`&&await e.loadMonthEvents(),t.selectedAbId!==null&&!t.addressBooks.some(e=>e.id===t.selectedAbId)&&(t.selectedAbId=null,t.contacts=[],t.selectedContactUri=null,t.editingContact=null,t.creatingContact=!1),t.deleteAbConfirmId!==null&&!t.addressBooks.some(e=>e.id===t.deleteAbConfirmId)&&(t.deleteAbConfirmId=null),t.selectedAbId===null&&t.addressBooks.length>0&&(t.selectedAbId=t.addressBooks[0].id),t.selectedAbId!==null&&t.activeTab===`contacts`&&await e.loadContacts(t.selectedAbId),t.activeTab===`tasks`&&await wa(e.tasksHost),t.activeTab===`notes`&&await ua(e.notesHost),t.activeTab===`files`&&await A(e.filesHost)}function Uo(e){let{state:t}=e;return $r(t.portalUi.timeFormat)}function Wo(e){let{state:t}=e;return ei(t.portalUi.weekStart)}function Go(e){let{state:t}=e;return ti(t.portalUi.weekStart)}function Ko(e,t,n){let{state:r}=e;return ri(t,n,r.portalUi.timeFormat)}function qo(e,t,n,r,i){let{state:a}=e,o=ii(n);return ui({field:t,value:n,dateOnly:r,allowClear:i,viewY:a.eventDtPicker?.viewY??Number(o.date.slice(0,4)),viewM:a.eventDtPicker?.viewM??Number(o.date.slice(5,7))-1,weekStart:a.portalUi.weekStart,timeFormat:a.portalUi.timeFormat})}function Jo(e){di(e.root)}function Yo(t,n){let{state:r}=t,{field:i,name:a,label:o,value:s,dateOnly:c=!1,required:l,disabled:u,allowClear:d=!0}=n,f=r.eventDtPicker?.field===i,p=Ko(t,s,c);return`<div class="dt-field${f?` is-open`:``}" data-dt-id="${e(i)}">
    ...
    ${f&&!u?qo(t,i,s,c,d):``}
  </div>`}function Xo(e,t){let{state:n}=e;return t===`start`?String(n.editingEvent?.start||``):t===`end`?String(n.editingEvent?.end||``):t===`until`?n.editingEvent?.repeat?.until||Zr(n.editingEvent?.start)||U(new Date):t===`due`?li(n.editingTask?.due):t===`dtstart`?li(n.editingNote?.dtstart):t===`bulk-due`?n.bulkDueValue:t===`birthday`?String(n.editingContact?.birthday||``):``}function Zo(e,t,n){let{state:r}=e;if(t===`start`&&r.editingEvent){r.editingEvent={...r.editingEvent,start:n||``};return}if(t===`end`&&r.editingEvent){r.editingEvent={...r.editingEvent,end:n};return}if(t===`until`&&r.editingEvent){r.editingEvent={...r.editingEvent,repeat:{...r.editingEvent.repeat??e.defaultRepeat(),until:n,endMode:`until`}};return}if(t===`due`&&r.editingTask){if(n===null||n===``)r.editingTask={...r.editingTask,due:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(n))r.editingTask={...r.editingTask,due:new Date(n+`T00:00:00`).toISOString()};else{let e=new Date((n.length,n));r.editingTask={...r.editingTask,due:Number.isNaN(e.getTime())?n:e.toISOString()}}return}if(t===`dtstart`&&r.editingNote){if(n===null||n===``)r.editingNote={...r.editingNote,dtstart:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(n))r.editingNote={...r.editingNote,dtstart:new Date(n+`T00:00:00`).toISOString()};else{let e=new Date((n.length,n));r.editingNote={...r.editingNote,dtstart:Number.isNaN(e.getTime())?n:e.toISOString()}}return}if(t===`birthday`&&r.editingContact){r.editingContact={...r.editingContact,birthday:n&&/^\d{4}-\d{2}-\d{2}/.test(n)?n.slice(0,10):null};return}t===`bulk-due`&&(r.bulkDueValue=n||``)}function Qo(t,n){let{root:r}=t,i=Vn[n];if(!i)return;let a=r.querySelector(`#info-modal`),o=r.querySelector(`#info-modal-title`),s=r.querySelector(`#info-modal-body`);!a||!o||!s||(o.textContent=i.title,s.innerHTML=i.paragraphs.map(t=>`<p>${e(t)}</p>`).join(``),a.hidden=!1,document.body.classList.add(`info-modal-open`),a.querySelector(`.info-modal-close`)?.focus())}function $o(e){let{root:t}=e,n=t.querySelector(`#info-modal`);n&&(n.hidden=!0,document.body.classList.remove(`info-modal-open`))}async function es(e,t){let n=window;if(typeof n.showSaveFilePicker==`function`)try{let r=await(await n.showSaveFilePicker({suggestedName:t})).createWritable();try{await r.write(e)}finally{await r.close()}return`saved`}catch(e){if(e instanceof DOMException&&e.name===`AbortError`)return`cancelled`}let r=URL.createObjectURL(e),i=document.createElement(`a`);return i.href=r,i.download=t,i.rel=`noopener`,i.style.display=`none`,document.body.appendChild(i),i.click(),window.setTimeout(()=>{URL.revokeObjectURL(r),i.remove()},6e4),`started`}function ts(e){let t=e.querySelector(`input[name="color_picker"]`),n=e.querySelector(`input[name="color"]`);!t||!n||(t.addEventListener(`input`,()=>{n.value=t.value.toUpperCase()}),n.addEventListener(`change`,()=>{let e=n.value.trim();e&&!e.startsWith(`#`)&&(e=`#${e}`),/^#[0-9A-Fa-f]{6}/.test(e)&&(t.value=e.slice(0,7),n.value=e.toUpperCase())}))}function ns(e){let t=Pe({activeTab:Xa(),adminPage:Za(),adminSelectedUsername:Ya().adminUsername??null}),n,r,i,a,o,s,c;function l(e,n){Fe(t,e,n)}function u(){Ie(t)}function d(){let n=Qe(e);t.user?fo(c):Ze(e,t,(e,n)=>st(t,e,n)),mo(c),$e(e,n),requestAnimationFrame(()=>{Jo(c),e.querySelector(`.dt-time.is-selected`)?.scrollIntoView({block:`center`})})}function f(){G(i)}function p(){Sn(n)}function m(){j(n)}function h(){ct(t)}function g(){z(n)}function _(){We(t,{stopImportElapsedTimer:f,stopFilesUploadElapsedTimer:p,resetFilesTransferTree:m,unbindUserMenuOutside:h,unbindFilesUploadMenuOutside:g})}function v(e){Ge(t,{message:e,clearSession:_,render:d})}function y(){return{state:t,render:d,handleSessionExpired:v,clearPortalSessionState:_,normalizeActiveTab:()=>zo(c),persistTab:$a,loadHome:()=>Ho(c),loadAdminCapabilities:()=>cr(r),loadAdminDashboard:()=>lr(r),loadAdminUsers:()=>ur(r),loadAdminUserDetail:e=>H(r,e),loadAdminUserResources:e=>dr(r,e),loadAdminSystemSettings:()=>fr(r),loadAdminDatabaseSettings:()=>pr(r),adminPageMeta:e=>V(r,e),setFlash:l,clearFlash:u}}n={state:t,root:e,render:d,setFlash:l,clearFlash:u},r={state:t,root:e,render:d,setFlash:l,clearFlash:u,userIsAdmin:()=>Re(t),adminUiEnabled:()=>ze(t),persistTab:$a,activateTab:(e,t)=>Vo(c,e,t),loadHome:()=>Ho(c),normalizeActiveTab:()=>zo(c)},i={state:t,root:e,render:d,setFlash:l,clearFlash:u,localeWeekStart:()=>Wo(c),localeDowLabels:()=>Go(c),formatDtDisplay:(e,t)=>Ko(c,e,t),timeFormatOpts:()=>Uo(c),renderPortalDateTimeField:e=>Yo(c,e),getDtFieldCurrentValue:e=>Xo(c,e),setDtFieldValue:(e,t)=>Zo(c,e,t),positionDtPopovers:()=>Jo(c),renderFlashBanner:()=>Le(t),accessBadge:eo,formatImportResult:to,loadHome:()=>Ho(c),onImportContacts:e=>Ba(s,e)},a={state:t,root:e,render:d,setFlash:l,clearFlash:u,renderPortalDateTimeField:e=>Yo(c,e)},o={state:t,root:e,render:d,setFlash:l,clearFlash:u,renderPortalDateTimeField:e=>Yo(c,e)},s={state:t,root:e,render:d,setFlash:l,clearFlash:u,renderPortalDateTimeField:e=>Yo(c,e),stopImportElapsedTimer:()=>G(i),startImportElapsedTimer:()=>Wi(i),setImportPhase:(e,t)=>Gi(i,e,t),applyServerImportProgress:e=>qi(i,e),readFileTextWithProgress:(e,t)=>Xi(i,e,t),formatImportResult:to,loadHome:()=>Ho(c)},c={state:t,root:e,render:d,setFlash:l,clearFlash:u,filesHost:n,adminHost:r,calendarsHost:i,notesHost:a,tasksHost:o,contactsHost:s,clearPortalSessionState:_,userIsAdmin:()=>Re(t),adminUiEnabled:()=>ze(t),normalizeActiveTab:()=>zo(c),persistTab:$a,activateTab:(e,t)=>Vo(c,e,t),activateAdminPage:(e,t)=>Bo(c,e,t),loadHome:()=>Ho(c),handleSessionExpired:v,loadShares:e=>Ci(i,e),loadMonthEvents:()=>Ti(i),loadContacts:e=>Pa(s,e),loadTasks:()=>wa(o),loadNotes:()=>ua(a),loadAdminCapabilities:()=>cr(r),loadAdminDashboard:()=>lr(r),loadAdminUsers:()=>ur(r),loadAdminUserDetail:e=>H(r,e),loadAdminUserResources:e=>dr(r,e),loadAdminSystemSettings:()=>fr(r),loadAdminDatabaseSettings:()=>pr(r),adminPageMeta:e=>V(r,e),pickDefaultCalendar:()=>wi(i),toggleCalendarSelected:e=>Di(i,e),blankEventForDay:(e,t)=>Vi(i,e,t),blankEventForSlot:(e,t,n)=>Hi(i,e,t,n),defaultRepeat:()=>Ii(),itemKey:q,openContact:e=>Fa(s,e),startNewContact:()=>Ia(s),emptyAddress:()=>La(s),syncEditingEventFromForm:e=>Ui(i,e),syncEditingTaskFromForm:e=>Aa(o,e),syncEditingNoteFromForm:e=>ba(a,e),runBulkTaskAction:e=>ja(o,e),shell:(e,n)=>st(t,e,n),renderLogin:()=>Ze(e,t,(e,n)=>st(t,e,n)),renderFlashBanner:()=>Le(t),renderMonthGrid:()=>Pi(i),renderEventModal:()=>zi(i),adminSubnavButtons:()=>rr(r),renderPortalDateTimeField:e=>Yo(c,e),getDtFieldCurrentValue:e=>Xo(c,e),setDtFieldValue:(e,t)=>Zo(c,e,t),positionDtPopovers:()=>Jo(c),accessBadge:eo,formatImportResult:to,closeImportProgress:()=>Ki(i),closeFilesUploadProgress:()=>wn(n),resetFilesTransferTree:m,stopImportElapsedTimer:f,stopFilesUploadElapsedTimer:p,unbindUserMenuOutside:h,bindUserMenuOutside:()=>lt(t,d),unbindFilesUploadMenuOutside:g,bindFilesUploadMenuOutside:()=>xn(n),onLogin:e=>Xe(e,y()),onShare:e=>ea(i,e),onSaveEvent:e=>ta(i,e),onEditCal:e=>na(i,e),onCreateCal:e=>ra(i,e),onSaveContact:e=>Ha(s,e),onCreateAb:e=>Ua(s,e),onEditAb:e=>Wa(s,e),onSaveTask:e=>Ma(o,e),onSaveNote:e=>Sa(a,e),bindColorPair:ts,bindImportInput:()=>void 0,bindHolidaysToggle:()=>aa(i),bindContactPhotoInput:()=>void 0,bindFilesDom:()=>$n(n),bindAdminDom:()=>void 0,saveBlobAsFile:es,openInfoModal:e=>Qo(c,e),closeInfoModal:()=>$o(c),captureScroll:()=>Qe(e),restoreScroll:t=>$e(e,t)},xo(c),Ye(y())}var J=``,Y=null,X=!1,Z=null,Q=null,rs=`sqlite`,is=!1;async function as(e,t={}){let n={Accept:`application/json`,...t.headers};t.body&&(n[`Content-Type`]=`application/json`),J&&t.method&&t.method!==`GET`&&(n[`X-CSRF-Token`]=J);let r=await fetch(`/api/install${e}`,{credentials:`same-origin`,...t,headers:n}),i;try{i=await r.json()}catch{throw Error(`Request failed (${r.status})`)}if(!r.ok)throw Error(i.error||`Request failed (${r.status})`);return i&&typeof i==`object`&&`data`in i&&i.data!==void 0?i.data:i}async function os(){Y=await as(`/status`),J=Y.csrfToken||J,rs=Y.defaults?.backend===`pgsql`?`pgsql`:`sqlite`}function ss(t,n,r){return`<label class="check-row"><input type="checkbox" name="${e(t)}" ${n?`checked`:``} ${X?`disabled`:``} /> ${e(r)}</label>`}function cs(){let n=Y?.permissions;return`<section class="card">
  ...
  </section>`}function ls(){let t=Y?.defaults;return`<section class="card">
    ...
    <form class="stack" data-form="initialize">
      ...
      <h3 class="admin-subsection-title">DAV services</h3>
      ${ss(`cal_enabled`,t?.cal_enabled!==!1,`Enable CalDAV`)}
      ${ss(`card_enabled`,t?.card_enabled!==!1,`Enable CardDAV`)}
      ${ss(`tasks_enabled`,t?.tasks_enabled!==!1,`Enable Tasks (VTODO)`)}
      ${ss(`notes_enabled`,!!t?.notes_enabled,`Enable Notes (VJOURNAL)`)}
      ${ss(`files_enabled`,!!t?.files_enabled,`Enable WebDAV file storage`)}
      <label>WebDAV authentication type
  ...
  </section>`}function us(){let t=Y?.defaults,n=Y?.pdoDrivers||[],r=n.includes(`sqlite`),i=n.includes(`pgsql`);return`<section class="card">
    <h2>Database</h2>
    ...
    <form class="stack" data-form="database">
      <label>Database backend
        <select name="backend" data-action="backend-change" ${X?`disabled`:``}>
          ${r?`<option value="sqlite" ${rs===`sqlite`?`selected`:``}>SQLite</option>`:``}
          ${i?`<option value="pgsql" ${rs===`pgsql`?`selected`:``}>PostgreSQL</option>`:``}
        </select>
      </label>
      <div data-backend-panel="sqlite" style="${rs===`sqlite`?``:`display:none`}">
        <label>SQLite file path
      ...
      <div data-backend-panel="pgsql" style="${rs===`pgsql`?``:`display:none`}">
        <label>PostgreSQL host
  ...
  </section>`}function ds(){return`<section class="card">
    ...
    <label class="admin-delete-confirm">
      <input type="checkbox" data-action="upgrade-toggle" ${is?`checked`:``} ${X?`disabled`:``} />
      I have a backup and want to run the upgrade
    </label>
    <div class="form-actions-row" style="margin-top:1rem">
      <button type="button" class="btn btn-primary" data-action="upgrade-run"
        ${X||!is?`disabled`:``}>Run upgrade</button>
    </div>
  </section>`}function fs(){return`<section class="card">
  ...
  </section>`}function ps(){return`<section class="card card-danger-zone">
  ...
  </section>`}function $(){let n=document.getElementById(`app`);if(!n)return;let r=Y?.step||`permissions`,i=``;i=Y?r===`permissions`?cs():r===`initialize`?ls():r===`database`?us():r===`upgrade`?ds():r===`done`?fs():r===`locked`?ps():`<section class="card"><p>Unknown step: ${e(r)}</p></section>`:`<section class="card"><p class="muted">Loading installer…</p></section>`,n.innerHTML=`
  ...
  `,ms()}function ms(){let e=document.getElementById(`app`);e&&(e.querySelector(`[data-action="reload"]`)?.addEventListener(`click`,()=>{hs()}),e.querySelector(`[data-action="backend-change"]`)?.addEventListener(`change`,e=>{rs=e.target.value===`pgsql`?`pgsql`:`sqlite`,$()}),e.querySelector(`[data-action="upgrade-toggle"]`)?.addEventListener(`change`,e=>{is=!!e.target.checked,$()}),e.querySelector(`[data-action="upgrade-run"]`)?.addEventListener(`click`,()=>{vs()}),e.querySelector(`[data-form="initialize"]`)?.addEventListener(`submit`,e=>{e.preventDefault(),gs(e.target)}),e.querySelector(`[data-form="database"]`)?.addEventListener(`submit`,e=>{e.preventDefault(),_s(e.target)}))}async function hs(){X=!0,Z=null,$();try{await os(),Q=null}catch(e){Z=e instanceof Error?e.message:`Failed to load installer status`}finally{X=!1,$()}}async function gs(e){let t=new FormData(e),n=t=>!!e.querySelector(`input[name="${t}"]`)?.checked,r={timezone:String(t.get(`timezone`)??``).trim(),cal_enabled:n(`cal_enabled`),card_enabled:n(`card_enabled`),tasks_enabled:n(`tasks_enabled`),notes_enabled:n(`notes_enabled`),files_enabled:n(`files_enabled`),dav_auth_type:String(t.get(`dav_auth_type`)??`Digest`),invite_from:String(t.get(`invite_from`)??``).trim(),session_max_age_minutes:Number(t.get(`session_max_age_minutes`)??15),admin_password:String(t.get(`admin_password`)??``),admin_password_confirm:String(t.get(`admin_password_confirm`)??``)};X=!0,Z=null,Q=null,$();try{Y=await as(`/initialize`,{method:`POST`,body:JSON.stringify(r)}),J=Y.csrfToken||J,Q=`Server settings saved. Configure the database next.`,C.event(`install.initialize`)}catch(e){Z=e instanceof Error?e.message:`Initialize failed`}finally{X=!1,$()}}async function _s(e){let t=new FormData(e),n=String(t.get(`backend`)??rs),r={backend:n,admin_password:String(t.get(`admin_password`)??``),admin_password_confirm:String(t.get(`admin_password_confirm`)??``)};n===`sqlite`?r.sqlite_file=String(t.get(`sqlite_file`)??``).trim():(r.pgsql_host=String(t.get(`pgsql_host`)??``).trim(),r.pgsql_dbname=String(t.get(`pgsql_dbname`)??``).trim(),r.pgsql_username=String(t.get(`pgsql_username`)??``).trim(),r.pgsql_password=String(t.get(`pgsql_password`)??``)),X=!0,Z=null,Q=null,$();try{Y=await as(`/database`,{method:`POST`,body:JSON.stringify(r)}),J=Y.csrfToken||J,Q=`Database configured. Installer is locked.`,C.event(`install.database`),Y.completed||Y.step}catch(e){Z=e instanceof Error?e.message:`Database setup failed`}finally{X=!1,$()}}async function vs(){if(is){X=!0,Z=null,Q=null,$();try{let e=await as(`/upgrade`,{method:`POST`,body:JSON.stringify({confirm:!0})});Q=`Upgrade completed.`+(e.messages&&e.messages.length?` `+e.messages.slice(0,3).join(` · `):``),C.event(`install.upgrade`),await os()}catch(e){Z=e instanceof Error?e.message:`Upgrade failed`}finally{X=!1,$()}}}async function ys(e){document.title=`AngaraDAV · Setup`,document.body.classList.add(`layout-install`),e.innerHTML=`<section class="card"><p class="muted">Loading installer…</p></section>`;try{await os()}catch(e){Z=e instanceof Error?e.message:`Failed to load installer`}$()}b();var bs=document.getElementById(`app`);if(!bs)throw Error(`#app missing`);var xs=window.location.pathname.replace(/\/+$/,``)||`/`;xs===`/portal/install`||xs.endsWith(`/portal/install`)?ys(bs):ns(bs);