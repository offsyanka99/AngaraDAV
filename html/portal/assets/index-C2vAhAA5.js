var Jn=Object.defineProperty;var Gn=(e,t,a)=>t in e?Jn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var It=(e,t,a)=>Gn(e,typeof t!="symbol"?t+"":t,a);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();function d(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function se(e,t,a={}){if(!t)return"";const s=a.dismissible!==void 0?a.dismissible:a.dismissAction!==void 0,n=a.dismissAction??"flash-close",i=a.role??"status",r=a.className?` ${a.className}`:"",l=a.style?` style="${d(a.style)}"`:"",o=s?`<button type="button" class="flash-close" data-action="${d(n)}" aria-label="Dismiss message" title="Dismiss">×</button>`:"";return`<div class="flash flash-${d(e)}${r}" role="${d(i)}"${l}>
      <span class="flash-text">${d(t)}</span>
      ${o}
    </div>`}function Xn(e){return e==="sm"?" cal-modal-card-sm":e==="wide"?" cal-modal-card-wide":""}function Qn(e){return e==="danger"?"btn btn-danger":e==="ghost"?"btn btn-ghost":"btn btn-primary"}function Zt(e){return e.map(a=>{const s=a.type??"button",n=Qn(a.variant),i=a.disabled?" disabled":"",r=a.id?` id="${d(a.id)}"`:"",l=a.action?` data-action="${d(a.action)}"`:"",o=a.attrs?` ${a.attrs}`:"";return`<button type="${s}" class="${n}"${l}${r}${o}${i}>${d(a.label)}</button>`}).join(`
`)}function N(e){const t=e.titleId||(e.id?`${e.id}-title`:`modal-title-${Math.random().toString(36).slice(2,9)}`),a=e.id?` id="${d(e.id)}"`:"",s=e.className?` ${e.className}`:"",n=e.rootAttrs?` ${e.rootAttrs}`:"",i=`${Xn(e.size)}${e.cardClassName?` ${e.cardClassName}`:""}`,r=e.closeAction,l=e.lockBackdrop?"":` data-action="${d(r)}"`,o=e.hideClose?"":`<button type="button" class="modal-close info-modal-close" data-action="${d(r)}" aria-label="Close">×</button>`;let c="";e.footer!==void 0&&(c=typeof e.footer=="string"?e.footer:Zt(e.footer));const m=c?`<footer class="cal-modal-footer">${c}</footer>`:"",f=`<div class="cal-modal-body">${e.body}</div>`;let b;return e.form?b=`<form class="stack"${e.formAttrs?` ${e.formAttrs}`:""}>
        ${f}
        ${m}
      </form>`:b=`${f}
      ...
      <div class="cal-modal-card${i}">
        ...
        ${b}
            ...
            ${d(e.label)}
          </label>`}const ea="angaradav-portal-theme";function $e(e){return e==="dark"||e==="light"?e:null}function an(e){return`${ea}:${e}`}function Zn(e){try{if(e){const t=$e(localStorage.getItem(an(e)));if(t)return t}return $e(localStorage.getItem(ea))??"dark"}catch{return"dark"}}function es(e,t){try{localStorage.setItem(ea,e),t&&localStorage.setItem(an(t),e)}catch{}}function ht(e){const t=document.documentElement;t.setAttribute("data-theme",e),t.style.colorScheme=e;const a=document.querySelector('meta[name="color-scheme"]');a&&a.setAttribute("content",e)}const dt="angaradav-portal-user-settings",Ut={theme:"dark",dayStartHour:8,dayEndHour:18};function ct(e){const t=typeof e=="number"?e:Number(e);return!Number.isInteger(t)||t<0||t>23?null:t}function nn(e){const t=$e(e==null?void 0:e.theme)??Ut.theme,a=ct(e==null?void 0:e.dayStartHour)??Ut.dayStartHour,s=ct(e==null?void 0:e.dayEndHour)??Ut.dayEndHour;return{theme:t,dayStartHour:a,dayEndHour:s,showWeekNumbers:!!(e!=null&&e.showWeekNumbers)}}function sn(e){return`${dt}:${e}`}function Mt(e){try{const t=localStorage.getItem(e);if(!t)return null;const a=JSON.parse(t);return!a||typeof a!="object"?null:a}catch{return null}}function rn(e){const a={...(e?Mt(sn(e))??Mt(dt):Mt(dt))??{}};return $e(a.theme)||(a.theme=Zn(e)),nn(a)}function ts(e,t){const a=nn(e);try{const s=JSON.stringify(a);localStorage.setItem(dt,s),t&&localStorage.setItem(sn(t),s)}catch{}es(a.theme,t)}function ta(e){const t=rn(e);return ht(t.theme),t}function Pa(e){const t=[];for(let a=0;a<24;a++){const s=`${String(a).padStart(2,"0")}:00`;t.push(`<option value="${a}" ${a===e?"selected":""}>${s}</option>`)}return t.join("")}function as(e){if(!e.userSettingsOpen||!e.user)return"";const t=e.userSettings,a=$e(document.documentElement.getAttribute("data-theme"))??t.theme,s=`
    <div class="stack user-settings-form">
      ...
      <fieldset class="user-settings-fieldset">
        ...
        <label>Day starts at
          <select name="dayStartHour">${Pa(t.dayStartHour)}</select>
        </label>
        <label>Day ends at
          <select name="dayEndHour">${Pa(t.dayEndHour)}</select>
        </label>
...
`);f=$.pop()??"";for(const S of $){const C=S.trim();C&&p(C)}}f.trim()&&p(f.trim());const g=Math.round((typeof performance<"u"?performance.now():Date.now())-i);if(b.error)throw b.error.status===401?(w.debug(`api ← POST ${e} stream 401 (${g}ms)`,b.error.message),Je(e,b.error.message)):w.warn(`api ← POST ${e} stream error (${g}ms)`,b.error.message),new _(b.error.message,b.error.status);if(!b.final)throw w.error(`api ← POST ${e} stream incomplete (${g}ms)`,{sawProgress:b.sawProgress}),new _(b.sawProgress?"Import stopped before finishing (server crash, out of memory, or gateway timeout). On TrueNAS, set memory limit to at least 1G, pull latest image, and recreate the app.":"Import failed to start on the server. Check container logs and that you are on the latest image.",500);return w.info(`api ← POST ${e} stream done (${g}ms)`),kt(e),b.final}const us={adminPing:()=>D("/admin/ping"),adminDashboard:()=>D("/admin/dashboard"),adminCapabilities:()=>D("/admin/capabilities"),adminUsers:()=>D("/admin/users"),adminUser:e=>D(`/admin/users/${encodeURIComponent(e)}`),adminCreateUser:e=>D("/admin/users",{method:"POST",body:JSON.stringify(e)}),adminUpdateUser:(e,t)=>D(`/admin/users/${encodeURIComponent(e)}`,{method:"PATCH",body:JSON.stringify(t)}),adminDeleteUser:(e,t=!0)=>D(`/admin/users/${encodeURIComponent(e)}`,{method:"DELETE",body:JSON.stringify({confirm:t})}),adminUserCalendars:e=>D(`/admin/users/${encodeURIComponent(e)}/calendars`),adminCreateUserCalendar:(e,t)=>D(`/admin/users/${encodeURIComponent(e)}/calendars`,{method:"POST",body:JSON.stringify(t)}),adminUpdateUserCalendar:(e,t,a)=>D(`/admin/users/${encodeURIComponent(e)}/calendars/${t}`,{method:"PATCH",body:JSON.stringify(a)}),adminDeleteUserCalendar:(e,t,a=!0)=>D(`/admin/users/${encodeURIComponent(e)}/calendars/${t}`,{method:"DELETE",body:JSON.stringify({confirm:a})}),adminUserAddressBooks:e=>D(`/admin/users/${encodeURIComponent(e)}/addressbooks`),adminCreateUserAddressBook:(e,t)=>D(`/admin/users/${encodeURIComponent(e)}/addressbooks`,{method:"POST",body:JSON.stringify(t)}),adminUpdateUserAddressBook:(e,t,a)=>D(`/admin/users/${encodeURIComponent(e)}/addressbooks/${t}`,{method:"PATCH",body:JSON.stringify(a)}),adminDeleteUserAddressBook:(e,t,a=!0,s=!1)=>D(`/admin/users/${encodeURIComponent(e)}/addressbooks/${t}`,{method:"DELETE",body:JSON.stringify({confirm:a,force:s})}),adminSystemSettings:()=>D("/admin/settings/system"),adminUpdateSystemSettings:e=>D("/admin/settings/system",{method:"PATCH",body:JSON.stringify(e)}),adminResetToDefault:(e=!0,t="")=>D("/admin/settings/reset-to-default",{method:"POST",body:JSON.stringify({confirm:e,password:t})}),adminDatabaseSettings:()=>D("/admin/settings/database"),adminTestDatabaseConnection:e=>D("/admin/settings/database/test",{method:"POST",body:JSON.stringify(e)}),adminUpdateDatabaseSettings:e=>D("/admin/settings/database",{method:"PATCH",body:JSON.stringify(e)}),me:async()=>{var t;const e=await D("/me");return it(e.csrfToken||((t=e.user)==null?void 0:t.csrfToken)||""),e},login:async(e,t)=>{var s;const a=await D("/login",{method:"POST",body:JSON.stringify({username:e,password:t})});return it((s=a.user)==null?void 0:s.csrfToken),a},logout:async()=>{try{return await D("/logout",{method:"POST"})}finally{it("")}}},ms={calendars:()=>D("/calendars"),createCalendar:e=>D("/calendars",{method:"POST",body:JSON.stringify(e)}),holidayCountries:()=>D("/holidays/countries"),updateCalendar:(e,t)=>D(`/calendars/${e}`,{method:"PATCH",body:JSON.stringify(t)}),deleteCalendar:e=>D(`/calendars/${e}`,{method:"DELETE"}),calendarEvents:(e,t,a)=>{const s=new URLSearchParams({from:t,to:a}).toString();return D(`/calendars/${e}/events?${s}`)},getEvent:(e,t)=>D(`/calendars/${e}/events/${W(t)}`),createEvent:(e,t)=>D(`/calendars/${e}/events`,{method:"POST",body:JSON.stringify(t)}),updateEvent:(e,t,a)=>D(`/calendars/${e}/events/${W(t)}`,{method:"PATCH",body:JSON.stringify(a)}),deleteEvent:(e,t)=>D(`/calendars/${e}/events/${W(t)}`,{method:"DELETE"}),exportCalendar:async e=>{const t=await fetch(`/api/calendars/${e}/export`,{credentials:"same-origin"});if(!t.ok){let r=`Export failed (${t.status})`;try{const l=await t.json();l.error&&(r=l.error)}catch{}throw new _(r,t.status)}const a=t.headers.get("Content-Disposition")||"",s=/filename="([^"]+)"/i.exec(a),n=(s==null?void 0:s[1])||`calendar-${e}.ics`;return{blob:await t.blob(),filename:n}},importCalendar:(e,t,a)=>cn(`/calendars/${e}/import`,t,"text/calendar; charset=utf-8",a),directory:()=>D("/directory"),shares:e=>D(`/calendars/${e}/shares`),share:(e,t,a)=>D(`/calendars/${e}/shares`,{method:"POST",body:JSON.stringify({username:t,access:a})}),revoke:(e,t)=>D(`/calendars/${e}/shares`,{method:"DELETE",body:JSON.stringify({href:t})})},fs={addressbooks:()=>D("/addressbooks"),createAddressBook:e=>D("/addressbooks",{method:"POST",body:JSON.stringify(e)}),updateAddressBook:(e,t)=>D(`/addressbooks/${e}`,{method:"PATCH",body:JSON.stringify(t)}),deleteAddressBook:(e,t=!1)=>D(`/addressbooks/${e}`,{method:"DELETE",body:JSON.stringify({force:t})}),exportAddressBook:async e=>{const t=await fetch(`/api/addressbooks/${e}/export`,{credentials:"same-origin"});if(!t.ok){let r=`Export failed (${t.status})`;try{const l=await t.json();l.error&&(r=l.error)}catch{}throw new _(r,t.status)}const a=t.headers.get("Content-Disposition")||"",s=/filename="([^"]+)"/i.exec(a),n=(s==null?void 0:s[1])||`contacts-${e}.vcf`;return{blob:await t.blob(),filename:n}},importAddressBook:(e,t,a)=>cn(`/addressbooks/${e}/import`,t,"text/vcard; charset=utf-8",a),contacts:(e,t="")=>{const a=t.trim()?`?q=${encodeURIComponent(t.trim())}`:"";return D(`/addressbooks/${e}/contacts${a}`)},getContact:(e,t)=>D(`/addressbooks/${e}/contacts/${W(t)}`),createContact:(e,t)=>D(`/addressbooks/${e}/contacts`,{method:"POST",body:JSON.stringify(t)}),updateContact:(e,t,a)=>D(`/addressbooks/${e}/contacts/${W(t)}`,{method:"PATCH",body:JSON.stringify(a)}),deleteContact:(e,t)=>D(`/addressbooks/${e}/contacts/${W(t)}`,{method:"DELETE"}),exportContact:async(e,t)=>{const a=await fetch(`/api/addressbooks/${e}/contacts/${W(t)}/export`,{credentials:"same-origin"});if(!a.ok){let l=`Export failed (${a.status})`;try{const o=await a.json();o.error&&(l=o.error)}catch{}throw new _(l,a.status)}const s=a.headers.get("Content-Disposition")||"",n=/filename="([^"]+)"/i.exec(s),i=(n==null?void 0:n[1])||"contact.vcf";return{blob:await a.blob(),filename:i}},contactPhotoUrl:(e,t)=>`/api/addressbooks/${e}/contacts/${W(t)}/photo`},ps={filesStatus:()=>D("/files"),filesList:(e="")=>{const t=new URLSearchParams;e&&t.set("path",e);const a=t.toString()?`?${t}`:"";return D(`/files/entries${a}`)},filesMkdir:(e,t)=>D("/files/mkdir",{method:"POST",body:JSON.stringify({path:e,name:t})}),filesUpload:(e,t,a={})=>{const s=new URLSearchParams;e&&s.set("path",e),s.set("name",t.name),a.replace&&s.set("replace","1");const n=new FormData;n.append("file",t,t.name),e&&n.append("path",e);const i=typeof performance<"u"?performance.now():Date.now();return w.debug(`api → POST /files/upload path=${e||"/"} name=${t.name} size=${t.size}`),new Promise((r,l)=>{const o=new XMLHttpRequest;o.open("POST",`/api/files/upload?${s}`),o.withCredentials=!0;const c=ls();c&&o.setRequestHeader("X-CSRF-Token",c),a.onProgress&&(o.upload.onprogress=m=>{var f,b;m.lengthComputable?(f=a.onProgress)==null||f.call(a,m.loaded,m.total):(b=a.onProgress)==null||b.call(a,m.loaded,t.size||m.loaded)}),o.onload=()=>{const m=Math.round((typeof performance<"u"?performance.now():Date.now())-i);let f=null;const b=o.responseText||"";if(b)try{f=JSON.parse(b)}catch{f={error:b}}const p=o.status;if(p<200||p>=300){let g=`Upload failed (${p||0})`;f&&typeof f=="object"&&f!==null&&"error"in f&&typeof f.error=="string"&&(g=f.error),p===401?(w.debug(`api ← POST /files/upload 401 (${m}ms)`,g),Je("/files/upload",g)):p>=500?w.error(`api ← POST /files/upload ${p} (${m}ms)`,g):w.warn(`api ← POST /files/upload ${p} (${m}ms)`,g),l(new _(g,p||0));return}w.info(`api ← POST /files/upload 200 (${m}ms)`),kt("/files/upload"),r(f)},o.onerror=()=>{const m=Math.round((typeof performance<"u"?performance.now():Date.now())-i);w.error(`api ← POST /files/upload network error (${m}ms)`),l(new _("Upload failed (network error)",0))},o.onabort=()=>{l(new _("Upload cancelled",0))},o.send(n)})},filesDownloadUrl:(e,t)=>{const a=new URLSearchParams;return a.set("path",e),t!=null&&t.inline&&a.set("inline","1"),`/api/files/download?${a}`},filesGetBlob:(e,t)=>{const a=new URLSearchParams;return a.set("path",e),t!=null&&t.inline&&a.set("inline","1"),cs(`/files/download?${a}`)},filesDelete:e=>D("/files/entry",{method:"DELETE",body:JSON.stringify({path:e})}),filesRename:(e,t)=>D("/files/rename",{method:"POST",body:JSON.stringify({path:e,newName:t})}),filesMove:(e,t,a)=>D("/files/move",{method:"POST",body:JSON.stringify({from:e,to:t,newName:a})}),filesCopy:(e,t={})=>D("/files/copy",{method:"POST",body:JSON.stringify({path:e,to:t.to,newName:t.newName})}),filesBulk:(e,t)=>D("/files/bulk",{method:"POST",body:JSON.stringify({op:e,paths:t})})},bs={tasks:(e={})=>{const t=new URLSearchParams;e.q&&t.set("q",e.q),e.sort&&t.set("sort",e.sort),e.order&&t.set("order",e.order);const a=t.toString()?`?${t}`:"";return D(`/tasks${a}`)},createTask:e=>D("/tasks",{method:"POST",body:JSON.stringify(e)}),updateTask:(e,t,a)=>D(`/tasks/${e}/${W(t)}`,{method:"PATCH",body:JSON.stringify(a)}),deleteTask:(e,t)=>D(`/tasks/${e}/${W(t)}`,{method:"DELETE"}),bulkTasks:e=>D("/tasks/bulk",{method:"POST",body:JSON.stringify(e)}),notes:(e={})=>{const t=new URLSearchParams;e.q&&t.set("q",e.q),e.sort&&t.set("sort",e.sort),e.order&&t.set("order",e.order);const a=t.toString()?`?${t}`:"";return D(`/notes${a}`)},createNote:e=>D("/notes",{method:"POST",body:JSON.stringify(e)}),updateNote:(e,t,a)=>D(`/notes/${e}/${W(t)}`,{method:"PATCH",body:JSON.stringify(a)}),deleteNote:(e,t)=>D(`/notes/${e}/${W(t)}`,{method:"DELETE"})},gs={ui:()=>D("/ui"),installStatus:async()=>{const e=await D("/install/status");return e&&typeof e=="object"&&"data"in e&&e.data?e.data:e}},k={...gs,...us,...ms,...fs,...bs,...ps},un="angaradav-portal-tab",mn="angaradav-portal-admin-page",ys="angaradav-portal-cal-selection",Ht="2.3.1";function vs(e){const t=(e||Ht).trim(),a=t.indexOf("+");return a<=0?{version:t||Ht,build:""}:{version:t.slice(0,a),build:t.slice(a+1)}}const $s="https://github.com/offsyanka99/AngaraDAV/tree/main/docs";function ws(e){const t=new Date;return{user:null,flash:null,activeTab:e.activeTab,adminPage:e.adminPage,adminDashboard:null,adminDashboardLoading:!1,adminDashboardError:null,adminCapabilities:null,adminCapabilitiesError:null,adminUsers:[],adminUsersLoading:!1,adminUsersError:null,adminUsersQuery:"",adminSelectedUsername:e.adminSelectedUsername,adminUserDetail:null,adminUserDetailLoading:!1,adminUserDetailError:null,adminUserCreateOpen:!1,adminUserEditOpen:!1,adminUserDeleteUsername:null,adminUserDeleteConfirmChecked:!1,adminUserCalendars:[],adminUserAddressBooks:[],adminUserResourcesLoading:!1,adminCalModal:null,adminCalEditId:null,adminAbModal:null,adminAbEditId:null,adminResourceDelete:null,adminSystemSettings:null,adminSystemSettingsLoading:!1,adminSystemSettingsError:null,adminResetModalOpen:!1,adminResetConfirmChecked:!1,adminResetPassword:"",adminDatabaseSettings:null,adminDatabaseSettingsLoading:!1,adminDatabaseSettingsError:null,adminDbFormBackend:"sqlite",adminDbConfirmOpen:!1,adminDbConfirmText:"",adminDbPendingBody:null,userMenuOpen:!1,userMenuDocClick:null,userSettings:rn(),userSettingsOpen:!1,calendars:[],directory:[],holidayCountries:[],selectedId:null,selectedIds:[],calendarSelectionSeeded:!1,listKeyboardFocus:!1,shares:[],installGate:null,calModalOpen:!1,createCalModalOpen:!1,deleteConfirmId:null,deleteAbConfirmId:null,monthCursor:{y:t.getFullYear(),m:t.getMonth()},calView:"month",calFocusDay:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,"0")}-${String(t.getDate()).padStart(2,"0")}`,eventSearch:"",eventSearchFocus:!1,monthEvents:[],monthEventsLoading:!1,eventModalOpen:!1,editingEvent:null,creatingEvent:!1,eventDtPicker:null,bulkDueValue:"",monthExpandDay:null,addressBooks:[],selectedAbId:null,contacts:[],contactSearch:"",selectedContactUri:null,editingContact:null,creatingContact:!1,contactModalOpen:!1,abModalOpen:!1,photoPreview:null,photoBase64Pending:null,removePhotoPending:!1,busy:!1,importProgress:null,importElapsedTimer:null,filesUploadProgress:null,filesUploadElapsedTimer:null,filesUploadMenuOpen:!1,filesUploadMenuDocClick:null,filesUploadDropActive:!1,filesDropDepth:0,escapeBound:!1,portalEventsBound:!1,portalUi:{timeFormat:"auto",weekStart:"auto",logLevel:"off",services:null},searchTimer:null,sessionIdleSeconds:900,sessionIdleTimer:null,appVersion:Ht,handlingSessionExpiry:!1,suppressErrorFlashAfterExpiry:!1,tasks:[],notes:[],taskCalendars:[],noteCalendars:[],taskSearch:"",noteSearch:"",taskSort:"due",taskOrder:"asc",noteSort:"dtstart",noteOrder:"desc",selectedTaskKey:null,selectedNoteKey:null,editingTask:null,editingNote:null,creatingTask:!1,creatingNote:!1,checkedTaskKeys:[],filesStatus:null,filesPath:"",filesEntries:[],filesLoading:!1,filesRenamePath:null,filesDeletePaths:null,filesTransfer:null,filesTransferDest:"",filesTreeChildren:{},filesTreeExpanded:[],filesMkdirOpen:!1,filesSearch:"",filesSearchFocus:!1,filesSort:"name",filesOrder:"asc",filesTypeFilter:"all",checkedFilePaths:[],filesItemMenu:null,filesItemMenuDocClick:null,filesItemMenuWinClose:null,filesPreview:null,filesPreviewSeq:0,filesUploadConflict:null,confirmDelete:null,dtPickerDocClick:null}}function fn(e,t,a){e.suppressErrorFlashAfterExpiry&&t==="error"||(t!=="error"&&(e.suppressErrorFlashAfterExpiry=!1),e.flash={type:t,message:a})}function hs(e){e.flash=null,e.suppressErrorFlashAfterExpiry=!1}function Vt(e){return e.flash?se(e.flash.type,e.flash.message,{dismissible:!0}):""}function we(e){var t,a;return!!((t=e.user)!=null&&t.isAdmin||((a=e.user)==null?void 0:a.role)==="Admin")}function Ge(e){return we(e)?e.adminCapabilities===null?!0:e.adminCapabilities.uiEnabled!==!1:!1}function lt(e,t){if(!t)return;const a=(t.timeFormat||"auto").toLowerCase(),s=(t.weekStart||"auto").toLowerCase(),n=e.portalUi.services;let i=n;if(t.services&&typeof t.services=="object"){const r=n??{caldav:!0,carddav:!0,tasks:!0,notes:!0,files:!0},l=t.services;i={caldav:typeof l.caldav=="boolean"?l.caldav:r.caldav,carddav:typeof l.carddav=="boolean"?l.carddav:r.carddav,tasks:typeof l.tasks=="boolean"?l.tasks:r.tasks,notes:typeof l.notes=="boolean"?l.notes:r.notes,files:typeof l.files=="boolean"?l.files:r.files}}e.portalUi={timeFormat:a==="12h"||a==="24h"?a:"auto",weekStart:s==="monday"||s==="sunday"?s:"auto",logLevel:t.logLevel||"off",services:i},rs(e.portalUi.logLevel),typeof t.sessionIdleSeconds=="number"&&Number.isFinite(t.sessionIdleSeconds)&&t.sessionIdleSeconds>0&&(e.sessionIdleSeconds=Math.floor(t.sessionIdleSeconds)),typeof t.version=="string"&&t.version.trim()!==""&&(e.appVersion=t.version.trim())}function te(e,t){if(t==="admin")return!0;const a=e.portalUi.services;if(!a)return!0;switch(t){case"calendars":return a.caldav;case"contacts":return a.carddav;case"tasks":return a.tasks;case"notes":return a.notes;case"files":return a.files;default:return!0}}function mt(e){const t=["calendars","contacts","tasks","notes","files"];for(const a of t)if(te(e,a))return a;return"calendars"}function aa(e){e.sessionIdleTimer!==null&&(clearTimeout(e.sessionIdleTimer),e.sessionIdleTimer=null)}function jt(e,t){if(aa(e),!e.user)return;const a=Math.max(30,e.sessionIdleSeconds)*1e3;e.sessionIdleTimer=setTimeout(()=>{e.sessionIdleTimer=null,t("Your session timed out. Please sign in again.")},a)}function ks(e,t){var a;aa(e),t.stopImportElapsedTimer(),e.importProgress=null,e.filesUploadProgress=null,t.stopFilesUploadElapsedTimer(),e.filesUploadMenuOpen=!1,t.unbindFilesUploadMenuOutside(),e.filesUploadDropActive=!1,e.user=null,e.calendars=[],e.shares=[],e.selectedId=null,e.selectedIds=[],e.calendarSelectionSeeded=!1,e.listKeyboardFocus=!1,e.directory=[],e.addressBooks=[],e.selectedAbId=null,e.contacts=[],e.selectedContactUri=null,e.editingContact=null,e.creatingContact=!1,e.contactModalOpen=!1,e.abModalOpen=!1,e.createCalModalOpen=!1,e.calModalOpen=!1,e.deleteConfirmId=null,e.deleteAbConfirmId=null,e.eventModalOpen=!1,e.userSettingsOpen=!1,e.editingEvent=null,e.creatingEvent=!1,e.monthEvents=[],e.calView="month",e.eventSearch="",e.eventSearchFocus=!1;{const s=new Date;e.calFocusDay=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`,e.monthCursor={y:s.getFullYear(),m:s.getMonth()}}if(e.tasks=[],e.notes=[],e.taskCalendars=[],e.noteCalendars=[],e.selectedTaskKey=null,e.selectedNoteKey=null,e.editingTask=null,e.editingNote=null,e.creatingTask=!1,e.creatingNote=!1,e.checkedTaskKeys=[],e.filesStatus=null,e.filesPath="",e.filesEntries=[],e.filesLoading=!1,e.filesRenamePath=null,e.filesDeletePaths=null,t.resetFilesTransferTree(),e.filesMkdirOpen=!1,e.filesSearch="",e.filesSearchFocus=!1,e.filesSort="name",e.filesOrder="asc",e.filesTypeFilter="all",e.filesItemMenu=null,e.filesItemMenuDocClick&&(document.removeEventListener("click",e.filesItemMenuDocClick,!0),e.filesItemMenuDocClick=null),e.filesItemMenuWinClose&&(window.removeEventListener("resize",e.filesItemMenuWinClose),e.filesItemMenuWinClose=null),(a=e.filesPreview)!=null&&a.objectUrl)try{URL.revokeObjectURL(e.filesPreview.objectUrl)}catch{}e.filesPreview=null,e.filesPreviewSeq+=1,e.filesUploadMenuOpen=!1,t.unbindFilesUploadMenuOutside(),e.filesUploadDropActive=!1,e.filesUploadConflict=null,e.confirmDelete=null,e.dtPickerDocClick=null,e.checkedFilePaths=[],e.photoPreview=null,e.photoBase64Pending=null,e.removePhotoPending=!1,e.busy=!1,e.userMenuOpen=!1,e.adminDashboard=null,e.adminDashboardLoading=!1,e.adminDashboardError=null,e.adminCapabilities=null,e.adminCapabilitiesError=null,e.adminUsers=[],e.adminUsersLoading=!1,e.adminUsersError=null,e.adminUsersQuery="",e.adminSelectedUsername=null,e.adminUserDetail=null,e.adminUserDetailLoading=!1,e.adminUserDetailError=null,e.adminUserCreateOpen=!1,e.adminUserEditOpen=!1,e.adminUserDeleteUsername=null,e.adminUserDeleteConfirmChecked=!1,e.adminUserCalendars=[],e.adminUserAddressBooks=[],e.adminUserResourcesLoading=!1,e.adminCalModal=null,e.adminCalEditId=null,e.adminAbModal=null,e.adminAbEditId=null,e.adminResourceDelete=null,e.adminSystemSettings=null,e.adminSystemSettingsLoading=!1,e.adminSystemSettingsError=null,e.adminResetModalOpen=!1,e.adminResetConfirmChecked=!1,e.adminResetPassword="",e.adminDatabaseSettings=null,e.adminDatabaseSettingsLoading=!1,e.adminDatabaseSettingsError=null,e.adminDbFormBackend="sqlite",e.adminDbConfirmOpen=!1,e.adminDbConfirmText="",e.adminDbPendingBody=null,t.unbindUserMenuOutside()}function Ss(e,t){if(!e.handlingSessionExpiry){if(!e.user){aa(e);return}e.handlingSessionExpiry=!0;try{w.event("session.expired"),t.clearSession(),e.suppressErrorFlashAfterExpiry=!0,e.flash={type:"info",message:t.message&&t.message.trim()?t.message:"Your session timed out. Please sign in again."},t.render()}finally{e.handlingSessionExpiry=!1}}}function Ds(e,t){const a=String(t.step||"");a==="upgrade"||a==="initialize"||a==="permissions"||a==="database"?(e.installGate={step:a,message:t.message||(a==="upgrade"?"Complete the upgrade wizard before signing in.":"Complete setup before signing in."),installUrl:t.installUrl||"/portal/install/",productVersion:t.productVersion,configuredVersion:t.configuredVersion??null},typeof t.productVersion=="string"&&t.productVersion.trim()!==""&&(e.appVersion=t.productVersion.trim())):e.installGate=null}function Cs(e,t){if(!(t instanceof _)||t.status!==503)return!1;const a=typeof t.payload.code=="string"?t.payload.code:"";if(a!=="upgrade_required"&&a!=="not_configured"&&a!=="admin_password_missing")return!1;const s=a==="upgrade_required"?"upgrade":"initialize";return e.installGate={step:s,message:t.message,installUrl:typeof t.payload.installUrl=="string"?t.payload.installUrl:"/portal/install/",productVersion:typeof t.payload.productVersion=="string"?t.payload.productVersion:void 0,configuredVersion:typeof t.payload.configuredVersion=="string"?t.payload.configuredVersion:null},e.installGate.productVersion&&(e.appVersion=e.installGate.productVersion),!0}async function pn(e){var a,s,n,i;const{state:t}=e;if(t.activeTab==="admin"&&we(t)&&Ge(t))try{t.adminPage==="overview"&&((a=e.adminPageMeta("overview"))==null?void 0:a.available)!==!1?await e.loadAdminDashboard():t.adminPage==="users"&&((s=e.adminPageMeta("users"))==null?void 0:s.available)!==!1?(await e.loadAdminUsers(),t.adminSelectedUsername&&(await e.loadAdminUserDetail(t.adminSelectedUsername),await e.loadAdminUserResources(t.adminSelectedUsername))):t.adminPage==="settings"&&((n=e.adminPageMeta("settings"))==null?void 0:n.available)!==!1?await e.loadAdminSystemSettings():t.adminPage==="database"&&((i=e.adminPageMeta("database"))==null?void 0:i.available)!==!1&&await e.loadAdminDatabaseSettings()}catch(r){w.warn("admin page load",r instanceof Error?r.message:r)}}async function Es(e){var a;const{state:t}=e;w.event("bootstrap.start"),os(s=>{e.handleSessionExpired(/timed\s*out|session expired/i.test(s)?s:"Your session timed out. Please sign in again.")}),ds(()=>{jt(t,s=>e.handleSessionExpired(s))});try{const s=await k.installStatus();Ds(t,s)}catch(s){w.debug("bootstrap: /api/install/status failed",s instanceof Error?s.message:s)}try{const s=await k.ui();lt(t,s.ui),typeof s.version=="string"&&s.version.trim()!==""?t.appVersion=s.version.trim():s.ui&&typeof s.ui.version=="string"&&s.ui.version.trim()!==""&&(t.appVersion=s.ui.version.trim())}catch(s){w.debug("bootstrap: /api/ui failed",s instanceof Error?s.message:s),Cs(t,s)}if(t.installGate&&t.installGate.step!=="done"&&t.installGate.step!=="locked"){e.clearPortalSessionState(),w.event("bootstrap.installGate",{step:t.installGate.step}),e.render();return}try{const s=await k.me();if(!s.user)e.clearPortalSessionState(),lt(t,s.ui),typeof s.version=="string"&&s.version.trim()!==""&&(t.appVersion=s.version.trim()),w.event("bootstrap.anonymous");else{if(t.user=s.user,t.userSettings=ta(t.user.username),lt(t,s.ui),typeof s.version=="string"&&s.version.trim()!==""&&(t.appVersion=s.version.trim()),w.event("bootstrap.session",{username:((a=t.user)==null?void 0:a.username)??null}),jt(t,n=>e.handleSessionExpired(n)),we(t))try{await e.loadAdminCapabilities()}catch(n){w.warn("admin.capabilities bootstrap",n instanceof Error?n.message:n)}e.normalizeActiveTab(),e.persistTab(t.activeTab,t.adminPage),await e.loadHome(),await pn(e)}}catch(s){s instanceof _&&s.status===401?(e.clearPortalSessionState(),w.event("bootstrap.anonymous")):(w.error("bootstrap failed",s instanceof Error?s.message:s),fn(t,"error",s instanceof Error?s.message:"Failed to load"))}e.render()}async function Ts(e,t){var r,l;const{state:a}=t,s=new FormData(e),n=String(s.get("username")??""),i=String(s.get("password")??"");a.busy=!0,t.clearFlash(),t.render(),w.event("login.attempt",{username:n});try{const o=await k.login(n,i);if(a.user=o.user,a.userSettings=ta(((r=a.user)==null?void 0:r.username)??n),lt(a,o.ui),w.event("login.ok",{username:((l=a.user)==null?void 0:l.username)??n}),jt(a,c=>t.handleSessionExpired(c)),we(a))try{await t.loadAdminCapabilities()}catch(c){w.warn("admin.capabilities login",c instanceof Error?c.message:c)}t.normalizeActiveTab(),t.persistTab(a.activeTab,a.adminPage),await t.loadHome(),await pn(t),t.setFlash("success","Signed in")}catch(o){w.warn("login.failed",o instanceof Error?o.message:o),t.setFlash("error",o instanceof Error?o.message:"Login failed")}finally{a.busy=!1,t.render()}}function Aa(e,t,a){const s=t.installGate,n=s&&(s.step==="upgrade"||s.step==="initialize"||s.step==="permissions"||s.step==="database"),i=(s==null?void 0:s.installUrl)||"/portal/install/";let r="";if(n&&s){const o=s.step==="upgrade"?"Server upgrade required":"Setup incomplete",c=s.step==="upgrade"&&(s.configuredVersion||s.productVersion)?`<p class="muted small" style="margin:0.5rem 0 0">Configured <span class="mono">${d(String(s.configuredVersion||"—"))}</span>
    ...
    <div class="info-modal" id="about-modal" hidden role="dialog" aria-modal="true" aria-labelledby="about-modal-title">
      ...
      <div class="info-modal-card about-modal-card">
        ...
        <div class="about-modal-body">
          ...
          <p class="about-name">${d(Ps)}</p>
          <dl class="about-meta">
            <div><dt>Version</dt><dd class="mono">${d(t)}</dd></div>
            <div><dt>Build</dt><dd class="mono">${d(s)}</dd></div>
            <div><dt>Contact</dt><dd><a href="mailto:${d(Ma)}">${d(Ma)}</a></dd></div>
            <div><dt>GitHub</dt><dd><a href="${d(Oa)}" target="_blank" rel="noopener noreferrer">${d(Oa.replace(/^https:\/\//,""))}</a></dd></div>
          </dl>
        </div>
    ...
    </div>`}function As(e){var a;const t=e.querySelector("#about-modal");t&&(t.hidden=!1,document.body.classList.add("info-modal-open"),(a=t.querySelector(".info-modal-close"))==null||a.focus())}function bn(e){const t=e.querySelector("#about-modal");if(!t)return;t.hidden=!0;const a=e.querySelector("#info-modal");(!a||a.hidden)&&document.body.classList.remove("info-modal-open")}function Is(e){const t=e.querySelector("#about-modal");return!!t&&!t.hidden}function Ot(e,t,a={}){const s=!!e.user&&e.activeTab==="admin"&&we(e)&&Ge(e),r=`
      <img class="brand-logo" src="/logo.png" width="28" height="28" alt="" aria-hidden="true" />
      <span class="brand-text">Angara<span class="brand-dav">DAV</span><span class="brand-sep" aria-hidden="true"> · </span><span class="${s?"brand-portal brand-portal-admin":"brand-portal brand-portal-user"}">${d(s?"Administration Portal":"User Portal")}</span></span>`,l=e.user?d(e.user.displayname||e.user.username):"",o=Ge(e)?`<button type="button" class="user-menu-item${e.activeTab==="admin"?" is-active":""}" role="menuitem" data-action="tab" data-tab="admin">
              Administration
          ...
          <a class="brand" href="/portal/">${r}</a>
        </nav>`,p=!(e.calModalOpen||e.createCalModalOpen||e.deleteConfirmId!==null||e.deleteAbConfirmId!==null||e.eventModalOpen||e.contactModalOpen||e.abModalOpen||e.filesRenamePath!==null||e.filesDeletePaths!==null||e.filesTransfer!==null||e.filesMkdirOpen||e.filesPreview!==null||e.filesUploadConflict!==null||e.filesUploadProgress!==null||e.confirmDelete!==null)?Vt(e):"",g=a.tabs&&a.tabs.trim()!==""?`<div class="tabs-bar" role="presentation">
      ...
      <footer class="site-footer">
        <div class="container footer-inner">
          ...
          <span class="footer-sep" aria-hidden="true">·</span>
          <a href="${d($s)}" target="_blank" rel="noopener noreferrer">Docs</a>
        </div>
      </footer>
      ${Fs(e)}
      ${as(e)}`;return a.auth?document.body.className="layout-auth":document.body.classList.remove("layout-auth"),`<div class="app-chrome">
      ${f}
      ${g}
    </div>
      ...
      ${u}`}function zt(e){e.userMenuDocClick&&(document.removeEventListener("click",e.userMenuDocClick,!0),e.userMenuDocClick=null)}function Us(e,t){zt(e),e.userMenuDocClick=s=>{var i;const n=s.target;(i=n==null?void 0:n.closest)!=null&&i.call(n,".user-menu")||(e.userMenuOpen=!1,zt(e),t())};const a=e.userMenuDocClick;setTimeout(()=>{e.userMenuOpen&&e.userMenuDocClick===a&&document.addEventListener("click",a,!0)},0)}function ft(e){e.dtPickerDocClick&&(document.removeEventListener("click",e.dtPickerDocClick,!0),e.dtPickerDocClick=null)}function Ms(e,t){if(ft(e),!e.eventDtPicker)return;e.dtPickerDocClick=s=>{var i,r;const n=s.target;(i=n==null?void 0:n.closest)!=null&&i.call(n,".dt-field.is-open, .dt-popover, [data-dt-popover]")||(r=n==null?void 0:n.closest)!=null&&r.call(n,'[data-action="dt-open"]')||(e.eventDtPicker=null,ft(e),t())};const a=e.dtPickerDocClick;setTimeout(()=>{e.eventDtPicker&&e.dtPickerDocClick===a&&document.addEventListener("click",a,!0)},0)}function Os(e,t){return!t||e.includes(t)?e:[t]}function na(e,t){const a=new Map(e.map(r=>[r.path,r])),s=[];for(const r of t){const l=a.get(r);l&&s.push(l)}const n=s.filter(r=>r.type==="file"),i=s.length;return{count:i,heading:i>1?`${i} items`:null,showDownload:n.length>0,downloadItems:n.map(r=>({path:r.path,name:r.name})),renameEnabled:i===1,renamePath:i===1?s[0].path:null,renameName:i===1?s[0].name:null}}function sa(e){return!!(e.busy||e.filesRenamePath||e.filesDeletePaths||e.filesTransfer||e.filesMkdirOpen||e.filesPreview||e.filesUploadConflict||e.filesUploadProgress)}function M(e){ia(e),e.state.filesItemMenu=null}function ra(e,t,a){!t||sa(e.state)||e.state.filesEntries.some(s=>s.path===t)&&(e.state.checkedFilePaths=Os(e.state.checkedFilePaths,t),e.state.filesItemMenu={path:t,x:a.x,y:a.y,origin:a.origin},e.state.filesUploadMenuOpen=!1,e.render())}function ia(e){e.state.filesItemMenuDocClick&&(document.removeEventListener("click",e.state.filesItemMenuDocClick,!0),e.state.filesItemMenuDocClick=null),e.state.filesItemMenuWinClose&&(window.removeEventListener("resize",e.state.filesItemMenuWinClose),e.state.filesItemMenuWinClose=null)}function Ns(e){ia(e),e.state.filesItemMenuDocClick=a=>{var n,i;const s=a.target;(n=s==null?void 0:s.closest)!=null&&n.call(s,"#files-item-menu")||(i=s==null?void 0:s.closest)!=null&&i.call(s,'[data-action="files-item-menu-toggle"]')||(M(e),e.render())};const t=e.state.filesItemMenuDocClick;setTimeout(()=>{e.state.filesItemMenu&&e.state.filesItemMenuDocClick===t&&document.addEventListener("click",t,!0)},0),e.state.filesItemMenuWinClose=()=>{e.state.filesItemMenu&&(M(e),e.render())},window.addEventListener("resize",e.state.filesItemMenuWinClose)}function xs(e){const t=e.root.querySelector("#files-item-menu");if(!t||!e.state.filesItemMenu)return;Na(e),requestAnimationFrame(()=>Na(e));const a=e.root.querySelector(".files-table-wrap"),s=e.state.filesItemMenuWinClose;a&&s&&a.addEventListener("scroll",s,{passive:!0});const n=[...t.querySelectorAll('[role="menuitem"]:not([disabled])')];e.state.filesItemMenu.origin==="button"&&n.length>0&&!t.contains(document.activeElement)&&n[0].focus(),t.addEventListener("keydown",r=>{var f;if(r.key!=="ArrowDown"&&r.key!=="ArrowUp"&&r.key!=="Home"&&r.key!=="End")return;const l=[...t.querySelectorAll('[role="menuitem"]:not([disabled])')];if(l.length===0)return;r.preventDefault();const o=document.activeElement,c=o?l.indexOf(o):-1;let m=0;r.key==="ArrowDown"?m=c<0?0:(c+1)%l.length:r.key==="ArrowUp"?m=c<0?l.length-1:(c-1+l.length)%l.length:r.key==="End"&&(m=l.length-1),(f=l[m])==null||f.focus()})}function Na(e){const t=e.root.querySelector("#files-item-menu"),a=e.state.filesItemMenu;if(!t||!a)return;let s=a.x,n=a.y;if(a.origin==="button"){const c=e.root.querySelector(`.files-row-menu-btn[data-path="${CSS.escape(a.path)}"]`);if(c){const m=c.getBoundingClientRect();s=m.right,n=m.bottom+4}}t.style.left=`${s}px`,t.style.top=`${n}px`;const i=t.getBoundingClientRect(),r=8;let l=a.origin==="button"?s-i.width:s,o=n;l+i.width>window.innerWidth-r&&(l=window.innerWidth-r-i.width),l<r&&(l=r),o+i.height>window.innerHeight-r&&(o=n-i.height-(a.origin==="button"?8:0)),o<r&&(o=r),t.style.left=`${Math.round(l)}px`,t.style.top=`${Math.round(o)}px`}function Ls(e){const t=e.state.filesItemMenu;if(!t)return"";const a=na(e.state.filesEntries,e.state.checkedFilePaths);if(a.count===0)return"";const s=e.state.busy?"disabled":"",n=a.showDownload?`<button type="button" class="files-item-menu-item" role="menuitem"
    ...
    <button type="button" class="files-item-menu-item is-danger" role="menuitem"
  ...
  </div>`}function _s(e){e.forEach((t,a)=>{window.setTimeout(()=>{const s=document.createElement("a");s.href=k.filesDownloadUrl(t.path),s.download=t.name,s.rel="noopener",document.body.appendChild(s),s.click(),s.remove(),w.event("files.download",{path:t.path,via:"selection"})},a*100)})}async function ne(e){e.state.filesLoading=!0;try{w.debug("loadFiles",{path:e.state.filesPath});const[t,a]=await Promise.all([k.filesStatus(),k.filesList(e.state.filesPath).catch(s=>{if(s instanceof _&&(s.status===503||s.status===404))return{path:e.state.filesPath,entries:[]};throw s})]);if(e.state.filesStatus=t,t.ready){e.state.filesPath=a.path,e.state.filesEntries=a.entries;const s=new Set(e.state.filesEntries.map(n=>n.path));e.state.checkedFilePaths=e.state.checkedFilePaths.filter(n=>s.has(n)),e.state.filesItemMenu&&!s.has(e.state.filesItemMenu.path)&&M(e)}else e.state.filesEntries=[],e.state.checkedFilePaths=[],M(e);w.event("loadFiles",{path:e.state.filesPath,count:e.state.filesEntries.length,enabled:t.enabled,ready:t.ready})}finally{e.state.filesLoading=!1}}function gn(...e){return e.map(t=>t.replace(/\\/g,"/").replace(/^\/+|\/+$/g,"")).filter(Boolean).join("/")}function We(e){const t=e.replace(/\\/g,"/").split("/").filter(Boolean);return t[t.length-1]||e}function St(e,t,a){for(const s of a)if(s&&(t===s||t.startsWith(`${s}/`)))return!0;return!1}function Q(e){e.state.filesTransfer=null,e.state.filesTransferDest="",e.state.filesTreeChildren={},e.state.filesTreeExpanded=[]}async function tt(e,t,a){if(a.length===0)return;e.state.filesTransfer={op:t,paths:[...a]},e.state.filesTransferDest=e.state.filesPath,e.state.filesTreeChildren={};const s=new Set([""]);if(e.state.filesPath){const n=e.state.filesPath.split("/").filter(Boolean);let i="";for(const r of n)i=i?`${i}/${r}`:r,s.add(i)}e.state.filesTreeExpanded=[...s],e.state.filesRenamePath=null,e.state.filesDeletePaths=null,e.state.filesMkdirOpen=!1,e.state.filesUploadMenuOpen=!1,e.state.filesUploadMenuDocClick&&(document.removeEventListener("click",e.state.filesUploadMenuDocClick,!0),e.state.filesUploadMenuDocClick=null),M(e),e.clearFlash(),e.render(),await Promise.all([...s].map(n=>Kt(e,n)))}async function Kt(e,t){const a=e.state.filesTreeChildren[t];if(!(a&&a!=="error")){e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:"loading"},e.render();try{const n=(await k.filesList(t)).entries.filter(i=>i.type==="dir").slice().sort((i,r)=>i.name.localeCompare(r.name,void 0,{sensitivity:"base"}));if(!e.state.filesTransfer)return;e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:n}}catch(s){if(!e.state.filesTransfer)return;e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:"error"},w.warn("files.tree",{path:t||"/",error:s instanceof Error?s.message:String(s)})}e.render()}}function Rs(e){if(!e.state.filesTransfer)return"";const t=e.state.filesTransfer.paths,a=[],s=(n,i)=>{const r=e.state.filesTransferDest===n,l=St(e,n,t),o=e.state.filesTreeExpanded.includes(n),c=e.state.filesTreeChildren[n],m=Array.isArray(c),f=n===""||c==="loading"||c==="error"||!m||c.length>0,b=n===""?"Home":We(n),p=l?"Cannot use a selected item (or a folder inside it) as the destination":n===""?"File home host.root":n,g=o?"▾":"▸";if(a.push(`<div class="files-tree-row${r?" is-selected":""}${l?" is-blocked":""}" style="--depth:${i}" role="treeitem" aria-selected="${r}" aria-expanded="${o}" aria-disabled="${l}">
      ...
      <button type="button" class="files-tree-select${r?" is-selected":""}" data-action="files-tree-select" data-path="${d(n)}"
        ...
        </div>`);return}if(m){for(const u of c)s(u.path,i+1);c.length===0&&n===""&&a.push(`<div class="files-tree-status muted small" style="--depth:${i+1}">No subfolders yet — destination will be Home.</div>`)}}};return s("",0),`<div class="files-folder-tree" role="tree" aria-label="Destination folder">${a.join("")}</div>`}async function qs(e,t){if(!e.state.filesTransfer||e.state.filesTransfer.paths.length===0)return;const a=new FormData(t),s=(e.state.filesTransferDest||String(a.get("toPath")??"")).trim().replace(/^\/+|\/+$/g,""),n=String(a.get("newName")??"").trim(),i=e.state.filesTransfer.op,r=[...e.state.filesTransfer.paths],l=r.length>1;if(St(e,s,r)){e.setFlash("error","Choose a different destination folder"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();let o=0;const c=[];try{for(const f of r)try{if(i==="copy"){const b=We(f),p=l||!n||n===b?void 0:n,g=await k.filesCopy(f,{to:s,newName:p});w.event("files.copy",{path:f,to:g.entry.path})}else{const b=We(f),p=l||!n||n===b?void 0:n;await k.filesMove(f,s,p),w.event("files.move",{path:f,to:s})}o+=1}catch(b){c.push(`${We(f)}: ${b instanceof Error?b.message:"failed"}`)}Q(e),e.state.checkedFilePaths=[],await ne(e);const m=i==="copy"?"Copied":"Moved";o>0&&c.length===0?e.setFlash("success",o===1?`${m} 1 item`:`${m} ${o} items`):o>0?e.setFlash("info",`${m} ${o}; ${c.length} failed. ${c[0]}`):e.setFlash("error",c[0]||`${i==="copy"?"Copy":"Move"} failed`)}catch(m){e.setFlash("error",m instanceof Error?m.message:"Operation failed")}finally{e.state.busy=!1,e.render()}}function Wt(...e){return e.map(t=>t.replace(/\\/g,"/").replace(/^\/+|\/+$/g,"")).filter(Boolean).join("/")}function yn(e){if(!e||typeof e!="object")return!1;const t=e.name;return t==="AbortError"||t==="NotAllowedError"}function vn(e,t=!0){return Array.from(e).map(s=>{const i=(s.webkitRelativePath||"").replace(/\\/g,"/").replace(/^\/+/,"")||s.name;return{file:s,relativePath:i||s.name}})}function Bs(e){return new Promise((t,a)=>{const s=[],n=()=>{e.readEntries(i=>{if(!i.length){t(s);return}s.push(...i),n()},i=>a(i))};n()})}function Hs(e){return new Promise((t,a)=>{e.file(t,a)})}async function $n(e,t){const a=Wt(t,e.name);if(e.isFile)return[{file:await Hs(e),relativePath:a||e.name}];if(e.isDirectory){const s=e.createReader(),n=await Bs(s);if(n.length===0)return[{file:null,relativePath:a,isEmptyDir:!0}];const i=[];for(const r of n)i.push(...await $n(r,a));return i}return[]}async function*Vs(e){const t=e;if(typeof t.values=="function"){for await(const a of t.values())yield a;return}if(typeof t.entries=="function")for await(const[,a]of t.entries())yield a}async function la(e,t){const a=Wt(t,e.name),s=[];let n=0;for await(const i of Vs(e))if(n+=1,i.kind==="file"){const r=await i.getFile();s.push({file:r,relativePath:Wt(a,i.name)||r.name})}else i.kind==="directory"&&s.push(...await la(i,a));return n===0&&s.push({file:null,relativePath:a,isEmptyDir:!0}),s}async function js(){const e=window;if(typeof e.showOpenFilePicker!="function")return{kind:"fallback"};try{const t=await e.showOpenFilePicker({multiple:!0});if(!t||t.length===0)return{kind:"cancel"};const a=[];for(const s of t){const n=await s.getFile();a.push({file:n,relativePath:n.name})}return{kind:"items",items:a}}catch(t){return yn(t)?{kind:"cancel"}:{kind:"fallback"}}}async function zs(){const e=window;if(typeof e.showDirectoryPicker!="function")return{kind:"fallback"};try{const t=await e.showDirectoryPicker({mode:"read"}),a=await la(t,"");return a.length===0?{kind:"cancel"}:{kind:"items",items:a}}catch(t){return yn(t)?{kind:"cancel"}:{kind:"fallback"}}}function xa(e){return e.replace(/\\/g,"/").replace(/^\/+/,"").replace(/\/+$/,"")}function Ks(e){const t=e.files?Array.from(e.files):[],a=[],s=[],n=e.items?Array.from(e.items):[];for(const i of n){if(i.kind!=="file")continue;const r=i;typeof r.getAsFileSystemHandle=="function"?a.push(r.getAsFileSystemHandle().catch(()=>null)):a.push(Promise.resolve(null));let l=null;if(typeof r.webkitGetAsEntry=="function")try{l=r.webkitGetAsEntry()}catch{l=null}s.push(l)}return{handlePromises:a,entries:s,files:t}}async function Ws(e){var i,r;const t=[],a=await Promise.all(e.handlePromises);for(let l=0;l<Math.max(a.length,e.entries.length);l++){const o=a[l]??null;if(o)try{if(o.kind==="file"){const m=await o.getFile();t.push({file:m,relativePath:m.name})}else o.kind==="directory"&&t.push(...await la(o,""));continue}catch{}const c=e.entries[l];if(c)try{t.push(...await $n(c,""))}catch{}}const s=vn(e.files,!0),n=new Map;for(const l of s){const o=xa(l.relativePath||((i=l.file)==null?void 0:i.name)||"");o&&n.set(o,l)}for(const l of t){const o=xa(l.relativePath||((r=l.file)==null?void 0:r.name)||"");o&&n.set(o,l)}return Array.from(n.values())}function Ys(e){if(!e)return!1;if(e.types&&typeof e.types.includes=="function")return e.types.includes("Files");try{for(let t=0;t<e.types.length;t++)if(e.types[t]==="Files")return!0}catch{}return!1}function wn(e,t=80){const a=String(e??"").replace(/\s+/g," ").trim();return a?a.length>t?`${a.slice(0,t-1)}…`:a:""}function me(e,t,a){const s=wn(t);return s?`${e} “${s}” ${a}`:`${e} ${a}`}function Nt(e){const t=wn(e.displayname||e.fullname);return t||[e.firstname,e.lastname].map(s=>String(s??"").trim()).filter(Boolean).join(" ")||"Unnamed contact"}function hn(e){if(!e)return"—";try{const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}function pt(e){return!Number.isFinite(e)||e<0?"":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function Z(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/60),s=t%60;return a>0?`${a}m ${s}s`:`${s}s`}function X(e){return!Number.isFinite(e)||e<0?"—":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:e<1024*1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:`${(e/(1024*1024*1024)).toFixed(2)} GB`}function Js(e){if(!e)return"—";try{return new Date(e*1e3).toLocaleString()}catch{return"—"}}function Y(e,t,a,s,n,i=""){const r=a===t,l=r?s==="asc"?" ▲":" ▼":"";return`<th class="${`sortable-th${r?" is-sorted":""}${i?" "+i:""}`}" data-action="sort-${n}" data-sort="${d(t)}" role="columnheader" tabindex="0">${d(e)}${l}</th>`}const Gs=new Set(["docx","xlsx","pptx","odt","ods","odp","doc","xls","ppt"]),Xs=new Set(["jpg","jpeg","jfif","png","gif","webp","bmp","avif","ico","heic","heif"]),Qs=new Set(["mp3","wav","ogg","oga","flac","aac","m4a","opus","weba"]),Zs=new Set(["mp4","m4v","webm","ogv","mov"]),er=new Set(["txt","md","markdown","rst","csv","tsv","json","jsonc","xml","yml","yaml","html","htm","xhtml","js","mjs","cjs","ts","tsx","jsx","css","scss","less","php","py","rb","go","rs","java","c","h","cpp","hpp","cs","sh","bash","zsh","sql","log","ini","conf","cfg","env","toml","diff","patch","vue","svelte","svg","rss","atom","ics","vcf","eml","nfo","rtf","tex","lua","kt","swift","pl","pm"]);function oa(e){const t=e.split(/[/\\]/).pop()||e,a=t.lastIndexOf(".");return a<=0?"":t.slice(a+1).toLowerCase()}function kn(e){const t=oa(e);return Xs.has(t)?"image":t==="pdf"?"pdf":Qs.has(t)?"audio":Zs.has(t)?"video":Gs.has(t)?"office":er.has(t)?"text":"unsupported"}function ve(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Sn(e){return e.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&apos;/g,"'").replace(/&#(\d+);/g,(t,a)=>String.fromCharCode(Number(a))).replace(/&#x([0-9a-fA-F]+);/g,(t,a)=>String.fromCharCode(parseInt(a,16)))}function tr(e,t){const a=[],s=new RegExp(t.source,t.flags.includes("g")?t.flags:`${t.flags}g`);let n;for(;n=s.exec(e);)a.push(n[1]??n[0]);return a}function le(e,t){const a=new RegExp(`<(?:[\\w.-]+:)?${t}\\b[^>]*>[\\s\\S]*?</(?:[\\w.-]+:)?${t}>`,"gi");return e.match(a)??[]}function de(e,t){const a=new RegExp(`<(?:[\\w.-]+:)?${t}\\b[^>]*>([\\s\\S]*?)</(?:[\\w.-]+:)?${t}>`,"gi");return tr(e,a).map(s=>Sn(s.replace(/<[^>]+>/g,"")))}function ar(e){const t=le(e,"p");if(t.length===0){const n=de(e,"t").join(" ").trim();return n?`<p>${ve(n)}</p>`:""}const a=[];for(const n of t){const i=le(n,"r"),r=[],l=i.length?i:[n];for(const o of l){const c=de(o,"t").join("");if(!c)continue;let m=ve(c);(/<(?:[\w.-]+:)?b\b/i.test(o)||/w:val="true"[^>]*w:b|w:b\s*\/>/i.test(o))&&(m=`<strong>${m}</strong>`),/<(?:[\w.-]+:)?i\b/i.test(o)&&(m=`<em>${m}</em>`),r.push(m)}a.push(`<p>${r.join("")||"&nbsp;"}</p>`)}const s=le(e,"tbl");for(const n of s){const i=le(n,"tr").map(r=>`<tr>${le(r,"tc").map(o=>`<td>${ve(de(o,"t").join(" "))}</td>`).join("")}</tr>`).join("");i&&a.push(`<table class="files-preview-sheet">${i}</table>`)}return a.join("")}function nr(e,t){const a=e?de(e,"t"):[],s=le(t,"row");return s.length===0?"":`<table class="files-preview-sheet">${s.map(i=>`<tr>${le(i,"c").map(l=>{const o=/\bt="s"/.test(l),c=(de(l,"v")[0]??de(l,"t")[0]??"").trim();let m=c;if(o){const f=Number(c);m=Number.isFinite(f)&&a[f]!==void 0?a[f]:c}return`<td>${ve(m)}</td>`}).join("")}</tr>`).join("")}</table>`}function sr(e){return e.map((t,a)=>{const n=de(t,"t").map(i=>i.trim()).filter(Boolean).map(i=>`<p>${ve(i)}</p>`).join("")||'<p class="muted">(empty slide)</p>';return`<section class="files-preview-slide"><h3>Slide ${a+1}</h3>${n}</section>`}).join("")}function rr(e){const t=le(e,"p");return t.length===0?de(e,"p").map(a=>`<p>${ve(a)}</p>`).join(""):t.map(a=>`<p>${ve(Sn(a.replace(/<[^>]+>/g," ")).replace(/\s+/g," ").trim())||"&nbsp;"}</p>`).join("")}function be(e,t){return e.getUint16(t,!0)}function Oe(e,t){return e.getUint32(t,!0)}async function ir(e){if(typeof DecompressionStream>"u")throw new Error("Deflate is not available in this browser");const t=new DecompressionStream("deflate-raw"),a=new Blob([e]).stream().pipeThrough(t),s=await new Response(a).arrayBuffer();return new Uint8Array(s)}async function lr(e){const t=new Uint8Array(e),a=new DataView(e);let s=-1;const n=Math.max(0,t.length-22-65535);for(let c=t.length-22;c>=n;c--)if(Oe(a,c)===101010256){s=c;break}if(s<0)throw new Error("Not a ZIP file");const i=be(a,s+10);let r=Oe(a,s+16);const l=new Map,o=new TextDecoder("utf-8");for(let c=0;c<i;c++){if(Oe(a,r)!==33639248)throw new Error("Bad ZIP directory");const m=be(a,r+10),f=Oe(a,r+20),b=be(a,r+28),p=be(a,r+30),g=be(a,r+32),u=Oe(a,r+42),v=o.decode(t.subarray(r+46,r+46+b)).replace(/\\/g,"/");if(r+=46+b+p+g,!v||v.endsWith("/"))continue;const $=be(a,u+26),S=be(a,u+28),C=u+30+$+S,y=t.subarray(C,C+f);m===0?l.set(v,y.slice()):m===8&&l.set(v,await ir(y))}return l}function Ne(e,t){const a=e.get(t);return a?new TextDecoder("utf-8").decode(a):null}const or=20*1024*1024;async function dr(e,t){const a=oa(e);if(a==="doc"||a==="xls"||a==="ppt")throw new Error("Older binary Office files (.doc / .xls / .ppt) cannot be previewed. Download to open them.");if(t.size>or)throw new Error("This document is too large to preview. Download it instead.");const s=await lr(await t.arrayBuffer());if(a==="docx"){const n=Ne(s,"word/document.xml");if(!n)throw new Error("This Word file has no document.xml");const i=ar(n);if(!i)throw new Error("No readable text in this Word file");return i}if(a==="xlsx"){const n=[...s.keys()].filter(l=>/^xl\/worksheets\/sheet\d+\.xml$/i.test(l)).sort((l,o)=>l.localeCompare(o,void 0,{numeric:!0}))[0],i=n?Ne(s,n):null;if(!i)throw new Error("This spreadsheet has no worksheet");const r=nr(Ne(s,"xl/sharedStrings.xml"),i);if(!r)throw new Error("No readable cells in this spreadsheet");return r}if(a==="pptx"){const n=[...s.keys()].filter(i=>/^ppt\/slides\/slide\d+\.xml$/i.test(i)).sort((i,r)=>i.localeCompare(r,void 0,{numeric:!0})).map(i=>Ne(s,i)).filter(i=>!!i);if(n.length===0)throw new Error("This presentation has no slides");return sr(n)}if(a==="odt"||a==="ods"||a==="odp"){const n=Ne(s,"content.xml");if(!n)throw new Error("This OpenDocument file has no content.xml");const i=rr(n);if(!i)throw new Error("No readable text in this document");return i}throw new Error("This Office file type cannot be previewed")}const Yt=2*1024*1024,cr=50*1024*1024;function ur(e){const t=e.filesPreview;if(t!=null&&t.objectUrl)try{URL.revokeObjectURL(t.objectUrl)}catch{}e.filesPreviewSeq+=1,e.filesPreview=null}function z(e){ur(e.state)}async function mr(e,t){const a=e.state.filesEntries.find(l=>l.path===t);if(!a||a.type!=="file")return;z(e),e.state.filesRenamePath=null,e.state.filesDeletePaths=null,Q(e),e.state.filesMkdirOpen=!1,e.state.filesUploadMenuOpen=!1,M(e);const s=kn(a.name),n=e.state.filesPreviewSeq+1;e.state.filesPreviewSeq=n;const i={path:a.path,name:a.name,size:a.size,kind:s,status:"loading",objectUrl:null,text:null,html:null,truncated:!1,error:null};if(!(s==="text"||s==="pdf"||s==="office")){e.state.filesPreview={...i,status:"ready"},w.event("files.preview",{path:a.path,kind:s}),e.render();return}e.state.filesPreview=i,e.render();try{if(s==="pdf"&&a.size>cr){if(e.state.filesPreviewSeq!==n)return;e.state.filesPreview={...i,status:"error",error:`This PDF is too large to preview (${X(a.size)}). Download it instead.`},e.render();return}const{blob:l}=await k.filesGetBlob(a.path,{inline:!0});if(e.state.filesPreviewSeq!==n)return;if(s==="office"){const o=await dr(a.name,l);if(e.state.filesPreviewSeq!==n)return;e.state.filesPreview={...i,status:"ready",html:o}}else if(s==="pdf"){const o=l.type&&l.type.toLowerCase().includes("pdf")?l:new Blob([l],{type:"application/pdf"});e.state.filesPreview={...i,status:"ready",objectUrl:URL.createObjectURL(o)}}else{const o=l.size>Yt,m=await(o?l.slice(0,Yt):l).text();if(e.state.filesPreviewSeq!==n)return;e.state.filesPreview={...i,status:"ready",text:m,truncated:o}}w.event("files.preview",{path:a.path,kind:s})}catch(l){if(e.state.filesPreviewSeq!==n)return;e.state.filesPreview={...i,status:"error",error:l instanceof Error?l.message:"Could not open file"}}e.render()}function fr(e){const t=e.state.filesPreview;if(!t)return"";let a;if(t.status==="loading")a='<p class="muted" style="margin:0">Loading preview…</p>';else if(t.status==="error")a=`<p class="flash flash-error" style="margin:0">${d(t.error||"Could not open file")}</p>`;else if(t.kind==="image"){const s=k.filesDownloadUrl(t.path,{inline:!0});a=`<div class="files-preview-media">
    ...
    </div>`}else t.kind==="office"&&t.html?a=`<div class="files-preview-office">${t.html}</div>`:t.kind==="text"?a=`${t.truncated?`<p class="muted small files-preview-truncated">Showing the first ${d(X(Yt))} of this file.</p>`:""}<pre class="files-preview-text">${d(t.text||"")}</pre>`:a=`<p style="margin:0">This file type cannot be previewed in the browser. Download it to open with another app.</p>
      <p class="muted small" style="margin:0.75rem 0 0">${d(t.name)} · ${d(X(t.size))}</p>`;return N({id:"files-preview-modal",title:t.name,titleId:"files-preview-title",closeAction:"files-preview-close",size:"wide",cardClassName:"files-preview-card",className:"files-preview-modal",body:a,footer:[{label:"Download",action:"files-preview-download",variant:"ghost"},{label:"Close",action:"files-preview-close",variant:"primary"}]})}function ce(e){e.state.filesUploadMenuDocClick&&(document.removeEventListener("click",e.state.filesUploadMenuDocClick,!0),e.state.filesUploadMenuDocClick=null)}function pr(e){ce(e),e.state.filesUploadMenuDocClick=a=>{var n;const s=a.target;(n=s==null?void 0:s.closest)!=null&&n.call(s,".files-upload-menu")||(e.state.filesUploadMenuOpen=!1,ce(e),e.render())};const t=e.state.filesUploadMenuDocClick;setTimeout(()=>{e.state.filesUploadMenuOpen&&e.state.filesUploadMenuDocClick===t&&document.addEventListener("click",t,!0)},0)}function Ae(e){e.state.filesUploadElapsedTimer!==null&&(clearInterval(e.state.filesUploadElapsedTimer),e.state.filesUploadElapsedTimer=null)}function br(e){Ae(e),e.state.filesUploadElapsedTimer=setInterval(()=>{if(!e.state.filesUploadProgress||e.state.filesUploadProgress.phase==="done"||e.state.filesUploadProgress.phase==="error"){Ae(e);return}e.state.filesUploadProgress={...e.state.filesUploadProgress,elapsedSec:Math.floor((Date.now()-e.state.filesUploadProgress.startedAt)/1e3)},Ce(e,e.state.filesUploadProgress)},1e3)}function Dn(e){Ae(e),e.state.filesUploadProgress=null,e.render()}function Cn(e,t){return t.bytesTotal>0?Math.min(100,Math.max(0,Math.round(100*t.bytesSent/t.bytesTotal))):t.totalFiles>0?Math.min(100,Math.max(0,Math.round(100*t.completedFiles/t.totalFiles))):null}function Ce(e,t){if(!e.root.querySelector("[data-files-upload-progress]"))return;const a=e.root.querySelector(".files-upload-progress-bar"),s=e.root.querySelector(".files-upload-progress-track"),n=e.root.querySelector("[data-files-upload-status]"),i=e.root.querySelector("[data-files-upload-current]"),r=Cn(e,t),l=t.phase==="uploading"?`Uploading ${t.completedFiles.toLocaleString()} / ${t.totalFiles.toLocaleString()} file${t.totalFiles===1?"":"s"}${t.failedFiles?` · ${t.failedFiles} failed`:""}${r!==null?` (${r}%)`:""} · ${Z(t.elapsedSec)}`:(n==null?void 0:n.textContent)||"";n&&t.phase==="uploading"&&(n.textContent=l),i&&t.phase==="uploading"&&(i.textContent=t.currentName||"",i.title=t.currentName||""),a&&r!==null&&(a.classList.remove("is-indeterminate"),a.style.width=`${r}%`),s&&r!==null&&(s.setAttribute("aria-valuenow",String(r)),s.removeAttribute("aria-valuetext"))}function gr(e){if(!e.state.filesUploadProgress)return"";const t=e.state.filesUploadProgress,a=t.phase==="uploading",s=t.phase==="done"?"Upload finished":t.phase==="error"?"Upload failed":"Uploading…",n=Cn(e,t),i=n===null?"files-upload-progress-bar is-indeterminate":"files-upload-progress-bar",r=n!==null?` style="width:${n}%"`:"";let l="";if(a){const c=`Uploading ${t.completedFiles.toLocaleString()} / ${t.totalFiles.toLocaleString()} file${t.totalFiles===1?"":"s"}${t.failedFiles?` · ${t.failedFiles} failed`:""}${n!==null?` (${n}%)`:""} · ${Z(t.elapsedSec)}`,m=t.bytesTotal>0?`${pt(t.bytesSent)} / ${pt(t.bytesTotal)}`:"";l=`
    ...
    <div class="info-modal" id="info-modal" hidden role="dialog" aria-modal="true" aria-labelledby="info-modal-title">
    ...
    </div>`}const Sr=new Set(["zip","tar","gz","tgz","bz2","7z","rar","xz"]),Dr=[{value:"all",label:"All types"},{value:"folder",label:"Folders"},{value:"file",label:"Files"},{value:"image",label:"Images"},{value:"document",label:"Documents"},{value:"audio",label:"Audio"},{value:"video",label:"Video"},{value:"archive",label:"Archives"},{value:"other",label:"Other"}];function Cr(e){if(e.type==="dir")return"folder";const t=kn(e.name);return t==="image"?"image":t==="pdf"||t==="office"||t==="text"?"document":t==="audio"?"audio":t==="video"?"video":Sr.has(oa(e.name))?"archive":"other"}function Er(e,t){return t==="all"?!0:t==="file"?e.type==="file":Cr(e)===t}function Tn(e,t){const a=t.search.trim().toLowerCase();let s=e.filter(i=>!(!Er(i,t.type)||a&&!i.name.toLowerCase().includes(a)));const n=t.order==="desc"?-1:1;return s=s.slice().sort((i,r)=>t.sort==="name"?i.type!==r.type?i.type==="dir"?-1:1:n*i.name.localeCompare(r.name,void 0,{sensitivity:"base"}):t.sort==="size"?i.type!==r.type?i.type==="dir"?1:-1:i.size!==r.size?n*(i.size-r.size):i.name.localeCompare(r.name,void 0,{sensitivity:"base"}):i.mtime!==r.mtime?n*(i.mtime-r.mtime):i.name.localeCompare(r.name,void 0,{sensitivity:"base"})),s}function Tr(e,t){const a=t?t.split("/").filter(Boolean):[];let s="";const n=[`<button type="button" class="files-crumb" data-action="files-nav" data-path="" ${e.state.busy?"disabled":""}>Home</button>`];for(const i of a){s=s?`${s}/${i}`:i;const r=s;n.push('<span class="files-crumb-sep" aria-hidden="true">/</span>'),n.push(`<button type="button" class="files-crumb" data-action="files-nav" data-path="${d(r)}" ${e.state.busy?"disabled":""}>${d(i)}</button>`)}return`<nav class="files-breadcrumb" aria-label="Folder path">${n.join("")}</nav>`}function Pr(e){const t=e.state.filesStatus;if(!t)return`<div class="card"><p class="muted">${e.state.filesLoading||e.state.busy?"Loading…":"Unable to load file storage status."}</p></div>`;if(!t.enabled)return`<div class="portal-grid portal-grid-files">
      <section class="card">
        ${R("Files","files","h1")}
      ...
      <section class="card">
        ...
        <p class="muted small">DAV path: <span class="mono">${d(t.davPath)}</span></p>
    ...
    </div>`;const a=t.quotaBytes>0?`${X(t.usedBytes)} used · ${X(t.availableBytes)} free of ${X(t.quotaBytes)}`:`${X(t.usedBytes)} used · ${X(t.availableBytes)} free (no app quota)`,s=t.quotaBytes>0?Math.min(100,Math.round(100*t.usedBytes/t.quotaBytes)):0,n=Tn(e.state.filesEntries,{search:e.state.filesSearch,type:e.state.filesTypeFilter,sort:e.state.filesSort,order:e.state.filesOrder}),i=e.state.checkedFilePaths.length,r=(()=>{if(i===0)return null;const h=new Set(e.state.checkedFilePaths);let P=0,F=0;for(const U of e.state.filesEntries)!h.has(U.path)||U.type!=="file"||(P+=U.size,F+=1);return F>0?P:null})(),l=n.length>0&&n.every(h=>e.state.checkedFilePaths.includes(h.path)),o=i>0,c=e.state.filesEntries.filter(h=>h.type==="dir").length,m=e.state.filesEntries.length-c,f=na(e.state.filesEntries,e.state.checkedFilePaths),b=n.length!==e.state.filesEntries.length,p=(()=>{if(e.state.filesLoading&&e.state.filesEntries.length===0)return"Loading…";if(e.state.filesEntries.length===0)return"0 items";const h=[];c>0&&h.push(`${c} folder${c===1?"":"s"}`),m>0&&h.push(`${m} file${m===1?"":"s"}`);const P=`${e.state.filesEntries.length} item${e.state.filesEntries.length===1?"":"s"}`;return h.length===2?`${P} · ${h.join(", ")}`:h[0]??P})(),g=e.state.filesEntries.length===0?'<tr><td colspan="5" class="muted">This folder is empty.</td></tr>':n.length===0?'<tr><td colspan="5" class="muted">No items match this search or filter.</td></tr>':n.map(h=>{var q,K;const P=e.state.checkedFilePaths.includes(h.path),F=h.type==="dir"?"📁":"📄",U=h.type==="dir"?`<button type="button" class="files-name-btn" data-action="files-nav" data-path="${d(h.path)}" ${e.state.busy?"disabled":""}>
                    ...
                    <span class="files-icon" aria-hidden="true">${F}</span>${d(h.name)}
                  </button>`,V=h.type==="dir"?"—":X(h.size),O=((K=e.state.filesItemMenu)==null?void 0:K.path)===h.path;return`<tr class="files-row${P?" is-checked":""}${O?" is-menu-open":""}" data-path="${d(h.path)}" data-type="${h.type}">
              ...
              <td class="files-col-size mono">${V}</td>
              <td class="files-col-mtime hide-sm">${d(Js(h.mtime))}</td>
              <td class="files-col-actions">
                <button type="button" class="files-row-menu-btn" data-action="files-item-menu-toggle"
                  data-path="${d(h.path)}"
                  aria-haspopup="menu"
                  aria-expanded="${O?"true":"false"}"
                  ${O?'aria-controls="files-item-menu"':""}
            ...
            </tr>`}).join(""),u=e.state.filesRenamePath!==null?(()=>{const h=e.state.filesEntries.find(F=>F.path===e.state.filesRenamePath),P=(h==null?void 0:h.name)??"";return N({id:"files-rename-modal",title:"Rename",titleId:"files-rename-title",closeAction:"files-rename-close",size:"sm",form:!0,formAttrs:'data-form="files-rename" id="files-rename-form"',body:`
                  ...
                  </label>`,footer:[{label:"Cancel",action:"files-rename-close",variant:"ghost"},{label:"Rename",type:"submit",variant:"primary",disabled:e.state.busy}]})})():"",v=e.state.filesDeletePaths!==null&&e.state.filesDeletePaths.length>0?(()=>{const h=e.state.filesDeletePaths,P=h.length>1,F=e.state.filesEntries.find(O=>O.path===h[0]),U=P?`Delete ${h.length} items`:`Delete ${(F==null?void 0:F.type)==="dir"?"folder":"file"}`,V=P?`<p style="margin:0 0 0.75rem">Delete <strong>${h.length}</strong> selected items? Folders are removed with their contents. This cannot be undone.</p>
               <ul class="files-delete-list muted small">
                 ${h.slice(0,12).map(O=>{const q=e.state.filesEntries.find(K=>K.path===O);return`<li><span class="mono">${d((q==null?void 0:q.name)??O)}</span></li>`}).join("")}
                 ${h.length>12?`<li>…and ${h.length-12} more</li>`:""}
               </ul>`:`<p style="margin:0">Delete <strong>${d((F==null?void 0:F.name)??h[0])}</strong>?${(F==null?void 0:F.type)==="dir"?" This removes the folder and everything inside it.":""}</p>`;return N({id:"files-delete-modal",title:U,titleId:"files-delete-title",closeAction:"files-delete-close",size:"sm",body:V,footer:[{label:"Cancel",action:"files-delete-close",variant:"ghost"},{label:"Delete",action:"files-delete-confirm",variant:"danger",disabled:e.state.busy}]})})():"",$=e.state.filesTransfer!==null&&e.state.filesTransfer.paths.length>0?(()=>{const h=e.state.filesTransfer.op,P=e.state.filesTransfer.paths,F=P.length>1,U=e.state.filesEntries.find(At=>At.path===P[0]),V=(U==null?void 0:U.name)??We(P[0]),O=F?`${h==="copy"?"Copy":"Move"} ${P.length} items`:`${h==="copy"?"Copy":"Move"} ${(U==null?void 0:U.type)==="dir"?"folder":"file"}`,q=e.state.filesTransferDest===""?"Home":e.state.filesTransferDest,K=St(e,e.state.filesTransferDest,P);return N({id:"files-transfer-modal",title:O,titleId:"files-transfer-title",closeAction:"files-transfer-close",size:"md",form:!0,formAttrs:'data-form="files-transfer"',body:`
                  ${F?`<p class="muted small" style="margin:0 0 0.75rem">${P.length} items will be ${h==="copy"?"copied":"moved"} into the destination folder (original names kept).</p>`:`<p class="muted small" style="margin:0 0 0.75rem"><span class="mono">${d(V)}</span></p>`}
                  ...
                  ${F?"":`<label style="margin-top:0.85rem">New name <span class="muted">(optional)</span>
                          <input type="text" name="newName" value="${d(V)}" maxlength="255" autocomplete="off" />
                        </label>
              ...
              </label>`,footer:[{label:"Cancel",action:"files-mkdir-close",variant:"ghost"},{label:"Create",type:"submit",variant:"primary",disabled:e.state.busy}]}):"",C=e.state.filesUploadConflict?(()=>{const h=e.state.filesUploadConflict,P=h.conflictCount,F=Math.max(0,h.totalFiles-P),U=P===1?"1 file already exists in the destination.":`${P} of ${h.totalFiles} files already exist in the destination.`,V=F>0?F===1?" Skip existing keeps the other 1 new file.":` Skip existing keeps the other ${F} new files.`:" Skip existing cancels the upload (nothing new to send).",O=h.names.slice(0,12).map(K=>`<li><span class="mono">${d(K)}</span></li>`).join(""),q=h.names.length>12?`<li class="muted">…and ${h.names.length-12} more</li>`:"";return N({id:"files-upload-conflict-modal",title:P===1?"File already exists":"Files already exist",titleId:"files-upload-conflict-title",closeAction:"files-upload-conflict-cancel",size:"sm",body:`
              <p style="margin:0 0 0.75rem">${d(U)}${d(V)}</p>
        ...
        </div>`,x=`<input type="file" data-action="files-upload-pick-files" ${e.state.busy?"disabled":""} multiple hidden />
        <input type="file" data-action="files-upload-pick-folder" ${e.state.busy?"disabled":""}
          multiple webkitdirectory directory hidden />`,H=Dr.map(h=>`<option value="${d(h.value)}" ${e.state.filesTypeFilter===h.value?"selected":""}>${d(h.label)}</option>`).join(""),j=`<div class="files-filter-bar">
        ...
        </div>`,L=i>0?`<div class="files-toolbar-actions" role="toolbar" aria-label="Selected files">
    ...
    <section class="card files-panel${e.state.filesUploadDropActive?" is-dragover":""}" data-files-drop-target>
      ...
      <div class="files-status-bar muted small" role="status" aria-live="polite">
        ${i>0?`${i} of ${e.state.filesEntries.length} selected${r!==null?` · ${d(X(r))}`:""}`:b?`${n.length} shown of ${e.state.filesEntries.length}`:d(p)}
      </div>
    </section>
    ${u}
    ${v}
    ...
    ${S}
    ${C}
  </div>`}async function Fr(e,t){const a=new FormData(t),s=String(a.get("path")??""),n=String(a.get("newName")??"").trim();if(!s||!n){e.setFlash("error","Name is required"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{await k.filesRename(s,n),w.event("files.rename",{path:s,newName:n}),e.state.filesRenamePath=null,await ne(e),e.setFlash("success",`Renamed to “${n}”`)}catch(i){e.setFlash("error",i instanceof Error?i.message:"Rename failed")}finally{e.state.busy=!1,e.render()}}async function Ar(e,t){const a=new FormData(t),s=String(a.get("name")??"").trim();if(!s){e.setFlash("error","Folder name is required"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{await k.filesMkdir(e.state.filesPath,s),w.event("files.mkdir",{path:e.state.filesPath,name:s}),e.state.filesMkdirOpen=!1,await ne(e),e.setFlash("success",`Created folder “${s}”`)}catch(n){e.setFlash("error",n instanceof Error?n.message:"Could not create folder")}finally{e.state.busy=!1,e.render()}}async function Ir(e,t,a,s){var i;const{state:n}=e;if(t==="files-upload-menu-toggle")return n.busy||n.filesUploadProgress||(n.filesUploadMenuOpen=!n.filesUploadMenuOpen,n.filesUploadMenuOpen&&(n.filesRenamePath=null,n.filesDeletePaths=null,Q(e),n.filesMkdirOpen=!1,M(e)),e.render()),!0;if(t==="files-item-menu-toggle"){s.stopPropagation();const r=a.dataset.path??"";if(!r||sa(n))return!0;if(((i=n.filesItemMenu)==null?void 0:i.path)===r)return M(e),e.render(),!0;const l=a.getBoundingClientRect();return ra(e,r,{x:l.right,y:l.bottom+4,origin:"button"}),!0}if(t==="sort-file"){const r=a.dataset.sort||"";return r!=="name"&&r!=="size"&&r!=="mtime"||(n.filesSort===r?n.filesOrder=n.filesOrder==="asc"?"desc":"asc":(n.filesSort=r,n.filesOrder=r==="name"?"asc":"desc"),e.render()),!0}if(t==="files-type-filter"){const r=a.value;return n.filesTypeFilter=r==="folder"||r==="file"||r==="image"||r==="document"||r==="audio"||r==="video"||r==="archive"||r==="other"?r:"all",e.render(),!0}if(t==="files-clear-selection")return n.checkedFilePaths=[],M(e),e.render(),!0;if(t==="files-upload-files")return _a(e,"files"),!0;if(t==="files-upload-folder")return _a(e,"folder"),!0;if(t==="files-nav"){const r=a.dataset.path??"";n.filesPath=r,n.filesRenamePath=null,n.filesDeletePaths=null,n.filesTransfer=null,n.filesMkdirOpen=!1,z(e),M(e),n.checkedFilePaths=[],n.busy=!0,e.clearFlash(),e.render();try{await ne(e)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Failed to open folder")}finally{n.busy=!1,e.render()}return!0}if(t==="files-toggle"){s.stopPropagation();const r=a.dataset.path??"";return r&&(a.checked?n.checkedFilePaths.includes(r)||(n.checkedFilePaths=[...n.checkedFilePaths,r]):n.checkedFilePaths=n.checkedFilePaths.filter(o=>o!==r),n.filesItemMenu&&!n.checkedFilePaths.includes(n.filesItemMenu.path)&&M(e),e.render()),!0}if(t==="files-select-all"){s.stopPropagation();const r=a.checked,l=Tn(n.filesEntries,{search:n.filesSearch,type:n.filesTypeFilter,sort:n.filesSort,order:n.filesOrder});return n.checkedFilePaths=r?l.map(o=>o.path):[],n.filesItemMenu&&!n.checkedFilePaths.includes(n.filesItemMenu.path)&&M(e),e.render(),!0}if(t==="files-copy"){const r=a.dataset.path??"";return r&&(z(e),M(e),tt(e,"copy",[r])),!0}if(t==="files-move"){const r=a.dataset.path??"";return r&&(z(e),M(e),tt(e,"move",[r])),!0}if(t==="files-bulk-copy")return n.checkedFilePaths.length===0||(z(e),M(e),tt(e,"copy",[...n.checkedFilePaths])),!0;if(t==="files-bulk-move")return n.checkedFilePaths.length===0||(z(e),M(e),tt(e,"move",[...n.checkedFilePaths])),!0;if(t==="files-bulk-download"){const r=na(n.filesEntries,n.checkedFilePaths);return r.downloadItems.length===0||(M(e),_s(r.downloadItems),e.render()),!0}if(t==="files-tree-select"){if(s.preventDefault(),s.stopPropagation(),!n.filesTransfer)return!0;const r=a.dataset.path??"";return St(e,r,n.filesTransfer.paths)||(n.filesTransferDest=r,e.render()),!0}if(t==="files-tree-toggle"||t==="files-tree-retry"){if(s.preventDefault(),s.stopPropagation(),!n.filesTransfer)return!0;const r=a.dataset.path??"";if(t==="files-tree-retry"){const o={...n.filesTreeChildren};return delete o[r],n.filesTreeChildren=o,n.filesTreeExpanded.includes(r)||(n.filesTreeExpanded=[...n.filesTreeExpanded,r]),Kt(e,r),!0}return n.filesTreeExpanded.includes(r)?(n.filesTreeExpanded=n.filesTreeExpanded.filter(o=>o!==r),e.render()):(n.filesTreeExpanded=[...n.filesTreeExpanded,r],Kt(e,r)),!0}if(t==="files-transfer-close")return Q(e),e.render(),!0;if(t==="files-bulk-delete")return n.checkedFilePaths.length===0||(n.filesDeletePaths=[...n.checkedFilePaths],n.filesRenamePath=null,Q(e),z(e),M(e),e.render()),!0;if(t==="files-refresh"){M(e),n.busy=!0,e.clearFlash(),e.render();try{await ne(e),e.setFlash("success","Refreshed")}catch(r){e.setFlash("error",r instanceof Error?r.message:"Refresh failed")}finally{n.busy=!1,e.render()}return!0}if(t==="files-mkdir")return n.filesMkdirOpen=!0,n.filesUploadMenuOpen=!1,ce(e),n.filesUploadDropActive=!1,n.filesRenamePath=null,n.filesDeletePaths=null,Q(e),z(e),M(e),e.clearFlash(),e.render(),!0;if(t==="files-mkdir-close")return n.filesMkdirOpen=!1,e.render(),!0;if(t==="files-rename-open"){const r=a.dataset.path||(n.checkedFilePaths.length===1?n.checkedFilePaths[0]:"");return r&&(n.filesRenamePath=r,n.filesDeletePaths=null,Q(e),n.filesUploadMenuOpen=!1,ce(e),z(e),M(e),e.render()),!0}if(t==="files-rename-close")return n.filesRenamePath=null,e.render(),!0;if(t==="files-delete-open"){const r=a.dataset.path??"";return n.filesDeletePaths=r?[r]:null,n.filesRenamePath=null,Q(e),n.filesUploadMenuOpen=!1,ce(e),z(e),M(e),e.render(),!0}if(t==="files-delete-close")return n.filesDeletePaths=null,e.render(),!0;if(t==="files-delete-confirm"){const r=n.filesDeletePaths?[...n.filesDeletePaths]:[];if(r.length===0)return!0;n.busy=!0,e.clearFlash(),e.render();try{if(r.length===1)await k.filesDelete(r[0]),w.event("files.delete",{path:r[0]}),e.setFlash("success","Deleted");else{const l=await k.filesBulk("delete",r);w.event("files.bulk-delete",{ok:l.ok,failed:l.failed}),l.failed===0?e.setFlash("success",l.ok===1?"Deleted 1 item":`Deleted ${l.ok} items`):l.ok>0?e.setFlash("info",`Deleted ${l.ok}; ${l.failed} failed. ${l.errors[0]||""}`):e.setFlash("error",l.errors[0]||"Delete failed")}n.filesDeletePaths=null,n.checkedFilePaths=[],await ne(e)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Delete failed")}finally{n.busy=!1,e.render()}return!0}if(t==="files-download")return w.event("files.download",{path:a.getAttribute("href")??""}),!0;if(t==="files-preview-open"){const r=a.dataset.path??"";return r&&mr(e,r),!0}if(t==="files-preview-close")return z(e),e.render(),!0;if(t==="files-preview-download"){const r=n.filesPreview;if(!r)return!0;const l=document.createElement("a");return l.href=k.filesDownloadUrl(r.path),l.download=r.name,l.rel="noopener",document.body.appendChild(l),l.click(),l.remove(),w.event("files.download",{path:r.path,via:"preview"}),!0}return t==="close-files-upload-progress"?(n.filesUploadProgress&&(n.filesUploadProgress.phase==="done"||n.filesUploadProgress.phase==="error")&&Dn(e),!0):t==="files-upload-conflict-cancel"?(ot(e,"cancel"),!0):t==="files-upload-conflict-skip"?(ot(e,"skip"),!0):t==="files-upload-conflict-overwrite"?(ot(e,"overwrite"),!0):!1}function Pn(e){const{root:t}=e;t.querySelectorAll('input[data-action="files-select-all"][data-indeterminate="1"]').forEach(a=>{a.indeterminate=!0}),ia(e),e.state.filesItemMenu&&(t.querySelector("#files-item-menu")?(Ns(e),xs(e)):e.state.filesItemMenu=null)}function Ur(e){return e==="overview"||e==="users"||e==="settings"||e==="database"?e:null}function fe(e,t){var s;const a=(s=e.state.adminCapabilities)==null?void 0:s.pages;return a?a.find(n=>n.id===t)??null:null}function Me(e,t){switch(t){case"full":return"Full";case"read-only":return"Read-only";case"coming-soon":return"Coming soon";case"deferred":return"Unavailable";default:return t}}function Ze(e,t){return t==="full"||t==="read-only"?"badge-ok":t==="deferred"?"badge-off":"badge-soon"}function Mr(e){var i;const t=["overview","settings","users","database"],a={overview:"Overview",settings:"System settings",users:"Users",database:"Database"},s=(i=e.state.adminCapabilities)==null?void 0:i.pages,n=new Map;if(s)for(const r of s)Ur(r.id)&&n.set(r.id,r);return t.map(r=>{const l=n.get(r),o=(l==null?void 0:l.label)||a[r],c=(l==null?void 0:l.status)??(r==="overview"?"read-only":"full"),m=(l==null?void 0:l.available)===!1;return`<button type="button" role="tab" class="tab-btn${e.state.adminPage===r?" is-active":""}${m?" is-gated":""}"
          data-action="admin-page" data-admin-page="${r}"
          aria-selected="${e.state.adminPage===r}"
          title="${d(o)}${m?" — "+Me(e,c):""}">
          ${d(o)}
        </button>`}).join("")}function Ct(e,t){const a=fe(e,t),s=(a==null?void 0:a.status)??"coming-soon",n=(a==null?void 0:a.label)??t,i=(a==null?void 0:a.summary)||"This area is not available in portal Administration yet.",r=Me(e,s);return`<section class="card admin-coming-soon-card">
    <div class="admin-coming-soon-head">
      <span class="badge ${Ze(e,s)}">${d(r)}</span>
    ...
    with role <span class="badge badge-admin">Admin</span>.
    ...
    </section>`;else if(e.state.adminDashboard){const r=e.state.adminDashboard,l=r.services,o=r.links??{},c=t?`<span class="badge ${Ze(e,t.status)}">${d(Me(e,t.status))}</span>`:"",m=r.version?d(r.version):"—",f=r.git?d(r.git):"";s=`
      <section class="card admin-about-card">
        <div class="section-header">
          ${R("About this system","admin-overview")}
      ...
      ${R("System snapshot","admin-overview")}
      ${a}
    </section>`;return`${s}
    ${n}`}function Nr(e){const t=e.state.adminUsersQuery.trim().toLowerCase();return t?e.state.adminUsers.filter(a=>a.username.toLowerCase().includes(t)||(a.displayname||"").toLowerCase().includes(t)||(a.email||"").toLowerCase().includes(t)):e.state.adminUsers}function xr(e){return e.state.adminUserCreateOpen?N({id:"admin-user-create-modal",title:"Add user",titleId:"admin-user-create-title",closeAction:"admin-user-create-close",size:"sm",form:!0,formAttrs:'data-form="admin-user-create"',body:`
        ...
        <p class="muted small">Username <span class="mono">${d(t.username)}</span> cannot be changed. Leave password fields empty to keep the current password.</p>
          ...
          </label>`,footer:[{label:"Cancel",action:"admin-user-edit-close",variant:"ghost",disabled:e.state.busy},{label:"Save changes",type:"submit",variant:"primary",disabled:e.state.busy}]})}function _r(e){if(!e.state.adminUserDeleteUsername)return"";const t=e.state.adminUserDeleteUsername,a=e.state.adminUserDetail&&e.state.adminUserDetail.username.toLowerCase()===t.toLowerCase()?e.state.adminUserDetail:e.state.adminUsers.find(n=>n.username.toLowerCase()===t.toLowerCase())??null,s=a?`${a.displayname||a.username} (${a.username})`:t;return N({id:"admin-user-delete-modal",title:"Delete user",titleId:"admin-user-delete-title",closeAction:"admin-user-delete-close",size:"sm",body:`
  ...
  ${r}${l}${o}`}function qr(e){const t=fe(e,"users");if(t&&t.available===!1)return Ct(e,"users");const a=Nr(e),s=e.state.adminUsersLoading&&e.state.adminUsers.length===0?'<tr><td colspan="4" class="muted admin-table-empty">Loading users…</td></tr>':a.length===0?`<tr><td colspan="4" class="muted admin-table-empty">${e.state.adminUsersError?d(e.state.adminUsersError):e.state.adminUsersQuery.trim()?"No users match this filter.":"No users found."}</td></tr>`:a.map(n=>`<tr class="contact-table-row${e.state.adminSelectedUsername&&e.state.adminSelectedUsername.toLowerCase()===n.username.toLowerCase()?" is-selected":""}" data-action="admin-user-view" data-username="${d(n.username)}" tabindex="0" role="button">
    ...
    <section class="card">
      <div class="section-header">
        ${R("Users","admin-users")}
        <div class="section-actions">
          ${t?`<span class="badge ${Ze(e,t.status)}">${d(Me(e,t.status))}</span>`:""}
    ...
    ${xr(e)}
    ${Lr(e)}
    ${_r(e)}`}async function Br(e,t){const a=new FormData(t),s=String(a.get("username")??"").trim(),n=String(a.get("displayname")??"").trim(),i=String(a.get("email")??"").trim(),r=String(a.get("password")??""),l=String(a.get("passwordConfirm")??"");if(!s||!n||!i||!r){e.setFlash("error","Username, display name, email, and password are required"),e.render();return}if(r!==l){e.setFlash("error","Password confirmation does not match"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{const o=await k.adminCreateUser({username:s,displayname:n,email:i,password:r,passwordConfirm:l});w.event("admin.user.create",{username:o.user.username}),e.state.adminUserCreateOpen=!1,e.state.adminSelectedUsername=o.user.username,e.state.adminUserDetail=o.user,e.persistTab("admin","users",o.user.username),await he(e),e.setFlash("success",`Created user “${o.user.username}”`)}catch(o){e.setFlash("error",o instanceof Error?o.message:"Create failed")}finally{e.state.busy=!1,e.render()}}async function Hr(e,t){const a=new FormData(t),s=String(a.get("username")??"").trim(),n=String(a.get("displayname")??"").trim(),i=String(a.get("email")??"").trim(),r=String(a.get("password")??""),l=String(a.get("passwordConfirm")??"");if(!s){e.setFlash("error","Username is required"),e.render();return}if(!n||!i){e.setFlash("error","Display name and email are required"),e.render();return}if(r!==""||l!==""){if(r===""||l===""){e.setFlash("error","Password and confirmation are required to change password"),e.render();return}if(r!==l){e.setFlash("error","Password confirmation does not match"),e.render();return}}e.state.busy=!0,e.clearFlash(),e.render();try{const o={displayname:n,email:i};r!==""&&(o.password=r,o.passwordConfirm=l);const c=await k.adminUpdateUser(s,o);w.event("admin.user.update",{username:c.user.username,passwordChanged:r!==""}),e.state.adminUserEditOpen=!1,e.state.adminUserDetail=c.user,e.state.adminSelectedUsername=c.user.username,await he(e),e.setFlash("success",r!==""?`Updated “${c.user.username}” (password changed)`:`Updated “${c.user.username}”`)}catch(o){e.setFlash("error",o instanceof Error?o.message:"Update failed")}finally{e.state.busy=!1,e.render()}}async function Vr(e,t){var c,m;if(!e.state.adminSelectedUsername)return;const a=e.state.adminSelectedUsername,s=new FormData(t),n=String(s.get("displayname")??"").trim(),i=String(s.get("description")??"").trim(),r=String(s.get("calendarcolor")??"").trim(),l=((c=t.querySelector('input[name="todos"]'))==null?void 0:c.checked)??!1,o=((m=t.querySelector('input[name="notes"]'))==null?void 0:m.checked)??!1;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.adminCalModal==="create"){const f=String(s.get("uri")??"").trim().toLowerCase();await k.adminCreateUserCalendar(a,{uri:f,displayname:n,description:i,calendarcolor:r||void 0,todos:l,notes:o}),e.setFlash("success",`Created calendar “${n}”`)}else{const f=Number(s.get("instanceId"));await k.adminUpdateUserCalendar(a,f,{displayname:n,description:i,calendarcolor:r,todos:l,notes:o}),e.setFlash("success",`Updated calendar “${n}”`)}e.state.adminCalModal=null,e.state.adminCalEditId=null,await ke(e,a),await ae(e,a)}catch(f){e.setFlash("error",f instanceof Error?f.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function jr(e,t){if(!e.state.adminSelectedUsername)return;const a=e.state.adminSelectedUsername,s=new FormData(t),n=String(s.get("displayname")??"").trim(),i=String(s.get("description")??"").trim();e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.adminAbModal==="create"){const r=String(s.get("uri")??"").trim().toLowerCase();await k.adminCreateUserAddressBook(a,{uri:r,displayname:n,description:i}),e.setFlash("success",`Created address book “${n}”`)}else{const r=Number(s.get("id"));await k.adminUpdateUserAddressBook(a,r,{displayname:n,description:i}),e.setFlash("success",`Updated address book “${n}”`)}e.state.adminAbModal=null,e.state.adminAbEditId=null,await ke(e,a),await ae(e,a)}catch(r){e.setFlash("error",r instanceof Error?r.message:"Save failed")}finally{e.state.busy=!1,e.render()}}const zr=["UTC","Africa/Cairo","Africa/Johannesburg","America/Anchorage","America/Argentina/Buenos_Aires","America/Chicago","America/Denver","America/Edmonton","America/Halifax","America/Los_Angeles","America/Mexico_City","America/New_York","America/Sao_Paulo","America/Toronto","America/Vancouver","Asia/Dubai","Asia/Hong_Kong","Asia/Jerusalem","Asia/Kolkata","Asia/Seoul","Asia/Shanghai","Asia/Singapore","Asia/Tokyo","Australia/Melbourne","Australia/Sydney","Europe/Amsterdam","Europe/Berlin","Europe/London","Europe/Madrid","Europe/Moscow","Europe/Paris","Europe/Rome","Europe/Warsaw","Pacific/Auckland","Pacific/Honolulu"];let De=null;function Kr(){if(De)return De;try{const e=Intl;if(typeof e.supportedValuesOf=="function"){const t=e.supportedValuesOf("timeZone");if(Array.isArray(t)&&t.length>0)return De=[...t].sort((a,s)=>a.localeCompare(s)),De}}catch{}return De=[...zr],De}function Fn(e){const t=e||"UTC",a=Kr(),s=a.includes(t),n=a.map(i=>`<option value="${qa(i)}" ${i===t?"selected":""}>${Ba(i)}</option>`);return!s&&t&&n.unshift(`<option value="${qa(t)}" selected>${Ba(t)}</option>`),n.join("")}function qa(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function Ba(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Wr(e){const t=fe(e,"settings");if(t&&t.available===!1)return Ct(e,"settings");if(e.state.adminSystemSettingsLoading&&!e.state.adminSystemSettings)return'<section class="card"><p class="muted">Loading system settings…</p></section>';if(e.state.adminSystemSettingsError&&!e.state.adminSystemSettings)return`<section class="card">
    ...
    <section class="card">
      <div class="section-header">
        ${R("System settings","admin-settings")}
        <div class="section-actions">
          ${t?`<span class="badge ${Ze(e,t.status)}">${d(Me(e,t.status))}</span>`:""}
    ...
    ${Yr(e)}`}function Yr(e){return e.state.adminResetModalOpen?N({id:"admin-reset-modal",title:"Reset to Default",titleId:"admin-reset-title",closeAction:"admin-reset-close",size:"sm",body:`
    ...
    ${Zr(e)}`}function Zr(e){if(!e.state.adminDbConfirmOpen)return"";const t=e.state.adminDbConfirmText.trim()==="CONFIRM";return N({id:"admin-db-confirm-modal",title:"Confirm database change",titleId:"admin-db-confirm-title",closeAction:"admin-db-confirm-close",size:"sm",body:`
        ...
        <div class="dt-cal">
          <div class="dt-cal-toolbar">
            ...
            <div class="dt-cal-jump" role="group" aria-label="Month and year">
              <select class="dt-month-select" data-action="dt-set-month" data-dt-field="${d(t)}" aria-label="Month">${H}</select>
    ...
    </div>`}function ci(e=document){e.querySelectorAll(".dt-field.is-open").forEach(t=>{const a=t.querySelector(".dt-trigger"),s=t.querySelector(".dt-popover");if(!a||!s)return;const n=a.getBoundingClientRect(),i=8;s.style.position="fixed",s.style.visibility="hidden",s.style.top="0",s.style.left="0";const r=s.offsetWidth||320,l=s.offsetHeight||300;let o=n.bottom+6;o+l>window.innerHeight-i&&(o=Math.max(i,n.top-l-6));let c=n.left;c+r>window.innerWidth-i&&(c=Math.max(i,window.innerWidth-r-i)),c<i&&(c=i),s.style.top=`${Math.round(o)}px`,s.style.left=`${Math.round(c)}px`,s.style.right="auto",s.style.visibility="visible",s.style.zIndex="200"})}function ga(e,t){const a=t.summary||"(No title)";if(t.allDay||/^\d{4}-\d{2}-\d{2}$/.test(t.start))return a;const s=new Date(t.start);return Number.isNaN(s.getTime())?a:`${s.toLocaleTimeString(void 0,e.timeFormatOpts())} ${a}`}function ui(e,t,a){return new Date(t,a,1).toLocaleString(void 0,{month:"long",year:"numeric"})}function Et(e){return vt(e.state.calFocusDay)??new Date}function ya(e){const t=e.state.eventSearch.trim().toLowerCase();return t?e.state.monthEvents.filter(a=>(a.summary||"").toLowerCase().includes(t)):e.state.monthEvents}function mi(e){const t=e.localeWeekStart(),a=Et(e);if(e.state.calView==="week"){const l=ua(a,t);return{from:l.from,to:l.to}}if(e.state.calView==="agenda"){const l=Xe(a,34);return{from:A(a),to:A(l)}}const s=e.state.monthCursor.y,n=e.state.monthCursor.m,i=new Date(s,n,1),r=new Date(s,n+1,0);return{from:A(i),to:A(r)}}function fi(e){return e.allDay||/^\d{4}-\d{2}-\d{2}$/.test(e.start)?vt(e.start.slice(0,10))??new Date(NaN):new Date(e.start)}function Lt(e){return e.getHours()*60+e.getMinutes()}function On(e){return e==="month"||e==="week"||e==="agenda"?e:null}function Nn(e){return`${ys}:${e}`}function pi(e){if(!e)return null;try{const t=localStorage.getItem(Nn(e));if(t==null||t==="")return null;const a=JSON.parse(t);if(!a||typeof a!="object")return null;const s=a;let n=[];Array.isArray(s.ids)&&(n=s.ids.map(l=>Number(l)).filter(l=>Number.isFinite(l)&&l>0).map(l=>Math.floor(l)));let i=null;if(s.selectedId===null||s.selectedId===void 0)i=null;else{const l=Number(s.selectedId);i=Number.isFinite(l)&&l>0?Math.floor(l):null}const r=On(s.view)??void 0;return{ids:n,selectedId:i,view:r}}catch{return null}}function Ye(e){var a;const t=(a=e.user)==null?void 0:a.username;if(t)try{const s={ids:e.selectedIds.slice(),selectedId:e.selectedId,view:On(e.calView)??"month"};localStorage.setItem(Nn(t),JSON.stringify(s))}catch{}}async function va(e,t){const a=await k.shares(t);e.state.shares=a.shares}function bi(e){const t=e.state.calendars.filter(s=>s.canShare);if(t.length===0)return null;const a=s=>{const n=s.uri.toLowerCase(),i=s.displayname.toLowerCase();return n==="default"||i==="default"||i==="default calendar"};return t.find(a)??t[0]??null}async function Tt(e){const t=e.state.selectedIds.filter(n=>e.state.calendars.some(i=>i.id===n));if(t.length===0){e.state.monthEvents=[];return}const{from:a,to:s}=mi(e);e.state.monthEventsLoading=!0,w.debug("loadMonthEvents",{selectedIds:t,from:a,to:s});try{const i=(await Promise.all(t.map(async r=>(await k.calendarEvents(r,a,s)).events.map(o=>({...o,instanceId:r}))))).flat();i.sort((r,l)=>{const o=r.start||"",c=l.start||"";return o!==c?o<c?-1:1:(r.summary||"").localeCompare(l.summary||"")}),e.state.monthEvents=i,w.event("monthEvents.loaded",{calendarIds:t,count:e.state.monthEvents.length,from:a,to:s})}catch(n){e.state.monthEvents=[],w.warn("loadMonthEvents failed",n instanceof Error?n.message:n)}finally{e.state.monthEventsLoading=!1}}function $a(e,t){const a=e.state.calendars.find(s=>s.id===t);return a!=null&&a.color?a.color.length>=7?a.color.slice(0,7):a.color:"#3B82F6"}function gi(e,t){e.state.selectedIds.includes(t)?(e.state.selectedIds=e.state.selectedIds.filter(a=>a!==t),e.state.selectedId===t&&(e.state.selectedId=e.state.selectedIds[0]??null)):(e.state.selectedIds=[...e.state.selectedIds,t],e.state.selectedId=t),Ye(e.state)}function wa(e){const t=e.state.calendars.filter(p=>e.state.selectedIds.includes(p.id)),a=t.length===0?"No calendar selected":t.length===1?t[0].displayname:`${t.length} calendars`,s=t.slice(0,6).map(p=>{const g=p.color&&p.color.length>=7?p.color.slice(0,7):p.color||"#3B82F6";return`<span class="cal-swatch" style="background:${d(g)};margin-top:0" title="${d(p.displayname)}"></span>`}).join(""),n=t.length===0?e.state.calendars.length===0?'<p class="muted small month-empty-hint">No calendars yet — create one on the left, or wait for someone to share with you.</p>':"":e.state.monthEventsLoading?'<p class="muted small month-empty-hint">Loading events…</p>':"",i=e.state.calView,r=Et(e);let l,o,c;if(i==="week"){const p=ua(r,e.localeWeekStart());l=Ha(p.days[0],p.days[6]),o="Previous week",c="Next week"}else i==="agenda"?(l=`Agenda · ${Ha(r,new Date(r.getFullYear(),r.getMonth(),r.getDate()+34))}`,o="Previous period",c="Next period"):(l=ui(e,e.state.monthCursor.y,e.state.monthCursor.m),o="Previous month",c="Next month");const f=[{id:"month",label:"Month"},{id:"week",label:"Week"},{id:"agenda",label:"Agenda"}].map(p=>`<button type="button" class="btn btn-ghost btn-small cal-view-btn${i===p.id?" is-active":""}" data-action="cal-view" data-view="${p.id}" ${e.state.busy?"disabled":""}>${p.label}</button>`).join(""),b=`<div class="month-cal-toolbar">
    ...
    </div>`;return{calName:a,swatches:s,emptyHint:n,toolbar:b}}function yi(e){const t=wa(e),a=Et(e),s=ya(e),n=new Map;for(const o of s)for(const c of ma(o)){const m=n.get(c)??[];m.push(o),n.set(c,m)}const i=A(new Date),r=[];for(let o=0;o<35;o++){const c=Xe(a,o),m=A(c),f=n.get(m)??[];if(f.length===0)continue;const b=c.toLocaleString(void 0,{weekday:"long",month:"long",day:"numeric",year:"numeric"}),p=f.map(g=>{var y;const u=g.instanceId,v=ga(e,g),$=$a(e,u),S=((y=e.state.calendars.find(T=>T.id===u))==null?void 0:y.displayname)||"",C=S?`${v} · ${S}`:v;return`<button type="button" class="agenda-event" title="${d(C)}" style="--ev-color:${d($)}"
            data-action="open-event" data-instance="${u}" data-uri="${d(g.uri)}" ${e.state.busy?"disabled":""}>${d(v)}</button>`}).join("");r.push(`<section class="agenda-day${m===i?" is-today":""}">
  ...
  </section>`}const Pe=40;function Va(e,t,a){var f;const s=t.instanceId,n=ga(e,t),i=$a(e,s),r=((f=e.state.calendars.find(b=>b.id===s))==null?void 0:f.displayname)||"",l=r?`${n} · ${r}`:n;let o=0,c=Pe;if(!t.allDay&&!/^\d{4}-\d{2}-\d{2}$/.test(t.start)){const b=fi(t);A(b)===a&&(o=Lt(b)/60*Pe);const p=t.end&&!/^\d{4}-\d{2}-\d{2}$/.test(t.end)?new Date(t.end):null;if(p&&!Number.isNaN(p.getTime())){const g=A(b)===a?Lt(b):0,u=A(p)===a?Lt(p):1440;c=Math.max(18,(u-g)/60*Pe)}}const m=t.allDay||/^\d{4}-\d{2}-\d{2}$/.test(t.start)?`--ev-color:${d(i)}`:`--ev-color:${d(i)};top:${o}px;height:${c}px`;return`<button type="button" class="week-event${t.allDay?"":" is-timed"}" title="${d(l)}"
      style="${m}"
      data-action="open-event" data-instance="${s}" data-uri="${d(t.uri)}" ${e.state.busy?"disabled":""}>${d(n)}</button>`}function vi(e){const t=wa(e),a=Et(e),{days:s}=ua(a,e.localeWeekStart()),n=A(new Date),i=ya(e),r=new Map;for(const g of i)for(const u of ma(g)){const v=r.get(u)??[];v.push(g),r.set(u,v)}const l=e.state.userSettings.dayStartHour,o=e.state.userSettings.dayEndHour,c=Array.from({length:24},(g,u)=>{const $=new Date(2024,0,1,u).toLocaleTimeString(void 0,e.timeFormatOpts());return`<div class="week-hour-label${u>=l&&u<o?" is-workhour":""}" style="height:${Pe}px">${d($)}</div>`}).join(""),m=(()=>{const g=e.state.selectedId!==null?e.state.calendars.find(u=>u.id===e.state.selectedId)??null:null;return!!(g&&!g.readOnly&&(g.canShare||g.access==="readwrite"))})(),f=[],b=[],p=[];for(const g of s){const u=A(g),v=u===n,$=r.get(u)??[],S=$.filter(L=>L.allDay||/^\d{4}-\d{2}-\d{2}$/.test(L.start)),C=$.filter(L=>!L.allDay&&!/^\d{4}-\d{2}-\d{2}$/.test(L.start)),y=S.map(L=>Va(e,L,u)).join(""),T=C.map(L=>Va(e,L,u)).join(""),x=g.toLocaleString(void 0,{weekday:"short",month:"short",day:"numeric"});f.push(`<div class="week-day-head${v?" is-today":""}"${m?` data-action="new-event-day" data-day="${d(u)}" role="button" tabindex="0" title="Add event on ${d(u)}"`:""}>${d(x)}</div>`),b.push(`<div class="week-allday${v?" is-today":""}">${y||'<span class="week-allday-empty"></span>'}</div>`);const H=m?`<div class="week-slots">${Array.from({length:24},(L,h)=>{const P=String(h).padStart(2,"0");return`<button type="button" class="week-slot" data-action="new-event-slot" data-day="${d(u)}" data-hour="${h}" title="Add event at ${d(u)} ${P}:00" ${e.state.busy?"disabled":""}></button>`}).join("")}</div>`:"",j=o>l?'<div class="week-workday" aria-hidden="true"></div>':"";p.push(`<div class="week-timed${v?" is-today":""}${m?" is-clickable":""}" style="height:${24*Pe}px">${j}${H}${T}</div>`)}return`<section class="card month-cal-card week-cal-card">
    ${t.toolbar}
    ${t.emptyHint}
    <div class="week-wrap" style="--week-hour:${Pe}px;--day-start-h:${l};--day-end-h:${o}">
      ...
      <div class="week-grid-row week-timed-row">
        <div class="week-hours">${c}</div>
        ${p.join("")}
      </div>
    </div>
  </section>`}function $i(e){return e.state.calView==="week"?vi(e):e.state.calView==="agenda"?yi(e):hi(e)}function wi(e){return $i(e)}function hi(e){const t=e.state.monthCursor.y,a=e.state.monthCursor.m,s=new Date(t,a,1),n=e.localeWeekStart(),i=(s.getDay()-n+7)%7,r=new Date(t,a+1,0).getDate(),l=new Date(t,a,0).getDate(),c=A(new Date),m=e.localeDowLabels(),f=new Map;for(const v of ya(e))for(const $ of ma(v)){const S=f.get($)??[];S.push(v),f.set($,S)}const b=e.state.userSettings.showWeekNumbers,p=[],g=Math.ceil((i+r)/7)*7;for(let v=0;v<g;v++){let $,S=!0,C;v<i?($=l-i+v+1,S=!1,C=new Date(t,a-1,$)):v>=i+r?($=v-(i+r)+1,S=!1,C=new Date(t,a+1,$)):($=v-i+1,C=new Date(t,a,$));const y=A(C),T=y===c,x=S?f.get(y)??[]:[],H=e.state.monthExpandDay===y?50:3,j=x.slice(0,H),L=x.length-j.length,h=j.map(O=>{var Ta;const q=O.instanceId,K=ga(e,O),At=$a(e,q),Ea=((Ta=e.state.calendars.find(Yn=>Yn.id===q))==null?void 0:Ta.displayname)||"",Wn=Ea?`${K} · ${Ea}`:K;return`<button type="button" class="month-event${O.allDay?"":" is-timed"}" title="${d(Wn)}" style="--ev-color:${d(At)}"
          data-action="open-event" data-instance="${q}" data-uri="${d(O.uri)}" ${e.state.busy?"disabled":""}>${d(K)}</button>`}).join(""),P=L>0?`<button type="button" class="month-event-more" data-action="open-event-day" data-day="${d(y)}" title="Show all events this day" ${e.state.busy?"disabled":""}>+${L} more</button>`:"",F=!S&&($===1||v===i+r)?C.toLocaleString(void 0,{month:"short",day:"numeric"}):String($),U=e.state.selectedId!==null?e.state.calendars.find(O=>O.id===e.state.selectedId)??null:null,V=!!(U&&!U.readOnly&&(U.canShare||U.access==="readwrite"));if(b&&v%7===0){const O=si(C,n);p.push(`<div class="month-weeknum" title="ISO week ${O}"><span>${O}</span></div>`)}p.push(`<div class="month-cell${S?"":" is-outside"}${T?" is-today":""}${V?" is-clickable":""}"${V?` data-action="new-event-day" data-day="${d(y)}" role="button" tabindex="0" title="Add event on ${d(y)}"`:""}>
      <div class="month-daynum${T?" is-today-num":""}">${d(F)}</div>
      <div class="month-events">${h}${P}</div>
    </div>`)}const u=wa(e);return`<section class="card month-cal-card">
    ${u.toolbar}
    ${u.emptyHint}
    <div class="month-grid-wrap${b?" has-weeknums":""}" role="grid" aria-label="Month calendar">
      <div class="month-dow-row${b?" has-weeknums":""}" role="row">
        ...
        ${m.map(v=>`<div class="month-dow">${d(v)}</div>`).join("")}
      </div>
      <div class="month-grid${b?" has-weeknums":""}" role="rowgroup">
        ${p.join("")}
      </div>
    </div>
  </section>`}function ha(){return{freq:"",interval:1,until:null,count:null,byDay:[],endMode:"never"}}function ki(e){return e.endMode==="until"||e.endMode==="count"||e.endMode==="never"?e.endMode:e.until?"until":e.count?"count":"never"}function Qe(e){const t=String(e.get("repeatFreq")??"").trim().toUpperCase();if(!t)return{freq:"",interval:1,until:null,count:null,byDay:[],endMode:"never"};const a=Math.max(1,Math.min(99,Number(e.get("repeatInterval")??1)||1)),s=String(e.get("repeatEndMode")??"never"),n=s==="until"||s==="count"?s:"never";let i=null,r=null;if(n==="until"){const o=String(e.get("repeatUntil")??"").trim();i=o?o.slice(0,10):null}else if(n==="count"){const o=Number(e.get("repeatCount")??0);r=Number.isFinite(o)&&o>0?Math.min(999,Math.round(o)):10}const l=e.getAll("repeatByDay").map(o=>String(o).toUpperCase()).filter(Boolean);return{freq:t,interval:a,until:i,count:r,byDay:l,endMode:n}}function Si(e){if(!e.state.eventModalOpen||!e.state.editingEvent)return"";const t=e.state.editingEvent,a=t.repeat??ha(),s=(a.freq||"").toUpperCase(),n=e.state.calendars.filter(g=>g.canShare||g.access==="readwrite"),i=e.state.calendars.filter(g=>g.id===t.instanceId?!0:g.readOnly?!1:g.canShare||g.access==="readwrite").map(g=>`<option value="${g.id}" ${g.id===t.instanceId?"selected":""}>${d(g.displayname)}</option>`).join(""),r=t.readOnly||!t.canWrite;let l,o;if(t.allDay)l=Te(t.start),o=Te(t.end);else{const g=t.start||"",u=t.end||"";if(/^\d{4}-\d{2}-\d{2}$/.test(g)){const v=ba(g,u||null);l=v.start,o=v.end||""}else l=Ie(t.start),o=Ie(t.end)}const c=[{code:"MO",label:"Mon"},{code:"TU",label:"Tue"},{code:"WE",label:"Wed"},{code:"TH",label:"Thu"},{code:"FR",label:"Fri"},{code:"SA",label:"Sat"},{code:"SU",label:"Sun"}],m=new Set((a.byDay||[]).map(g=>g.toUpperCase())),f=ki(a),b=!!s&&f==="until",p=a.until||(f==="until"?Te(t.start)||A(new Date):"");return`<div class="cal-modal" id="event-edit-modal" role="dialog" aria-modal="true" aria-labelledby="event-modal-title">
    ...
    <div class="cal-modal-card">
        ...
        <form class="stack" data-form="edit-event">
          ...
          <fieldset class="event-repeat" ${r?"disabled":""}>
            ...
            ${s?`<div class="form-grid form-grid-2" style="margin-top:0.5rem">
                    ...
                    ${f==="until"?e.renderPortalDateTimeField({field:"until",name:"repeatUntil",label:"Until",value:p,dateOnly:!0,disabled:r,allowClear:!0}):f==="count"?`<label>Occurrences
      ...
      <p class="muted small" style="margin:0">
        ...
        · Took ${d(Z(t.elapsedSec))}
      </p>`:r=`
      ${se("error",`Failed. ${t.resultMessage||"Import failed."}`,{className:"import-result",style:"margin:0 0 1rem"})}
      <p class="muted small" style="margin:0">
        File: <span class="mono">${d(t.fileName)}</span>
        · After ${d(Z(t.elapsedSec))}
      </p>
      <p class="muted small">Large imports can time out; try again — already-imported items update faster.</p>`;const l=a?'<p class="muted small" style="margin:0">Please wait…</p>':Zt([{label:"Close",action:"close-import-progress",variant:"primary"}]);return N({title:n,titleId:"import-progress-title",closeAction:"close-import-progress",size:"sm",className:"import-progress-modal",cardClassName:"import-progress-card",rootAttrs:"data-import-progress",hideClose:a,lockBackdrop:a,body:r,footer:l})}function qn(e,t,a){return new Promise((s,n)=>{const i=new FileReader;i.onprogress=r=>{r.lengthComputable&&r.total>0?a(Math.min(100,Math.round(r.loaded/r.total*100))):a(null)},i.onload=()=>s(String(i.result??"")),i.onerror=()=>n(i.error??new Error("Failed to read file")),i.readAsText(t)})}async function Fi(e,t){var s;if(e.state.selectedId===null)return;const a=(s=t.files)==null?void 0:s[0];t.value="",a&&(e.state.calModalOpen=!0,await Bn(e,e.state.selectedId,a,{keepEditModalOpen:!0}))}async function Ai(e,t){var m;const a=(m=t.files)==null?void 0:m[0];if(t.value="",!a)return;const s=e.root.querySelector('[data-form="create-cal"]'),n=s?new FormData(s):new FormData,i=n.get("holidays")==="on",r=n.get("readOnly")==="on";if(i){e.setFlash("error","Turn off “Holidays calendar” to import a .ics file into a new calendar."),e.state.createCalModalOpen=!0,e.render();return}if(r){e.setFlash("error","Turn off “Read-only” before importing — import cannot write to a read-only calendar."),e.state.createCalModalOpen=!0,e.render();return}let l=String(n.get("displayname")??"").trim();l||(l=a.name.replace(/\.ics$/i,"").trim()||"Imported calendar");const o=String(n.get("description")??""),c=String(n.get("color")??"").trim();e.state.busy=!0,e.clearFlash(),e.state.createCalModalOpen=!0,e.render();try{const f=await k.createCalendar({displayname:l,description:o,color:c,readOnly:!1});e.state.selectedId=f.calendar.id,e.state.createCalModalOpen=!1,await e.loadHome(),e.setFlash("success",`Created “${f.calendar.displayname}” — importing…`),await Bn(e,f.calendar.id,a,{keepEditModalOpen:!1,successPrefix:`Calendar “${f.calendar.displayname}” created. `})}catch(f){const b=f instanceof Error?f.message:"Create or import failed";e.state.createCalModalOpen=!0,e.setFlash("error",b),e.state.busy=!1,e.render()}}async function Bn(e,t,a,s={}){e.state.busy=!0,e.clearFlash(),ue(e),e.state.importProgress={kind:"calendar",fileName:a.name,fileSizeLabel:pt(a.size),phase:"reading",readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},Ln(e),e.render();try{const n=await qn(e,a,l=>{if(!e.state.importProgress||e.state.importProgress.phase!=="reading")return;e.state.importProgress={...e.state.importProgress,readPercent:l};const o=e.root.querySelector(".import-progress-bar"),c=e.root.querySelector("[data-import-status-line]");o&&l!==null&&(o.classList.remove("is-indeterminate"),o.style.width=`${l}%`),c&&l!==null&&(c.textContent=`Reading file… ${l}%`)});ze(e,"uploading",{readPercent:100}),ze(e,"processing",{processPercent:0}),w.event("import.calendar.start",{file:a.name,bytes:a.size,calId:t});const i=await k.importCalendar(t,n,l=>{_n(e,l)}),r=e.formatImportResult(i);e.state.selectedId===t&&await Tt(e),ue(e),ze(e,"done",{ok:!0,resultMessage:`${r} (from “${a.name}”)`}),e.setFlash("success",`${s.successPrefix||""}Import finished for “${a.name}”: ${r}.`)}catch(n){const i=n instanceof Error?n.message:"Import failed";ue(e),ze(e,"error",{ok:!1,resultMessage:i}),e.setFlash("error",i)}finally{s.keepEditModalOpen&&(e.state.calModalOpen=!0),e.state.busy=!1,e.render()}}async function Ii(e,t){if(e.state.selectedId===null)return;const a=new FormData(t),s=String(a.get("username")??"").trim(),n=String(a.get("access")??"read");if(!s){e.setFlash("error","Select a user to share with"),e.render();return}e.state.calModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.render();try{await k.share(e.state.selectedId,s,n),await va(e,e.state.selectedId),e.setFlash("success",`Shared with ${s}`)}catch(i){e.setFlash("error",i instanceof Error?i.message:"Share failed")}finally{e.state.busy=!1,e.render()}}async function Ui(e,t){if(!e.state.editingEvent||!e.state.editingEvent.canWrite)return;const a=new FormData(t),s=String(a.get("summary")??"").trim(),n=String(a.get("description")??"").trim(),i=String(a.get("location")??"").trim(),r=a.get("allDay")==="on",l=String(a.get("start")??"").trim(),o=String(a.get("end")??"").trim(),c=Number(a.get("instanceId"))||e.state.editingEvent.instanceId,m=Qe(a);if(!s){e.setFlash("error","Title is required"),e.render();return}if(!l){e.setFlash("error","Start is required"),e.render();return}let f,b;if(r)f=l.slice(0,10),b=o?o.slice(0,10):f;else if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const v=ba(l,o||null);f=new Date(v.start).toISOString(),b=v.end?new Date(v.end).toISOString():null}else f=new Date(l).toISOString(),b=o?new Date(o).toISOString():null;const p=e.state.editingEvent.instanceId,g=e.state.editingEvent.uri,u=e.state.creatingEvent;e.state.busy=!0,e.clearFlash(),e.state.eventModalOpen=!0,e.render(),w.event(u?"event.create":"event.update",{instanceId:c,uri:u?null:g,allDay:r,summary:s});try{const v={summary:s,description:n,location:i,allDay:r,start:f,end:b,instanceId:c,repeat:m},$=u?await k.createEvent(c,v):await k.updateEvent(p,g,v);(e.state.selectedId===null||$.event.instanceId!==e.state.selectedId)&&(e.state.selectedId=$.event.instanceId),await Tt(e),e.state.eventModalOpen=!1,e.state.editingEvent=null,e.state.creatingEvent=!1,e.state.eventDtPicker=null,w.event(u?"event.created":"event.saved",{uri:$.event.uri,instanceId:$.event.instanceId}),e.setFlash("success",me("Event",$.event.summary||s,u?"created":"saved"))}catch(v){w.warn("event.save failed",v instanceof Error?v.message:v),e.setFlash("error",v instanceof Error?v.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function Mi(e,t){if(e.state.selectedId===null)return;const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??""),i=String(a.get("color")??"").trim();e.state.busy=!0,e.clearFlash(),e.render();try{const r=await k.updateCalendar(e.state.selectedId,{displayname:s,description:n,color:i});e.state.calModalOpen=!0,await e.loadHome(),e.state.selectedId=r.calendar.id,await va(e,e.state.selectedId),await Tt(e),e.setFlash("success","Calendar updated")}catch(r){e.setFlash("error",r instanceof Error?r.message:"Update failed")}finally{e.state.busy=!1,e.render()}}async function Oi(e,t){const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??""),i=String(a.get("color")??"").trim(),r=a.get("holidays")==="on",l=String(a.get("holidayCountry")??"").trim(),o=a.get("readOnly")==="on";if(e.state.createCalModalOpen=!0,r&&!l){e.setFlash("error","Select a country for the holidays calendar"),e.render();return}if(!r&&!s){e.setFlash("error","Display name is required"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{const c=await k.createCalendar({displayname:s,description:n,color:i,holidays:r,holidayCountry:r?l:void 0,readOnly:o});e.state.selectedId=c.calendar.id,e.state.selectedIds.includes(c.calendar.id)||(e.state.selectedIds=[...e.state.selectedIds,c.calendar.id]),e.state.createCalModalOpen=!1,await e.loadHome();let m=`Created “${c.calendar.displayname}”`;const f=c.holidayImport??c.calendar.holidayImport;f&&(m+=`. Holidays imported: ${e.formatImportResult(f)}.`),o&&(m+=" Calendar is read-only."),e.setFlash("success",m)}catch(c){e.state.createCalModalOpen=!0,e.setFlash("error",c instanceof Error?c.message:"Create failed")}finally{e.state.busy=!1,e.render()}}function Hn(e){const t=e.root.querySelector('[data-form="create-cal"]');if(!t)return;const a=t.querySelector('input[name="holidays"]'),s=t.querySelector("#holidays-country-wrap"),n=t.querySelector('input[name="displayname"]'),i=t.querySelector('input[name="readOnly"]');if(!a||!s)return;const r=a.checked;s.hidden=!r,n&&(n.required=!r,r&&!n.value.trim()?n.placeholder="Auto: Holidays (XX)":r||(n.placeholder="Work")),r&&i&&(i.checked=!0)}function Ni(e){Hn(e)}function ja(e){const{state:t}=e,a=t.calendars.filter(u=>u.canShare),s=t.calendars.filter(u=>!u.canShare),n=t.calendars.find(u=>u.id===t.selectedId)??null,i=a.map(u=>{const v=t.selectedIds.includes(u.id),$=v?" is-selected":"",S=u.id===t.selectedId?" is-primary":"",C=u.color?`<span class="cal-swatch" style="background:${d(u.color)}"></span>`:'<span class="cal-swatch cal-swatch-empty"></span>',y=e.accessBadge(u.access)+(u.readOnly?'<span class="badge">read-only</span>':"")+(u.holidaysCountry?`<span class="badge badge-admin">holidays ${d(u.holidaysCountry)}</span>`:"");return`<div class="cal-row${$}${S}" data-action="select-cal" data-id="${u.id}" role="button" tabindex="0" title="Toggle on the month grid">
        ...
        <span class="cal-row-actions">
          <button type="button" class="btn btn-small" data-action="export-cal" data-id="${u.id}" ${t.busy?"disabled":""} title="Export as .ics">Export</button>
            ...
            </tr>`).join(""),c=n!=null&&n.color&&n.color.length>=7?n.color.slice(0,7):"#3B82F6",m=!!(n&&n.readOnly),f=t.calModalOpen&&n&&n.canShare?N({id:"cal-edit-modal",title:"Calendar details",titleId:"cal-modal-title",closeAction:"close-cal-modal",body:`
              ${e.renderFlashBanner()}
              <section>
              ...
              </section>`,footer:[{label:"Close",action:"close-cal-modal",variant:"ghost"}]}):"",b=t.deleteConfirmId!==null?t.calendars.find(u=>u.id===t.deleteConfirmId&&u.canShare)??null:null,p=b?N({id:"cal-delete-modal",title:"Delete calendar",titleId:"cal-delete-title",closeAction:"cancel-delete-cal",size:"sm",body:`
            ${e.renderFlashBanner()}
        ...
        <section class="card calendars-sidebar-card">
          ...
          <div class="cal-list calendars-owned-list">
            ...
            ${s.length?`<div class="calendars-shared-block">
                     ${R("Shared with me","shared-with-me")}
...
`).trim()}function Se(e){if(!e)return"";if(!Ri(e))return e;if(typeof DOMParser>"u")return e.replace(/<script[\s\S]*?<\/script>/gi,"").replace(/on\w+\s*=/gi,"");const a=new DOMParser().parseFromString(`<div id="n">${e}</div>`,"text/html").getElementById("n");if(!a)return"";const s=n=>{var r;const i=[...n.childNodes];for(const l of i)if(l.nodeType===1){const o=l,c=o.tagName;if(!_i.has(c)){const m=o.parentNode;if(m){for(;o.firstChild;)m.insertBefore(o.firstChild,o);m.removeChild(o)}continue}for(const m of[...o.attributes]){const f=m.name.toLowerCase();if(f.startsWith("on")||f==="style")o.removeAttribute(m.name);else if(c==="A"&&f==="href"){const b=m.value.trim();/^(https?:|mailto:|#)/i.test(b)||o.removeAttribute("href")}else c==="A"&&(f==="href"||f==="target"||f==="rel")||o.removeAttribute(m.name)}c==="A"&&(o.setAttribute("rel","noopener noreferrer"),o.setAttribute("target","_blank")),s(o)}else l.nodeType!==3&&((r=l.parentNode)==null||r.removeChild(l))};return s(a),a.innerHTML}function Bi(e,t){const a=Se(e);return`<div class="note-editor">
      ...
      <textarea name="description" hidden>${d(e)}</textarea>
              ...
              <td class="col-note-date muted small">${d(hn(i.dtstart))}</td>
          ...
          ${R(e.state.creatingNote?"New note":"Edit note","notes")}
          <form class="stack" data-form="note" style="margin-top:1rem">
            ...
            ${e.renderPortalDateTimeField({field:"dtstart",name:"dtstart",label:"Date",value:Ie(a.dtstart),dateOnly:!1,disabled:!!(a.readOnly&&!e.state.creatingNote),allowClear:!0})}
            <label>Body
              ${Bi(a.description,!!(a.readOnly&&!e.state.creatingNote))}
            </label>
            <div class="form-actions-row">
      ...
      ${n}
  ...
  </div>`}function zi(e,t){if(!e.state.editingNote)return;const a=t.querySelector("[data-note-editor]"),s=t.querySelector('textarea[name="description"]');a&&s&&(s.value=Se(a.innerHTML));const n=new FormData(t),i=String(n.get("dtstart")??"").trim(),r=n.get("instanceId"),l=r!==null&&String(r)!==""?Number(r):e.state.editingNote.instanceId;e.state.editingNote={...e.state.editingNote,instanceId:Number.isFinite(l)&&l>0?l:e.state.editingNote.instanceId,summary:String(n.get("summary")??e.state.editingNote.summary),description:Se(String(n.get("description")??e.state.editingNote.description)),dtstart:i?new Date(i).toISOString():null}}async function Ki(e,t){const a=t.querySelector("[data-note-editor]"),s=t.querySelector('textarea[name="description"]');a&&s&&(s.value=Se(a.innerHTML));const n=new FormData(t),i=String(n.get("summary")??"").trim(),r=Se(String(n.get("description")??"").trim()),l=String(n.get("dtstart")??"").trim(),o=l?new Date(l).toISOString():null;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.creatingNote){const c=Number(n.get("instanceId"));if(!Number.isFinite(c)||c<=0)throw new Error("Select a calendar");const m=await k.createNote({instanceId:c,summary:i,description:r,dtstart:o});e.state.creatingNote=!1,e.state.selectedNoteKey=B(m.note.instanceId,m.note.uri),e.state.editingNote=m.note,e.setFlash("success",me("Note",m.note.summary||i,"created"))}else if(e.state.editingNote){const c=await k.updateNote(e.state.editingNote.instanceId,e.state.editingNote.uri,{summary:i,description:r,dtstart:o});e.state.editingNote=c.note,e.state.selectedNoteKey=B(c.note.instanceId,c.note.uri),e.setFlash("success",me("Note",c.note.summary||i,"saved"))}await Pt(e)}catch(c){e.setFlash("error",c instanceof Error?c.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function Wi(e,t,a,s){var o;const{state:n,render:i,setFlash:r,clearFlash:l}=e;if(t==="note-fmt")return s.preventDefault(),Vi(a.dataset.cmd||"",a.dataset.value),!0;if(t==="sort-note"){const c=a.dataset.sort||"";if(!c)return!0;n.noteSort===c?n.noteOrder=n.noteOrder==="asc"?"desc":"asc":(n.noteSort=c,n.noteOrder="asc"),n.busy=!0,i();try{await e.loadNotes()}catch(m){r("error",m instanceof Error?m.message:"Sort failed")}finally{n.busy=!1,i()}return!0}if(t==="select-note"){const c=Number(a.dataset.instance),m=a.dataset.uri??"";if(!Number.isFinite(c)||!m)return!0;const f=n.notes.find(b=>b.instanceId===c&&b.uri===m)??null;return n.creatingNote=!1,n.selectedNoteKey=e.itemKey(c,m),n.editingNote=f?{...f}:null,l(),i(),!0}if(t==="new-note")return n.creatingNote=!0,n.selectedNoteKey=null,n.editingNote={uri:"",instanceId:((o=n.noteCalendars[0])==null?void 0:o.id)??0,calendarId:0,calendarName:"",calendarUri:"",summary:"",description:"",dtstart:new Date().toISOString(),lastmodified:0,readOnly:!1,canWrite:!0},l(),i(),!0;if(t==="cancel-note")return n.creatingNote=!1,n.editingNote=null,n.selectedNoteKey=null,i(),!0;if(t==="delete-note"){if(!n.editingNote||n.creatingNote)return!0;const c=String(n.editingNote.summary||"this note").trim()||"this note";return n.confirmDelete={scope:"note",title:"Delete note",message:`Delete “${c}”?`,detail:"CalDAV clients will sync the removal. This cannot be undone."},i(),!0}return!1}async function Ue(e){const t=await k.tasks({q:e.state.taskSearch,sort:e.state.taskSort,order:e.state.taskOrder});e.state.tasks=t.tasks,e.state.taskCalendars=t.calendars;const a=new Set(e.state.tasks.map(s=>B(s.instanceId,s.uri)));e.state.checkedTaskKeys=e.state.checkedTaskKeys.filter(s=>a.has(s)),e.state.selectedTaskKey!==null&&!e.state.tasks.some(s=>`${s.instanceId}|${s.uri}`===e.state.selectedTaskKey)&&(e.state.selectedTaskKey=null,e.state.creatingTask||(e.state.editingTask=null))}function Yi(e,t){const a=new Map;for(const m of t)m.uid&&a.set(m.uid,m);const s=new Map(t.map((m,f)=>[B(m.instanceId,m.uri),f])),n=new Map,i=[];for(const m of t){const f=m.parentUid;if(f&&a.has(f)&&f!==m.uid){const b=n.get(f)??[];b.push(m),n.set(f,b)}else i.push(m)}const r=(m,f)=>(s.get(B(m.instanceId,m.uri))??0)-(s.get(B(f.instanceId,f.uri))??0);i.sort(r);for(const[,m]of n)m.sort(r);const l=[],o=new Set,c=(m,f)=>{const b=m.uid||B(m.instanceId,m.uri);if(!o.has(b)){o.add(b),l.push({task:m,depth:Math.min(f,8)});for(const p of n.get(m.uid)??[])c(p,f+1);o.delete(b)}};for(const m of i)c(m,0);for(const m of t)l.some(f=>f.task===m)||l.push({task:m,depth:0});return l}function Ji(e,t){const a=new Set([t]);if(!t)return a;let s=!0;for(;s;){s=!1;for(const n of e.state.tasks)n.parentUid&&a.has(n.parentUid)&&n.uid&&!a.has(n.uid)&&(a.add(n.uid),s=!0)}return a}function Gi(e,t,a){const s=t.instanceId,n=a||!t.uid?new Set:Ji(e,t.uid),i=e.state.tasks.filter(o=>o.uid&&o.instanceId===s&&!n.has(o.uid)&&o.uid!==t.uid),r=t.parentUid||"",l=['<option value="">None (top-level)</option>',...i.map(o=>`<option value="${d(o.uid)}" ${o.uid===r?"selected":""}>${d(o.summary||o.uid)}</option>`)];if(r&&!i.some(o=>o.uid===r)){const o=e.state.tasks.find(c=>c.uid===r);l.push(`<option value="${d(r)}" selected>${d((o==null?void 0:o.summary)||r)} (current)</option>`)}return l.join("")}function Vn(e){const t=new Set(e.state.checkedTaskKeys);return e.state.tasks.filter(a=>t.has(B(a.instanceId,a.uri))&&a.canWrite&&!a.readOnly)}function Xi(e){const t=u=>({"NEEDS-ACTION":"To do","IN-PROCESS":"In progress",COMPLETED:"Done",CANCELLED:"Cancelled"})[u]||u,a=Yi(e,e.state.tasks),s=e.state.tasks.filter(u=>u.canWrite&&!u.readOnly).map(u=>B(u.instanceId,u.uri)),n=s.length>0&&s.every(u=>e.state.checkedTaskKeys.includes(u)),i=e.state.checkedTaskKeys.length>0,l=Vn(e).length,o=e.state.tasks.length===0?`<tr class="contacts-empty-row"><td colspan="6" class="muted">${e.state.taskSearch?"No tasks match your search.":"No tasks yet. Add one below."}</td></tr>`:a.map(({task:u,depth:v})=>{const $=B(u.instanceId,u.uri),S=!e.state.creatingTask&&$===e.state.selectedTaskKey?" is-selected":"",C=e.state.checkedTaskKeys.includes($),y=u.status==="COMPLETED"?"badge-ok":u.status==="CANCELLED"?"":"badge-admin",T=v>0?` style="--task-depth:${v}"`:"",x=v>0?'<span class="task-subtask-marker" aria-hidden="true">↳</span>':"",H=u.canWrite&&!u.readOnly;return`<tr class="contact-table-row task-row${v>0?" is-subtask":""}${S}${C?" is-checked":""}" data-action="select-task" data-instance="${u.instanceId}" data-uri="${d(u.uri)}" tabindex="0" role="button"${T}>
              <td class="col-task-check" data-stop-row>
                <input type="checkbox" class="task-check" data-action="task-check" data-instance="${u.instanceId}" data-uri="${d(u.uri)}"
                  ${C?"checked":""} ${H?"":"disabled"} aria-label="Select ${d(u.summary||u.uri)}" ${e.state.busy?"disabled":""} />
              </td>
              <td class="col-task-title"><span class="task-title-inner">${x}<span class="contact-name-primary">${d(u.summary||u.uri)}</span></span>
                ${u.readOnly?'<span class="badge">read-only</span>':""}</td>
              <td class="col-task-status"><span class="badge ${y}">${d(t(u.status))}</span></td>
              <td class="col-task-due muted small">${d(hn(u.due))}</td>
    ...
    <path d="M3.5 8.5 6.5 11.5 12.5 4.5" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>`,m=(u,v)=>`<button type="button" class="btn btn-small bulk-apply-btn" data-action="${u}"
      title="${d(v)}" aria-label="${d(v)}" ${e.state.busy||l===0?"disabled":""}>${c}</button>`,f=i?`<div class="bulk-bar" style="margin-top:0.75rem">
          ...
          ${R(e.state.creatingTask?b.parentUid?"New subtask":"New task":"Edit task","tasks")}
          <form class="stack" data-form="task" style="margin-top:1rem">
            ...
            <div class="form-grid form-grid-2">
              ...
              ${e.renderPortalDateTimeField({field:"due",name:"due",label:"Due",value:Ie(b.due),dateOnly:!1,disabled:!!(b.readOnly&&!e.state.creatingTask),allowClear:!0})}
            </div>
            <div class="form-grid form-grid-2">
              <label>Priority (0–9)
    ...
    <section class="stack items-edit-panel">
      ${g}
  ...
  </div>`}function Qi(e,t){if(!e.state.editingTask)return;const a=new FormData(t),s=String(a.get("due")??"").trim(),n=a.get("instanceId"),i=n!==null&&String(n)!==""?Number(n):e.state.editingTask.instanceId,r=String(a.get("parentUid")??"").trim();e.state.editingTask={...e.state.editingTask,instanceId:Number.isFinite(i)&&i>0?i:e.state.editingTask.instanceId,summary:String(a.get("summary")??e.state.editingTask.summary),description:String(a.get("description")??e.state.editingTask.description),status:String(a.get("status")??e.state.editingTask.status),due:s?new Date(s).toISOString():null,priority:Number(a.get("priority")??e.state.editingTask.priority??0),percent:Number(a.get("percent")??e.state.editingTask.percent??0),parentUid:r===""?null:r}}async function Zi(e,t){var i,r;const a=Vn(e);if(a.length===0){e.setFlash("error","No writable tasks selected"),e.render();return}const s=a.map(l=>({instanceId:l.instanceId,uri:l.uri}));if(t==="bulk-task-delete"){e.state.busy=!0,e.clearFlash(),e.render();try{const l=await k.bulkTasks({op:"delete",items:s});e.state.checkedTaskKeys=[],e.state.selectedTaskKey&&a.some(o=>B(o.instanceId,o.uri)===e.state.selectedTaskKey)&&(e.state.selectedTaskKey=null,e.state.editingTask=null,e.state.creatingTask=!1),await Ue(e),l.failed>0?e.setFlash("error",`Deleted ${l.ok}, failed ${l.failed}${l.errors[0]?`: ${l.errors[0]}`:""}`):e.setFlash("success",`Deleted ${l.ok} task${l.ok===1?"":"s"}`)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Bulk delete failed")}finally{e.state.busy=!1,e.render()}return}let n={};if(t==="bulk-task-status"){const l=e.root.querySelector("#bulk-task-status"),o=((i=l==null?void 0:l.value)==null?void 0:i.trim())??"";if(!o){e.setFlash("error","Choose a status to apply"),e.render();return}n={status:o}}else if(t==="bulk-task-due"){const l=e.state.bulkDueValue.trim();if(!l){e.setFlash("error","Choose a due date to apply"),e.render();return}const o=/^\d{4}-\d{2}-\d{2}$/.test(l)?new Date(l+"T00:00:00"):new Date((l.length===16,l));if(Number.isNaN(o.getTime())){e.setFlash("error","Invalid due date"),e.render();return}n={due:o.toISOString()}}else if(t==="bulk-task-clear-due")n={due:null};else if(t==="bulk-task-percent"){const l=e.root.querySelector("#bulk-task-percent"),o=((r=l==null?void 0:l.value)==null?void 0:r.trim())??"";if(o===""){e.setFlash("error","Enter a percent complete (0–100)"),e.render();return}const c=Number(o);if(!Number.isFinite(c)||c<0||c>100){e.setFlash("error","Percent must be between 0 and 100"),e.render();return}n={percent:Math.round(c)}}e.state.busy=!0,e.clearFlash(),e.render();try{const l=await k.bulkTasks({op:"update",items:s,fields:n});if(await Ue(e),e.state.editingTask&&!e.state.creatingTask){const c=B(e.state.editingTask.instanceId,e.state.editingTask.uri),m=e.state.tasks.find(f=>B(f.instanceId,f.uri)===c);m&&(e.state.editingTask={...m})}const o=t==="bulk-task-status"?"status":t==="bulk-task-due"||t==="bulk-task-clear-due"?"due date":"percent";l.failed>0?e.setFlash("error",`Updated ${o} on ${l.ok}, failed ${l.failed}${l.errors[0]?`: ${l.errors[0]}`:""}`):e.setFlash("success",`Updated ${o} on ${l.ok} task${l.ok===1?"":"s"}`)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Bulk update failed")}finally{e.state.busy=!1,e.render()}}async function el(e,t){const a=new FormData(t),s=String(a.get("summary")??"").trim(),n=String(a.get("description")??"").trim(),i=String(a.get("status")??"NEEDS-ACTION"),r=String(a.get("due")??"").trim(),l=r?new Date(r).toISOString():null,o=Number(a.get("priority")??0),c=Number(a.get("percent")??0),m=String(a.get("parentUid")??"").trim(),f=m===""?null:m;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.creatingTask){const b=Number(a.get("instanceId"));if(!Number.isFinite(b)||b<=0)throw new Error("Select a calendar");const p=await k.createTask({instanceId:b,summary:s,description:n,status:i,due:l,priority:o,percent:c,parentUid:f});e.state.creatingTask=!1,e.state.selectedTaskKey=B(p.task.instanceId,p.task.uri),e.state.editingTask=p.task,e.setFlash("success",me(f?"Subtask":"Task",p.task.summary||s,"created"))}else if(e.state.editingTask){const b=await k.updateTask(e.state.editingTask.instanceId,e.state.editingTask.uri,{summary:s,description:n,status:i,due:l,priority:o,percent:c,parentUid:f});e.state.editingTask=b.task,e.state.selectedTaskKey=B(b.task.instanceId,b.task.uri),e.setFlash("success",me("Task",b.task.summary||s,"saved"))}await Ue(e)}catch(b){e.setFlash("error",b instanceof Error?b.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function tl(e,t,a,s){var o;const{state:n,render:i,setFlash:r,clearFlash:l}=e;if(t==="sort-task"){const c=a.dataset.sort||"";if(!c)return!0;n.taskSort===c?n.taskOrder=n.taskOrder==="asc"?"desc":"asc":(n.taskSort=c,n.taskOrder=c==="due"||c==="summary"?"asc":"desc"),n.busy=!0,i();try{await e.loadTasks()}catch(m){r("error",m instanceof Error?m.message:"Sort failed")}finally{n.busy=!1,i()}return!0}if(t==="select-task"){if(s.target.closest("[data-stop-row], .task-check"))return!0;const c=Number(a.dataset.instance),m=a.dataset.uri??"";if(!Number.isFinite(c)||!m)return!0;const f=n.tasks.find(b=>b.instanceId===c&&b.uri===m)??null;return n.creatingTask=!1,n.selectedTaskKey=e.itemKey(c,m),n.editingTask=f?{...f}:null,l(),i(),!0}if(t==="task-check"){s.preventDefault(),s.stopPropagation();const c=Number(a.dataset.instance),m=a.dataset.uri??"";if(!Number.isFinite(c)||!m)return!0;const f=e.itemKey(c,m),b=n.tasks.find(p=>e.itemKey(p.instanceId,p.uri)===f);return!b||!b.canWrite||b.readOnly||(n.checkedTaskKeys.includes(f)?n.checkedTaskKeys=n.checkedTaskKeys.filter(p=>p!==f):n.checkedTaskKeys=[...n.checkedTaskKeys,f],i()),!0}if(t==="task-select-all"){s.preventDefault();const c=n.tasks.filter(f=>f.canWrite&&!f.readOnly);return c.length>0&&c.every(f=>n.checkedTaskKeys.includes(e.itemKey(f.instanceId,f.uri)))?n.checkedTaskKeys=[]:n.checkedTaskKeys=c.map(f=>e.itemKey(f.instanceId,f.uri)),i(),!0}if(t==="bulk-task-clear")return n.checkedTaskKeys=[],i(),!0;if(t==="bulk-task-status"||t==="bulk-task-due"||t==="bulk-task-clear-due"||t==="bulk-task-percent"||t==="bulk-task-delete"){if(t==="bulk-task-delete"){const c=n.checkedTaskKeys.length;return c===0?(r("error","No tasks selected"),i(),!0):(n.confirmDelete={scope:"bulk-task",title:c===1?"Delete task":`Delete ${c} tasks`,message:c===1?"Delete the selected task?":`Delete ${c} selected tasks?`,detail:"CalDAV clients will sync the removal. This cannot be undone.",count:c},i(),!0)}return e.runBulkTaskAction(t),!0}if(t==="new-task")return n.creatingTask=!0,n.selectedTaskKey=null,n.editingTask={uri:"",instanceId:((o=n.taskCalendars[0])==null?void 0:o.id)??0,calendarId:0,calendarName:"",calendarUri:"",uid:"",parentUid:null,summary:"",description:"",status:"NEEDS-ACTION",due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},l(),i(),!0;if(t==="new-subtask"){if(!n.editingTask||n.creatingTask||!n.editingTask.uid||!n.editingTask.canWrite)return!0;const c=n.editingTask;return n.creatingTask=!0,n.selectedTaskKey=null,n.editingTask={uri:"",instanceId:c.instanceId,calendarId:c.calendarId,calendarName:c.calendarName,calendarUri:c.calendarUri,uid:"",parentUid:c.uid,summary:"",description:"",status:"NEEDS-ACTION",due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},l(),i(),!0}if(t==="cancel-task")return n.creatingTask=!1,n.editingTask=null,n.selectedTaskKey=null,i(),!0;if(t==="delete-task"){if(!n.editingTask||n.creatingTask)return!0;const c=String(n.editingTask.summary||"this task").trim()||"this task";return n.confirmDelete={scope:"task",title:"Delete task",message:`Delete “${c}”?`,detail:"CalDAV clients will sync the removal. This cannot be undone."},i(),!0}return!1}async function ka(e,t){const a=await k.contacts(t,e.state.contactSearch);e.state.contacts=a.contacts,e.state.selectedContactUri!==null&&!e.state.contacts.some(s=>s.uri===e.state.selectedContactUri)&&(e.state.selectedContactUri=null,e.state.creatingContact||(e.state.editingContact=null,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1))}async function al(e,t){if(e.state.selectedAbId===null)return;const a=await k.getContact(e.state.selectedAbId,t);e.state.selectedContactUri=t,e.state.creatingContact=!1;const s=a.contact;e.state.editingContact={...s,emails:Array.isArray(s.emails)?s.emails:[],phones:Array.isArray(s.phones)?s.phones:[],custom:Array.isArray(s.custom)?s.custom:[],address:s.address??jn(),birthday:s.birthday??null},e.state.photoPreview=s.photoDataUri??(s.hasPhoto&&e.state.selectedAbId!==null?`${k.contactPhotoUrl(e.state.selectedAbId,t)}?t=${Date.now()}`:null),e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.contactModalOpen=!0}function nl(e){e.state.creatingContact=!0,e.state.selectedContactUri=null,e.state.contactModalOpen=!0,e.state.editingContact={uri:"",displayname:"",firstname:"",lastname:"",fullname:"",org:"",title:"",emails:[""],phones:[{type:"cell",value:""}],address:{street:"",city:"",region:"",postal:"",country:""},birthday:null,url:"",note:"",custom:[],hasPhoto:!1,photoDataUri:null},e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1}function jn(e){return{street:"",city:"",region:"",postal:"",country:""}}function sl(e,t){return new Promise((a,s)=>{const n=new FileReader;n.onload=()=>{const i=String(n.result??""),r=i.indexOf(",");a(r>=0?i.slice(r+1):i)},n.onerror=()=>s(new Error("Failed to read photo file")),n.readAsDataURL(t)})}async function rl(e,t){var s;const a=(s=t.files)==null?void 0:s[0];if(t.value="",!!a){if(a.size>2.5*1024*1024){e.setFlash("error","Photo is too large (max ~2 MB)"),e.render();return}try{const n=await sl(e,a);e.state.photoBase64Pending=n,e.state.photoPreview=`data:${a.type||"image/jpeg"};base64,${n}`,e.state.removePhotoPending=!1,e.render()}catch(n){e.setFlash("error",n instanceof Error?n.message:"Failed to read photo"),e.render()}}}async function il(e,t){var n;if(e.state.selectedAbId===null)return;const a=(n=t.files)==null?void 0:n[0];if(t.value="",!a)return;const s=e.state.selectedAbId;e.state.abModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.stopImportElapsedTimer(),e.state.importProgress={kind:"contacts",fileName:a.name,fileSizeLabel:pt(a.size),phase:"reading",readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},e.startImportElapsedTimer(),e.render();try{const i=await e.readFileTextWithProgress(a,o=>{if(!e.state.importProgress||e.state.importProgress.phase!=="reading")return;e.state.importProgress={...e.state.importProgress,readPercent:o};const c=e.root.querySelector(".import-progress-bar"),m=e.root.querySelector("[data-import-status-line]");c&&o!==null&&(c.classList.remove("is-indeterminate"),c.style.width=`${o}%`),m&&o!==null&&(m.textContent=`Reading file… ${o}%`)});e.setImportPhase("uploading",{readPercent:100}),e.setImportPhase("processing",{processPercent:0}),w.event("import.contacts.start",{file:a.name,bytes:a.size,abId:s});const r=await k.importAddressBook(s,i,o=>{e.applyServerImportProgress(o)}),l=e.formatImportResult(r);await e.loadHome(),e.state.selectedAbId===s&&await ka(e,s),e.stopImportElapsedTimer(),e.setImportPhase("done",{ok:!0,resultMessage:`${l} (from “${a.name}”)`}),e.setFlash("success",`Import finished for “${a.name}”: ${l}.`)}catch(i){const r=i instanceof Error?i.message:"Import failed";e.stopImportElapsedTimer(),e.setImportPhase("error",{ok:!1,resultMessage:r}),e.setFlash("error",r)}finally{e.state.busy=!1,e.render()}}async function ll(e,t){if(e.state.selectedAbId===null)return;const a=xi(e,t),s=Nt(a);e.state.busy=!0,e.clearFlash(),e.state.contactModalOpen=!0,e.render();try{if(e.state.creatingContact){const n=await k.createContact(e.state.selectedAbId,a);e.state.creatingContact=!1,e.state.selectedContactUri=n.contact.uri,e.state.editingContact=null,e.state.contactModalOpen=!1,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.eventDtPicker=null,e.setFlash("success",me("Contact",Nt(n.contact)||s,"created"))}else if(e.state.selectedContactUri){const n=await k.updateContact(e.state.selectedAbId,e.state.selectedContactUri,a);e.state.selectedContactUri=n.contact.uri,e.state.editingContact=null,e.state.contactModalOpen=!1,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.eventDtPicker=null,e.setFlash("success",me("Contact",Nt(n.contact)||s,"saved"))}try{await e.loadHome()}catch(n){if(console.error(n),e.state.selectedAbId!==null)try{await ka(e,e.state.selectedAbId)}catch{}}}catch(n){e.setFlash("error",n instanceof Error?n.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function ol(e,t){const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??"").trim();if(s){e.state.busy=!0,e.clearFlash(),e.render();try{const i=await k.createAddressBook({displayname:s,description:n});e.state.selectedAbId=i.addressbook.id,e.state.selectedContactUri=null,e.state.editingContact=null,e.state.creatingContact=!1,e.state.contactSearch="",await e.loadHome(),e.setFlash("success",`Address book “${i.addressbook.displayname}” created`)}catch(i){e.setFlash("error",i instanceof Error?i.message:"Create failed")}finally{e.state.busy=!1,e.render()}}}async function dl(e,t){if(e.state.selectedAbId===null)return;const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??"").trim();e.state.abModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.render();try{await k.updateAddressBook(e.state.selectedAbId,{displayname:s,description:n}),await e.loadHome(),e.setFlash("success",me("Address book",s,"updated"))}catch(i){e.setFlash("error",i instanceof Error?i.message:"Update failed")}finally{e.state.busy=!1,e.render()}}function cl(e){const{state:t}=e,a=t.addressBooks.map($=>`<div class="cal-row${$.id===t.selectedAbId?" is-selected":""}" data-action="select-ab" data-id="${$.id}" role="button" tabindex="0">
        ...
        <button type="button" class="btn btn-ghost btn-small" data-action="remove-phone" data-idx="${S}" ${l.length<=1?"disabled":""} title="Remove">×</button>
      </div>`).join(""),f=Array.isArray(i==null?void 0:i.custom)?i.custom:[],b=f.length===0?'<p class="muted small" style="margin:0 0 0.5rem">No custom fields yet. Labels and values can use any language (e.g. Супруг, 日本語).</p>':f.map(($,S)=>`<div class="multi-row multi-row-custom" data-multi="custom" data-idx="${S}">
          ...
          <div class="cal-modal-card cal-modal-card-wide">
            ...
            <div class="cal-modal-body">
        ...
        </div>`:"",g=t.abModalOpen&&s?N({id:"ab-edit-modal",title:"Address book details",titleId:"ab-modal-title",closeAction:"close-ab-modal",body:`
              ${e.renderFlashBanner()}
              <section>
                <p class="muted small mono" style="margin:0">
                ...
                <div class="import-export" style="margin-top:1.35rem">
                  ${R("Import / export","contact-import-export")}
              ...
              </section>`,footer:[{label:"Close",action:"close-ab-modal",variant:"ghost"}]}):"",u=t.deleteAbConfirmId!==null?t.addressBooks.find($=>$.id===t.deleteAbConfirmId)??null:null,v=u?N({id:"ab-delete-modal",title:"Delete address book",titleId:"ab-delete-title",closeAction:"cancel-delete-ab",size:"sm",body:`
            ${e.renderFlashBanner()}
    ...
    ${v}
    ${g}
    ${p}`}async function ul(e,t,a,s){var c,m;const{state:n,root:i,render:r,setFlash:l,clearFlash:o}=e;if(t==="select-ab"){const f=Number(a.dataset.id);if(!Number.isFinite(f))return!0;n.selectedAbId=f,n.abModalOpen=!1,n.selectedContactUri=null,n.editingContact=null,n.creatingContact=!1,n.contactModalOpen=!1,n.contactSearch="",n.contacts=[],n.photoPreview=null,n.photoBase64Pending=null,n.removePhotoPending=!1,o(),n.busy=!0,r();try{await e.loadContacts(f)}catch(b){l("error",b instanceof Error?b.message:"Failed to load contacts")}finally{n.busy=!1,r()}return!0}if(t==="edit-ab"){s.stopPropagation();const f=Number(a.dataset.id);if(!Number.isFinite(f)||!n.addressBooks.find(g=>g.id===f))return!0;const p=n.selectedAbId!==f;n.selectedAbId=f,n.abModalOpen=!0,n.contactModalOpen=!1,o(),p&&(n.selectedContactUri=null,n.editingContact=null,n.creatingContact=!1,n.contactSearch="",n.contacts=[],n.photoPreview=null,n.photoBase64Pending=null,n.removePhotoPending=!1),n.busy=!0,r();try{p&&await e.loadContacts(f)}catch(g){l("error",g instanceof Error?g.message:"Failed to open address book")}finally{n.busy=!1,r()}return!0}if(t==="close-ab-modal")return n.abModalOpen=!1,r(),!0;if(t==="select-contact"){const f=a.dataset.uri??"";if(!f)return!0;o();try{await e.openContact(f)}catch(b){l("error",b instanceof Error?b.message:"Failed to load contact")}return r(),!0}if(t==="new-contact")return n.selectedAbId===null||(e.startNewContact(),o(),r()),!0;if(t==="cancel-contact"||t==="close-contact-modal")return n.creatingContact=!1,n.contactModalOpen=!1,n.editingContact=null,n.selectedContactUri=null,n.photoPreview=null,n.photoBase64Pending=null,n.removePhotoPending=!1,n.eventDtPicker=null,o(),r(),!0;if(t==="add-email"||t==="add-phone"||t==="add-custom")return n.editingContact&&(Ke(e.contactsHost),Array.isArray(n.editingContact.emails)||(n.editingContact.emails=[""]),Array.isArray(n.editingContact.phones)||(n.editingContact.phones=[{type:"cell",value:""}]),Array.isArray(n.editingContact.custom)||(n.editingContact.custom=[]),t==="add-email"?n.editingContact.emails.length<10&&n.editingContact.emails.push(""):t==="add-phone"?n.editingContact.phones.length<10&&n.editingContact.phones.push({type:"other",value:""}):n.editingContact.custom.length<30&&n.editingContact.custom.push({label:"",value:""}),r()),!0;if(t==="remove-email"){if(!n.editingContact)return!0;Ke(e.contactsHost);const f=Number(a.dataset.idx);if(!Number.isFinite(f))return!0;const b=Array.isArray(n.editingContact.emails)?n.editingContact.emails:[""];return n.editingContact.emails=b.filter((p,g)=>g!==f),n.editingContact.emails.length===0&&(n.editingContact.emails=[""]),r(),!0}if(t==="remove-phone"){if(!n.editingContact)return!0;Ke(e.contactsHost);const f=Number(a.dataset.idx);if(!Number.isFinite(f))return!0;const b=Array.isArray(n.editingContact.phones)?n.editingContact.phones:[{type:"cell",value:""}];return n.editingContact.phones=b.filter((p,g)=>g!==f),n.editingContact.phones.length===0&&(n.editingContact.phones=[{type:"cell",value:""}]),r(),!0}if(t==="remove-custom"){if(!n.editingContact)return!0;Ke(e.contactsHost);const f=Number(a.dataset.idx);return Number.isFinite(f)&&(n.editingContact.custom=(Array.isArray(n.editingContact.custom)?n.editingContact.custom:[]).filter((b,p)=>p!==f),r()),!0}if(t==="remove-photo")return n.photoPreview=null,n.photoBase64Pending=null,n.removePhotoPending=!0,n.editingContact&&(n.editingContact.hasPhoto=!1),r(),!0;if(t==="delete-contact"){if(n.selectedAbId===null||!n.selectedContactUri)return!0;const f=String(((c=n.editingContact)==null?void 0:c.fullname)||((m=n.editingContact)==null?void 0:m.displayname)||"this contact").trim()||"this contact";return n.confirmDelete={scope:"contact",title:"Delete contact",message:`Delete “${f}”?`,detail:"CardDAV clients will sync the removal. This cannot be undone."},r(),!0}if(t==="delete-ab"){s.stopPropagation();const f=Number(a.dataset.id??n.selectedAbId);return!Number.isFinite(f)||!n.addressBooks.find(p=>p.id===f)||(n.deleteAbConfirmId=f,n.abModalOpen=!1,n.contactModalOpen=!1,o(),r()),!0}if(t==="cancel-delete-ab")return n.deleteAbConfirmId=null,r(),!0;if(t==="confirm-delete-ab"){const f=Number(a.dataset.id),b=i.querySelector("#delete-ab-confirm");if(!Number.isFinite(f)||!(b!=null&&b.checked))return!0;const p=n.addressBooks.find(u=>u.id===f);if(!p)return!0;const g=(p.cardCount??0)>0;n.busy=!0,o(),r();try{await k.deleteAddressBook(f,g),n.selectedAbId===f&&(n.selectedAbId=null,n.contacts=[],n.editingContact=null,n.selectedContactUri=null,n.creatingContact=!1),n.deleteAbConfirmId=null,n.abModalOpen=!1,n.contactModalOpen=!1,await e.loadHome(),n.selectedAbId===null&&n.addressBooks.length>0&&(n.selectedAbId=n.addressBooks[0].id,await e.loadContacts(n.selectedAbId)),l("success","Address book deleted")}catch(u){l("error",u instanceof Error?u.message:"Delete failed")}finally{n.busy=!1,r()}return!0}if(t==="export-ab"){s.stopPropagation();const f=a.dataset.id,b=f!==void 0&&f!==""?Number(f):n.selectedAbId;if(b===null||Number.isNaN(b))return!0;n.busy=!0,o(),r();try{const{blob:p,filename:g}=await k.exportAddressBook(b),u=await e.saveBlobAsFile(p,g);u==="cancelled"?l("info","Export cancelled"):u==="saved"?l("success",`Saved ${g}`):l("success",`Download started: ${g}`)}catch(p){l("error",p instanceof Error?p.message:"Export failed")}finally{n.busy=!1,r()}return!0}if(t==="export-contact"){if(n.selectedAbId===null||!n.selectedContactUri||n.creatingContact)return!0;n.contactModalOpen=!0,n.busy=!0,o(),r();try{const{blob:f,filename:b}=await k.exportContact(n.selectedAbId,n.selectedContactUri),p=await e.saveBlobAsFile(f,b);p==="cancelled"?l("info","Export cancelled"):p==="saved"?l("success",`Saved ${b}`):l("success",`Download started: ${b}`)}catch(f){l("error",f instanceof Error?f.message:"Export failed")}finally{n.busy=!1,r()}return!0}return!1}function Sa(e){return e==="calendars"||e==="contacts"||e==="tasks"||e==="notes"||e==="files"||e==="admin"?e:null}function zn(e){return e==="overview"||e==="users"||e==="settings"||e==="database"?e:null}function Da(){const e=(typeof location<"u"?location.hash:"").replace(/^#/,"").split(/[?&]/)[0].replace(/^\/+/,"");if(!e)return{tab:null,adminPage:null,adminUsername:null};if(e==="admin"||e.startsWith("admin/")){const t=e.split("/").filter(Boolean),a=t[1]??"overview",s=zn(a)??"overview";let n=null;if(s==="users"&&t[2])try{n=decodeURIComponent(t[2])}catch{n=t[2]}return{tab:"admin",adminPage:s,adminUsername:n}}return{tab:Sa(e),adminPage:null,adminUsername:null}}function ml(){const e=Da().tab;if(e)return e;try{const t=Sa(sessionStorage.getItem(un));if(t)return t}catch{}return"calendars"}function fl(){const e=Da().adminPage;if(e)return e;try{const t=zn(sessionStorage.getItem(mn));if(t)return t}catch{}return"overview"}function pl(e,t=null){return e==="overview"?"#admin":e==="users"&&t?`#admin/users/${encodeURIComponent(t)}`:`#admin/${e}`}function _t(e,t="overview",a=null){try{sessionStorage.setItem(un,e),e==="admin"&&sessionStorage.setItem(mn,t)}catch{}if(typeof history>"u"||typeof location>"u")return;const s=e==="admin"?pl(t,a):`#${e}`;location.hash!==s&&history.replaceState(null,"",`${location.pathname}${location.search}${s}`)}function za(e){return e==="readwrite"?'<span class="badge badge-admin">full access</span>':e==="read"?'<span class="badge">read-only</span>':e==="owner"?'<span class="badge badge-ok">owner</span>':`<span class="badge">${d(e)}</span>`}function Rt(e){const t=[`${e.imported} new`,`${e.updated} updated`];return e.skipped>0&&t.push(`${e.skipped} skipped`),t.join(", ")}function bl(e){const t=e.confirmDelete;if(!t)return"";const a=t.detail?`<p class="muted small" style="margin:0.75rem 0 0">${d(t.detail)}</p>`:"";return N({id:"portal-confirm-delete-modal",title:t.title,titleId:"portal-confirm-delete-title",closeAction:"confirm-delete-cancel",size:"sm",body:`<p style="margin:0">${d(t.message)}</p>${a}`,footer:[{label:"Cancel",action:"confirm-delete-cancel",variant:"ghost",disabled:e.busy},{label:"Delete",action:"confirm-delete-ok",variant:"danger",disabled:e.busy}]})}function Ka(e){e.confirmDelete=null}const Wa="portal-page",Ya="portal-overlays";function gl(e){let t=e.querySelector(`#${Wa}`),a=e.querySelector(`#${Ya}`);return(!t||!a)&&(e.replaceChildren(),t=document.createElement("div"),t.id=Wa,a=document.createElement("div"),a.id=Ya,e.append(t,a)),{page:t,overlays:a}}function yl(e){const t=e.filesPreview,a=t?[t.path,t.status,t.kind,t.objectUrl??"",t.truncated?"1":"0",String((t.text??"").length),t.error??""].join("|"):"",s=e.filesUploadProgress,n=s?[s.phase,s.completedFiles,s.failedFiles,s.bytesSent,s.currentName].join("|"):"",i=e.importProgress,r=i?[i.phase,i.readPercent??"",i.processPercent??"",i.processCurrent,i.ok??""].join("|"):"",l=e.confirmDelete?e.confirmDelete.scope:"";return`p:${a};u:${n};i:${r};c:${l}`}function vl(e){return`${kr()}
      ${bl(e.state)}
      ${Pi(e.calendarsHost)}
      ${gr(e.filesHost)}
      ${fr(e.filesHost)}`}function $l(e,t,a){e.dataset.overlayKey===a&&e.childElementCount>0||(e.dataset.overlayKey=a,e.innerHTML=t)}function Le(e,t,a){if(!te(e,t))return"";const s=e.activeTab===t;return`<button type="button" role="tab" class="tab-btn${s?" is-active":""}"
            data-action="tab" data-tab="${t}" aria-selected="${s}">
            ${a}
          </button>`}function wl(e){const{state:t,root:a}=e;if(!t.user){e.renderLogin();return}let s;switch(t.activeTab){case"calendars":s=te(t,"calendars")?ja(e):_e("Calendar","CalDAV");break;case"contacts":s=te(t,"contacts")?cl(e):_e("Contacts","CardDAV");break;case"tasks":s=te(t,"tasks")?Xi(e.tasksHost):_e("Tasks","Tasks (VTODO)");break;case"notes":s=te(t,"notes")?ji(e.notesHost):_e("Notes","Notes (VJOURNAL)");break;case"files":s=te(t,"files")?Pr(e.filesHost):_e("Files","WebDAV file storage");break;case"admin":s=ei(e.adminHost);break;default:s=ja(e)}const n=t.activeTab==="calendars"?"my-calendars":t.activeTab==="contacts"?"my-contacts":t.activeTab==="tasks"?"tasks":t.activeTab==="notes"?"notes":t.activeTab==="files"?"files":"administration",i=t.activeTab==="admin"?`<div class="tabs" role="tablist" aria-label="Administration sections">
  ...
  </div>`}function hl(e){const{state:t,render:a}=e;e.unbindUserMenuOutside(),t.userMenuOpen&&e.bindUserMenuOutside(),ft(t),t.eventDtPicker&&Ms(t,a),e.unbindFilesUploadMenuOutside(),t.filesUploadMenuOpen&&e.bindFilesUploadMenuOutside(),Pn(e.filesHost),Hi(e.notesHost),e.bindHolidaysToggle(),Dl(e),Sl(e.root),kl(e)}function kl(e){const{state:t,root:a}=e,s=t.filesSearchFocus&&t.activeTab==="files"?'input[data-action="files-search"]':t.eventSearchFocus&&t.activeTab==="calendars"?'input[data-action="event-search"]':null;if(!s)return;const n=a.querySelector(s);if(!n)return;n.focus({preventScroll:!0});const i=n.value.length;try{n.setSelectionRange(i,i)}catch{}t.filesSearchFocus=!1,t.eventSearchFocus=!1}function Sl(e){const t=e.querySelector(".cal-modal[data-focus-trap]");if(!t)return;const a=document.activeElement;if(a&&t.contains(a))return;const s=e.querySelector("#portal-page");if(a&&(s!=null&&s.contains(a)))return;const n=t.querySelector("button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex='-1'])");n==null||n.focus()}function Dl(e){var i;const{state:t,root:a}=e;if(!t.listKeyboardFocus||t.activeTab!=="contacts"&&t.activeTab!=="tasks"&&t.activeTab!=="notes")return;const s=document.activeElement;if(s&&a.contains(s)&&s.matches("input:not([type=checkbox]), textarea, select, [contenteditable='true']")&&!s.closest("tr.contact-table-row[data-action]")||(i=s==null?void 0:s.closest)!=null&&i.call(s,"tr.contact-table-row[data-action]"))return;let n=null;if(t.activeTab==="contacts"&&t.selectedContactUri)n=a.querySelector(`tr[data-action="select-contact"][data-uri="${CSS.escape(t.selectedContactUri)}"]`);else if(t.activeTab==="tasks"&&t.selectedTaskKey){const r=t.selectedTaskKey.indexOf("|");if(r>0){const l=t.selectedTaskKey.slice(0,r),o=t.selectedTaskKey.slice(r+1);n=a.querySelector(`tr[data-action="select-task"][data-instance="${CSS.escape(l)}"][data-uri="${CSS.escape(o)}"]`)}}else if(t.activeTab==="notes"&&t.selectedNoteKey){const r=t.selectedNoteKey.indexOf("|");if(r>0){const l=t.selectedNoteKey.slice(0,r),o=t.selectedNoteKey.slice(r+1);n=a.querySelector(`tr[data-action="select-note"][data-instance="${CSS.escape(l)}"][data-uri="${CSS.escape(o)}"]`)}}if(!n){const r=t.activeTab==="contacts"?"select-contact":t.activeTab==="tasks"?"select-task":"select-note";n=a.querySelector(`tr.contact-table-row[data-action="${r}"]`)}n&&n.focus({preventScroll:!0})}async function Cl(e,t,a,s){const{state:n,render:i,clearFlash:r,setFlash:l}=e;if(t==="confirm-delete-cancel")return Ka(n),i(),!0;if(t==="confirm-delete-ok"){const o=n.confirmDelete;if(!o)return i(),!0;const c=o.scope;if(Ka(n),c==="event"){if(!n.editingEvent||!n.editingEvent.canWrite||n.creatingEvent)return i(),!0;const m=n.editingEvent.instanceId,f=n.editingEvent.uri;n.busy=!0,r(),i();try{await k.deleteEvent(m,f),n.eventModalOpen=!1,n.editingEvent=null,await e.loadMonthEvents(),l("success","Event deleted")}catch(b){l("error",b instanceof Error?b.message:"Delete failed")}finally{n.busy=!1,i()}return!0}if(c==="task"){if(!n.editingTask||n.creatingTask)return i(),!0;n.busy=!0,r(),i();try{await k.deleteTask(n.editingTask.instanceId,n.editingTask.uri),n.selectedTaskKey=null,n.editingTask=null,await e.loadTasks(),l("success","Task deleted")}catch(m){l("error",m instanceof Error?m.message:"Delete failed")}finally{n.busy=!1,i()}return!0}if(c==="note"){if(!n.editingNote||n.creatingNote)return i(),!0;n.busy=!0,r(),i();try{await k.deleteNote(n.editingNote.instanceId,n.editingNote.uri),n.selectedNoteKey=null,n.editingNote=null,await e.loadNotes(),l("success","Note deleted")}catch(m){l("error",m instanceof Error?m.message:"Delete failed")}finally{n.busy=!1,i()}return!0}if(c==="contact"){if(n.selectedAbId===null||!n.selectedContactUri)return i(),!0;n.busy=!0,r(),n.contactModalOpen=!0,i();try{await k.deleteContact(n.selectedAbId,n.selectedContactUri),n.selectedContactUri=null,n.editingContact=null,n.creatingContact=!1,n.contactModalOpen=!1,n.eventDtPicker=null,n.photoPreview=null,await e.loadHome(),l("success","Contact deleted")}catch(m){l("error",m instanceof Error?m.message:"Delete failed")}finally{n.busy=!1,i()}return!0}if(c==="bulk-task")return await e.runBulkTaskAction("bulk-task-delete"),!0;if(c==="revoke-share"){const m=o.href??"";if(!m||n.selectedId===null)return i(),!0;n.calModalOpen=!0,n.busy=!0,r(),i();try{await k.revoke(n.selectedId,m),await e.loadShares(n.selectedId),l("success","Share revoked")}catch(f){l("error",f instanceof Error?f.message:"Revoke failed")}finally{n.busy=!1,i()}return!0}return i(),!0}if(t==="close-import-progress")return n.importProgress&&(n.importProgress.phase==="done"||n.importProgress.phase==="error")&&e.closeImportProgress(),!0;if(t==="logout"){n.busy=!0,w.event("logout");try{await k.logout()}catch{}return e.clearPortalSessionState(),r(),i(),!0}if(t==="info"){const o=a.dataset.info??"";return e.openInfoModal(o),!0}if(t==="info-close")return e.closeInfoModal(),!0;if(t==="about-open")return s.preventDefault(),As(e.root),!0;if(t==="about-close")return s.preventDefault(),bn(e.root),!0;if(t==="flash-close")return r(),i(),!0;if(t==="user-settings-open")return n.userMenuOpen=!1,n.userSettingsOpen=!0,i(),!0;if(t==="user-settings-close")return ln(n),i(),!0;if(t==="set-theme"){const o=$e(a.dataset.theme);if(o){if(ht(o),n.userSettingsOpen)return!0;i()}return!0}if(t==="user-menu-toggle")return s.stopPropagation(),n.userMenuOpen=!n.userMenuOpen,i(),!0;if(t==="user-menu-close")return n.userMenuOpen&&(n.userMenuOpen=!1,i()),!0;if(t==="tab"){const o=Sa(a.dataset.tab);return o&&(o==="admin"&&(n.adminPage="overview"),await e.activateTab(o)),!0}return!1}async function Xt(e,t){const a=t.target.closest("[data-action]");if(!a)return;const s=a.dataset.action;s&&(w.debug(`action:${s}`,{id:a.dataset.id,tab:a.dataset.tab,uri:a.dataset.uri}),!await Cl(e,s,a,t)&&(s.startsWith("admin-")&&await ai(e.adminHost,s,a)||(s.startsWith("files-")||s==="sort-file"||s==="close-files-upload-progress")&&await Ir(e.filesHost,s,a,t)||await Li(e,s,a,t)||await tl(e,s,a,t)||await Wi(e,s,a,t)||await ul(e,s,a,t)))}const Ja=new WeakMap;function El(e){if(Ja.has(e.root)){w.debug("portalEvents: already bound for root");return}Ja.set(e.root,!0),e.state.portalEventsBound=!0,e.state.escapeBound=!0;const{root:t}=e;t.addEventListener("click",a=>Tl(e,a)),t.addEventListener("contextmenu",a=>Pl(e,a)),t.addEventListener("submit",a=>Fl(e,a)),t.addEventListener("change",a=>Al(e,a)),t.addEventListener("input",a=>Il(e,a)),t.addEventListener("keydown",a=>Ml(e,a)),document.addEventListener("keydown",a=>_l(e,a)),t.addEventListener("dragenter",a=>at(e,"enter",a)),t.addEventListener("dragover",a=>at(e,"over",a)),t.addEventListener("dragleave",a=>at(e,"leave",a)),t.addEventListener("drop",a=>at(e,"drop",a)),t.addEventListener("error",a=>Nl(e,a),!0),w.event("portalEvents.registered")}function Tl(e,t){var n,i;const a=(i=(n=t.target)==null?void 0:n.closest)==null?void 0:i.call(n,"[data-action]");if(!a||!e.root.contains(a))return;const s=a.dataset.action??"";(s==="info"||s==="info-close"||s==="about-open"||s==="about-close"||s==="user-settings-open"||s==="user-settings-close")&&(t.preventDefault(),t.stopPropagation()),(s==="dt-set-month"||s==="dt-set-year")&&t.stopPropagation(),(s==="select-contact"||s==="select-task"||s==="select-note")&&(e.state.listKeyboardFocus=!0),w.debug("portalEvents.click",{action:s}),Xt(e,t)}function Pl(e,t){const a=t.target;if(!a||!e.root.contains(a))return;if(a.closest("#files-item-menu")){t.preventDefault();return}const s=a.closest("tr.files-row");if(!s||!e.root.contains(s))return;const n=s.dataset.path??"";!n||sa(e.state)||(t.preventDefault(),ra(e.filesHost,n,{x:t.clientX,y:t.clientY,origin:"context"}))}function Fl(e,t){var n,i,r;const a=(i=(n=t.target)==null?void 0:n.closest)==null?void 0:i.call(n,"form[data-form]");if(!a||!e.root.contains(a))return;const s=a.dataset.form??"";if(s)switch(t.preventDefault(),w.debug("portalEvents.submit",{form:s}),s){case"login":e.onLogin(a);return;case"share":e.onShare(a);return;case"edit-event":e.onSaveEvent(a);return;case"edit-cal":e.onEditCal(a);return;case"create-cal":e.onCreateCal(a);return;case"contact":e.onSaveContact(a);return;case"create-ab":e.onCreateAb(a);return;case"edit-ab":e.onEditAb(a);return;case"task":e.onSaveTask(a);return;case"note":e.onSaveNote(a);return;case"files-rename":Fr(e.filesHost,a);return;case"files-transfer":qs(e.filesHost,a);return;case"files-mkdir":Ar(e.filesHost,a);return;case"admin-user-create":Br(e.adminHost,a);return;case"admin-user-edit":Hr(e.adminHost,a);return;case"admin-cal":Vr(e.adminHost,a);return;case"admin-ab":jr(e.adminHost,a);return;case"admin-settings":Jr(e.adminHost,a);return;case"admin-database":Gr(e.adminHost,a);return;case"user-settings":{const l=ns(a);if("error"in l){e.setFlash("error",l.error),e.render();return}ts(l,((r=e.state.user)==null?void 0:r.username)??null),e.state.userSettings=l,e.state.userSettingsOpen=!1,ht(l.theme),e.clearFlash(),e.render();return}default:w.debug("portalEvents.submit.unknown",{form:s})}}function Al(e,t){const a=t.target;if(!a||!e.root.contains(a))return;const{state:s,root:n,render:i}=e,r=a.closest("[data-action]"),l=(r==null?void 0:r.dataset.action)??"";if(l==="dt-set-month"||l==="dt-set-year"){t.stopPropagation(),w.debug("portalEvents.change",{action:l}),Xt(e,t);return}if(l==="admin-db-backend"&&a instanceof HTMLSelectElement){s.adminDbFormBackend=a.value==="pgsql"?"pgsql":"sqlite",i();return}if(l==="files-upload-pick-files"&&a instanceof HTMLInputElement){Ra(e.filesHost,a,!1);return}if(l==="files-upload-pick-folder"&&a instanceof HTMLInputElement){Ra(e.filesHost,a,!0);return}if(l==="files-type-filter"){w.debug("portalEvents.change",{action:l}),Xt(e,t);return}if(l==="import-cal"&&a instanceof HTMLInputElement){Fi(e.calendarsHost,a);return}if(l==="import-create-cal"&&a instanceof HTMLInputElement){Ai(e.calendarsHost,a);return}if(l==="import-ab"&&a instanceof HTMLInputElement){e.calendarsHost.onImportContacts(a);return}if(l==="contact-photo"&&a instanceof HTMLInputElement){rl(e.contactsHost,a);return}if(a instanceof HTMLInputElement&&a.id==="delete-cal-confirm"){const o=n.querySelector("#delete-cal-submit");o&&(o.disabled=!a.checked||s.busy);return}if(a instanceof HTMLInputElement&&a.id==="delete-ab-confirm"){const o=n.querySelector("#delete-ab-submit");o&&(o.disabled=!a.checked||s.busy);return}if(a instanceof HTMLSelectElement&&(a.name==="repeatFreq"||a.name==="repeatEndMode")){const o=a.closest('[data-form="edit-event"]');if(o&&s.editingEvent){const c=new FormData(o);s.editingEvent={...s.editingEvent,repeat:Qe(c),hasRrule:!!String(c.get("repeatFreq")??"").trim()},i()}return}if(a instanceof HTMLSelectElement&&a.name==="instanceId"){const o=a.closest('[data-form="task"]');if(o&&s.creatingTask&&s.editingTask){const m=Number(a.value);if(!Number.isFinite(m)||m<=0)return;e.syncEditingTaskFromForm(o);const f=s.editingTask.parentUid;s.editingTask={...s.editingTask,instanceId:m,parentUid:f&&s.tasks.some(b=>b.uid===f&&b.instanceId===m)?f:null},i();return}const c=a.closest('[data-form="note"]');if(c&&s.creatingNote&&s.editingNote){const m=Number(a.value);if(!Number.isFinite(m)||m<=0)return;e.syncEditingNoteFromForm(c),s.editingNote={...s.editingNote,instanceId:m},i();return}}if(a instanceof HTMLInputElement&&a.name==="holidays"&&a.closest('[data-form="create-cal"]')){Hn(e.calendarsHost);return}if(a instanceof HTMLInputElement&&a.name==="color"){const o=a.closest("form"),c=o==null?void 0:o.querySelector('input[name="color_picker"]');if(c){let m=a.value.trim();m&&!m.startsWith("#")&&(m=`#${m}`),/^#[0-9A-Fa-f]{6}/.test(m)&&(c.value=m.slice(0,7),a.value=m.toUpperCase())}return}}function Il(e,t){var o;const a=t.target;if(!a||!e.root.contains(a))return;const{state:s,root:n,render:i,setFlash:r}=e;if(a instanceof HTMLInputElement&&a.name==="color_picker"){const c=a.closest("form"),m=c==null?void 0:c.querySelector('input[name="color"]');m&&(m.value=a.value.toUpperCase());return}const l=((o=a.closest("[data-action]"))==null?void 0:o.dataset.action)??"";if(l==="contact-search"&&a instanceof HTMLInputElement){s.listKeyboardFocus=!1,s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.contactSearch=c,(async()=>{try{s.selectedAbId!==null&&await e.loadContacts(s.selectedAbId),i()}catch(m){r("error",m instanceof Error?m.message:"Search failed"),i()}})()},250);return}if(l==="task-search"&&a instanceof HTMLInputElement){s.listKeyboardFocus=!1,s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.taskSearch=c,(async()=>{try{await e.loadTasks(),i()}catch(m){r("error",m instanceof Error?m.message:"Search failed"),i()}})()},250);return}if(l==="files-search"&&a instanceof HTMLInputElement){s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.filesSearch=c,s.filesSearchFocus=!0,i()},150);return}if(l==="event-search"&&a instanceof HTMLInputElement){s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.eventSearch=c,s.eventSearchFocus=!0,i()},150);return}if(l==="note-search"&&a instanceof HTMLInputElement){s.listKeyboardFocus=!1,s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.noteSearch=c,(async()=>{try{await e.loadNotes(),i()}catch(m){r("error",m instanceof Error?m.message:"Search failed"),i()}})()},250);return}if(l==="admin-db-confirm-input"&&a instanceof HTMLInputElement){s.adminDbConfirmText=a.value;const c=n.querySelector('[data-action="admin-db-confirm-save"]');c&&(c.disabled=s.busy||s.adminDbConfirmText.trim()!=="CONFIRM");return}if(l==="admin-reset-password"&&a instanceof HTMLInputElement){s.adminResetPassword=a.value;const c=n.querySelector('[data-action="admin-reset-confirm"]');c&&(c.disabled=s.busy||!s.adminResetConfirmChecked||s.adminResetPassword.trim()==="");return}}const Ga='tr.contact-table-row[data-action="select-contact"], tr.contact-table-row[data-action="select-task"], tr.contact-table-row[data-action="select-note"]',Xa="tr.contact-table-row[data-action], .cal-row[data-action], .month-cell[data-action]";function Ul(e){const{state:t,root:a}=e;let s="";if(t.activeTab==="contacts")s="select-contact";else if(t.activeTab==="tasks")s="select-task";else if(t.activeTab==="notes")s="select-note";else return[];return Array.from(a.querySelectorAll(`tr.contact-table-row[data-action="${s}"]`))}function Re(e){e.focus({preventScroll:!1}),e.scrollIntoView({block:"nearest"})}function Ml(e,t){const a=t.target;if(!a||!e.root.contains(a))return;if((t.key==="ContextMenu"||t.key==="F10"&&t.shiftKey)&&e.state.activeTab==="files"){const l=a.closest("tr.files-row");if(l&&e.root.contains(l)){const o=l.dataset.path??"";if(o){t.preventDefault();const m=(l.querySelector(".files-row-menu-btn")??l).getBoundingClientRect();ra(e.filesHost,o,{x:m.right,y:m.bottom+4,origin:"button"});return}}}const s=e.state.activeTab,n=s==="contacts"||s==="tasks"||s==="notes",i=a instanceof HTMLInputElement&&(a.dataset.action==="contact-search"||a.dataset.action==="task-search"||a.dataset.action==="note-search");if(!i&&a.closest("button, a, input, select, textarea, [contenteditable=true]")&&!a.matches(Xa)&&!a.matches(Ga))return;if(n&&(t.key==="ArrowDown"||t.key==="ArrowUp"||t.key==="Home"||t.key==="End")){const l=Ul(e);if(l.length===0)return;const o=a.closest(Ga);if(e.state.listKeyboardFocus=!0,t.preventDefault(),!o||i){t.key==="ArrowDown"||t.key==="Home"?Re(l[0]):Re(l[l.length-1]);return}const c=l.indexOf(o);if(c<0)return;if(t.key==="Home"){Re(l[0]);return}if(t.key==="End"){Re(l[l.length-1]);return}const m=t.key==="ArrowDown"?l[c+1]:l[c-1];m&&Re(m);return}if(t.key!=="Enter"&&t.key!==" ")return;const r=a.closest(Xa);!r||!e.root.contains(r)||t.target!==r&&t.target.closest("button, a, input, select, textarea")||(t.preventDefault(),(r.dataset.action==="select-contact"||r.dataset.action==="select-task"||r.dataset.action==="select-note")&&(e.state.listKeyboardFocus=!0),w.debug("portalEvents.keydown.row",{action:r.dataset.action,key:t.key}),r.click())}function at(e,t,a){var o,c,m;const{state:s,root:n}=e;if(s.activeTab!=="files"||s.busy||s.filesUploadProgress||!Ys(a.dataTransfer))return;const i=(c=(o=a.target)==null?void 0:o.closest)==null?void 0:c.call(o,"[data-files-drop-target]");if(!i||!n.contains(i)){if(t==="leave"&&s.filesDropDepth>0){const f=a.relatedTarget;f&&f instanceof Node&&((m=n.querySelector("[data-files-drop-target]"))==null?void 0:m.contains(f))||(s.filesDropDepth=0,Ol(e))}return}if(t==="enter"){a.preventDefault(),a.stopPropagation(),s.filesDropDepth+=1,nt(e,i,!0);return}if(t==="over"){a.preventDefault(),a.stopPropagation(),a.dataTransfer&&(a.dataTransfer.dropEffect="copy"),nt(e,i,!0);return}if(t==="leave"){a.preventDefault(),a.stopPropagation();const f=a.relatedTarget;if(f&&i.contains(f))return;s.filesDropDepth=Math.max(0,s.filesDropDepth-1),s.filesDropDepth===0&&nt(e,i,!1);return}a.preventDefault(),a.stopPropagation(),s.filesDropDepth=0,nt(e,i,!1);const r=a.dataTransfer;if(!r||s.busy||s.filesUploadProgress)return;s.filesUploadMenuOpen=!1,e.unbindFilesUploadMenuOutside(),M(e.filesHost);const l=Ks(r);w.event("files.drop.snapshot",{handles:l.handlePromises.length,entries:l.entries.filter(Boolean).length,files:l.files.length}),(async()=>{try{const f=await Ws(l);if(w.event("files.drop.items",{count:f.length,sample:f.slice(0,8).map(b=>b.relativePath)}),f.length===0){e.setFlash("info","Nothing to upload from that drop"),e.render();return}await ca(e.filesHost,f)}catch(f){e.setFlash("error",f instanceof Error?f.message:"Drop failed"),e.render()}})()}function nt(e,t,a){if(e.state.filesUploadDropActive===a){t.classList.toggle("is-dragover",a);return}e.state.filesUploadDropActive=a,t.classList.toggle("is-dragover",a)}function Ol(e){e.state.filesUploadDropActive=!1,e.root.querySelectorAll("[data-files-drop-target].is-dragover").forEach(t=>{t.classList.remove("is-dragover")})}function Nl(e,t){const a=t.target;if(!(a instanceof HTMLImageElement)||!a.classList.contains("contact-avatar")||!a.dataset.avatarFallback||!a.isConnected)return;const s=a.dataset.avatarFallback||"?",n=document.createElement("span");n.className="contact-avatar contact-avatar-fallback",n.setAttribute("aria-hidden","true"),n.textContent=s,a.replaceWith(n)}const xl='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function Ll(e,t){if(t.key!=="Tab")return;const a=e.querySelector(".cal-modal[data-focus-trap]");if(!a)return;const s=[...a.querySelectorAll(xl)].filter(l=>l.offsetParent!==null||l===document.activeElement);if(s.length===0)return;const n=s[0],i=s[s.length-1],r=document.activeElement;!t.shiftKey&&r===i?(t.preventDefault(),n.focus()):t.shiftKey&&(r===n||!a.contains(r))&&(t.preventDefault(),i.focus())}function _l(e,t){if(Ll(e.root,t),t.key!=="Escape")return;const{state:a,render:s}=e;if(a.importProgress&&(a.importProgress.phase==="done"||a.importProgress.phase==="error")){e.closeImportProgress();return}if(a.importProgress)return;if(a.filesUploadProgress&&(a.filesUploadProgress.phase==="done"||a.filesUploadProgress.phase==="error")){e.closeFilesUploadProgress();return}if(a.filesUploadProgress)return;if(a.filesUploadMenuOpen){a.filesUploadMenuOpen=!1,e.unbindFilesUploadMenuOutside(),s();return}if(a.filesItemMenu){M(e.filesHost),s();return}if(a.userMenuOpen){a.userMenuOpen=!1,e.unbindUserMenuOutside(),s();return}if(a.filesUploadConflict!==null){ot(e.filesHost,"cancel");return}if(a.filesPreview!==null){z(e.filesHost),s();return}if(a.filesRenamePath!==null||a.filesDeletePaths!==null||a.filesTransfer!==null||a.filesMkdirOpen){a.filesRenamePath=null,a.filesDeletePaths=null,e.resetFilesTransferTree(),a.filesMkdirOpen=!1,s();return}if(a.confirmDelete){a.confirmDelete=null,s();return}if(a.userSettingsOpen){ln(a),s();return}if(Is(e.root)){bn(e.root);return}const n=e.root.querySelector("#info-modal");if(n&&!n.hidden){e.closeInfoModal();return}if(a.eventDtPicker){a.eventDtPicker=null,ft(a),s();return}if(a.eventModalOpen){a.eventModalOpen=!1,a.editingEvent=null,a.creatingEvent=!1,a.eventDtPicker=null,s();return}if(a.contactModalOpen){a.contactModalOpen=!1,a.editingContact=null,a.creatingContact=!1,a.photoPreview=null,a.photoBase64Pending=null,a.removePhotoPending=!1,s();return}if(a.abModalOpen){a.abModalOpen=!1,s();return}if(a.calModalOpen||a.createCalModalOpen||a.deleteConfirmId!==null||a.deleteAbConfirmId!==null){a.calModalOpen=!1,a.createCalModalOpen=!1,a.deleteConfirmId=null,a.deleteAbConfirmId=null,s();return}if(a.adminUserCreateOpen||a.adminUserEditOpen||a.adminUserDeleteUsername!==null){a.adminUserCreateOpen=!1,a.adminUserEditOpen=!1,a.adminUserDeleteUsername=null,s();return}if(a.adminResetModalOpen){a.adminResetModalOpen=!1,s();return}if(a.adminDbConfirmOpen){a.adminDbConfirmOpen=!1,a.adminDbConfirmText="",a.adminDbPendingBody=null,s();return}(a.adminCalModal!==null||a.adminAbModal!==null||a.adminResourceDelete!==null)&&(a.adminCalModal=null,a.adminAbModal=null,a.adminResourceDelete=null,s())}function qt(e){const{state:t}=e;if(t.activeTab==="admin"&&(!e.userIsAdmin()||!e.adminUiEnabled())){t.activeTab=mt(t),t.adminPage="overview",e.persistTab(t.activeTab);return}t.activeTab!=="admin"&&!te(t,t.activeTab)&&(t.activeTab=mt(t),e.persistTab(t.activeTab))}async function Rl(e,t,a={}){return In(e.adminHost,t,a)}async function Qa(e,t,a={}){const{state:s,render:n,setFlash:i,clearFlash:r}=e;if(t==="admin"&&(!e.userIsAdmin()||!e.adminUiEnabled())&&(e.userIsAdmin()&&s.adminCapabilities&&!s.adminCapabilities.uiEnabled&&i("info","Portal Administration UI is disabled (portal_admin_ui_enabled)."),t=mt(s)),t!=="admin"&&!te(s,t)&&(i("info","That section is disabled in system settings."),t=mt(s)),t!=="files"&&M(e.filesHost),t==="admin"){await e.activateAdminPage(s.adminPage||"overview",{...a,username:s.adminPage==="users"?s.adminSelectedUsername:null});return}s.activeTab=t,s.userMenuOpen=!1,s.listKeyboardFocus=!1,e.persistTab(t),w.event("tab",{tab:t}),t!=="calendars"&&(s.calModalOpen=!1,s.deleteConfirmId=null),t!=="contacts"&&(s.deleteAbConfirmId=null),a.clearFlash!==!1&&r(),s.busy=!0,n();try{t==="contacts"&&s.selectedAbId!==null?await e.loadContacts(s.selectedAbId):t==="calendars"?await e.loadMonthEvents():t==="tasks"?await Ue(e.tasksHost):t==="notes"?await Pt(e.notesHost):t==="files"&&await ne(e.filesHost)}catch(l){w.warn("tab load failed",l instanceof Error?l.message:l),i("error",l instanceof Error?l.message:"Failed to load")}finally{s.busy=!1,n()}}async function qe(e){var i;const{state:t}=e;w.debug("loadHome");const[a,s,n]=await Promise.all([k.calendars(),k.directory().catch(()=>({users:[]})),k.addressbooks()]);if(t.calendars=a.calendars,t.directory=s.users,t.addressBooks=n.addressbooks,w.event("loadHome",{calendars:t.calendars.length,addressBooks:t.addressBooks.length,directory:t.directory.length}),t.holidayCountries.length===0)try{const r=await k.holidayCountries();t.holidayCountries=r.countries}catch{t.holidayCountries=[]}if(t.selectedIds=t.selectedIds.filter(r=>t.calendars.some(l=>l.id===r)),t.selectedId!==null&&!t.calendars.some(r=>r.id===t.selectedId)&&(t.selectedId=null,t.shares=[],t.calModalOpen=!1,t.deleteConfirmId=null),!t.calendarSelectionSeeded&&t.selectedIds.length===0){const r=pi((i=t.user)==null?void 0:i.username);if(r){r.view&&(t.calView=r.view);const l=r.ids.filter(o=>t.calendars.some(c=>c.id===o));t.selectedIds=l,r.selectedId!==null&&t.calendars.some(o=>o.id===r.selectedId)?t.selectedId=r.selectedId:t.selectedId=l[0]??null,t.calendarSelectionSeeded=!0,w.debug("loadHome.calSelection.restored",{count:l.length,selectedId:t.selectedId,view:t.calView})}else{const l=e.pickDefaultCalendar();l?(t.selectedIds=[l.id],t.selectedId=l.id):t.calendars.length>0&&(t.selectedIds=[t.calendars[0].id],t.selectedId=t.calendars[0].id),t.calendarSelectionSeeded=!0}}else t.selectedIds.length===0?t.selectedId=null:t.calendarSelectionSeeded=!0;t.selectedId===null&&t.selectedIds.length>0&&(t.selectedId=t.selectedIds[0]),Ye(t),t.selectedId!==null&&t.calModalOpen?await e.loadShares(t.selectedId):t.selectedId!==null&&(t.shares=[]),t.activeTab==="calendars"&&await e.loadMonthEvents(),t.selectedAbId!==null&&!t.addressBooks.some(r=>r.id===t.selectedAbId)&&(t.selectedAbId=null,t.contacts=[],t.selectedContactUri=null,t.editingContact=null,t.creatingContact=!1),t.deleteAbConfirmId!==null&&!t.addressBooks.some(r=>r.id===t.deleteAbConfirmId)&&(t.deleteAbConfirmId=null),t.selectedAbId===null&&t.addressBooks.length>0&&(t.selectedAbId=t.addressBooks[0].id),t.selectedAbId!==null&&t.activeTab==="contacts"&&await e.loadContacts(t.selectedAbId),t.activeTab==="tasks"&&await Ue(e.tasksHost),t.activeTab==="notes"&&await Pt(e.notesHost),t.activeTab==="files"&&await ne(e.filesHost)}function ql(e){const{state:t}=e;return fa(t.portalUi.timeFormat)}function Bl(e){const{state:t}=e;return pa(t.portalUi.weekStart)}function Hl(e){const{state:t}=e;return Un(t.portalUi.weekStart)}function Kn(e,t,a){const{state:s}=e;return ii(t,a,s.portalUi.timeFormat)}function Vl(e,t,a,s,n){var c,m;const{state:i}=e,r=Ee(a),l=((c=i.eventDtPicker)==null?void 0:c.viewY)??Number(r.date.slice(0,4)),o=((m=i.eventDtPicker)==null?void 0:m.viewM)??Number(r.date.slice(5,7))-1;return di({field:t,value:a,dateOnly:s,allowClear:n,viewY:l,viewM:o,weekStart:i.portalUi.weekStart,timeFormat:i.portalUi.timeFormat})}function Bt(e){ci(e.root)}function Be(e,t){var p;const{state:a}=e,{field:s,name:n,label:i,value:r,dateOnly:l=!1,required:o,disabled:c,allowClear:m=!0}=t,f=((p=a.eventDtPicker)==null?void 0:p.field)===s,b=Kn(e,r,l);return`<div class="dt-field${f?" is-open":""}" data-dt-id="${d(s)}">
    ...
    ${f&&!c?Vl(e,s,r,l,m):""}
  </div>`}function Za(e,t){var s,n,i,r,l,o,c,m;const{state:a}=e;return t==="start"?String(((s=a.editingEvent)==null?void 0:s.start)||""):t==="end"?String(((n=a.editingEvent)==null?void 0:n.end)||""):t==="until"?((r=(i=a.editingEvent)==null?void 0:i.repeat)==null?void 0:r.until)||Te((l=a.editingEvent)==null?void 0:l.start)||A(new Date):t==="due"?Ie((o=a.editingTask)==null?void 0:o.due):t==="dtstart"?Ie((c=a.editingNote)==null?void 0:c.dtstart):t==="bulk-due"?a.bulkDueValue:t==="birthday"?String(((m=a.editingContact)==null?void 0:m.birthday)||""):""}function en(e,t,a){const{state:s}=e;if(t==="start"&&s.editingEvent){s.editingEvent={...s.editingEvent,start:a||""};return}if(t==="end"&&s.editingEvent){s.editingEvent={...s.editingEvent,end:a};return}if(t==="until"&&s.editingEvent){s.editingEvent={...s.editingEvent,repeat:{...s.editingEvent.repeat??e.defaultRepeat(),until:a,endMode:"until"}};return}if(t==="due"&&s.editingTask){if(a===null||a==="")s.editingTask={...s.editingTask,due:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(a))s.editingTask={...s.editingTask,due:new Date(a+"T00:00:00").toISOString()};else{const n=new Date((a.length===16,a));s.editingTask={...s.editingTask,due:Number.isNaN(n.getTime())?a:n.toISOString()}}return}if(t==="dtstart"&&s.editingNote){if(a===null||a==="")s.editingNote={...s.editingNote,dtstart:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(a))s.editingNote={...s.editingNote,dtstart:new Date(a+"T00:00:00").toISOString()};else{const n=new Date((a.length===16,a));s.editingNote={...s.editingNote,dtstart:Number.isNaN(n.getTime())?a:n.toISOString()}}return}if(t==="birthday"&&s.editingContact){s.editingContact={...s.editingContact,birthday:a&&/^\d{4}-\d{2}-\d{2}/.test(a)?a.slice(0,10):null};return}t==="bulk-due"&&(s.bulkDueValue=a||"")}function jl(e,t){const{root:a}=e,s=hr[t];if(!s)return;const n=a.querySelector("#info-modal"),i=a.querySelector("#info-modal-title"),r=a.querySelector("#info-modal-body");if(!n||!i||!r)return;i.textContent=s.title,r.innerHTML=s.paragraphs.map(o=>`<p>${d(o)}</p>`).join(""),n.hidden=!1,document.body.classList.add("info-modal-open");const l=n.querySelector(".info-modal-close");l==null||l.focus()}function zl(e){const{root:t}=e,a=t.querySelector("#info-modal");a&&(a.hidden=!0,document.body.classList.remove("info-modal-open"))}async function Kl(e,t){const a=window;if(typeof a.showSaveFilePicker=="function")try{const r=await(await a.showSaveFilePicker({suggestedName:t})).createWritable();try{await r.write(e)}finally{await r.close()}return"saved"}catch(i){if(i instanceof DOMException&&i.name==="AbortError")return"cancelled"}const s=URL.createObjectURL(e),n=document.createElement("a");return n.href=s,n.download=t,n.rel="noopener",n.style.display="none",document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(s),n.remove()},6e4),"started"}function Wl(e){const t=e.querySelector('input[name="color_picker"]'),a=e.querySelector('input[name="color"]');!t||!a||(t.addEventListener("input",()=>{a.value=t.value.toUpperCase()}),a.addEventListener("change",()=>{let s=a.value.trim();s&&!s.startsWith("#")&&(s=`#${s}`),/^#[0-9A-Fa-f]{6}/.test(s)&&(t.value=s.slice(0,7),a.value=s.toUpperCase())}))}function Yl(e){const t=ws({activeTab:ml(),adminPage:fl(),adminSelectedUsername:Da().adminUsername??null});let a,s,n,i,r,l,o;function c(y,T){fn(t,y,T)}function m(){hs(t)}function f(){const y=Ia(e);t.user?wl(o):Aa(e,t,(T,x)=>Ot(t,T,x)),hl(o),Ua(e,y),requestAnimationFrame(()=>{var T;Bt(o),(T=e.querySelector(".dt-time.is-selected"))==null||T.scrollIntoView({block:"center"})})}function b(){ue(n)}function p(){Ae(a)}function g(){Q(a)}function u(){zt(t)}function v(){ce(a)}function $(){ks(t,{stopImportElapsedTimer:b,stopFilesUploadElapsedTimer:p,resetFilesTransferTree:g,unbindUserMenuOutside:u,unbindFilesUploadMenuOutside:v})}function S(y){Ss(t,{message:y,clearSession:$,render:f})}function C(){return{state:t,render:f,handleSessionExpired:S,clearPortalSessionState:$,normalizeActiveTab:()=>qt(o),persistTab:_t,loadHome:()=>qe(o),loadAdminCapabilities:()=>Jt(s),loadAdminDashboard:()=>bt(s),loadAdminUsers:()=>he(s),loadAdminUserDetail:y=>ae(s,y),loadAdminUserResources:y=>ke(s,y),loadAdminSystemSettings:()=>gt(s),loadAdminDatabaseSettings:()=>yt(s),adminPageMeta:y=>fe(s,y),setFlash:c,clearFlash:m}}a={state:t,root:e,render:f,setFlash:c,clearFlash:m},s={state:t,root:e,render:f,setFlash:c,clearFlash:m,userIsAdmin:()=>we(t),adminUiEnabled:()=>Ge(t),persistTab:_t,activateTab:(y,T)=>Qa(o,y,T),loadHome:()=>qe(o),normalizeActiveTab:()=>qt(o)},n={state:t,root:e,render:f,setFlash:c,clearFlash:m,localeWeekStart:()=>Bl(o),localeDowLabels:()=>Hl(o),formatDtDisplay:(y,T)=>Kn(o,y,T),timeFormatOpts:()=>ql(o),renderPortalDateTimeField:y=>Be(o,y),getDtFieldCurrentValue:y=>Za(o,y),setDtFieldValue:(y,T)=>en(o,y,T),positionDtPopovers:()=>Bt(o),renderFlashBanner:()=>Vt(t),accessBadge:za,formatImportResult:Rt,loadHome:()=>qe(o),onImportContacts:y=>il(l,y)},i={state:t,root:e,render:f,setFlash:c,clearFlash:m,renderPortalDateTimeField:y=>Be(o,y)},r={state:t,root:e,render:f,setFlash:c,clearFlash:m,renderPortalDateTimeField:y=>Be(o,y)},l={state:t,root:e,render:f,setFlash:c,clearFlash:m,renderPortalDateTimeField:y=>Be(o,y),stopImportElapsedTimer:()=>ue(n),startImportElapsedTimer:()=>Ln(n),setImportPhase:(y,T)=>ze(n,y,T),applyServerImportProgress:y=>_n(n,y),readFileTextWithProgress:(y,T)=>qn(n,y,T),formatImportResult:Rt,loadHome:()=>qe(o)},o={state:t,root:e,render:f,setFlash:c,clearFlash:m,filesHost:a,adminHost:s,calendarsHost:n,notesHost:i,tasksHost:r,contactsHost:l,clearPortalSessionState:$,userIsAdmin:()=>we(t),adminUiEnabled:()=>Ge(t),normalizeActiveTab:()=>qt(o),persistTab:_t,activateTab:(y,T)=>Qa(o,y,T),activateAdminPage:(y,T)=>Rl(o,y,T),loadHome:()=>qe(o),handleSessionExpired:S,loadShares:y=>va(n,y),loadMonthEvents:()=>Tt(n),loadContacts:y=>ka(l,y),loadTasks:()=>Ue(r),loadNotes:()=>Pt(i),loadAdminCapabilities:()=>Jt(s),loadAdminDashboard:()=>bt(s),loadAdminUsers:()=>he(s),loadAdminUserDetail:y=>ae(s,y),loadAdminUserResources:y=>ke(s,y),loadAdminSystemSettings:()=>gt(s),loadAdminDatabaseSettings:()=>yt(s),adminPageMeta:y=>fe(s,y),pickDefaultCalendar:()=>bi(n),toggleCalendarSelected:y=>gi(n,y),blankEventForDay:(y,T)=>Di(n,y,T),blankEventForSlot:(y,T,x)=>Ci(n,y,T,x),defaultRepeat:()=>ha(),itemKey:B,openContact:y=>al(l,y),startNewContact:()=>nl(l),emptyAddress:()=>jn(),syncEditingEventFromForm:y=>Ei(n,y),syncEditingTaskFromForm:y=>Qi(r,y),syncEditingNoteFromForm:y=>zi(i,y),runBulkTaskAction:y=>Zi(r,y),shell:(y,T)=>Ot(t,y,T),renderLogin:()=>Aa(e,t,(y,T)=>Ot(t,y,T)),renderFlashBanner:()=>Vt(t),renderMonthGrid:()=>wi(n),renderEventModal:()=>Si(n),adminSubnavButtons:()=>Mr(s),renderPortalDateTimeField:y=>Be(o,y),getDtFieldCurrentValue:y=>Za(o,y),setDtFieldValue:(y,T)=>en(o,y,T),positionDtPopovers:()=>Bt(o),accessBadge:za,formatImportResult:Rt,closeImportProgress:()=>Ti(n),closeFilesUploadProgress:()=>Dn(a),resetFilesTransferTree:g,stopImportElapsedTimer:b,stopFilesUploadElapsedTimer:p,unbindUserMenuOutside:u,bindUserMenuOutside:()=>Us(t,f),unbindFilesUploadMenuOutside:v,bindFilesUploadMenuOutside:()=>pr(a),onLogin:y=>Ts(y,C()),onShare:y=>Ii(n,y),onSaveEvent:y=>Ui(n,y),onEditCal:y=>Mi(n,y),onCreateCal:y=>Oi(n,y),onSaveContact:y=>ll(l,y),onCreateAb:y=>ol(l,y),onEditAb:y=>dl(l,y),onSaveTask:y=>el(r,y),onSaveNote:y=>Ki(i,y),bindColorPair:Wl,bindImportInput:()=>void 0,bindHolidaysToggle:()=>Ni(n),bindContactPhotoInput:()=>void 0,bindFilesDom:()=>Pn(a),bindAdminDom:()=>void 0,saveBlobAsFile:Kl,openInfoModal:y=>jl(o,y),closeInfoModal:()=>zl(o),captureScroll:()=>Ia(e),restoreScroll:y=>Ua(e,y)},El(o),Es(C())}let pe="",E=null,I=!1,J=null,re=null,oe="sqlite",$t=!1;async function Ft(e,t={}){const a={Accept:"application/json",...t.headers};t.body&&(a["Content-Type"]="application/json"),pe&&t.method&&t.method!=="GET"&&(a["X-CSRF-Token"]=pe);const s=await fetch(`/api/install${e}`,{credentials:"same-origin",...t,headers:a});let n;try{n=await s.json()}catch{throw new Error(`Request failed (${s.status})`)}if(!s.ok)throw new Error(n.error||`Request failed (${s.status})`);return n&&typeof n=="object"&&"data"in n&&n.data!==void 0?n.data:n}async function Ca(){var e;E=await Ft("/status"),pe=E.csrfToken||pe,((e=E.defaults)==null?void 0:e.backend)==="pgsql"?oe="pgsql":oe="sqlite"}function He(e,t,a){return`<label class="check-row"><input type="checkbox" name="${d(e)}" ${t?"checked":""} ${I?"disabled":""} /> ${d(a)}</label>`}function Jl(){const e=E==null?void 0:E.permissions;return`<section class="card">
    ...
    ${se("error",(E==null?void 0:E.message)||"Fix directory permissions, then reload.")}
    <button type="button" class="btn btn-primary" data-action="reload" ${I?"disabled":""}>Retry</button>
  </section>`}function Gl(){const e=E==null?void 0:E.defaults;return`<section class="card">
  ...
  </section>`}function Xl(){const e=E==null?void 0:E.defaults,t=(E==null?void 0:E.pdoDrivers)||[],a=t.includes("sqlite"),s=t.includes("pgsql");return`<section class="card">
    <h2>Database</h2>
    ...
    <label class="admin-delete-confirm">
      <input type="checkbox" data-action="upgrade-toggle" ${$t?"checked":""} ${I?"disabled":""} />
      I have a backup and want to run the upgrade
    </label>
    <div class="form-actions-row" style="margin-top:1rem">
      <button type="button" class="btn btn-primary" data-action="upgrade-run"
        ${I||!$t?"disabled":""}>Run upgrade</button>
    </div>
  </section>`}function Zl(){return`<section class="card">
  ...
  </section>`}function eo(){return`<section class="card card-danger-zone">
    <h2>Installer locked</h2>
    ${se("error",(E==null?void 0:E.message)||"Installer is locked.")}
  ...
  </section>`}function G(){const e=document.getElementById("app");if(!e)return;const t=(E==null?void 0:E.step)||"permissions";let a="";E?t==="permissions"?a=Jl():t==="initialize"?a=Gl():t==="database"?a=Xl():t==="upgrade"?a=Ql():t==="done"?a=Zl():t==="locked"?a=eo():a=`<section class="card"><p>Unknown step: ${d(t)}</p></section>`:a='<section class="card"><p class="muted">Loading installer…</p></section>',e.innerHTML=`
  ...
  `,to()}function to(){var t,a,s,n,i,r;const e=document.getElementById("app");e&&((t=e.querySelector('[data-action="reload"]'))==null||t.addEventListener("click",()=>{ao()}),(a=e.querySelector('[data-action="backend-change"]'))==null||a.addEventListener("change",l=>{oe=l.target.value==="pgsql"?"pgsql":"sqlite",G()}),(s=e.querySelector('[data-action="upgrade-toggle"]'))==null||s.addEventListener("change",l=>{$t=!!l.target.checked,G()}),(n=e.querySelector('[data-action="upgrade-run"]'))==null||n.addEventListener("click",()=>{ro()}),(i=e.querySelector('[data-form="initialize"]'))==null||i.addEventListener("submit",l=>{l.preventDefault(),no(l.target)}),(r=e.querySelector('[data-form="database"]'))==null||r.addEventListener("submit",l=>{l.preventDefault(),so(l.target)}))}async function ao(){I=!0,J=null,G();try{await Ca(),re=null}catch(e){J=e instanceof Error?e.message:"Failed to load installer status"}finally{I=!1,G()}}async function no(e){const t=new FormData(e),a=n=>{var i;return!!((i=e.querySelector(`input[name="${n}"]`))!=null&&i.checked)},s={timezone:String(t.get("timezone")??"").trim(),cal_enabled:a("cal_enabled"),card_enabled:a("card_enabled"),tasks_enabled:a("tasks_enabled"),notes_enabled:a("notes_enabled"),files_enabled:a("files_enabled"),dav_auth_type:String(t.get("dav_auth_type")??"Digest"),invite_from:String(t.get("invite_from")??"").trim(),session_max_age_minutes:Number(t.get("session_max_age_minutes")??15),admin_password:String(t.get("admin_password")??""),admin_password_confirm:String(t.get("admin_password_confirm")??"")};I=!0,J=null,re=null,G();try{E=await Ft("/initialize",{method:"POST",body:JSON.stringify(s)}),pe=E.csrfToken||pe,re="Server settings saved. Configure the database next.",w.event("install.initialize")}catch(n){J=n instanceof Error?n.message:"Initialize failed"}finally{I=!1,G()}}async function so(e){const t=new FormData(e),a=String(t.get("backend")??oe),s={backend:a,admin_password:String(t.get("admin_password")??""),admin_password_confirm:String(t.get("admin_password_confirm")??"")};a==="sqlite"?s.sqlite_file=String(t.get("sqlite_file")??"").trim():(s.pgsql_host=String(t.get("pgsql_host")??"").trim(),s.pgsql_dbname=String(t.get("pgsql_dbname")??"").trim(),s.pgsql_username=String(t.get("pgsql_username")??"").trim(),s.pgsql_password=String(t.get("pgsql_password")??"")),I=!0,J=null,re=null,G();try{E=await Ft("/database",{method:"POST",body:JSON.stringify(s)}),pe=E.csrfToken||pe,re="Database configured. Installer is locked.",w.event("install.database"),E.completed||E.step}catch(n){J=n instanceof Error?n.message:"Database setup failed"}finally{I=!1,G()}}async function ro(){if($t){I=!0,J=null,re=null,G();try{const e=await Ft("/upgrade",{method:"POST",body:JSON.stringify({confirm:!0})});re="Upgrade completed."+(e.messages&&e.messages.length?" "+e.messages.slice(0,3).join(" · "):""),w.event("install.upgrade"),await Ca()}catch(e){J=e instanceof Error?e.message:"Upgrade failed"}finally{I=!1,G()}}}async function io(e){document.title="AngaraDAV · Setup",document.body.classList.add("layout-install"),e.innerHTML='<section class="card"><p class="muted">Loading installer…</p></section>';try{await Ca()}catch(t){J=t instanceof Error?t.message:"Failed to load installer"}G()}ta();const Qt=document.getElementById("app");if(!Qt)throw new Error("#app missing");const tn=window.location.pathname.replace(/\/+$/,"")||"/";tn==="/portal/install"||tn.endsWith("/portal/install")?io(Qt):Yl(Qt);
