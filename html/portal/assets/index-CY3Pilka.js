          ...
          <p class="muted small">DAV path: <span class="mono">${d(e.davPath)}</span></p>
            ...
            <div class="bulk-bar-actions">
              ...
              <div class="cal-modal-card" style="max-width:28rem">
                ...
                <p>Delete <strong>${d(g)}</strong>?${(f==null?void 0:f.type)==="dir"?" This removes the folder and everything inside it.":""}</p>
