...
`)}function U(e){const t=e.titleId||(e.id?`${e.id}-title`:`modal-title-${Math.random().toString(36).slice(2,9)}`),a=e.id?` id="${d(e.id)}"`:"",s=e.className?` ${e.className}`:"",n=e.rootAttrs?` ${e.rootAttrs}`:"",r=`${ln(e.size)}${e.cardClassName?` ${e.cardClassName}`:""}`,i=e.closeAction,l=e.lockBackdrop?"":` data-action="${d(i)}"`,o=e.hideClose?"":`<button type="button" class="modal-close info-modal-close" data-action="${d(i)}" aria-label="Close">×</button>`;let c="";e.footer!==void 0&&(c=typeof e.footer=="string"?e.footer:Ut(e.footer));const p=c?`<footer class="cal-modal-footer">${c}</footer>`:"",m=`<div class="cal-modal-body">${e.body}</div>`;let u;return e.form?u=`<form class="stack"${e.formAttrs?` ${e.formAttrs}`:""}>
    ...
    <div class="info-modal" id="info-modal" hidden role="dialog" aria-modal="true" aria-labelledby="info-modal-title">
    ...
    </div>`}function bt(e,t,a={},s){const n=!!e.user&&e.activeTab==="admin"&&de(e)&&Ne(e),l=`
      ...
      <span class="brand-text">Angara<span class="brand-dav">DAV</span><span class="brand-sep" aria-hidden="true"> · </span><span class="${n?"brand-portal brand-portal-admin":"brand-portal brand-portal-user"}">${d(n?"Administration Portal":"User Portal")}</span></span>`,o=e.user?d(e.user.displayname||e.user.username):"",c=Ne(e)?`<button type="button" class="user-menu-item${e.activeTab==="admin"?" is-active":""}" role="menuitem" data-action="tab" data-tab="admin">
          ...
          <a class="brand" href="/portal/">${l}</a>
        </nav>`,y=!(e.calModalOpen||e.createCalModalOpen||e.deleteConfirmId!==null||e.deleteAbConfirmId!==null||e.eventModalOpen||e.contactModalOpen||e.abModalOpen||e.filesRenamePath!==null||e.filesDeletePaths!==null||e.filesTransfer!==null||e.filesMkdirOpen||e.filesUploadConflict!==null||e.filesUploadProgress!==null||e.confirmDelete!==null)?wt(e):"",f=a.tabs&&a.tabs.trim()!==""?`<div class="tabs-bar" role="presentation">
      ...
      <footer class="site-footer">
        <div class="container footer-inner">
          ...
          <span class="footer-sep" aria-hidden="true">·</span>
          <a href="${d(sn)}" target="_blank" rel="noopener noreferrer">Docs</a>
        </div>
      ...
      ${s.renderFilesUploadProgressModal()}`}function Dt(e){e.userMenuDocClick&&(document.removeEventListener("click",e.userMenuDocClick,!0),e.userMenuDocClick=null)}function $n(e,t){Dt(e),e.userMenuDocClick=s=>{var r;const n=s.target;(r=n==null?void 0:n.closest)!=null&&r.call(n,".user-menu")||(e.userMenuOpen=!1,Dt(e),t())};const a=e.userMenuDocClick;setTimeout(()=>{e.userMenuOpen&&e.userMenuDocClick===a&&document.addEventListener("click",a,!0)},0)}function Ze(e){e.dtPickerDocClick&&(document.removeEventListener("click",e.dtPickerDocClick,!0),e.dtPickerDocClick=null)}function kn(e,t){if(Ze(e),!e.eventDtPicker)return;e.dtPickerDocClick=s=>{var r,i;const n=s.target;(r=n==null?void 0:n.closest)!=null&&r.call(n,".dt-field.is-open, .dt-popover, [data-dt-popover]")||(i=n==null?void 0:n.closest)!=null&&i.call(n,'[data-action="dt-open"]')||(e.eventDtPicker=null,Ze(e),t())};const a=e.dtPickerDocClick;setTimeout(()=>{e.eventDtPicker&&e.dtPickerDocClick===a&&document.addEventListener("click",a,!0)},0)}async function Z(e){e.state.filesLoading=!0;try{h.debug("loadFiles",{path:e.state.filesPath});const[t,a]=await Promise.all([w.filesStatus(),w.filesList(e.state.filesPath).catch(s=>{if(s instanceof O&&(s.status===503||s.status===404))return{path:e.state.filesPath,entries:[]};throw s})]);if(e.state.filesStatus=t,t.ready){e.state.filesPath=a.path,e.state.filesEntries=a.entries;const s=new Set(e.state.filesEntries.map(n=>n.path));e.state.checkedFilePaths=e.state.checkedFilePaths.filter(n=>s.has(n))}else e.state.filesEntries=[],e.state.checkedFilePaths=[];h.event("loadFiles",{path:e.state.filesPath,count:e.state.filesEntries.length,enabled:t.enabled,ready:t.ready})}finally{e.state.filesLoading=!1}}function ka(...e){return e.map(t=>t.replace(/\\/g,"/").replace(/^\/+|\/+$/g,"")).filter(Boolean).join("/")}function Me(e){const t=e.replace(/\\/g,"/").split("/").filter(Boolean);return t[t.length-1]||e}function lt(e,t,a){for(const s of a)if(s&&(t===s||t.startsWith(`${s}/`)))return!0;return!1}function K(e){e.state.filesTransfer=null,e.state.filesTransferDest="",e.state.filesTreeChildren={},e.state.filesTreeExpanded=[]}async function qe(e,t,a){if(a.length===0)return;e.state.filesTransfer={op:t,paths:[...a]},e.state.filesTransferDest=e.state.filesPath,e.state.filesTreeChildren={};const s=new Set([""]);if(e.state.filesPath){const n=e.state.filesPath.split("/").filter(Boolean);let r="";for(const i of n)r=r?`${r}/${i}`:i,s.add(r)}e.state.filesTreeExpanded=[...s],e.state.filesRenamePath=null,e.state.filesDeletePaths=null,e.state.filesMkdirOpen=!1,e.state.filesUploadMenuOpen=!1,e.state.filesUploadMenuDocClick&&(document.removeEventListener("click",e.state.filesUploadMenuDocClick,!0),e.state.filesUploadMenuDocClick=null),e.clearFlash(),e.render(),await Promise.all([...s].map(n=>Ct(e,n)))}async function Ct(e,t){const a=e.state.filesTreeChildren[t];if(!(a&&a!=="error")){e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:"loading"},e.render();try{const n=(await w.filesList(t)).entries.filter(r=>r.type==="dir").slice().sort((r,i)=>r.name.localeCompare(i.name,void 0,{sensitivity:"base"}));if(!e.state.filesTransfer)return;e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:n}}catch(s){if(!e.state.filesTransfer)return;e.state.filesTreeChildren={...e.state.filesTreeChildren,[t]:"error"},h.warn("files.tree",{path:t||"/",error:s instanceof Error?s.message:String(s)})}e.render()}}function hn(e){if(!e.state.filesTransfer)return"";const t=e.state.filesTransfer.paths,a=[],s=(n,r)=>{const i=e.state.filesTransferDest===n,l=lt(e,n,t),o=e.state.filesTreeExpanded.includes(n),c=e.state.filesTreeChildren[n],p=Array.isArray(c),m=n===""||c==="loading"||c==="error"||!p||c.length>0,u=n===""?"Home":Me(n),b=l?"Cannot use a selected item (or a folder inside it) as the destination":n===""?"File home host.root":n,y=o?"▾":"▸";if(a.push(`<div class="files-tree-row${i?" is-selected":""}${l?" is-blocked":""}" style="--depth:${r}" role="treeitem" aria-selected="${i}" aria-expanded="${o}" aria-disabled="${l}">
      ...
      <button type="button" class="files-tree-select${i?" is-selected":""}" data-action="files-tree-select" data-path="${d(n)}"
        ...
        </div>`);return}if(p){for(const f of c)s(f.path,r+1);c.length===0&&n===""&&a.push(`<div class="files-tree-status muted small" style="--depth:${r+1}">No subfolders yet — destination will be Home.</div>`)}}};return s("",0),`<div class="files-folder-tree" role="tree" aria-label="Destination folder">${a.join("")}</div>`}async function wn(e,t){if(!e.state.filesTransfer||e.state.filesTransfer.paths.length===0)return;const a=new FormData(t),s=(e.state.filesTransferDest||String(a.get("toPath")??"")).trim().replace(/^\/+|\/+$/g,""),n=String(a.get("newName")??"").trim(),r=e.state.filesTransfer.op,i=[...e.state.filesTransfer.paths],l=i.length>1;if(lt(e,s,i)){e.setFlash("error","Choose a different destination folder"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();let o=0;const c=[];try{for(const m of i)try{if(r==="copy"){const u=Me(m),b=l||!n||n===u?void 0:n,y=await w.filesCopy(m,{to:s,newName:b});h.event("files.copy",{path:m,to:y.entry.path})}else{const u=Me(m),b=l||!n||n===u?void 0:n;await w.filesMove(m,s,b),h.event("files.move",{path:m,to:s})}o+=1}catch(u){c.push(`${Me(m)}: ${u instanceof Error?u.message:"failed"}`)}K(e),e.state.checkedFilePaths=[],await Z(e);const p=r==="copy"?"Copied":"Moved";o>0&&c.length===0?e.setFlash("success",o===1?`${p} 1 item`:`${p} ${o} items`):o>0?e.setFlash("info",`${p} ${o}; ${c.length} failed. ${c[0]}`):e.setFlash("error",c[0]||`${r==="copy"?"Copy":"Move"} failed`)}catch(p){e.setFlash("error",p instanceof Error?p.message:"Operation failed")}finally{e.state.busy=!1,e.render()}}function Tt(...e){return e.map(t=>t.replace(/\\/g,"/").replace(/^\/+|\/+$/g,"")).filter(Boolean).join("/")}function ha(e){if(!e||typeof e!="object")return!1;const t=e.name;return t==="AbortError"||t==="NotAllowedError"}function wa(e,t=!0){return Array.from(e).map(s=>{const r=(s.webkitRelativePath||"").replace(/\\/g,"/").replace(/^\/+/,"")||s.name;return{file:s,relativePath:r||s.name}})}function Sn(e){return new Promise((t,a)=>{const s=[],n=()=>{e.readEntries(r=>{if(!r.length){t(s);return}s.push(...r),n()},r=>a(r))};n()})}function Dn(e){return new Promise((t,a)=>{e.file(t,a)})}async function Sa(e,t){const a=Tt(t,e.name);if(e.isFile)return[{file:await Dn(e),relativePath:a||e.name}];if(e.isDirectory){const s=e.createReader(),n=await Sn(s);if(n.length===0)return[{file:null,relativePath:a,isEmptyDir:!0}];const r=[];for(const i of n)r.push(...await Sa(i,a));return r}return[]}async function*Cn(e){const t=e;if(typeof t.values=="function"){for await(const a of t.values())yield a;return}if(typeof t.entries=="function")for await(const[,a]of t.entries())yield a}async function Ot(e,t){const a=Tt(t,e.name),s=[];let n=0;for await(const r of Cn(e))if(n+=1,r.kind==="file"){const i=await r.getFile();s.push({file:i,relativePath:Tt(a,r.name)||i.name})}else r.kind==="directory"&&s.push(...await Ot(r,a));return n===0&&s.push({file:null,relativePath:a,isEmptyDir:!0}),s}async function Tn(){const e=window;if(typeof e.showOpenFilePicker!="function")return{kind:"fallback"};try{const t=await e.showOpenFilePicker({multiple:!0});if(!t||t.length===0)return{kind:"cancel"};const a=[];for(const s of t){const n=await s.getFile();a.push({file:n,relativePath:n.name})}return{kind:"items",items:a}}catch(t){return ha(t)?{kind:"cancel"}:{kind:"fallback"}}}async function En(){const e=window;if(typeof e.showDirectoryPicker!="function")return{kind:"fallback"};try{const t=await e.showDirectoryPicker({mode:"read"}),a=await Ot(t,"");return a.length===0?{kind:"cancel"}:{kind:"items",items:a}}catch(t){return ha(t)?{kind:"cancel"}:{kind:"fallback"}}}function Zt(e){return e.replace(/\\/g,"/").replace(/^\/+/,"").replace(/\/+$/,"")}function Pn(e){const t=e.files?Array.from(e.files):[],a=[],s=[],n=e.items?Array.from(e.items):[];for(const r of n){if(r.kind!=="file")continue;const i=r;typeof i.getAsFileSystemHandle=="function"?a.push(i.getAsFileSystemHandle().catch(()=>null)):a.push(Promise.resolve(null));let l=null;if(typeof i.webkitGetAsEntry=="function")try{l=i.webkitGetAsEntry()}catch{l=null}s.push(l)}return{handlePromises:a,entries:s,files:t}}async function An(e){var r,i;const t=[],a=await Promise.all(e.handlePromises);for(let l=0;l<Math.max(a.length,e.entries.length);l++){const o=a[l]??null;if(o)try{if(o.kind==="file"){const p=await o.getFile();t.push({file:p,relativePath:p.name})}else o.kind==="directory"&&t.push(...await Ot(o,""));continue}catch{}const c=e.entries[l];if(c)try{t.push(...await Sa(c,""))}catch{}}const s=wa(e.files,!0),n=new Map;for(const l of s){const o=Zt(l.relativePath||((r=l.file)==null?void 0:r.name)||"");o&&n.set(o,l)}for(const l of t){const o=Zt(l.relativePath||((i=l.file)==null?void 0:i.name)||"");o&&n.set(o,l)}return Array.from(n.values())}function Fn(e){if(!e)return!1;if(e.types&&typeof e.types.includes=="function")return e.types.includes("Files");try{for(let t=0;t<e.types.length;t++)if(e.types[t]==="Files")return!0}catch{}return!1}function Da(e,t=80){const a=String(e??"").replace(/\s+/g," ").trim();return a?a.length>t?`${a.slice(0,t-1)}…`:a:""}function ae(e,t,a){const s=Da(t);return s?`${e} “${s}” ${a}`:`${e} ${a}`}function gt(e){const t=Da(e.displayname||e.fullname);return t||[e.firstname,e.lastname].map(s=>String(s??"").trim()).filter(Boolean).join(" ")||"Unnamed contact"}function Ca(e){if(!e)return"—";try{const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}function et(e){return!Number.isFinite(e)||e<0?"":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function H(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/60),s=t%60;return a>0?`${a}m ${s}s`:`${s}s`}function be(e){return!Number.isFinite(e)||e<0?"—":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:e<1024*1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:`${(e/(1024*1024*1024)).toFixed(2)} GB`}function Un(e){if(!e)return"—";try{return new Date(e*1e3).toLocaleString()}catch{return"—"}}function G(e,t,a,s,n,r=""){const i=a===t,l=i?s==="asc"?" ▲":" ▼":"";return`<th class="${`sortable-th${i?" is-sorted":""}${r?" "+r:""}`}" data-action="sort-${n}" data-sort="${d(t)}" role="columnheader" tabindex="0">${d(e)}${l}</th>`}function ee(e){e.state.filesUploadMenuDocClick&&(document.removeEventListener("click",e.state.filesUploadMenuDocClick,!0),e.state.filesUploadMenuDocClick=null)}function In(e){ee(e),e.state.filesUploadMenuDocClick=a=>{var n;const s=a.target;(n=s==null?void 0:s.closest)!=null&&n.call(s,".files-upload-menu")||(e.state.filesUploadMenuOpen=!1,ee(e),e.render())};const t=e.state.filesUploadMenuDocClick;setTimeout(()=>{e.state.filesUploadMenuOpen&&e.state.filesUploadMenuDocClick===t&&document.addEventListener("click",t,!0)},0)}function ke(e){e.state.filesUploadElapsedTimer!==null&&(clearInterval(e.state.filesUploadElapsedTimer),e.state.filesUploadElapsedTimer=null)}function On(e){ke(e),e.state.filesUploadElapsedTimer=setInterval(()=>{if(!e.state.filesUploadProgress||e.state.filesUploadProgress.phase==="done"||e.state.filesUploadProgress.phase==="error"){ke(e);return}e.state.filesUploadProgress={...e.state.filesUploadProgress,elapsedSec:Math.floor((Date.now()-e.state.filesUploadProgress.startedAt)/1e3)},ye(e,e.state.filesUploadProgress)},1e3)}function Ta(e){ke(e),e.state.filesUploadProgress=null,e.render()}function Ea(e,t){return t.bytesTotal>0?Math.min(100,Math.max(0,Math.round(100*t.bytesSent/t.bytesTotal))):t.totalFiles>0?Math.min(100,Math.max(0,Math.round(100*t.completedFiles/t.totalFiles))):null}function ye(e,t){if(!e.root.querySelector("[data-files-upload-progress]"))return;const a=e.root.querySelector(".files-upload-progress-bar"),s=e.root.querySelector(".files-upload-progress-track"),n=e.root.querySelector("[data-files-upload-status]"),r=e.root.querySelector("[data-files-upload-current]"),i=Ea(e,t),l=t.phase==="uploading"?`Uploading ${t.completedFiles.toLocaleString()} / ${t.totalFiles.toLocaleString()} file${t.totalFiles===1?"":"s"}${t.failedFiles?` · ${t.failedFiles} failed`:""}${i!==null?` (${i}%)`:""} · ${H(t.elapsedSec)}`:(n==null?void 0:n.textContent)||"";n&&t.phase==="uploading"&&(n.textContent=l),r&&t.phase==="uploading"&&(r.textContent=t.currentName||"",r.title=t.currentName||""),a&&i!==null&&(a.classList.remove("is-indeterminate"),a.style.width=`${i}%`),s&&i!==null&&(s.setAttribute("aria-valuenow",String(i)),s.removeAttribute("aria-valuetext"))}function Be(e){if(!e.state.filesUploadProgress)return"";const t=e.state.filesUploadProgress,a=t.phase==="uploading",s=t.phase==="done"?"Upload finished":t.phase==="error"?"Upload failed":"Uploading…",n=Ea(e,t),r=n===null?"files-upload-progress-bar is-indeterminate":"files-upload-progress-bar",i=n!==null?` style="width:${n}%"`:"";let l="";if(a){const c=`Uploading ${t.completedFiles.toLocaleString()} / ${t.totalFiles.toLocaleString()} file${t.totalFiles===1?"":"s"}${t.failedFiles?` · ${t.failedFiles} failed`:""}${n!==null?` (${n}%)`:""} · ${H(t.elapsedSec)}`,p=t.bytesTotal>0?`${et(t.bytesSent)} / ${et(t.bytesTotal)}`:"";l=`
      ...
      ${c}
      <p class="muted small" style="margin:0.75rem 0 0">After ${d(H(t.elapsedSec))}</p>`}const o=a?'<p class="muted small" style="margin:0">Please wait…</p>':Ut([{label:"Close",action:"close-files-upload-progress",variant:"primary"}]);return U({title:s,titleId:"files-upload-progress-title",closeAction:"close-files-upload-progress",size:"sm",className:"import-progress-modal files-upload-progress-modal",cardClassName:"import-progress-card",rootAttrs:"data-files-upload-progress",hideClose:a,lockBackdrop:a,body:l,footer:o})}async function ea(e,t,a,s){const n=a.replace(/\\/g,"/").split("/").map(i=>i.trim()).filter(Boolean);let r=t;for(const i of n){const l=ka(r,i);if(s.has(l)){r=l;continue}try{await w.filesMkdir(r,i),h.event("files.mkdir",{path:r,name:i,via:"upload-folder"})}catch(o){if(!(o instanceof O&&o.status===409))throw o}s.add(l),r=l}}function Mn(e,t){var s;const a=t==="files"?'input[type="file"][data-action="files-upload-pick-files"]':'input[type="file"][data-action="files-upload-pick-folder"]';(s=e.root.querySelector(a))==null||s.click()}async function ta(e,t){if(e.state.busy||e.state.filesUploadProgress)return;e.state.filesUploadMenuOpen=!1,ee(e),e.state.filesRenamePath=null,e.state.filesDeletePaths=null,K(e),e.state.filesMkdirOpen=!1;const a=t==="files"?Tn:En;try{const s=await a();if(s.kind==="cancel"){e.render();return}if(s.kind==="items"){if(s.items.length===0){e.setFlash("info",t==="folder"?"Folder is empty":"No files selected"),e.render();return}await Nt(e,s.items);return}e.render(),requestAnimationFrame(()=>{Mn(e,t)})}catch(s){e.setFlash("error",s instanceof Error?s.message:"Could not open picker"),e.render()}}function ot(e,t){return`${e}\0${t}`}function Nn(e,t){return t.map(a=>{const s=a.file,n=(a.relativePath||s.name).replace(/\\/g,"/"),r=n.split("/").filter(Boolean),i=r.pop()||s.name,l=r.join("/"),o=ka(e,l);return{item:a,file:s,fileName:i,parentPath:o,displayName:n||i,relDir:l}})}function xn(e){const t=new Set,a=[];for(const s of e){const n=ot(s.parentPath,s.fileName);t.has(n)||(t.add(n),a.push(s))}return a}async function Ln(e,t){if(t.length===0)return[];const a=new Map;for(const n of t){const r=a.get(n.parentPath)??[];r.push(n),a.set(n.parentPath,r)}const s=[];for(const[n,r]of a){let i=new Map;try{const l=await w.filesList(n);i=new Map;for(const o of l.entries)(o.type==="file"||o.type==="dir")&&i.set(o.name,o.type)}catch{i=new Map}for(const l of r)i.has(l.fileName)&&s.push(l)}return s.sort((n,r)=>n.displayName.localeCompare(r.displayName)),s}const Mt=new WeakMap;function yt(e){e&&(Mt.delete(e.state),e.state.filesUploadConflict=null)}function Ye(e,t){var p;const a=Mt.get(e.state),s=e.state.filesUploadConflict;if(t==="cancel"){yt(e),e.setFlash("info","Upload cancelled"),e.render();return}if(!a){e.state.filesUploadConflict=null,e.setFlash("error","Upload session expired — drop or choose the files again"),e.render();return}const n=new Set(((p=s==null?void 0:s.conflictKeys)!=null&&p.length?s.conflictKeys:a.conflictKeys)??[]);let r=a.planned,i=new Set,l=0;if(t==="overwrite")i=new Set(n);else{const m=[];for(const u of a.planned){const b=ot(u.parentPath,u.fileName);n.has(b)?l+=1:m.push(u)}if(r=m,h.event("files.upload.skip_existing",{skipped:l,remaining:r.length,total:a.planned.length,conflictKeys:n.size}),r.length===0&&a.emptyDirs.length===0){yt(e),e.setFlash("info",l===1?"Nothing to upload — the selected file already exists":`Nothing to upload — all ${l} selected files already exist`),e.render();return}}const o=a.destBase,c=a.emptyDirs;yt(e),Pa(e,r,c,o,i)}async function Nt(e,t){if(t.length===0||e.state.filesUploadProgress||e.state.filesUploadConflict)return;e.state.filesUploadMenuOpen=!1,ee(e),e.state.filesUploadDropActive=!1;const a=t.filter(i=>i.file&&!i.isEmptyDir),s=t.filter(i=>i.isEmptyDir&&i.relativePath),n=e.state.filesPath,r=xn(Nn(n,a));if(h.event("files.upload.plan",{destBase:n||"/",files:r.length,emptyDirs:s.length,sample:r.slice(0,5).map(i=>({display:i.displayName,parent:i.parentPath||"/",name:i.fileName}))}),r.length>0){e.state.busy=!0,e.clearFlash(),e.render();try{const i=await Ln(n,r);if(i.length>0){const l=i.map(o=>ot(o.parentPath,o.fileName));Mt.set(e.state,{planned:r,emptyDirs:s,destBase:n,conflictKeys:l}),e.state.filesUploadConflict={names:i.map(o=>o.displayName),totalFiles:r.length,conflictCount:i.length,conflictKeys:l},h.event("files.upload.conflicts",{total:r.length,conflicts:i.length,names:i.slice(0,12).map(o=>o.displayName)}),e.state.busy=!1,e.render();return}}catch(i){e.state.busy=!1,e.setFlash("error",i instanceof Error?i.message:"Could not check existing files"),e.render();return}}await Pa(e,r,s,n,new Set)}async function Pa(e,t,a,s,n){var b,y;const r=t.reduce((f,$)=>f+($.file.size||0),0),i=Date.now(),l=t.length+a.length;e.state.filesUploadProgress={phase:"uploading",totalFiles:Math.max(t.length,1),completedFiles:0,failedFiles:0,currentName:((b=t[0])==null?void 0:b.displayName)||((y=a[0])==null?void 0:y.relativePath)||"",bytesTotal:r,bytesSent:0,startedAt:i,elapsedSec:0,resultMessage:null,errorSamples:[]},e.state.busy=!0,e.clearFlash(),On(e),e.render();let o=0;const c=[],p=new Set;let m=0,u=0;try{for(const k of a){const S=k.relativePath.replace(/\\/g,"/").replace(/^\/+|\/+$/g,"");if(S){e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,currentName:S+"/",elapsedSec:Math.floor((Date.now()-i)/1e3)},ye(e,e.state.filesUploadProgress));try{await ea(e,s,S,p)}catch(v){c.push(`${S}/: ${v instanceof Error?v.message:"failed"}`)}}}for(const k of t){const{file:S,fileName:v,parentPath:g,displayName:D,relDir:P}=k;e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,currentName:D,bytesSent:m,elapsedSec:Math.floor((Date.now()-i)/1e3)},ye(e,e.state.filesUploadProgress));try{P&&await ea(e,s,P,p);const F=n.has(ot(g,v));await w.filesUpload(g,S,{replace:F,onProgress:(I,_)=>{if(!e.state.filesUploadProgress||e.state.filesUploadProgress.phase!=="uploading")return;const E=_>0?_:S.size;e.state.filesUploadProgress={...e.state.filesUploadProgress,currentName:D,bytesSent:m+Math.min(I,E||I),elapsedSec:Math.floor((Date.now()-i)/1e3)},ye(e,e.state.filesUploadProgress)}}),h.event("files.upload",{path:g,name:v,size:S.size,relativePath:D,replace:F}),o+=1,F&&(u+=1),m+=S.size||0,e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,completedFiles:o,failedFiles:c.length,bytesSent:m},ye(e,e.state.filesUploadProgress))}catch(F){const I=`${D}: ${F instanceof Error?F.message:"failed"}`;c.push(I),m+=S.size||0,e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,completedFiles:o,failedFiles:c.length,bytesSent:m,errorSamples:c.slice(0,12)},ye(e,e.state.filesUploadProgress))}}await Z(e),ke(e);const f=Math.floor((Date.now()-i)/1e3),$=t.length;if(o>0&&c.length===0){let k=o===1?"Uploaded 1 file":`Uploaded ${o} files`;u>0&&(k+=u===1?" (1 overwritten)":` (${u} overwritten)`),e.state.filesUploadProgress={phase:"done",totalFiles:Math.max($,1),completedFiles:o,failedFiles:0,currentName:"",bytesTotal:r,bytesSent:r,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:[]},e.setFlash("success",k)}else if(o>0){const k=`Uploaded ${o}; ${c.length} failed. ${c[0]}`;e.state.filesUploadProgress={phase:"done",totalFiles:Math.max($,1),completedFiles:o,failedFiles:c.length,currentName:"",bytesTotal:r,bytesSent:r,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:c.slice(0,12)},e.setFlash("info",k)}else if(l>0&&c.length===0&&a.length>0){const k=a.length===1?"Created 1 empty folder":`Created ${a.length} empty folders`;e.state.filesUploadProgress={phase:"done",totalFiles:1,completedFiles:0,failedFiles:0,currentName:"",bytesTotal:0,bytesSent:0,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:[]},e.setFlash("success",k)}else{const k=c[0]||"Upload failed";e.state.filesUploadProgress={phase:"error",totalFiles:Math.max($,1),completedFiles:0,failedFiles:c.length,currentName:"",bytesTotal:r,bytesSent:0,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:c.slice(0,12)},e.setFlash("error",k)}}catch(f){ke(e);const $=f instanceof Error?f.message:"Upload failed";e.state.filesUploadProgress={phase:"error",totalFiles:Math.max(t.length,1),completedFiles:o,failedFiles:Math.max(c.length,1),currentName:"",bytesTotal:r,bytesSent:m,startedAt:i,elapsedSec:Math.floor((Date.now()-i)/1e3),resultMessage:$,errorSamples:c.length?c.slice(0,12):[$]},e.setFlash("error",$)}finally{e.state.busy=!1,e.render()}}function aa(e,t,a){const s=t.files;if(!s||s.length===0)return;const n=wa(s,a);t.value="",Nt(e,n)}function _n(e,t){const a=t?t.split("/").filter(Boolean):[];let s="";const n=[`<button type="button" class="files-crumb" data-action="files-nav" data-path="" ${e.state.busy?"disabled":""}>Home</button>`];for(const r of a){s=s?`${s}/${r}`:r;const i=s;n.push('<span class="files-crumb-sep" aria-hidden="true">/</span>'),n.push(`<button type="button" class="files-crumb" data-action="files-nav" data-path="${d(i)}" ${e.state.busy?"disabled":""}>${d(r)}</button>`)}return`<nav class="files-breadcrumb" aria-label="Folder path">${n.join("")}</nav>`}function Rn(e){const t=e.state.filesStatus;if(!t)return`<div class="card"><p class="muted">${e.state.filesLoading||e.state.busy?"Loading…":"Unable to load file storage status."}</p></div>`;if(!t.enabled)return`<div class="portal-grid portal-grid-files">
      <section class="card">
        ${M("Files","files","h1")}
        ...
        <p class="muted small">DAV path: <span class="mono">${d(t.davPath)}</span></p>
    ...
    </div>`;const a=t.quotaBytes>0?`${be(t.usedBytes)} used · ${be(t.availableBytes)} free of ${be(t.quotaBytes)}`:`${be(t.usedBytes)} used · ${be(t.availableBytes)} free (no app quota)`,s=t.quotaBytes>0?Math.min(100,Math.round(100*t.usedBytes/t.quotaBytes)):0,n=e.state.checkedFilePaths.length,r=e.state.filesEntries.length>0&&e.state.filesEntries.every(v=>e.state.checkedFilePaths.includes(v.path)),i=n>0,l=e.state.filesEntries.filter(v=>v.type==="dir").length,o=e.state.filesEntries.length-l,c=n>0?`<div class="bulk-bar files-bulk-bar" role="toolbar" aria-label="Selected files">
          ...
          <div class="bulk-bar-actions">
            ...
            <button type="button" class="btn btn-small btn-danger" data-action="files-bulk-delete" ${e.state.busy?"disabled":""}>Delete</button>
              ...
              <td class="files-col-mtime hide-sm">${d(Un(v.mtime))}</td>
              ...
              </label>`,footer:[{label:"Cancel",action:"files-mkdir-close",variant:"ghost"},{label:"Create",type:"submit",variant:"primary",disabled:e.state.busy}]}):"",$=e.state.filesUploadConflict?(()=>{const v=e.state.filesUploadConflict,g=v.conflictCount,D=Math.max(0,v.totalFiles-g),P=g===1?"1 file already exists in the destination.":`${g} of ${v.totalFiles} files already exist in the destination.`,F=D>0?D===1?" Skip existing keeps the other 1 new file.":` Skip existing keeps the other ${D} new files.`:" Skip existing cancels the upload (nothing new to send).",I=v.names.slice(0,12).map(E=>`<li><span class="mono">${d(E)}</span></li>`).join(""),_=v.names.length>12?`<li class="muted">…and ${v.names.length-12} more</li>`:"";return U({id:"files-upload-conflict-modal",title:g===1?"File already exists":"Files already exist",titleId:"files-upload-conflict-title",closeAction:"files-upload-conflict-cancel",size:"sm",body:`
    ...
    with role <span class="badge badge-admin">Admin</span>.
    ...
    </section>`;else if(e.state.adminDashboard){const i=e.state.adminDashboard,l=i.services,o=i.links??{},c=t?`<span class="badge ${Le(e,t.status)}">${d(we(e,t.status))}</span>`:"",p=i.version?d(i.version):"—",m=i.git?d(i.git):"";s=`
          ...
          <div>
            ...
            <div class="admin-service-table-wrap">
              <table class="admin-kv-table">
                <tbody>
                  <tr><td>Administration</td><td>${le(e,l.administration!==!1&&l.webAdmin!==!1)}</td></tr>
                  <tr><td>CalDAV</td><td>${le(e,!!l.caldav)}</td></tr>
                  <tr><td>CardDAV</td><td>${le(e,!!l.carddav)}</td></tr>
                  <tr><td>Files</td><td>${le(e,!!l.files)}</td></tr>
                  <tr><td>Tasks</td><td>${le(e,!!l.tasks)}</td></tr>
                  <tr><td>Notes</td><td>${le(e,!!l.notes)}</td></tr>
                  <tr><td>Push</td><td>${le(e,!!l.push)}</td></tr>
                </tbody>
              </table>
            </div>
          </div>
      ...
      <section class="card admin-stats-card">
        ...
        <div class="admin-service-row">
          ${ie(e,l.administration!==!1&&l.webAdmin!==!1,"Administration")}
          ${ie(e,!!l.caldav,"CalDAV")}
          ${ie(e,!!l.carddav,"CardDAV")}
          ${ie(e,!!l.files,"Files")}
          ${ie(e,!!l.tasks,"Tasks")}
          ${ie(e,!!l.notes,"Notes")}
          ${ie(e,!!l.push,"Push")}
    ...
    ${n}`}function jn(e){const t=e.state.adminUsersQuery.trim().toLowerCase();return t?e.state.adminUsers.filter(a=>a.username.toLowerCase().includes(t)||(a.displayname||"").toLowerCase().includes(t)||(a.email||"").toLowerCase().includes(t)):e.state.adminUsers}function Wn(e){return e.state.adminUserCreateOpen?U({id:"admin-user-create-modal",title:"Add user",titleId:"admin-user-create-title",closeAction:"admin-user-create-close",size:"sm",form:!0,formAttrs:'data-form="admin-user-create"',body:`
        ...
        <p class="muted small">Username <span class="mono">${d(t.username)}</span> cannot be changed. Leave password fields empty to keep the current password.</p>
          ...
          </label>`,footer:[{label:"Cancel",action:"admin-user-edit-close",variant:"ghost",disabled:e.state.busy},{label:"Save changes",type:"submit",variant:"primary",disabled:e.state.busy}]})}function Yn(e){if(!e.state.adminUserDeleteUsername)return"";const t=e.state.adminUserDeleteUsername,a=e.state.adminUserDetail&&e.state.adminUserDetail.username.toLowerCase()===t.toLowerCase()?e.state.adminUserDetail:e.state.adminUsers.find(n=>n.username.toLowerCase()===t.toLowerCase())??null,s=a?`${a.displayname||a.username} (${a.username})`:t;return U({id:"admin-user-delete-modal",title:"Delete user",titleId:"admin-user-delete-title",closeAction:"admin-user-delete-close",size:"sm",body:`
  ...
  ${i}${l}${o}`}function Qn(e){const t=ne(e,"users");if(t&&t.available===!1)return dt(e,"users");const a=jn(e),s=e.state.adminUsersLoading&&e.state.adminUsers.length===0?'<tr><td colspan="4" class="muted admin-table-empty">Loading users…</td></tr>':a.length===0?`<tr><td colspan="4" class="muted admin-table-empty">${e.state.adminUsersError?d(e.state.adminUsersError):e.state.adminUsersQuery.trim()?"No users match this filter.":"No users found."}</td></tr>`:a.map(n=>`<tr class="contact-table-row${e.state.adminSelectedUsername&&e.state.adminSelectedUsername.toLowerCase()===n.username.toLowerCase()?" is-selected":""}" data-action="admin-user-view" data-username="${d(n.username)}" tabindex="0" role="button">
    ...
    ${Wn(e)}
    ${Jn(e)}
    ${Yn(e)}`}async function Xn(e,t){const a=new FormData(t),s=String(a.get("username")??"").trim(),n=String(a.get("displayname")??"").trim(),r=String(a.get("email")??"").trim(),i=String(a.get("password")??""),l=String(a.get("passwordConfirm")??"");if(!s||!n||!r||!i){e.setFlash("error","Username, display name, email, and password are required"),e.render();return}if(i!==l){e.setFlash("error","Password confirmation does not match"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{const o=await w.adminCreateUser({username:s,displayname:n,email:r,password:i,passwordConfirm:l});h.event("admin.user.create",{username:o.user.username}),e.state.adminUserCreateOpen=!1,e.state.adminSelectedUsername=o.user.username,e.state.adminUserDetail=o.user,e.persistTab("admin","users",o.user.username),await ce(e),e.setFlash("success",`Created user “${o.user.username}”`)}catch(o){e.setFlash("error",o instanceof Error?o.message:"Create failed")}finally{e.state.busy=!1,e.render()}}async function Zn(e,t){const a=new FormData(t),s=String(a.get("username")??"").trim(),n=String(a.get("displayname")??"").trim(),r=String(a.get("email")??"").trim(),i=String(a.get("password")??""),l=String(a.get("passwordConfirm")??"");if(!s){e.setFlash("error","Username is required"),e.render();return}if(!n||!r){e.setFlash("error","Display name and email are required"),e.render();return}if(i!==""||l!==""){if(i===""||l===""){e.setFlash("error","Password and confirmation are required to change password"),e.render();return}if(i!==l){e.setFlash("error","Password confirmation does not match"),e.render();return}}e.state.busy=!0,e.clearFlash(),e.render();try{const o={displayname:n,email:r};i!==""&&(o.password=i,o.passwordConfirm=l);const c=await w.adminUpdateUser(s,o);h.event("admin.user.update",{username:c.user.username,passwordChanged:i!==""}),e.state.adminUserEditOpen=!1,e.state.adminUserDetail=c.user,e.state.adminSelectedUsername=c.user.username,await ce(e),e.setFlash("success",i!==""?`Updated “${c.user.username}” (password changed)`:`Updated “${c.user.username}”`)}catch(o){e.setFlash("error",o instanceof Error?o.message:"Update failed")}finally{e.state.busy=!1,e.render()}}async function es(e,t){var c,p;if(!e.state.adminSelectedUsername)return;const a=e.state.adminSelectedUsername,s=new FormData(t),n=String(s.get("displayname")??"").trim(),r=String(s.get("description")??"").trim(),i=String(s.get("calendarcolor")??"").trim(),l=((c=t.querySelector('input[name="todos"]'))==null?void 0:c.checked)??!1,o=((p=t.querySelector('input[name="notes"]'))==null?void 0:p.checked)??!1;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.adminCalModal==="create"){const m=String(s.get("uri")??"").trim().toLowerCase();await w.adminCreateUserCalendar(a,{uri:m,displayname:n,description:r,calendarcolor:i||void 0,todos:l,notes:o}),e.setFlash("success",`Created calendar “${n}”`)}else{const m=Number(s.get("instanceId"));await w.adminUpdateUserCalendar(a,m,{displayname:n,description:r,calendarcolor:i,todos:l,notes:o}),e.setFlash("success",`Updated calendar “${n}”`)}e.state.adminCalModal=null,e.state.adminCalEditId=null,await ue(e,a),await j(e,a)}catch(m){e.setFlash("error",m instanceof Error?m.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function ts(e,t){if(!e.state.adminSelectedUsername)return;const a=e.state.adminSelectedUsername,s=new FormData(t),n=String(s.get("displayname")??"").trim(),r=String(s.get("description")??"").trim();e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.adminAbModal==="create"){const i=String(s.get("uri")??"").trim().toLowerCase();await w.adminCreateUserAddressBook(a,{uri:i,displayname:n,description:r}),e.setFlash("success",`Created address book “${n}”`)}else{const i=Number(s.get("id"));await w.adminUpdateUserAddressBook(a,i,{displayname:n,description:r}),e.setFlash("success",`Updated address book “${n}”`)}e.state.adminAbModal=null,e.state.adminAbEditId=null,await ue(e,a),await j(e,a)}catch(i){e.setFlash("error",i instanceof Error?i.message:"Save failed")}finally{e.state.busy=!1,e.render()}}const as=["UTC","Africa/Cairo","Africa/Johannesburg","America/Anchorage","America/Argentina/Buenos_Aires","America/Chicago","America/Denver","America/Edmonton","America/Halifax","America/Los_Angeles","America/Mexico_City","America/New_York","America/Sao_Paulo","America/Toronto","America/Vancouver","Asia/Dubai","Asia/Hong_Kong","Asia/Jerusalem","Asia/Kolkata","Asia/Seoul","Asia/Shanghai","Asia/Singapore","Asia/Tokyo","Australia/Melbourne","Australia/Sydney","Europe/Amsterdam","Europe/Berlin","Europe/London","Europe/Madrid","Europe/Moscow","Europe/Paris","Europe/Rome","Europe/Warsaw","Pacific/Auckland","Pacific/Honolulu"];let ge=null;function ns(){if(ge)return ge;try{const e=Intl;if(typeof e.supportedValuesOf=="function"){const t=e.supportedValuesOf("timeZone");if(Array.isArray(t)&&t.length>0)return ge=[...t].sort((a,s)=>a.localeCompare(s)),ge}}catch{}return ge=[...as],ge}function Fa(e){const t=e||"UTC",a=ns(),s=a.includes(t),n=a.map(r=>`<option value="${na(r)}" ${r===t?"selected":""}>${sa(r)}</option>`);return!s&&t&&n.unshift(`<option value="${na(t)}" selected>${sa(t)}</option>`),n.join("")}function na(e){return e.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;")}function sa(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ss(e){const t=ne(e,"settings");if(t&&t.available===!1)return dt(e,"settings");if(e.state.adminSystemSettingsLoading&&!e.state.adminSystemSettings)return'<section class="card"><p class="muted">Loading system settings…</p></section>';if(e.state.adminSystemSettingsError&&!e.state.adminSystemSettings)return`<section class="card">
    ...
    ${rs(e)}`}function rs(e){return e.state.adminResetModalOpen?U({id:"admin-reset-modal",title:"Reset to Default",titleId:"admin-reset-title",closeAction:"admin-reset-close",size:"sm",body:`
        ...
        </label>`,footer:[{label:"Cancel",action:"admin-reset-close",variant:"ghost",disabled:e.state.busy},{label:"Reset and open installer",action:"admin-reset-confirm",variant:"danger",disabled:e.state.busy||!e.state.adminResetConfirmChecked||e.state.adminResetPassword.trim()===""}]}):""}async function is(e,t){const a=new FormData(t),s=l=>{var o;return!!((o=t.querySelector(`input[name="${l}"]`))!=null&&o.checked)},n={cal_enabled:s("cal_enabled"),card_enabled:s("card_enabled"),tasks_enabled:s("tasks_enabled"),notes_enabled:s("notes_enabled"),files_enabled:s("files_enabled"),push_enabled:s("push_enabled"),portal_admin_ui_enabled:s("portal_admin_ui_enabled"),timezone:String(a.get("timezone")??"").trim(),invite_from:String(a.get("invite_from")??"").trim(),dav_auth_type:String(a.get("dav_auth_type")??"Digest"),files_storage_path:String(a.get("files_storage_path")??"").trim(),files_max_upload_mb:Number(a.get("files_max_upload_mb")??0),files_quota_mb:Number(a.get("files_quota_mb")??0),files_quarantine_days:Number(a.get("files_quarantine_days")??0),session_max_age_minutes:Number(a.get("session_max_age_minutes")??15),portal_log_level:String(a.get("portal_log_level")??"off"),portal_admin_users:String(a.get("portal_admin_users")??"").trim(),push_external_url:String(a.get("push_external_url")??"").trim(),push_log_level:String(a.get("push_log_level")??"off")},r=String(a.get("admin_password")??""),i=String(a.get("admin_password_confirm")??"");(r!==""||i!=="")&&(n.admin_password=r,n.admin_password_confirm=i),e.state.busy=!0,e.clearFlash(),e.render();try{const l=await w.adminUpdateSystemSettings(n);e.state.adminSystemSettings=l.data;const o=l.data;e.state.portalUi={...e.state.portalUi,services:{caldav:!!o.cal_enabled,carddav:!!o.card_enabled,tasks:!!o.tasks_enabled,notes:!!o.notes_enabled,files:!!o.files_enabled}},h.event("admin.settings.save"),e.setFlash("success","System settings saved")}catch(l){e.setFlash("error",l instanceof Error?l.message:"Save failed")}finally{e.state.busy=!1,e.render()}}function Ua(e,t){const a=new FormData(t),s=String(a.get("backend")??e.state.adminDbFormBackend).toLowerCase()==="pgsql"?"pgsql":"sqlite",n={backend:s};return s==="sqlite"?n.sqlite_file=String(a.get("sqlite_file")??"").trim():(n.pgsql_host=String(a.get("pgsql_host")??"").trim(),n.pgsql_dbname=String(a.get("pgsql_dbname")??"").trim(),n.pgsql_username=String(a.get("pgsql_username")??"").trim(),n.pgsql_password=String(a.get("pgsql_password")??"")),n}function ls(e,t){e.state.adminDbPendingBody=Ua(e,t),e.state.adminDbConfirmText="",e.state.adminDbConfirmOpen=!0,e.clearFlash(),e.render()}async function os(e,t){if(t||(t=e.root.querySelector('[data-form="admin-database"]')),!t){e.setFlash("error","Database form not found"),e.render();return}const a=Ua(e,t);e.state.busy=!0,e.clearFlash(),e.render();try{const s=await w.adminTestDatabaseConnection(a);e.setFlash("success",s.message||"Connection successful"),h.event("admin.database.test",{backend:s.backend})}catch(s){e.setFlash("error",s instanceof Error?s.message:"Connection test failed")}finally{e.state.busy=!1,e.render()}}function ds(e){const t=ne(e,"database");if(t&&t.available===!1)return dt(e,"database");if(e.state.adminDatabaseSettingsLoading&&!e.state.adminDatabaseSettings)return'<section class="card"><p class="muted">Loading database settings…</p></section>';if(e.state.adminDatabaseSettingsError&&!e.state.adminDatabaseSettings)return`<section class="card">
    ...
    ${cs(e)}`}function cs(e){if(!e.state.adminDbConfirmOpen)return"";const t=e.state.adminDbConfirmText.trim()==="CONFIRM";return U({id:"admin-db-confirm-modal",title:"Confirm database change",titleId:"admin-db-confirm-title",closeAction:"admin-db-confirm-close",size:"sm",body:`
        ...
        </label>`,footer:[{label:"Cancel",action:"admin-db-confirm-close",variant:"ghost",disabled:e.state.busy},{label:"Save database settings",action:"admin-db-confirm-save",variant:"danger",disabled:e.state.busy||!t}]})}async function Ia(e,t,a={}){if(!e.userIsAdmin()){await e.activateTab("calendars",a);return}e.state.activeTab="admin",e.state.adminPage=t,t!=="users"?(e.state.adminSelectedUsername=null,e.state.adminUserDetail=null,e.state.adminUserDetailError=null):a.username!==void 0&&(e.state.adminSelectedUsername=a.username,a.username||(e.state.adminUserDetail=null,e.state.adminUserDetailError=null)),e.state.userMenuOpen=!1,e.persistTab("admin",t,e.state.adminSelectedUsername),h.event("tab",{tab:"admin",adminPage:t,user:e.state.adminSelectedUsername}),a.clearFlash!==!1&&e.clearFlash(),e.state.busy=!0,e.render();try{if(await Et(e),!e.adminUiEnabled()){e.state.activeTab="calendars",e.persistTab("calendars"),e.setFlash("info","Portal Administration UI is disabled.");return}const s=ne(e,t);t==="overview"&&(s==null?void 0:s.available)!==!1?await tt(e):t==="users"&&(s==null?void 0:s.available)!==!1?(await ce(e),e.state.adminSelectedUsername&&(await j(e,e.state.adminSelectedUsername),await ue(e,e.state.adminSelectedUsername))):t==="settings"&&(s==null?void 0:s.available)!==!1?await at(e):t==="database"&&(s==null?void 0:s.available)!==!1&&await nt(e)}catch(s){h.warn("admin page load failed",s instanceof Error?s.message:s),e.setFlash("error",s instanceof Error?s.message:"Failed to load")}finally{e.state.busy=!1,e.render()}}function us(e){return e.userIsAdmin()?e.adminUiEnabled()?e.state.adminPage==="users"?Qn(e):e.state.adminPage==="settings"?ss(e):e.state.adminPage==="database"?ds(e):zn(e):`<section class="card admin-coming-soon-card">
        <div class="admin-coming-soon-head">
    ...
    </div>`}function hs(e=document){e.querySelectorAll(".dt-field.is-open").forEach(t=>{const a=t.querySelector(".dt-trigger"),s=t.querySelector(".dt-popover");if(!a||!s)return;const n=a.getBoundingClientRect(),r=8;s.style.position="fixed",s.style.visibility="hidden",s.style.top="0",s.style.left="0";const i=s.offsetWidth||320,l=s.offsetHeight||300;let o=n.bottom+6;o+l>window.innerHeight-r&&(o=Math.max(r,n.top-l-6));let c=n.left;c+i>window.innerWidth-r&&(c=Math.max(r,window.innerWidth-i-r)),c<r&&(c=r),s.style.top=`${Math.round(o)}px`,s.style.left=`${Math.round(c)}px`,s.style.right="auto",s.style.visibility="visible",s.style.zIndex="200"})}async function Rt(e,t){const a=await w.shares(t);e.state.shares=a.shares}function ws(e){const t=e.state.calendars.filter(s=>s.canShare);if(t.length===0)return null;const a=s=>{const n=s.uri.toLowerCase(),r=s.displayname.toLowerCase();return n==="default"||r==="default"||r==="default calendar"};return t.find(a)??t[0]??null}async function ct(e){const t=e.state.selectedIds.filter(n=>e.state.calendars.some(r=>r.id===n));if(t.length===0){e.state.monthEvents=[];return}const{from:a,to:s}=fs(e.state.monthCursor.y,e.state.monthCursor.m);e.state.monthEventsLoading=!0,h.debug("loadMonthEvents",{selectedIds:t,from:a,to:s});try{const r=(await Promise.all(t.map(async i=>(await w.calendarEvents(i,a,s)).events.map(o=>({...o,instanceId:i}))))).flat();r.sort((i,l)=>{const o=i.start||"",c=l.start||"";return o!==c?o<c?-1:1:(i.summary||"").localeCompare(l.summary||"")}),e.state.monthEvents=r,h.event("monthEvents.loaded",{calendarIds:t,count:e.state.monthEvents.length,from:a,to:s})}catch(n){e.state.monthEvents=[],h.warn("loadMonthEvents failed",n instanceof Error?n.message:n)}finally{e.state.monthEventsLoading=!1}}function Ss(e,t){const a=e.state.calendars.find(s=>s.id===t);return a!=null&&a.color?a.color.length>=7?a.color.slice(0,7):a.color:"#3B82F6"}function Ds(e,t){e.state.selectedIds.includes(t)?(e.state.selectedIds=e.state.selectedIds.filter(a=>a!==t),e.state.selectedId===t&&(e.state.selectedId=e.state.selectedIds[0]??null)):(e.state.selectedIds=[...e.state.selectedIds,t],e.state.selectedId=t)}function Cs(e,t,a){return new Date(t,a,1).toLocaleString(void 0,{month:"long",year:"numeric"})}function Ts(e,t){const a=t.summary||"(No title)";if(t.allDay||/^\d{4}-\d{2}-\d{2}$/.test(t.start))return a;const s=new Date(t.start);return Number.isNaN(s.getTime())?a:`${s.toLocaleTimeString(void 0,e.timeFormatOpts())} ${a}`}function Es(e){const t=e.state.calendars.filter(S=>e.state.selectedIds.includes(S.id)),a=t.length===0?"No calendar selected":t.length===1?t[0].displayname:`${t.length} calendars`,s=e.state.monthCursor.y,n=e.state.monthCursor.m,r=new Date(s,n,1),i=e.localeWeekStart(),l=(r.getDay()-i+7)%7,o=new Date(s,n+1,0).getDate(),c=new Date(s,n,0).getDate(),m=N(new Date),u=e.localeDowLabels(),b=new Map;for(const S of e.state.monthEvents)for(const v of bs(S)){const g=b.get(v)??[];g.push(S),b.set(v,g)}const y=[],f=Math.ceil((l+o)/7)*7;for(let S=0;S<f;S++){let v,g=!0,D;S<l?(v=c-l+S+1,g=!1,D=new Date(s,n-1,v)):S>=l+o?(v=S-(l+o)+1,g=!1,D=new Date(s,n+1,v)):(v=S-l+1,D=new Date(s,n,v));const P=N(D),F=P===m,I=g?b.get(P)??[]:[],_=e.state.monthExpandDay===P?50:3,E=I.slice(0,_),x=I.length-E.length,V=E.map(fe=>{var jt;const mt=fe.instanceId,pt=Ts(e,fe),Wa=Ss(e,mt),zt=((jt=e.state.calendars.find(Ya=>Ya.id===mt))==null?void 0:jt.displayname)||"",Ja=zt?`${pt} · ${zt}`:pt;return`<button type="button" class="month-event${fe.allDay?"":" is-timed"}" title="${d(Ja)}" style="--ev-color:${d(Wa)}"
          data-action="open-event" data-instance="${mt}" data-uri="${d(fe.uri)}" ${e.state.busy?"disabled":""}>${d(pt)}</button>`}).join(""),re=x>0?`<button type="button" class="month-event-more" data-action="open-event-day" data-day="${d(P)}" title="Show all events this day" ${e.state.busy?"disabled":""}>+${x} more</button>`:"",me=!g&&(v===1||S===l+o)?D.toLocaleString(void 0,{month:"short",day:"numeric"}):String(v),pe=e.state.selectedId!==null?e.state.calendars.find(fe=>fe.id===e.state.selectedId)??null:null,_e=!!(pe&&!pe.readOnly&&(pe.canShare||pe.access==="readwrite"));y.push(`<div class="month-cell${g?"":" is-outside"}${F?" is-today":""}${_e?" is-clickable":""}"${_e?` data-action="new-event-day" data-day="${d(P)}" role="button" tabindex="0" title="Add event on ${d(P)}"`:""}>
    ...
    <div class="month-cal-toolbar">
      ...
      <h2 class="month-cal-title">${d(Cs(e,s,n))}</h2>
  ...
  </section>`}function qt(){return{freq:"",interval:1,until:null,count:null,byDay:[],endMode:"never"}}function Ps(e){return e.endMode==="until"||e.endMode==="count"||e.endMode==="never"?e.endMode:e.until?"until":e.count?"count":"never"}function xe(e){const t=String(e.get("repeatFreq")??"").trim().toUpperCase();if(!t)return{freq:"",interval:1,until:null,count:null,byDay:[],endMode:"never"};const a=Math.max(1,Math.min(99,Number(e.get("repeatInterval")??1)||1)),s=String(e.get("repeatEndMode")??"never"),n=s==="until"||s==="count"?s:"never";let r=null,i=null;if(n==="until"){const o=String(e.get("repeatUntil")??"").trim();r=o?o.slice(0,10):null}else if(n==="count"){const o=Number(e.get("repeatCount")??0);i=Number.isFinite(o)&&o>0?Math.min(999,Math.round(o)):10}const l=e.getAll("repeatByDay").map(o=>String(o).toUpperCase()).filter(Boolean);return{freq:t,interval:a,until:r,count:i,byDay:l,endMode:n}}function As(e){if(!e.state.eventModalOpen||!e.state.editingEvent)return"";const t=e.state.editingEvent,a=t.repeat??qt(),s=(a.freq||"").toUpperCase(),n=e.state.calendars.filter(y=>y.canShare||y.access==="readwrite"),r=e.state.calendars.filter(y=>y.id===t.instanceId?!0:y.readOnly?!1:y.canShare||y.access==="readwrite").map(y=>`<option value="${y.id}" ${y.id===t.instanceId?"selected":""}>${d(y.displayname)}</option>`).join(""),i=t.readOnly||!t.canWrite;let l,o;if(t.allDay)l=$e(t.start),o=$e(t.end);else{const y=t.start||"",f=t.end||"";if(/^\d{4}-\d{2}-\d{2}$/.test(y)){const $=_t(y,f||null);l=$.start,o=$.end||""}else l=he(t.start),o=he(t.end)}const c=[{code:"MO",label:"Mon"},{code:"TU",label:"Tue"},{code:"WE",label:"Wed"},{code:"TH",label:"Thu"},{code:"FR",label:"Fri"},{code:"SA",label:"Sat"},{code:"SU",label:"Sun"}],p=new Set((a.byDay||[]).map(y=>y.toUpperCase())),m=Ps(a),u=!!s&&m==="until",b=a.until||(m==="until"?$e(t.start)||N(new Date):"");return`<div class="cal-modal" id="event-edit-modal" role="dialog" aria-modal="true" aria-labelledby="event-modal-title">
    ...
    <div class="cal-modal-card">
      ...
      <p class="muted small">Large imports can time out; try again — already-imported items update faster.</p>`;const l=a?'<p class="muted small" style="margin:0">Please wait…</p>':Ut([{label:"Close",action:"close-import-progress",variant:"primary"}]);return U({title:n,titleId:"import-progress-title",closeAction:"close-import-progress",size:"sm",className:"import-progress-modal",cardClassName:"import-progress-card",rootAttrs:"data-import-progress",hideClose:a,lockBackdrop:a,body:i,footer:l})}function _a(e,t,a){return new Promise((s,n)=>{const r=new FileReader;r.onprogress=i=>{i.lengthComputable&&i.total>0?a(Math.min(100,Math.round(i.loaded/i.total*100))):a(null)},r.onload=()=>s(String(r.result??"")),r.onerror=()=>n(r.error??new Error("Failed to read file")),r.readAsText(t)})}async function Os(e,t){var s;if(e.state.selectedId===null)return;const a=(s=t.files)==null?void 0:s[0];t.value="",a&&(e.state.calModalOpen=!0,await Ra(e,e.state.selectedId,a,{keepEditModalOpen:!0}))}async function Ms(e,t){var p;const a=(p=t.files)==null?void 0:p[0];if(t.value="",!a)return;const s=e.root.querySelector('[data-form="create-cal"]'),n=s?new FormData(s):new FormData,r=n.get("holidays")==="on",i=n.get("readOnly")==="on";if(r){e.setFlash("error","Turn off “Holidays calendar” to import a .ics file into a new calendar."),e.state.createCalModalOpen=!0,e.render();return}if(i){e.setFlash("error","Turn off “Read-only” before importing — import cannot write to a read-only calendar."),e.state.createCalModalOpen=!0,e.render();return}let l=String(n.get("displayname")??"").trim();l||(l=a.name.replace(/\.ics$/i,"").trim()||"Imported calendar");const o=String(n.get("description")??""),c=String(n.get("color")??"").trim();e.state.busy=!0,e.clearFlash(),e.state.createCalModalOpen=!0,e.render();try{const m=await w.createCalendar({displayname:l,description:o,color:c,readOnly:!1});e.state.selectedId=m.calendar.id,e.state.createCalModalOpen=!1,await e.loadHome(),e.setFlash("success",`Created “${m.calendar.displayname}” — importing…`),await Ra(e,m.calendar.id,a,{keepEditModalOpen:!1,successPrefix:`Calendar “${m.calendar.displayname}” created. `})}catch(m){const u=m instanceof Error?m.message:"Create or import failed";e.state.createCalModalOpen=!0,e.setFlash("error",u),e.state.busy=!1,e.render()}}async function Ra(e,t,a,s={}){e.state.busy=!0,e.clearFlash(),te(e),e.state.importProgress={kind:"calendar",fileName:a.name,fileSizeLabel:et(a.size),phase:"reading",readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},Na(e),e.render();try{const n=await _a(e,a,l=>{if(!e.state.importProgress||e.state.importProgress.phase!=="reading")return;e.state.importProgress={...e.state.importProgress,readPercent:l};const o=e.root.querySelector(".import-progress-bar"),c=e.root.querySelector("[data-import-status-line]");o&&l!==null&&(o.classList.remove("is-indeterminate"),o.style.width=`${l}%`),c&&l!==null&&(c.textContent=`Reading file… ${l}%`)});Ie(e,"uploading",{readPercent:100}),Ie(e,"processing",{processPercent:0}),h.event("import.calendar.start",{file:a.name,bytes:a.size,calId:t});const r=await w.importCalendar(t,n,l=>{xa(e,l)}),i=e.formatImportResult(r);e.state.selectedId===t&&await ct(e),te(e),Ie(e,"done",{ok:!0,resultMessage:`${i} (from “${a.name}”)`}),e.setFlash("success",`${s.successPrefix||""}Import finished for “${a.name}”: ${i}.`)}catch(n){const r=n instanceof Error?n.message:"Import failed";te(e),Ie(e,"error",{ok:!1,resultMessage:r}),e.setFlash("error",r)}finally{s.keepEditModalOpen&&(e.state.calModalOpen=!0),e.state.busy=!1,e.render()}}async function Ns(e,t){if(e.state.selectedId===null)return;const a=new FormData(t),s=String(a.get("username")??"").trim(),n=String(a.get("access")??"read");if(!s){e.setFlash("error","Select a user to share with"),e.render();return}e.state.calModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.render();try{await w.share(e.state.selectedId,s,n),await Rt(e,e.state.selectedId),e.setFlash("success",`Shared with ${s}`)}catch(r){e.setFlash("error",r instanceof Error?r.message:"Share failed")}finally{e.state.busy=!1,e.render()}}async function xs(e,t){if(!e.state.editingEvent||!e.state.editingEvent.canWrite)return;const a=new FormData(t),s=String(a.get("summary")??"").trim(),n=String(a.get("description")??"").trim(),r=String(a.get("location")??"").trim(),i=a.get("allDay")==="on",l=String(a.get("start")??"").trim(),o=String(a.get("end")??"").trim(),c=Number(a.get("instanceId"))||e.state.editingEvent.instanceId,p=xe(a);if(!s){e.setFlash("error","Title is required"),e.render();return}if(!l){e.setFlash("error","Start is required"),e.render();return}let m,u;if(i)m=l.slice(0,10),u=o?o.slice(0,10):m;else if(/^\d{4}-\d{2}-\d{2}$/.test(l)){const $=_t(l,o||null);m=new Date($.start).toISOString(),u=$.end?new Date($.end).toISOString():null}else m=new Date(l).toISOString(),u=o?new Date(o).toISOString():null;const b=e.state.editingEvent.instanceId,y=e.state.editingEvent.uri,f=e.state.creatingEvent;e.state.busy=!0,e.clearFlash(),e.state.eventModalOpen=!0,e.render(),h.event(f?"event.create":"event.update",{instanceId:c,uri:f?null:y,allDay:i,summary:s});try{const $={summary:s,description:n,location:r,allDay:i,start:m,end:u,instanceId:c,repeat:p},k=f?await w.createEvent(c,$):await w.updateEvent(b,y,$);(e.state.selectedId===null||k.event.instanceId!==e.state.selectedId)&&(e.state.selectedId=k.event.instanceId),await ct(e),e.state.eventModalOpen=!1,e.state.editingEvent=null,e.state.creatingEvent=!1,e.state.eventDtPicker=null,h.event(f?"event.created":"event.saved",{uri:k.event.uri,instanceId:k.event.instanceId}),e.setFlash("success",ae("Event",k.event.summary||s,f?"created":"saved"))}catch($){h.warn("event.save failed",$ instanceof Error?$.message:$),e.setFlash("error",$ instanceof Error?$.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function Ls(e,t){if(e.state.selectedId===null)return;const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??""),r=String(a.get("color")??"").trim();e.state.busy=!0,e.clearFlash(),e.render();try{const i=await w.updateCalendar(e.state.selectedId,{displayname:s,description:n,color:r});e.state.calModalOpen=!0,await e.loadHome(),e.state.selectedId=i.calendar.id,await Rt(e,e.state.selectedId),await ct(e),e.setFlash("success","Calendar updated")}catch(i){e.setFlash("error",i instanceof Error?i.message:"Update failed")}finally{e.state.busy=!1,e.render()}}async function _s(e,t){const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??""),r=String(a.get("color")??"").trim(),i=a.get("holidays")==="on",l=String(a.get("holidayCountry")??"").trim(),o=a.get("readOnly")==="on";if(e.state.createCalModalOpen=!0,i&&!l){e.setFlash("error","Select a country for the holidays calendar"),e.render();return}if(!i&&!s){e.setFlash("error","Display name is required"),e.render();return}e.state.busy=!0,e.clearFlash(),e.render();try{const c=await w.createCalendar({displayname:s,description:n,color:r,holidays:i,holidayCountry:i?l:void 0,readOnly:o});e.state.selectedId=c.calendar.id,e.state.selectedIds.includes(c.calendar.id)||(e.state.selectedIds=[...e.state.selectedIds,c.calendar.id]),e.state.createCalModalOpen=!1,await e.loadHome();let p=`Created “${c.calendar.displayname}”`;const m=c.holidayImport??c.calendar.holidayImport;m&&(p+=`. Holidays imported: ${e.formatImportResult(m)}.`),o&&(p+=" Calendar is read-only."),e.setFlash("success",p)}catch(c){e.state.createCalModalOpen=!0,e.setFlash("error",c instanceof Error?c.message:"Create failed")}finally{e.state.busy=!1,e.render()}}function qa(e){const t=e.root.querySelector('[data-form="create-cal"]');if(!t)return;const a=t.querySelector('input[name="holidays"]'),s=t.querySelector("#holidays-country-wrap"),n=t.querySelector('input[name="displayname"]'),r=t.querySelector('input[name="readOnly"]');if(!a||!s)return;const i=a.checked;s.hidden=!i,n&&(n.required=!i,i&&!n.value.trim()?n.placeholder="Auto: Holidays (XX)":i||(n.placeholder="Work")),i&&r&&(r.checked=!0)}function Rs(e){qa(e)}function ra(e){const{state:t}=e,a=t.calendars.filter(f=>f.canShare),s=t.calendars.filter(f=>!f.canShare),n=t.calendars.find(f=>f.id===t.selectedId)??null,r=a.map(f=>{const $=t.selectedIds.includes(f.id),k=$?" is-selected":"",S=f.id===t.selectedId?" is-primary":"",v=f.color?`<span class="cal-swatch" style="background:${d(f.color)}"></span>`:'<span class="cal-swatch cal-swatch-empty"></span>',g=e.accessBadge(f.access)+(f.readOnly?'<span class="badge">read-only</span>':"")+(f.holidaysCountry?`<span class="badge badge-admin">holidays ${d(f.holidaysCountry)}</span>`:"");return`<div class="cal-row${k}${S}" data-action="select-cal" data-id="${f.id}" role="button" tabindex="0" title="Toggle on the month grid">
    ...
    ${e.renderEventModal()}`}function Oe(e){if(!e.state.editingContact)return;const t=e.root.querySelector('[data-form="contact"]');if(!t)return;const a=new FormData(t);e.state.editingContact.firstname=String(a.get("firstname")??""),e.state.editingContact.lastname=String(a.get("lastname")??""),e.state.editingContact.fullname=String(a.get("fullname")??""),e.state.editingContact.org=String(a.get("org")??""),e.state.editingContact.title=String(a.get("title")??""),e.state.editingContact.url=String(a.get("url")??""),e.state.editingContact.note=String(a.get("note")??"");const s=String(a.get("birthday")??"").trim();e.state.editingContact.birthday=s&&/^\d{4}-\d{2}-\d{2}/.test(s)?s.slice(0,10):null,e.state.editingContact.address={street:String(a.get("street")??""),city:String(a.get("city")??""),region:String(a.get("region")??""),postal:String(a.get("postal")??""),country:String(a.get("country")??"")};const n=[];let r=0;for(;a.has(`email_${r}`);)n.push(String(a.get(`email_${r}`)??"")),r++;n.length&&(e.state.editingContact.emails=n);const i=[];for(r=0;a.has(`phone_value_${r}`);)i.push({type:String(a.get(`phone_type_${r}`)??"other"),value:String(a.get(`phone_value_${r}`)??"")}),r++;i.length&&(e.state.editingContact.phones=i);const l=[];for(r=0;a.has(`custom_label_${r}`)||a.has(`custom_value_${r}`);)l.push({label:String(a.get(`custom_label_${r}`)??""),value:String(a.get(`custom_value_${r}`)??"")}),r++;e.state.editingContact.custom=l}function qs(e,t){const a=new FormData(t),s=[];let n=0;for(;a.has(`email_${n}`);){const o=String(a.get(`email_${n}`)??"").trim();o&&s.push(o),n++}const r=[];for(n=0;a.has(`phone_value_${n}`);){const o=String(a.get(`phone_value_${n}`)??"").trim();o&&r.push({type:String(a.get(`phone_type_${n}`)??"other"),value:o}),n++}const i=[];for(n=0;a.has(`custom_label_${n}`)||a.has(`custom_value_${n}`);){const o=String(a.get(`custom_label_${n}`)??"").trim(),c=String(a.get(`custom_value_${n}`)??"").trim();(o||c)&&i.push({label:o,value:c}),n++}const l={firstname:String(a.get("firstname")??"").trim(),lastname:String(a.get("lastname")??"").trim(),fullname:String(a.get("fullname")??"").trim(),org:String(a.get("org")??"").trim(),title:String(a.get("title")??"").trim(),emails:s,phones:r,address:{street:String(a.get("street")??"").trim(),city:String(a.get("city")??"").trim(),region:String(a.get("region")??"").trim(),postal:String(a.get("postal")??"").trim(),country:String(a.get("country")??"").trim()},url:String(a.get("url")??"").trim(),note:String(a.get("note")??"").trim(),birthday:(()=>{const o=String(a.get("birthday")??"").trim();return o&&/^\d{4}-\d{2}-\d{2}/.test(o)?o.slice(0,10):null})(),custom:i};return e.state.removePhotoPending?l.removePhoto=!0:e.state.photoBase64Pending&&(l.photoBase64=e.state.photoBase64Pending),l}function Y(e){const{state:t,root:a}=e,s=a.querySelector('[data-form="edit-event"]');s&&t.editingEvent&&e.syncEditingEventFromForm(s);const n=a.querySelector('[data-form="task"]');n&&t.editingTask&&e.syncEditingTaskFromForm(n);const r=a.querySelector('[data-form="note"]');r&&t.editingNote&&e.syncEditingNoteFromForm(r),t.editingContact&&Oe(e.contactsHost)}async function Bs(e,t,a,s){var c,p,m;const{state:n,root:r,render:i,setFlash:l,clearFlash:o}=e;if(t==="toggle-cal"){const u=Number(a.dataset.id);if(!Number.isFinite(u))return!0;s.stopPropagation(),e.toggleCalendarSelected(u),n.calendarSelectionSeeded=!0,n.busy=!0,o(),i();try{await e.loadMonthEvents()}catch(b){l("error",b instanceof Error?b.message:"Failed to load calendar")}finally{n.busy=!1,i()}return!0}if(t==="select-cal"){const u=Number(a.dataset.id);if(!Number.isFinite(u))return!0;n.selectedIds.includes(u)||(n.selectedIds=[...n.selectedIds,u]),n.selectedId=u,n.calendarSelectionSeeded=!0,n.busy=!0,o(),i();try{await e.loadMonthEvents()}catch(b){l("error",b instanceof Error?b.message:"Failed to load calendar")}finally{n.busy=!1,i()}return!0}if(t==="edit-cal"){const u=Number(a.dataset.id);if(!Number.isFinite(u)||!n.calendars.find(y=>y.id===u&&y.canShare))return!0;n.selectedId=u,n.selectedIds.includes(u)||(n.selectedIds=[...n.selectedIds,u]),n.calModalOpen=!0,n.deleteConfirmId=null,n.busy=!0,o(),i();try{await e.loadShares(u),await e.loadMonthEvents()}catch(y){l("error",y instanceof Error?y.message:"Failed to open calendar")}finally{n.busy=!1,i()}return!0}if(t==="close-cal-modal")return n.calModalOpen=!1,i(),!0;if(t==="open-create-cal-modal")return n.createCalModalOpen=!0,n.calModalOpen=!1,n.deleteConfirmId=null,o(),i(),!0;if(t==="close-create-cal-modal")return n.createCalModalOpen=!1,o(),i(),!0;if(t==="delete-cal"){const u=Number(a.dataset.id);return!Number.isFinite(u)||!n.calendars.find(y=>y.id===u&&y.canShare)||(n.deleteConfirmId=u,n.calModalOpen=!1,o(),i()),!0}if(t==="cancel-delete-cal")return n.deleteConfirmId=null,i(),!0;if(t==="confirm-delete-cal"){const u=Number(a.dataset.id),b=r.querySelector("#delete-cal-confirm");if(!Number.isFinite(u)||!(b!=null&&b.checked))return!0;n.busy=!0,o(),i();try{if(await w.deleteCalendar(u),n.selectedId===u&&(n.selectedId=null),n.selectedIds=n.selectedIds.filter(y=>y!==u),n.deleteConfirmId=null,n.calModalOpen=!1,n.shares=[],n.monthEvents=[],await e.loadHome(),n.selectedId===null){const y=e.pickDefaultCalendar();y?(n.selectedId=y.id,n.selectedIds.includes(y.id)||(n.selectedIds=[...n.selectedIds,y.id]),await e.loadMonthEvents()):n.selectedIds.length>0&&(n.selectedId=n.selectedIds[0],await e.loadMonthEvents())}l("success","Calendar deleted")}catch(y){l("error",y instanceof Error?y.message:"Delete failed")}finally{n.busy=!1,i()}return!0}if(t==="month-today"){const u=new Date;n.monthCursor={y:u.getFullYear(),m:u.getMonth()},n.monthExpandDay=null,n.busy=!0,i();try{await e.loadMonthEvents()}finally{n.busy=!1,i()}return!0}if(t==="month-prev"||t==="month-next"){const u=t==="month-prev"?-1:1,b=new Date(n.monthCursor.y,n.monthCursor.m+u,1);n.monthCursor={y:b.getFullYear(),m:b.getMonth()},n.monthExpandDay=null,n.busy=!0,i();try{await e.loadMonthEvents()}finally{n.busy=!1,i()}return!0}if(t==="open-event"){s.stopPropagation();const u=Number(a.dataset.instance),b=a.dataset.uri??"";if(!Number.isFinite(u)||!b)return!0;n.busy=!0,o(),i();try{const y=await w.getEvent(u,b);n.editingEvent={...y.event,repeat:y.event.repeat??e.defaultRepeat()},n.creatingEvent=!1,n.eventModalOpen=!0,n.eventDtPicker=null,n.calModalOpen=!1,n.deleteConfirmId=null}catch(y){l("error",y instanceof Error?y.message:"Failed to open event")}finally{n.busy=!1,i()}return!0}if(t==="open-event-day"){s.stopPropagation();const u=a.dataset.day??"";return n.monthExpandDay=n.monthExpandDay===u?null:u,i(),!0}if(t==="new-event-day"){const u=s.target;if((c=u==null?void 0:u.closest)!=null&&c.call(u,".month-event, .month-event-more"))return!0;const b=a.dataset.day??"";if(!/^\d{4}-\d{2}-\d{2}$/.test(b))return!0;if(n.selectedId===null)return l("error","Select a calendar first"),i(),!0;const y=n.calendars.find(f=>f.id===n.selectedId);return!y||y.readOnly||!(y.canShare||y.access==="readwrite")?(l("error","This calendar is read-only"),i(),!0):(n.creatingEvent=!0,n.editingEvent=e.blankEventForDay(b,n.selectedId),n.eventModalOpen=!0,n.eventDtPicker=null,n.calModalOpen=!1,n.deleteConfirmId=null,o(),i(),!0)}if(t==="close-event-modal")return n.eventModalOpen=!1,n.editingEvent=null,n.creatingEvent=!1,n.eventDtPicker=null,o(),i(),!0;if(t==="dt-open"){const u=a.dataset.dtField||"";if(!u)return!0;if(Y(e),((p=n.eventDtPicker)==null?void 0:p.field)===u)n.eventDtPicker=null;else{const b=a.dataset.dtDateOnly==="1",y=a.dataset.dtClear!=="0",f=a.dataset.dtName||u;let $=e.getDtFieldCurrentValue(u);!$&&(u==="due"||u==="dtstart"||u==="bulk-due")&&($=Ue().start);const k=ve($||N(new Date)),[S,v]=k.date.split("-").map(Number);n.eventDtPicker={field:u,viewY:S,viewM:(v||1)-1,dateOnly:b,allowClear:y,name:f}}return i(),!0}if(t==="dt-month-prev"||t==="dt-month-next"){if(!n.eventDtPicker)return!0;Y(e);const u=t==="dt-month-prev"?-1:1,b=new Date(n.eventDtPicker.viewY,n.eventDtPicker.viewM+u,1);return n.eventDtPicker={...n.eventDtPicker,viewY:b.getFullYear(),viewM:b.getMonth()},i(),!0}if(t==="dt-set-month"){if(!n.eventDtPicker)return!0;Y(e);const b=Number(a.value);return!Number.isFinite(b)||b<0||b>11||(n.eventDtPicker={...n.eventDtPicker,viewM:b},i()),!0}if(t==="dt-set-year"){if(!n.eventDtPicker)return!0;Y(e);const b=Number(a.value);return!Number.isFinite(b)||b<1||b>9999||(n.eventDtPicker={...n.eventDtPicker,viewY:b},i()),!0}if(t==="dt-pick-day"){if(!n.eventDtPicker)return!0;const u=n.eventDtPicker.field,b=a.dataset.day??"";if(!/^\d{4}-\d{2}-\d{2}$/.test(b))return!0;Y(e);const y=n.eventDtPicker.dateOnly;if(y)e.setDtFieldValue(u,b),n.eventDtPicker=null;else{const f=e.getDtFieldCurrentValue(u),$=ve(f||Ue(b).start).hm;e.setDtFieldValue(u,`${b}T${$}`),n.eventDtPicker={...n.eventDtPicker,viewY:Number(b.slice(0,4)),viewM:Number(b.slice(5,7))-1}}if(u==="start"&&n.editingEvent&&!y&&n.editingEvent.end){const f=new Date(String(n.editingEvent.start)),$=new Date(String(n.editingEvent.end));!Number.isNaN(f.getTime())&&!Number.isNaN($.getTime())&&$<=f&&e.setDtFieldValue("end",Q(new Date(f.getTime()+3600*1e3)))}return i(),!0}if(t==="dt-pick-time"){if(!n.eventDtPicker||n.eventDtPicker.dateOnly)return!0;const u=n.eventDtPicker.field,b=a.dataset.hm??"";if(!/^\d{2}:\d{2}$/.test(b))return!0;Y(e);const y=e.getDtFieldCurrentValue(u)||Ue().start,$=`${ve(y).date}T${b}`;if(e.setDtFieldValue(u,$),u==="start"&&n.editingEvent){n.editingEvent={...n.editingEvent,allDay:!1};const k=n.editingEvent.end?ve(String(n.editingEvent.end)):null,S=new Date($);(!k||new Date(`${k.date}T${k.hm}`)<=S)&&e.setDtFieldValue("end",Q(new Date(S.getTime()+3600*1e3)))}return n.eventDtPicker=null,i(),!0}if(t==="dt-today"){if(!n.eventDtPicker)return!0;const u=n.eventDtPicker.field;Y(e);const b=N(new Date);if(n.eventDtPicker.dateOnly)e.setDtFieldValue(u,b);else{const y=Ue(b);u==="start"?(e.setDtFieldValue("start",y.start),n.editingEvent&&!n.editingEvent.end&&e.setDtFieldValue("end",y.end)):u==="end"?e.setDtFieldValue("end",y.end):e.setDtFieldValue(u,y.start)}return n.eventDtPicker=null,i(),!0}if(t==="dt-clear"){if(!n.eventDtPicker||!n.eventDtPicker.allowClear)return!0;const u=n.eventDtPicker.field;return Y(e),e.setDtFieldValue(u,null),n.eventDtPicker=null,i(),!0}if(t==="event-allday-toggle"){if(!n.editingEvent)return!0;const u=r.querySelector('[data-form="edit-event"]'),b=a.checked;if(u){const y=new FormData(u),f=String(y.get("start")??n.editingEvent.start??""),$=String(y.get("end")??n.editingEvent.end??"")||null;let k=f,S=$;if(b){const v=$s(f,$);k=v.start,S=v.end}else{const v=f.slice(0,10),g=($||f).slice(0,10),D=_t(v,g);k=D.start,S=D.end}n.editingEvent={...n.editingEvent,summary:String(y.get("summary")??n.editingEvent.summary),description:String(y.get("description")??n.editingEvent.description),location:String(y.get("location")??n.editingEvent.location),instanceId:Number(y.get("instanceId"))||n.editingEvent.instanceId,allDay:b,start:k,end:S,repeat:xe(y)}}else n.editingEvent={...n.editingEvent,allDay:b};return n.eventDtPicker=null,i(),!0}if(t==="event-repeat-freq"||t==="event-repeat-end"){if(!n.editingEvent)return!0;const u=r.querySelector('[data-form="edit-event"]');if(!u)return!0;const b=new FormData(u),y=u.querySelector('input[name="allDay"]'),f=xe(b);return n.editingEvent={...n.editingEvent,summary:String(b.get("summary")??n.editingEvent.summary),description:String(b.get("description")??n.editingEvent.description),location:String(b.get("location")??n.editingEvent.location),instanceId:Number(b.get("instanceId"))||n.editingEvent.instanceId,allDay:(y==null?void 0:y.checked)??n.editingEvent.allDay,start:String(b.get("start")??n.editingEvent.start??""),end:String(b.get("end")??n.editingEvent.end??"")||null,repeat:f,hasRrule:!!String(b.get("repeatFreq")??"").trim()},f.freq&&f.endMode==="until"&&((m=n.eventDtPicker)==null?void 0:m.field)==="end"&&(n.eventDtPicker=null),i(),!0}if(t==="delete-event"){if(!n.editingEvent||!n.editingEvent.canWrite||n.creatingEvent)return!0;const u=String(n.editingEvent.summary||"this event").trim()||"this event";return n.confirmDelete={scope:"event",title:"Delete event",message:`Delete “${u}”?`,detail:"CalDAV clients will sync the removal. This cannot be undone."},i(),!0}if(t==="revoke"){const u=a.dataset.href??"";return!u||n.selectedId===null||(n.confirmDelete={scope:"revoke-share",title:"Revoke share",message:"Revoke access for this user?",detail:"They will lose this calendar until you share it again.",href:u},i()),!0}if(t==="export-cal"){s.stopPropagation();const u=a.dataset.id,b=u!==void 0&&u!==""?Number(u):n.selectedId;if(b===null||Number.isNaN(b))return!0;n.busy=!0,o(),i();try{const{blob:y,filename:f}=await w.exportCalendar(b),$=await e.saveBlobAsFile(y,f);$==="cancelled"?l("info","Export cancelled"):$==="saved"?l("success",`Saved ${f}`):l("success",`Download started: ${f}`)}catch(y){l("error",y instanceof Error?y.message:"Export failed")}finally{n.busy=!1,i()}return!0}return!1}async function Ba(e){const t=await w.notes({q:e.state.noteSearch,sort:e.state.noteSort,order:e.state.noteOrder});e.state.notes=t.notes,e.state.noteCalendars=t.calendars,e.state.selectedNoteKey!==null&&!e.state.notes.some(a=>`${a.instanceId}|${a.uri}`===e.state.selectedNoteKey)&&(e.state.selectedNoteKey=null,e.state.creatingNote||(e.state.editingNote=null))}function L(e,t){return`${e}|${t}`}function Vs(e){const t=e.state.notes.length===0?`<tr class="contacts-empty-row"><td colspan="3" class="muted">${e.state.noteSearch?"No notes match your search.":"No notes yet. Add one below."}</td></tr>`:e.state.notes.map(r=>{const i=L(r.instanceId,r.uri),l=!e.state.creatingNote&&i===e.state.selectedNoteKey?" is-selected":"",o=(r.description||"").replace(/\s+/g," ").slice(0,80);return`<tr class="contact-table-row${l}" data-action="select-note" data-instance="${r.instanceId}" data-uri="${d(r.uri)}" tabindex="0" role="button">
              ...
              <td class="col-note-date muted small">${d(Ca(r.dtstart))}</td>
    ...
    <section class="stack items-edit-panel">
      ${n}
  ...
  </div>`}function Hs(e,t){if(!e.state.editingNote)return;const a=new FormData(t),s=String(a.get("dtstart")??"").trim(),n=a.get("instanceId"),r=n!==null&&String(n)!==""?Number(n):e.state.editingNote.instanceId;e.state.editingNote={...e.state.editingNote,instanceId:Number.isFinite(r)&&r>0?r:e.state.editingNote.instanceId,summary:String(a.get("summary")??e.state.editingNote.summary),description:String(a.get("description")??e.state.editingNote.description),dtstart:s?new Date(s).toISOString():null}}async function Ks(e,t){const a=new FormData(t),s=String(a.get("summary")??"").trim(),n=String(a.get("description")??"").trim(),r=String(a.get("dtstart")??"").trim(),i=r?new Date(r).toISOString():null;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.creatingNote){const l=Number(a.get("instanceId"));if(!Number.isFinite(l)||l<=0)throw new Error("Select a calendar");const o=await w.createNote({instanceId:l,summary:s,description:n,dtstart:i});e.state.creatingNote=!1,e.state.selectedNoteKey=L(o.note.instanceId,o.note.uri),e.state.editingNote=o.note,e.setFlash("success",ae("Note",o.note.summary||s,"created"))}else if(e.state.editingNote){const l=await w.updateNote(e.state.editingNote.instanceId,e.state.editingNote.uri,{summary:s,description:n,dtstart:i});e.state.editingNote=l.note,e.state.selectedNoteKey=L(l.note.instanceId,l.note.uri),e.setFlash("success",ae("Note",l.note.summary||s,"saved"))}await Ba(e)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function zs(e,t,a,s){var o;const{state:n,render:r,setFlash:i,clearFlash:l}=e;if(t==="sort-note"){const c=a.dataset.sort||"";if(!c)return!0;n.noteSort===c?n.noteOrder=n.noteOrder==="asc"?"desc":"asc":(n.noteSort=c,n.noteOrder="asc"),n.busy=!0,r();try{await e.loadNotes()}catch(p){i("error",p instanceof Error?p.message:"Sort failed")}finally{n.busy=!1,r()}return!0}if(t==="select-note"){const c=Number(a.dataset.instance),p=a.dataset.uri??"";if(!Number.isFinite(c)||!p)return!0;const m=n.notes.find(u=>u.instanceId===c&&u.uri===p)??null;return n.creatingNote=!1,n.selectedNoteKey=e.itemKey(c,p),n.editingNote=m?{...m}:null,l(),r(),!0}if(t==="new-note")return n.creatingNote=!0,n.selectedNoteKey=null,n.editingNote={uri:"",instanceId:((o=n.noteCalendars[0])==null?void 0:o.id)??0,calendarId:0,calendarName:"",calendarUri:"",summary:"",description:"",dtstart:new Date().toISOString(),lastmodified:0,readOnly:!1,canWrite:!0},l(),r(),!0;if(t==="cancel-note")return n.creatingNote=!1,n.editingNote=null,n.selectedNoteKey=null,r(),!0;if(t==="delete-note"){if(!n.editingNote||n.creatingNote)return!0;const c=String(n.editingNote.summary||"this note").trim()||"this note";return n.confirmDelete={scope:"note",title:"Delete note",message:`Delete “${c}”?`,detail:"CalDAV clients will sync the removal. This cannot be undone."},r(),!0}return!1}async function st(e){const t=await w.tasks({q:e.state.taskSearch,sort:e.state.taskSort,order:e.state.taskOrder});e.state.tasks=t.tasks,e.state.taskCalendars=t.calendars;const a=new Set(e.state.tasks.map(s=>L(s.instanceId,s.uri)));e.state.checkedTaskKeys=e.state.checkedTaskKeys.filter(s=>a.has(s)),e.state.selectedTaskKey!==null&&!e.state.tasks.some(s=>`${s.instanceId}|${s.uri}`===e.state.selectedTaskKey)&&(e.state.selectedTaskKey=null,e.state.creatingTask||(e.state.editingTask=null))}function js(e,t){const a=new Map;for(const p of t)p.uid&&a.set(p.uid,p);const s=new Map(t.map((p,m)=>[L(p.instanceId,p.uri),m])),n=new Map,r=[];for(const p of t){const m=p.parentUid;if(m&&a.has(m)&&m!==p.uid){const u=n.get(m)??[];u.push(p),n.set(m,u)}else r.push(p)}const i=(p,m)=>(s.get(L(p.instanceId,p.uri))??0)-(s.get(L(m.instanceId,m.uri))??0);r.sort(i);for(const[,p]of n)p.sort(i);const l=[],o=new Set,c=(p,m)=>{const u=p.uid||L(p.instanceId,p.uri);if(!o.has(u)){o.add(u),l.push({task:p,depth:Math.min(m,8)});for(const b of n.get(p.uid)??[])c(b,m+1);o.delete(u)}};for(const p of r)c(p,0);for(const p of t)l.some(m=>m.task===p)||l.push({task:p,depth:0});return l}function Ws(e,t){const a=new Set([t]);if(!t)return a;let s=!0;for(;s;){s=!1;for(const n of e.state.tasks)n.parentUid&&a.has(n.parentUid)&&n.uid&&!a.has(n.uid)&&(a.add(n.uid),s=!0)}return a}function Js(e,t,a){const s=t.instanceId,n=a||!t.uid?new Set:Ws(e,t.uid),r=e.state.tasks.filter(o=>o.uid&&o.instanceId===s&&!n.has(o.uid)&&o.uid!==t.uid),i=t.parentUid||"",l=['<option value="">None (top-level)</option>',...r.map(o=>`<option value="${d(o.uid)}" ${o.uid===i?"selected":""}>${d(o.summary||o.uid)}</option>`)];if(i&&!r.some(o=>o.uid===i)){const o=e.state.tasks.find(c=>c.uid===i);l.push(`<option value="${d(i)}" selected>${d((o==null?void 0:o.summary)||i)} (current)</option>`)}return l.join("")}function Va(e){const t=new Set(e.state.checkedTaskKeys);return e.state.tasks.filter(a=>t.has(L(a.instanceId,a.uri))&&a.canWrite&&!a.readOnly)}function Ys(e){const t=f=>({"NEEDS-ACTION":"To do","IN-PROCESS":"In progress",COMPLETED:"Done",CANCELLED:"Cancelled"})[f]||f,a=js(e,e.state.tasks),s=e.state.tasks.filter(f=>f.canWrite&&!f.readOnly).map(f=>L(f.instanceId,f.uri)),n=s.length>0&&s.every(f=>e.state.checkedTaskKeys.includes(f)),r=e.state.checkedTaskKeys.length>0,l=Va(e).length,o=e.state.tasks.length===0?`<tr class="contacts-empty-row"><td colspan="6" class="muted">${e.state.taskSearch?"No tasks match your search.":"No tasks yet. Add one below."}</td></tr>`:a.map(({task:f,depth:$})=>{const k=L(f.instanceId,f.uri),S=!e.state.creatingTask&&k===e.state.selectedTaskKey?" is-selected":"",v=e.state.checkedTaskKeys.includes(k),g=f.status==="COMPLETED"?"badge-ok":f.status==="CANCELLED"?"":"badge-admin",D=$>0?` style="--task-depth:${$}"`:"",P=$>0?'<span class="task-subtask-marker" aria-hidden="true">↳</span>':"",F=f.canWrite&&!f.readOnly;return`<tr class="contact-table-row task-row${$>0?" is-subtask":""}${S}${v?" is-checked":""}" data-action="select-task" data-instance="${f.instanceId}" data-uri="${d(f.uri)}" tabindex="0" role="button"${D}>
              ...
              <td class="col-task-due muted small">${d(Ca(f.due))}</td>
  ...
  </div>`}function Gs(e,t){if(!e.state.editingTask)return;const a=new FormData(t),s=String(a.get("due")??"").trim(),n=a.get("instanceId"),r=n!==null&&String(n)!==""?Number(n):e.state.editingTask.instanceId,i=String(a.get("parentUid")??"").trim();e.state.editingTask={...e.state.editingTask,instanceId:Number.isFinite(r)&&r>0?r:e.state.editingTask.instanceId,summary:String(a.get("summary")??e.state.editingTask.summary),description:String(a.get("description")??e.state.editingTask.description),status:String(a.get("status")??e.state.editingTask.status),due:s?new Date(s).toISOString():null,priority:Number(a.get("priority")??e.state.editingTask.priority??0),percent:Number(a.get("percent")??e.state.editingTask.percent??0),parentUid:i===""?null:i}}async function Qs(e,t){var r,i;const a=Va(e);if(a.length===0){e.setFlash("error","No writable tasks selected"),e.render();return}const s=a.map(l=>({instanceId:l.instanceId,uri:l.uri}));if(t==="bulk-task-delete"){e.state.busy=!0,e.clearFlash(),e.render();try{const l=await w.bulkTasks({op:"delete",items:s});e.state.checkedTaskKeys=[],e.state.selectedTaskKey&&a.some(o=>L(o.instanceId,o.uri)===e.state.selectedTaskKey)&&(e.state.selectedTaskKey=null,e.state.editingTask=null,e.state.creatingTask=!1),await st(e),l.failed>0?e.setFlash("error",`Deleted ${l.ok}, failed ${l.failed}${l.errors[0]?`: ${l.errors[0]}`:""}`):e.setFlash("success",`Deleted ${l.ok} task${l.ok===1?"":"s"}`)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Bulk delete failed")}finally{e.state.busy=!1,e.render()}return}let n={};if(t==="bulk-task-status"){const l=e.root.querySelector("#bulk-task-status"),o=((r=l==null?void 0:l.value)==null?void 0:r.trim())??"";if(!o){e.setFlash("error","Choose a status to apply"),e.render();return}n={status:o}}else if(t==="bulk-task-due"){const l=e.state.bulkDueValue.trim();if(!l){e.setFlash("error","Choose a due date to apply"),e.render();return}const o=/^\d{4}-\d{2}-\d{2}$/.test(l)?new Date(l+"T00:00:00"):new Date((l.length===16,l));if(Number.isNaN(o.getTime())){e.setFlash("error","Invalid due date"),e.render();return}n={due:o.toISOString()}}else if(t==="bulk-task-clear-due")n={due:null};else if(t==="bulk-task-percent"){const l=e.root.querySelector("#bulk-task-percent"),o=((i=l==null?void 0:l.value)==null?void 0:i.trim())??"";if(o===""){e.setFlash("error","Enter a percent complete (0–100)"),e.render();return}const c=Number(o);if(!Number.isFinite(c)||c<0||c>100){e.setFlash("error","Percent must be between 0 and 100"),e.render();return}n={percent:Math.round(c)}}e.state.busy=!0,e.clearFlash(),e.render();try{const l=await w.bulkTasks({op:"update",items:s,fields:n});if(await st(e),e.state.editingTask&&!e.state.creatingTask){const c=L(e.state.editingTask.instanceId,e.state.editingTask.uri),p=e.state.tasks.find(m=>L(m.instanceId,m.uri)===c);p&&(e.state.editingTask={...p})}const o=t==="bulk-task-status"?"status":t==="bulk-task-due"||t==="bulk-task-clear-due"?"due date":"percent";l.failed>0?e.setFlash("error",`Updated ${o} on ${l.ok}, failed ${l.failed}${l.errors[0]?`: ${l.errors[0]}`:""}`):e.setFlash("success",`Updated ${o} on ${l.ok} task${l.ok===1?"":"s"}`)}catch(l){e.setFlash("error",l instanceof Error?l.message:"Bulk update failed")}finally{e.state.busy=!1,e.render()}}async function Xs(e,t){const a=new FormData(t),s=String(a.get("summary")??"").trim(),n=String(a.get("description")??"").trim(),r=String(a.get("status")??"NEEDS-ACTION"),i=String(a.get("due")??"").trim(),l=i?new Date(i).toISOString():null,o=Number(a.get("priority")??0),c=Number(a.get("percent")??0),p=String(a.get("parentUid")??"").trim(),m=p===""?null:p;e.state.busy=!0,e.clearFlash(),e.render();try{if(e.state.creatingTask){const u=Number(a.get("instanceId"));if(!Number.isFinite(u)||u<=0)throw new Error("Select a calendar");const b=await w.createTask({instanceId:u,summary:s,description:n,status:r,due:l,priority:o,percent:c,parentUid:m});e.state.creatingTask=!1,e.state.selectedTaskKey=L(b.task.instanceId,b.task.uri),e.state.editingTask=b.task,e.setFlash("success",ae(m?"Subtask":"Task",b.task.summary||s,"created"))}else if(e.state.editingTask){const u=await w.updateTask(e.state.editingTask.instanceId,e.state.editingTask.uri,{summary:s,description:n,status:r,due:l,priority:o,percent:c,parentUid:m});e.state.editingTask=u.task,e.state.selectedTaskKey=L(u.task.instanceId,u.task.uri),e.setFlash("success",ae("Task",u.task.summary||s,"saved"))}await st(e)}catch(u){e.setFlash("error",u instanceof Error?u.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function Zs(e,t,a,s){var o;const{state:n,render:r,setFlash:i,clearFlash:l}=e;if(t==="sort-task"){const c=a.dataset.sort||"";if(!c)return!0;n.taskSort===c?n.taskOrder=n.taskOrder==="asc"?"desc":"asc":(n.taskSort=c,n.taskOrder=c==="due"||c==="summary"?"asc":"desc"),n.busy=!0,r();try{await e.loadTasks()}catch(p){i("error",p instanceof Error?p.message:"Sort failed")}finally{n.busy=!1,r()}return!0}if(t==="select-task"){if(s.target.closest("[data-stop-row], .task-check"))return!0;const c=Number(a.dataset.instance),p=a.dataset.uri??"";if(!Number.isFinite(c)||!p)return!0;const m=n.tasks.find(u=>u.instanceId===c&&u.uri===p)??null;return n.creatingTask=!1,n.selectedTaskKey=e.itemKey(c,p),n.editingTask=m?{...m}:null,l(),r(),!0}if(t==="task-check"){s.preventDefault(),s.stopPropagation();const c=Number(a.dataset.instance),p=a.dataset.uri??"";if(!Number.isFinite(c)||!p)return!0;const m=e.itemKey(c,p),u=n.tasks.find(b=>e.itemKey(b.instanceId,b.uri)===m);return!u||!u.canWrite||u.readOnly||(n.checkedTaskKeys.includes(m)?n.checkedTaskKeys=n.checkedTaskKeys.filter(b=>b!==m):n.checkedTaskKeys=[...n.checkedTaskKeys,m],r()),!0}if(t==="task-select-all"){s.preventDefault();const c=n.tasks.filter(m=>m.canWrite&&!m.readOnly);return c.length>0&&c.every(m=>n.checkedTaskKeys.includes(e.itemKey(m.instanceId,m.uri)))?n.checkedTaskKeys=[]:n.checkedTaskKeys=c.map(m=>e.itemKey(m.instanceId,m.uri)),r(),!0}if(t==="bulk-task-clear")return n.checkedTaskKeys=[],r(),!0;if(t==="bulk-task-status"||t==="bulk-task-due"||t==="bulk-task-clear-due"||t==="bulk-task-percent"||t==="bulk-task-delete"){if(t==="bulk-task-delete"){const c=n.checkedTaskKeys.length;return c===0?(i("error","No tasks selected"),r(),!0):(n.confirmDelete={scope:"bulk-task",title:c===1?"Delete task":`Delete ${c} tasks`,message:c===1?"Delete the selected task?":`Delete ${c} selected tasks?`,detail:"CalDAV clients will sync the removal. This cannot be undone.",count:c},r(),!0)}return e.runBulkTaskAction(t),!0}if(t==="new-task")return n.creatingTask=!0,n.selectedTaskKey=null,n.editingTask={uri:"",instanceId:((o=n.taskCalendars[0])==null?void 0:o.id)??0,calendarId:0,calendarName:"",calendarUri:"",uid:"",parentUid:null,summary:"",description:"",status:"NEEDS-ACTION",due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},l(),r(),!0;if(t==="new-subtask"){if(!n.editingTask||n.creatingTask||!n.editingTask.uid||!n.editingTask.canWrite)return!0;const c=n.editingTask;return n.creatingTask=!0,n.selectedTaskKey=null,n.editingTask={uri:"",instanceId:c.instanceId,calendarId:c.calendarId,calendarName:c.calendarName,calendarUri:c.calendarUri,uid:"",parentUid:c.uid,summary:"",description:"",status:"NEEDS-ACTION",due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},l(),r(),!0}if(t==="cancel-task")return n.creatingTask=!1,n.editingTask=null,n.selectedTaskKey=null,r(),!0;if(t==="delete-task"){if(!n.editingTask||n.creatingTask)return!0;const c=String(n.editingTask.summary||"this task").trim()||"this task";return n.confirmDelete={scope:"task",title:"Delete task",message:`Delete “${c}”?`,detail:"CalDAV clients will sync the removal. This cannot be undone."},r(),!0}return!1}async function Bt(e,t){const a=await w.contacts(t,e.state.contactSearch);e.state.contacts=a.contacts,e.state.selectedContactUri!==null&&!e.state.contacts.some(s=>s.uri===e.state.selectedContactUri)&&(e.state.selectedContactUri=null,e.state.creatingContact||(e.state.editingContact=null,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1))}async function er(e,t){if(e.state.selectedAbId===null)return;const a=await w.getContact(e.state.selectedAbId,t);e.state.selectedContactUri=t,e.state.creatingContact=!1;const s=a.contact;e.state.editingContact={...s,emails:Array.isArray(s.emails)?s.emails:[],phones:Array.isArray(s.phones)?s.phones:[],custom:Array.isArray(s.custom)?s.custom:[],address:s.address??Ha(),birthday:s.birthday??null},e.state.photoPreview=s.photoDataUri??(s.hasPhoto&&e.state.selectedAbId!==null?`${w.contactPhotoUrl(e.state.selectedAbId,t)}?t=${Date.now()}`:null),e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.contactModalOpen=!0}function tr(e){e.state.creatingContact=!0,e.state.selectedContactUri=null,e.state.contactModalOpen=!0,e.state.editingContact={uri:"",displayname:"",firstname:"",lastname:"",fullname:"",org:"",title:"",emails:[""],phones:[{type:"cell",value:""}],address:{street:"",city:"",region:"",postal:"",country:""},birthday:null,url:"",note:"",custom:[],hasPhoto:!1,photoDataUri:null},e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1}function Ha(e){return{street:"",city:"",region:"",postal:"",country:""}}function ar(e,t){return new Promise((a,s)=>{const n=new FileReader;n.onload=()=>{const r=String(n.result??""),i=r.indexOf(",");a(i>=0?r.slice(i+1):r)},n.onerror=()=>s(new Error("Failed to read photo file")),n.readAsDataURL(t)})}async function nr(e,t){var s;const a=(s=t.files)==null?void 0:s[0];if(t.value="",!!a){if(a.size>2.5*1024*1024){e.setFlash("error","Photo is too large (max ~2 MB)"),e.render();return}try{const n=await ar(e,a);e.state.photoBase64Pending=n,e.state.photoPreview=`data:${a.type||"image/jpeg"};base64,${n}`,e.state.removePhotoPending=!1,e.render()}catch(n){e.setFlash("error",n instanceof Error?n.message:"Failed to read photo"),e.render()}}}async function sr(e,t){var n;if(e.state.selectedAbId===null)return;const a=(n=t.files)==null?void 0:n[0];if(t.value="",!a)return;const s=e.state.selectedAbId;e.state.abModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.stopImportElapsedTimer(),e.state.importProgress={kind:"contacts",fileName:a.name,fileSizeLabel:et(a.size),phase:"reading",readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},e.startImportElapsedTimer(),e.render();try{const r=await e.readFileTextWithProgress(a,o=>{if(!e.state.importProgress||e.state.importProgress.phase!=="reading")return;e.state.importProgress={...e.state.importProgress,readPercent:o};const c=e.root.querySelector(".import-progress-bar"),p=e.root.querySelector("[data-import-status-line]");c&&o!==null&&(c.classList.remove("is-indeterminate"),c.style.width=`${o}%`),p&&o!==null&&(p.textContent=`Reading file… ${o}%`)});e.setImportPhase("uploading",{readPercent:100}),e.setImportPhase("processing",{processPercent:0}),h.event("import.contacts.start",{file:a.name,bytes:a.size,abId:s});const i=await w.importAddressBook(s,r,o=>{e.applyServerImportProgress(o)}),l=e.formatImportResult(i);await e.loadHome(),e.state.selectedAbId===s&&await Bt(e,s),e.stopImportElapsedTimer(),e.setImportPhase("done",{ok:!0,resultMessage:`${l} (from “${a.name}”)`}),e.setFlash("success",`Import finished for “${a.name}”: ${l}.`)}catch(r){const i=r instanceof Error?r.message:"Import failed";e.stopImportElapsedTimer(),e.setImportPhase("error",{ok:!1,resultMessage:i}),e.setFlash("error",i)}finally{e.state.busy=!1,e.render()}}async function rr(e,t){if(e.state.selectedAbId===null)return;const a=qs(e,t),s=gt(a);e.state.busy=!0,e.clearFlash(),e.state.contactModalOpen=!0,e.render();try{if(e.state.creatingContact){const n=await w.createContact(e.state.selectedAbId,a);e.state.creatingContact=!1,e.state.selectedContactUri=n.contact.uri,e.state.editingContact=null,e.state.contactModalOpen=!1,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.eventDtPicker=null,e.setFlash("success",ae("Contact",gt(n.contact)||s,"created"))}else if(e.state.selectedContactUri){const n=await w.updateContact(e.state.selectedAbId,e.state.selectedContactUri,a);e.state.selectedContactUri=n.contact.uri,e.state.editingContact=null,e.state.contactModalOpen=!1,e.state.photoPreview=null,e.state.photoBase64Pending=null,e.state.removePhotoPending=!1,e.state.eventDtPicker=null,e.setFlash("success",ae("Contact",gt(n.contact)||s,"saved"))}try{await e.loadHome()}catch(n){if(console.error(n),e.state.selectedAbId!==null)try{await Bt(e,e.state.selectedAbId)}catch{}}}catch(n){e.setFlash("error",n instanceof Error?n.message:"Save failed")}finally{e.state.busy=!1,e.render()}}async function ir(e,t){const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??"").trim();if(s){e.state.busy=!0,e.clearFlash(),e.render();try{const r=await w.createAddressBook({displayname:s,description:n});e.state.selectedAbId=r.addressbook.id,e.state.selectedContactUri=null,e.state.editingContact=null,e.state.creatingContact=!1,e.state.contactSearch="",await e.loadHome(),e.setFlash("success",`Address book “${r.addressbook.displayname}” created`)}catch(r){e.setFlash("error",r instanceof Error?r.message:"Create failed")}finally{e.state.busy=!1,e.render()}}}async function lr(e,t){if(e.state.selectedAbId===null)return;const a=new FormData(t),s=String(a.get("displayname")??"").trim(),n=String(a.get("description")??"").trim();e.state.abModalOpen=!0,e.state.busy=!0,e.clearFlash(),e.render();try{await w.updateAddressBook(e.state.selectedAbId,{displayname:s,description:n}),await e.loadHome(),e.setFlash("success",ae("Address book",s,"updated"))}catch(r){e.setFlash("error",r instanceof Error?r.message:"Update failed")}finally{e.state.busy=!1,e.render()}}function or(e){const{state:t}=e,a=t.addressBooks.map(k=>`<div class="cal-row${k.id===t.selectedAbId?" is-selected":""}" data-action="select-ab" data-id="${k.id}" role="button" tabindex="0">
  ...
  </div>`}function fr(e){const{state:t,render:a}=e;e.unbindUserMenuOutside(),t.userMenuOpen&&e.bindUserMenuOutside(),Ze(t),t.eventDtPicker&&kn(t,a),e.unbindFilesUploadMenuOutside(),t.filesUploadMenuOpen&&e.bindFilesUploadMenuOutside(),Aa(e.filesHost),e.bindHolidaysToggle(),br(e)}function br(e){var r;const{state:t,root:a}=e;if(!t.listKeyboardFocus||t.activeTab!=="contacts"&&t.activeTab!=="tasks"&&t.activeTab!=="notes")return;const s=document.activeElement;if(s&&a.contains(s)&&s.matches("input:not([type=checkbox]), textarea, select")&&!s.closest("tr.contact-table-row[data-action]")||(r=s==null?void 0:s.closest)!=null&&r.call(s,"tr.contact-table-row[data-action]"))return;let n=null;if(t.activeTab==="contacts"&&t.selectedContactUri)n=a.querySelector(`tr[data-action="select-contact"][data-uri="${CSS.escape(t.selectedContactUri)}"]`);else if(t.activeTab==="tasks"&&t.selectedTaskKey){const i=t.selectedTaskKey.indexOf("|");if(i>0){const l=t.selectedTaskKey.slice(0,i),o=t.selectedTaskKey.slice(i+1);n=a.querySelector(`tr[data-action="select-task"][data-instance="${CSS.escape(l)}"][data-uri="${CSS.escape(o)}"]`)}}else if(t.activeTab==="notes"&&t.selectedNoteKey){const i=t.selectedNoteKey.indexOf("|");if(i>0){const l=t.selectedNoteKey.slice(0,i),o=t.selectedNoteKey.slice(i+1);n=a.querySelector(`tr[data-action="select-note"][data-instance="${CSS.escape(l)}"][data-uri="${CSS.escape(o)}"]`)}}if(!n){const i=t.activeTab==="contacts"?"select-contact":t.activeTab==="tasks"?"select-task":"select-note";n=a.querySelector(`tr.contact-table-row[data-action="${i}"]`)}n&&n.focus({preventScroll:!0})}async function gr(e,t,a,s){const{state:n,render:r,clearFlash:i,setFlash:l}=e;if(t==="confirm-delete-cancel")return Xt(n),r(),!0;if(t==="confirm-delete-ok"){const o=n.confirmDelete;if(!o)return r(),!0;const c=o.scope;if(Xt(n),c==="event"){if(!n.editingEvent||!n.editingEvent.canWrite||n.creatingEvent)return r(),!0;const p=n.editingEvent.instanceId,m=n.editingEvent.uri;n.busy=!0,i(),r();try{await w.deleteEvent(p,m),n.eventModalOpen=!1,n.editingEvent=null,await e.loadMonthEvents(),l("success","Event deleted")}catch(u){l("error",u instanceof Error?u.message:"Delete failed")}finally{n.busy=!1,r()}return!0}if(c==="task"){if(!n.editingTask||n.creatingTask)return r(),!0;n.busy=!0,i(),r();try{await w.deleteTask(n.editingTask.instanceId,n.editingTask.uri),n.selectedTaskKey=null,n.editingTask=null,await e.loadTasks(),l("success","Task deleted")}catch(p){l("error",p instanceof Error?p.message:"Delete failed")}finally{n.busy=!1,r()}return!0}if(c==="note"){if(!n.editingNote||n.creatingNote)return r(),!0;n.busy=!0,i(),r();try{await w.deleteNote(n.editingNote.instanceId,n.editingNote.uri),n.selectedNoteKey=null,n.editingNote=null,await e.loadNotes(),l("success","Note deleted")}catch(p){l("error",p instanceof Error?p.message:"Delete failed")}finally{n.busy=!1,r()}return!0}if(c==="contact"){if(n.selectedAbId===null||!n.selectedContactUri)return r(),!0;n.busy=!0,i(),n.contactModalOpen=!0,r();try{await w.deleteContact(n.selectedAbId,n.selectedContactUri),n.selectedContactUri=null,n.editingContact=null,n.creatingContact=!1,n.contactModalOpen=!1,n.eventDtPicker=null,n.photoPreview=null,await e.loadHome(),l("success","Contact deleted")}catch(p){l("error",p instanceof Error?p.message:"Delete failed")}finally{n.busy=!1,r()}return!0}if(c==="bulk-task")return await e.runBulkTaskAction("bulk-task-delete"),!0;if(c==="revoke-share"){const p=o.href??"";if(!p||n.selectedId===null)return r(),!0;n.calModalOpen=!0,n.busy=!0,i(),r();try{await w.revoke(n.selectedId,p),await e.loadShares(n.selectedId),l("success","Share revoked")}catch(m){l("error",m instanceof Error?m.message:"Revoke failed")}finally{n.busy=!1,r()}return!0}return r(),!0}if(t==="close-import-progress")return n.importProgress&&(n.importProgress.phase==="done"||n.importProgress.phase==="error")&&e.closeImportProgress(),!0;if(t==="logout"){n.busy=!0,h.event("logout");try{await w.logout()}catch{}return e.clearPortalSessionState(),i(),r(),!0}if(t==="info"){const o=a.dataset.info??"";return e.openInfoModal(o),!0}if(t==="info-close")return e.closeInfoModal(),!0;if(t==="flash-close")return i(),r(),!0;if(t==="user-menu-toggle")return s.stopPropagation(),n.userMenuOpen=!n.userMenuOpen,r(),!0;if(t==="user-menu-close")return n.userMenuOpen&&(n.userMenuOpen=!1,r()),!0;if(t==="tab"){const o=Vt(a.dataset.tab);return o&&(o==="admin"&&(n.adminPage="overview"),await e.activateTab(o)),!0}return!1}async function za(e,t){const a=t.target.closest("[data-action]");if(!a)return;const s=a.dataset.action;s&&(h.debug(`action:${s}`,{id:a.dataset.id,tab:a.dataset.tab,uri:a.dataset.uri}),!await gr(e,s,a,t)&&(s.startsWith("admin-")&&await ps(e.adminHost,s,a)||(s.startsWith("files-")||s==="close-files-upload-progress")&&await Vn(e.filesHost,s,a,t)||await Bs(e,s,a,t)||await Zs(e,s,a,t)||await zs(e,s,a)||await dr(e,s,a,t)))}const la=new WeakMap;function yr(e){if(la.has(e.root)){h.debug("portalEvents: already bound for root");return}la.set(e.root,!0),e.state.portalEventsBound=!0,e.state.escapeBound=!0;const{root:t}=e;t.addEventListener("click",a=>vr(e,a)),t.addEventListener("submit",a=>$r(e,a)),t.addEventListener("change",a=>kr(e,a)),t.addEventListener("input",a=>hr(e,a)),t.addEventListener("keydown",a=>Sr(e,a)),document.addEventListener("keydown",a=>Tr(e,a)),t.addEventListener("dragenter",a=>He(e,"enter",a)),t.addEventListener("dragover",a=>He(e,"over",a)),t.addEventListener("dragleave",a=>He(e,"leave",a)),t.addEventListener("drop",a=>He(e,"drop",a)),t.addEventListener("error",a=>Cr(e,a),!0),h.event("portalEvents.registered")}function vr(e,t){var n,r;const a=(r=(n=t.target)==null?void 0:n.closest)==null?void 0:r.call(n,"[data-action]");if(!a||!e.root.contains(a))return;const s=a.dataset.action??"";(s==="info"||s==="info-close")&&(t.preventDefault(),t.stopPropagation()),(s==="dt-set-month"||s==="dt-set-year")&&t.stopPropagation(),(s==="select-contact"||s==="select-task"||s==="select-note")&&(e.state.listKeyboardFocus=!0),h.debug("portalEvents.click",{action:s}),za(e,t)}function $r(e,t){var n,r;const a=(r=(n=t.target)==null?void 0:n.closest)==null?void 0:r.call(n,"form[data-form]");if(!a||!e.root.contains(a))return;const s=a.dataset.form??"";if(s)switch(t.preventDefault(),h.debug("portalEvents.submit",{form:s}),s){case"login":e.onLogin(a);return;case"share":e.onShare(a);return;case"edit-event":e.onSaveEvent(a);return;case"edit-cal":e.onEditCal(a);return;case"create-cal":e.onCreateCal(a);return;case"contact":e.onSaveContact(a);return;case"create-ab":e.onCreateAb(a);return;case"edit-ab":e.onEditAb(a);return;case"task":e.onSaveTask(a);return;case"note":e.onSaveNote(a);return;case"files-rename":qn(e.filesHost,a);return;case"files-transfer":wn(e.filesHost,a);return;case"files-mkdir":Bn(e.filesHost,a);return;case"admin-user-create":Xn(e.adminHost,a);return;case"admin-user-edit":Zn(e.adminHost,a);return;case"admin-cal":es(e.adminHost,a);return;case"admin-ab":ts(e.adminHost,a);return;case"admin-settings":is(e.adminHost,a);return;case"admin-database":ls(e.adminHost,a);return;default:h.debug("portalEvents.submit.unknown",{form:s})}}function kr(e,t){const a=t.target;if(!a||!e.root.contains(a))return;const{state:s,root:n,render:r}=e,i=a.closest("[data-action]"),l=(i==null?void 0:i.dataset.action)??"";if(l==="dt-set-month"||l==="dt-set-year"){t.stopPropagation(),h.debug("portalEvents.change",{action:l}),za(e,t);return}if(l==="admin-db-backend"&&a instanceof HTMLSelectElement){s.adminDbFormBackend=a.value==="pgsql"?"pgsql":"sqlite",r();return}if(l==="files-upload-pick-files"&&a instanceof HTMLInputElement){aa(e.filesHost,a,!1);return}if(l==="files-upload-pick-folder"&&a instanceof HTMLInputElement){aa(e.filesHost,a,!0);return}if(l==="import-cal"&&a instanceof HTMLInputElement){Os(e.calendarsHost,a);return}if(l==="import-create-cal"&&a instanceof HTMLInputElement){Ms(e.calendarsHost,a);return}if(l==="import-ab"&&a instanceof HTMLInputElement){e.calendarsHost.onImportContacts(a);return}if(l==="contact-photo"&&a instanceof HTMLInputElement){nr(e.contactsHost,a);return}if(a instanceof HTMLInputElement&&a.id==="delete-cal-confirm"){const o=n.querySelector("#delete-cal-submit");o&&(o.disabled=!a.checked||s.busy);return}if(a instanceof HTMLInputElement&&a.id==="delete-ab-confirm"){const o=n.querySelector("#delete-ab-submit");o&&(o.disabled=!a.checked||s.busy);return}if(a instanceof HTMLSelectElement&&(a.name==="repeatFreq"||a.name==="repeatEndMode")){const o=a.closest('[data-form="edit-event"]');if(o&&s.editingEvent){const c=new FormData(o);s.editingEvent={...s.editingEvent,repeat:xe(c),hasRrule:!!String(c.get("repeatFreq")??"").trim()},r()}return}if(a instanceof HTMLSelectElement&&a.name==="instanceId"){const o=a.closest('[data-form="task"]');if(o&&s.creatingTask&&s.editingTask){const p=Number(a.value);if(!Number.isFinite(p)||p<=0)return;e.syncEditingTaskFromForm(o);const m=s.editingTask.parentUid;s.editingTask={...s.editingTask,instanceId:p,parentUid:m&&s.tasks.some(u=>u.uid===m&&u.instanceId===p)?m:null},r();return}const c=a.closest('[data-form="note"]');if(c&&s.creatingNote&&s.editingNote){const p=Number(a.value);if(!Number.isFinite(p)||p<=0)return;e.syncEditingNoteFromForm(c),s.editingNote={...s.editingNote,instanceId:p},r();return}}if(a instanceof HTMLInputElement&&a.name==="holidays"&&a.closest('[data-form="create-cal"]')){qa(e.calendarsHost);return}if(a instanceof HTMLInputElement&&a.name==="color"){const o=a.closest("form"),c=o==null?void 0:o.querySelector('input[name="color_picker"]');if(c){let p=a.value.trim();p&&!p.startsWith("#")&&(p=`#${p}`),/^#[0-9A-Fa-f]{6}/.test(p)&&(c.value=p.slice(0,7),a.value=p.toUpperCase())}return}}function hr(e,t){var o;const a=t.target;if(!a||!e.root.contains(a))return;const{state:s,root:n,render:r,setFlash:i}=e;if(a instanceof HTMLInputElement&&a.name==="color_picker"){const c=a.closest("form"),p=c==null?void 0:c.querySelector('input[name="color"]');p&&(p.value=a.value.toUpperCase());return}const l=((o=a.closest("[data-action]"))==null?void 0:o.dataset.action)??"";if(l==="contact-search"&&a instanceof HTMLInputElement){s.listKeyboardFocus=!1,s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.contactSearch=c,(async()=>{try{s.selectedAbId!==null&&await e.loadContacts(s.selectedAbId),r()}catch(p){i("error",p instanceof Error?p.message:"Search failed"),r()}})()},250);return}if(l==="task-search"&&a instanceof HTMLInputElement){s.listKeyboardFocus=!1,s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.taskSearch=c,(async()=>{try{await e.loadTasks(),r()}catch(p){i("error",p instanceof Error?p.message:"Search failed"),r()}})()},250);return}if(l==="note-search"&&a instanceof HTMLInputElement){s.listKeyboardFocus=!1,s.searchTimer&&clearTimeout(s.searchTimer);const c=a.value;s.searchTimer=setTimeout(()=>{s.noteSearch=c,(async()=>{try{await e.loadNotes(),r()}catch(p){i("error",p instanceof Error?p.message:"Search failed"),r()}})()},250);return}if(l==="admin-db-confirm-input"&&a instanceof HTMLInputElement){s.adminDbConfirmText=a.value;const c=n.querySelector('[data-action="admin-db-confirm-save"]');c&&(c.disabled=s.busy||s.adminDbConfirmText.trim()!=="CONFIRM");return}if(l==="admin-reset-password"&&a instanceof HTMLInputElement){s.adminResetPassword=a.value;const c=n.querySelector('[data-action="admin-reset-confirm"]');c&&(c.disabled=s.busy||!s.adminResetConfirmChecked||s.adminResetPassword.trim()==="");return}}const oa='tr.contact-table-row[data-action="select-contact"], tr.contact-table-row[data-action="select-task"], tr.contact-table-row[data-action="select-note"]',da="tr.contact-table-row[data-action], .cal-row[data-action], .month-cell[data-action]";function wr(e){const{state:t,root:a}=e;let s="";if(t.activeTab==="contacts")s="select-contact";else if(t.activeTab==="tasks")s="select-task";else if(t.activeTab==="notes")s="select-note";else return[];return Array.from(a.querySelectorAll(`tr.contact-table-row[data-action="${s}"]`))}function Te(e){e.focus({preventScroll:!1}),e.scrollIntoView({block:"nearest"})}function Sr(e,t){const a=t.target;if(!a||!e.root.contains(a))return;const s=e.state.activeTab,n=s==="contacts"||s==="tasks"||s==="notes",r=a instanceof HTMLInputElement&&(a.dataset.action==="contact-search"||a.dataset.action==="task-search"||a.dataset.action==="note-search");if(!r&&a.closest("button, a, input, select, textarea, [contenteditable=true]")&&!a.matches(da)&&!a.matches(oa))return;if(n&&(t.key==="ArrowDown"||t.key==="ArrowUp"||t.key==="Home"||t.key==="End")){const l=wr(e);if(l.length===0)return;const o=a.closest(oa);if(e.state.listKeyboardFocus=!0,t.preventDefault(),!o||r){t.key==="ArrowDown"||t.key==="Home"?Te(l[0]):Te(l[l.length-1]);return}const c=l.indexOf(o);if(c<0)return;if(t.key==="Home"){Te(l[0]);return}if(t.key==="End"){Te(l[l.length-1]);return}const p=t.key==="ArrowDown"?l[c+1]:l[c-1];p&&Te(p);return}if(t.key!=="Enter"&&t.key!==" ")return;const i=a.closest(da);!i||!e.root.contains(i)||t.target!==i&&t.target.closest("button, a, input, select, textarea")||(t.preventDefault(),(i.dataset.action==="select-contact"||i.dataset.action==="select-task"||i.dataset.action==="select-note")&&(e.state.listKeyboardFocus=!0),h.debug("portalEvents.keydown.row",{action:i.dataset.action,key:t.key}),i.click())}function He(e,t,a){var o,c,p;const{state:s,root:n}=e;if(s.activeTab!=="files"||s.busy||s.filesUploadProgress||!Fn(a.dataTransfer))return;const r=(c=(o=a.target)==null?void 0:o.closest)==null?void 0:c.call(o,"[data-files-drop-target]");if(!r||!n.contains(r)){if(t==="leave"&&s.filesDropDepth>0){const m=a.relatedTarget;m&&m instanceof Node&&((p=n.querySelector("[data-files-drop-target]"))==null?void 0:p.contains(m))||(s.filesDropDepth=0,Dr(e))}return}if(t==="enter"){a.preventDefault(),a.stopPropagation(),s.filesDropDepth+=1,Ke(e,r,!0);return}if(t==="over"){a.preventDefault(),a.stopPropagation(),a.dataTransfer&&(a.dataTransfer.dropEffect="copy"),Ke(e,r,!0);return}if(t==="leave"){a.preventDefault(),a.stopPropagation();const m=a.relatedTarget;if(m&&r.contains(m))return;s.filesDropDepth=Math.max(0,s.filesDropDepth-1),s.filesDropDepth===0&&Ke(e,r,!1);return}a.preventDefault(),a.stopPropagation(),s.filesDropDepth=0,Ke(e,r,!1);const i=a.dataTransfer;if(!i||s.busy||s.filesUploadProgress)return;s.filesUploadMenuOpen=!1,e.unbindFilesUploadMenuOutside();const l=Pn(i);h.event("files.drop.snapshot",{handles:l.handlePromises.length,entries:l.entries.filter(Boolean).length,files:l.files.length}),(async()=>{try{const m=await An(l);if(h.event("files.drop.items",{count:m.length,sample:m.slice(0,8).map(u=>u.relativePath)}),m.length===0){e.setFlash("info","Nothing to upload from that drop"),e.render();return}await Nt(e.filesHost,m)}catch(m){e.setFlash("error",m instanceof Error?m.message:"Drop failed"),e.render()}})()}function Ke(e,t,a){if(e.state.filesUploadDropActive===a){t.classList.toggle("is-dragover",a);return}e.state.filesUploadDropActive=a,t.classList.toggle("is-dragover",a)}function Dr(e){e.state.filesUploadDropActive=!1,e.root.querySelectorAll("[data-files-drop-target].is-dragover").forEach(t=>{t.classList.remove("is-dragover")})}function Cr(e,t){const a=t.target;if(!(a instanceof HTMLImageElement)||!a.classList.contains("contact-avatar")||!a.dataset.avatarFallback||!a.isConnected)return;const s=a.dataset.avatarFallback||"?",n=document.createElement("span");n.className="contact-avatar contact-avatar-fallback",n.setAttribute("aria-hidden","true"),n.textContent=s,a.replaceWith(n)}function Tr(e,t){if(t.key!=="Escape")return;const{state:a,render:s}=e;if(a.importProgress&&(a.importProgress.phase==="done"||a.importProgress.phase==="error")){e.closeImportProgress();return}if(a.importProgress)return;if(a.filesUploadProgress&&(a.filesUploadProgress.phase==="done"||a.filesUploadProgress.phase==="error")){e.closeFilesUploadProgress();return}if(a.filesUploadProgress)return;if(a.filesUploadMenuOpen){a.filesUploadMenuOpen=!1,e.unbindFilesUploadMenuOutside(),s();return}if(a.userMenuOpen){a.userMenuOpen=!1,e.unbindUserMenuOutside(),s();return}if(a.filesUploadConflict!==null){Ye(e.filesHost,"cancel");return}if(a.filesRenamePath!==null||a.filesDeletePaths!==null||a.filesTransfer!==null||a.filesMkdirOpen){a.filesRenamePath=null,a.filesDeletePaths=null,e.resetFilesTransferTree(),a.filesMkdirOpen=!1,s();return}if(a.confirmDelete){a.confirmDelete=null,s();return}const n=e.root.querySelector("#info-modal");if(n&&!n.hidden){e.closeInfoModal();return}if(a.eventDtPicker){a.eventDtPicker=null,Ze(a),s();return}if(a.eventModalOpen){a.eventModalOpen=!1,a.editingEvent=null,a.creatingEvent=!1,a.eventDtPicker=null,s();return}if(a.contactModalOpen){a.contactModalOpen=!1,a.editingContact=null,a.creatingContact=!1,a.photoPreview=null,a.photoBase64Pending=null,a.removePhotoPending=!1,s();return}if(a.abModalOpen){a.abModalOpen=!1,s();return}if(a.calModalOpen||a.createCalModalOpen||a.deleteConfirmId!==null||a.deleteAbConfirmId!==null){a.calModalOpen=!1,a.createCalModalOpen=!1,a.deleteConfirmId=null,a.deleteAbConfirmId=null,s();return}if(a.adminUserCreateOpen||a.adminUserEditOpen||a.adminUserDeleteUsername!==null){a.adminUserCreateOpen=!1,a.adminUserEditOpen=!1,a.adminUserDeleteUsername=null,s();return}if(a.adminResetModalOpen){a.adminResetModalOpen=!1,s();return}if(a.adminDbConfirmOpen){a.adminDbConfirmOpen=!1,a.adminDbConfirmText="",a.adminDbPendingBody=null,s();return}(a.adminCalModal!==null||a.adminAbModal!==null||a.adminResourceDelete!==null)&&(a.adminCalModal=null,a.adminAbModal=null,a.adminResourceDelete=null,s())}function kt(e){const{state:t}=e;if(t.activeTab==="admin"&&(!e.userIsAdmin()||!e.adminUiEnabled())){t.activeTab=Xe(t),t.adminPage="overview",e.persistTab(t.activeTab);return}t.activeTab!=="admin"&&!z(t,t.activeTab)&&(t.activeTab=Xe(t),e.persistTab(t.activeTab))}async function Er(e,t,a={}){return Ia(e.adminHost,t,a)}async function ca(e,t,a={}){const{state:s,render:n,setFlash:r,clearFlash:i}=e;if(t==="admin"&&(!e.userIsAdmin()||!e.adminUiEnabled())&&(e.userIsAdmin()&&s.adminCapabilities&&!s.adminCapabilities.uiEnabled&&r("info","Portal Administration UI is disabled (portal_admin_ui_enabled)."),t=Xe(s)),t!=="admin"&&!z(s,t)&&(r("info","That section is disabled in system settings."),t=Xe(s)),t==="admin"){await e.activateAdminPage(s.adminPage||"overview",{...a,username:s.adminPage==="users"?s.adminSelectedUsername:null});return}s.activeTab=t,s.userMenuOpen=!1,s.listKeyboardFocus=!1,e.persistTab(t),h.event("tab",{tab:t}),t!=="calendars"&&(s.calModalOpen=!1,s.deleteConfirmId=null),t!=="contacts"&&(s.deleteAbConfirmId=null),a.clearFlash!==!1&&i(),s.busy=!0,n();try{t==="contacts"&&s.selectedAbId!==null?await e.loadContacts(s.selectedAbId):t==="calendars"?await e.loadMonthEvents():t==="tasks"?await e.loadTasks():t==="notes"?await e.loadNotes():t==="files"&&await e.loadFiles()}catch(l){h.warn("tab load failed",l instanceof Error?l.message:l),r("error",l instanceof Error?l.message:"Failed to load")}finally{s.busy=!1,n()}}async function Ee(e){const{state:t}=e;h.debug("loadHome");const[a,s,n]=await Promise.all([w.calendars(),w.directory().catch(()=>({users:[]})),w.addressbooks()]);if(t.calendars=a.calendars,t.directory=s.users,t.addressBooks=n.addressbooks,h.event("loadHome",{calendars:t.calendars.length,addressBooks:t.addressBooks.length,directory:t.directory.length}),t.holidayCountries.length===0)try{const r=await w.holidayCountries();t.holidayCountries=r.countries}catch{t.holidayCountries=[]}if(t.selectedIds=t.selectedIds.filter(r=>t.calendars.some(i=>i.id===r)),t.selectedId!==null&&!t.calendars.some(r=>r.id===t.selectedId)&&(t.selectedId=null,t.shares=[],t.calModalOpen=!1,t.deleteConfirmId=null),t.selectedIds.length===0)if(t.calendarSelectionSeeded)t.selectedId=null;else{const r=e.pickDefaultCalendar();r?(t.selectedIds=[r.id],t.selectedId=r.id):t.calendars.length>0&&(t.selectedIds=[t.calendars[0].id],t.selectedId=t.calendars[0].id),t.calendarSelectionSeeded=!0}else t.calendarSelectionSeeded=!0;t.selectedId===null&&t.selectedIds.length>0&&(t.selectedId=t.selectedIds[0]),t.selectedId!==null&&t.calModalOpen?await e.loadShares(t.selectedId):t.selectedId!==null&&(t.shares=[]),t.activeTab==="calendars"&&await e.loadMonthEvents(),t.selectedAbId!==null&&!t.addressBooks.some(r=>r.id===t.selectedAbId)&&(t.selectedAbId=null,t.contacts=[],t.selectedContactUri=null,t.editingContact=null,t.creatingContact=!1),t.deleteAbConfirmId!==null&&!t.addressBooks.some(r=>r.id===t.deleteAbConfirmId)&&(t.deleteAbConfirmId=null),t.selectedAbId===null&&t.addressBooks.length>0&&(t.selectedAbId=t.addressBooks[0].id),t.selectedAbId!==null&&t.activeTab==="contacts"&&await e.loadContacts(t.selectedAbId),t.activeTab==="tasks"&&await e.loadTasks(),t.activeTab==="notes"&&await e.loadNotes(),t.activeTab==="files"&&await e.loadFiles()}function Pr(e){const{state:t}=e;return xt(t.portalUi.timeFormat)}function Ar(e){const{state:t}=e;return Lt(t.portalUi.weekStart)}function Fr(e){const{state:t}=e;return Oa(t.portalUi.weekStart)}function ja(e,t,a){const{state:s}=e;return ys(t,a,s.portalUi.timeFormat)}function Ur(e,t,a,s,n){var c,p;const{state:r}=e,i=ve(a),l=((c=r.eventDtPicker)==null?void 0:c.viewY)??Number(i.date.slice(0,4)),o=((p=r.eventDtPicker)==null?void 0:p.viewM)??Number(i.date.slice(5,7))-1;return ks({field:t,value:a,dateOnly:s,allowClear:n,viewY:l,viewM:o,weekStart:r.portalUi.weekStart,timeFormat:r.portalUi.timeFormat})}function ht(e){hs(e.root)}function Pe(e,t){var b;const{state:a}=e,{field:s,name:n,label:r,value:i,dateOnly:l=!1,required:o,disabled:c,allowClear:p=!0}=t,m=((b=a.eventDtPicker)==null?void 0:b.field)===s,u=ja(e,i,l);return`<div class="dt-field${m?" is-open":""}" data-dt-id="${d(s)}">
    ...
    ${m&&!c?Ur(e,s,i,l,p):""}
  </div>`}function ua(e,t){var s,n,r,i,l,o,c,p;const{state:a}=e;return t==="start"?String(((s=a.editingEvent)==null?void 0:s.start)||""):t==="end"?String(((n=a.editingEvent)==null?void 0:n.end)||""):t==="until"?((i=(r=a.editingEvent)==null?void 0:r.repeat)==null?void 0:i.until)||$e((l=a.editingEvent)==null?void 0:l.start)||N(new Date):t==="due"?he((o=a.editingTask)==null?void 0:o.due):t==="dtstart"?he((c=a.editingNote)==null?void 0:c.dtstart):t==="bulk-due"?a.bulkDueValue:t==="birthday"?String(((p=a.editingContact)==null?void 0:p.birthday)||""):""}function ma(e,t,a){const{state:s}=e;if(t==="start"&&s.editingEvent){s.editingEvent={...s.editingEvent,start:a||""};return}if(t==="end"&&s.editingEvent){s.editingEvent={...s.editingEvent,end:a};return}if(t==="until"&&s.editingEvent){s.editingEvent={...s.editingEvent,repeat:{...s.editingEvent.repeat??e.defaultRepeat(),until:a,endMode:"until"}};return}if(t==="due"&&s.editingTask){if(a===null||a==="")s.editingTask={...s.editingTask,due:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(a))s.editingTask={...s.editingTask,due:new Date(a+"T00:00:00").toISOString()};else{const n=new Date((a.length===16,a));s.editingTask={...s.editingTask,due:Number.isNaN(n.getTime())?a:n.toISOString()}}return}if(t==="dtstart"&&s.editingNote){if(a===null||a==="")s.editingNote={...s.editingNote,dtstart:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(a))s.editingNote={...s.editingNote,dtstart:new Date(a+"T00:00:00").toISOString()};else{const n=new Date((a.length===16,a));s.editingNote={...s.editingNote,dtstart:Number.isNaN(n.getTime())?a:n.toISOString()}}return}if(t==="birthday"&&s.editingContact){s.editingContact={...s.editingContact,birthday:a&&/^\d{4}-\d{2}-\d{2}/.test(a)?a.slice(0,10):null};return}t==="bulk-due"&&(s.bulkDueValue=a||"")}function Ir(e,t){const{root:a}=e,s=yn[t];if(!s)return;const n=a.querySelector("#info-modal"),r=a.querySelector("#info-modal-title"),i=a.querySelector("#info-modal-body");if(!n||!r||!i)return;r.textContent=s.title,i.innerHTML=s.paragraphs.map(o=>`<p>${d(o)}</p>`).join(""),n.hidden=!1,document.body.classList.add("info-modal-open");const l=n.querySelector(".info-modal-close");l==null||l.focus()}function Or(e){const{root:t}=e,a=t.querySelector("#info-modal");a&&(a.hidden=!0,document.body.classList.remove("info-modal-open"))}async function Mr(e,t){const a=window;if(typeof a.showSaveFilePicker=="function")try{const i=await(await a.showSaveFilePicker({suggestedName:t})).createWritable();try{await i.write(e)}finally{await i.close()}return"saved"}catch(r){if(r instanceof DOMException&&r.name==="AbortError")return"cancelled"}const s=URL.createObjectURL(e),n=document.createElement("a");return n.href=s,n.download=t,n.rel="noopener",n.style.display="none",document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(s),n.remove()},6e4),"started"}function Nr(e){const t=e.querySelector('input[name="color_picker"]'),a=e.querySelector('input[name="color"]');!t||!a||(t.addEventListener("input",()=>{a.value=t.value.toUpperCase()}),a.addEventListener("change",()=>{let s=a.value.trim();s&&!s.startsWith("#")&&(s=`#${s}`),/^#[0-9A-Fa-f]{6}/.test(s)&&(t.value=s.slice(0,7),a.value=s.toUpperCase())}))}function xr(e){const t=rn({activeTab:cr(),adminPage:ur(),adminSelectedUsername:Ht().adminUsername??null});let a,s,n,r,i,l,o;function c(g,D){va(t,g,D)}function p(){dn(t)}function m(){const g=Gt(e);t.user?pr(o):Yt(e,t,(D,P)=>bt(t,D,P,{renderImportProgressModal:()=>Ve(n),renderFilesUploadProgressModal:()=>Be(a)})),fr(o),Qt(e,g),requestAnimationFrame(()=>{var D;ht(o),(D=e.querySelector(".dt-time.is-selected"))==null||D.scrollIntoView({block:"center"})})}function u(){te(n)}function b(){ke(a)}function y(){K(a)}function f(){Dt(t)}function $(){ee(a)}function k(){cn(t,{stopImportElapsedTimer:u,stopFilesUploadElapsedTimer:b,resetFilesTransferTree:y,unbindUserMenuOutside:f,unbindFilesUploadMenuOutside:$})}function S(g){un(t,{message:g,clearSession:k,render:m})}function v(){return{state:t,render:m,handleSessionExpired:S,clearPortalSessionState:k,normalizeActiveTab:()=>kt(o),persistTab:vt,loadHome:()=>Ee(o),loadAdminCapabilities:()=>Et(s),loadAdminDashboard:()=>tt(s),loadAdminUsers:()=>ce(s),loadAdminUserDetail:g=>j(s,g),loadAdminUserResources:g=>ue(s,g),loadAdminSystemSettings:()=>at(s),loadAdminDatabaseSettings:()=>nt(s),adminPageMeta:g=>ne(s,g),setFlash:c,clearFlash:p}}a={state:t,root:e,render:m,setFlash:c,clearFlash:p},s={state:t,root:e,render:m,setFlash:c,clearFlash:p,userIsAdmin:()=>de(t),adminUiEnabled:()=>Ne(t),persistTab:vt,activateTab:(g,D)=>ca(o,g,D),loadHome:()=>Ee(o),normalizeActiveTab:()=>kt(o)},n={state:t,root:e,render:m,setFlash:c,clearFlash:p,localeWeekStart:()=>Ar(o),localeDowLabels:()=>Fr(o),formatDtDisplay:(g,D)=>ja(o,g,D),timeFormatOpts:()=>Pr(o),renderPortalDateTimeField:g=>Pe(o,g),getDtFieldCurrentValue:g=>ua(o,g),setDtFieldValue:(g,D)=>ma(o,g,D),positionDtPopovers:()=>ht(o),renderFlashBanner:()=>wt(t),accessBadge:ia,formatImportResult:$t,loadHome:()=>Ee(o),onImportContacts:g=>sr(l,g)},r={state:t,root:e,render:m,setFlash:c,clearFlash:p,renderPortalDateTimeField:g=>Pe(o,g)},i={state:t,root:e,render:m,setFlash:c,clearFlash:p,renderPortalDateTimeField:g=>Pe(o,g)},l={state:t,root:e,render:m,setFlash:c,clearFlash:p,renderPortalDateTimeField:g=>Pe(o,g),stopImportElapsedTimer:()=>te(n),startImportElapsedTimer:()=>Na(n),setImportPhase:(g,D)=>Ie(n,g,D),applyServerImportProgress:g=>xa(n,g),readFileTextWithProgress:(g,D)=>_a(n,g,D),formatImportResult:$t,loadHome:()=>Ee(o)},o={state:t,root:e,render:m,setFlash:c,clearFlash:p,filesHost:a,adminHost:s,calendarsHost:n,notesHost:r,tasksHost:i,contactsHost:l,clearPortalSessionState:k,userIsAdmin:()=>de(t),adminUiEnabled:()=>Ne(t),normalizeActiveTab:()=>kt(o),persistTab:vt,activateTab:(g,D)=>ca(o,g,D),activateAdminPage:(g,D)=>Er(o,g,D),loadHome:()=>Ee(o),handleSessionExpired:S,loadFiles:()=>Z(a),loadShares:g=>Rt(n,g),loadMonthEvents:()=>ct(n),loadContacts:g=>Bt(l,g),loadTasks:()=>st(i),loadNotes:()=>Ba(r),loadAdminCapabilities:()=>Et(s),loadAdminDashboard:()=>tt(s),loadAdminUsers:()=>ce(s),loadAdminUserDetail:g=>j(s,g),loadAdminUserResources:g=>ue(s,g),loadAdminSystemSettings:()=>at(s),loadAdminDatabaseSettings:()=>nt(s),adminPageMeta:g=>ne(s,g),pickDefaultCalendar:()=>ws(n),toggleCalendarSelected:g=>Ds(n,g),blankEventForDay:(g,D)=>Fs(n,g,D),defaultRepeat:()=>qt(),itemKey:L,openContact:g=>er(l,g),startNewContact:()=>tr(l),emptyAddress:()=>Ha(),syncEditingEventFromForm:g=>Us(n,g),syncEditingTaskFromForm:g=>Gs(i,g),syncEditingNoteFromForm:g=>Hs(r,g),runBulkTaskAction:g=>Qs(i,g),shell:(g,D)=>bt(t,g,D,{renderImportProgressModal:()=>Ve(n),renderFilesUploadProgressModal:()=>Be(a)}),renderLogin:()=>Yt(e,t,(g,D)=>bt(t,g,D,{renderImportProgressModal:()=>Ve(n),renderFilesUploadProgressModal:()=>Be(a)})),renderFlashBanner:()=>wt(t),renderMonthGrid:()=>Es(n),renderEventModal:()=>As(n),renderImportProgressModal:()=>Ve(n),renderFilesUploadProgressModal:()=>Be(a),renderTasksTab:()=>Ys(i),renderNotesTab:()=>Vs(r),renderFilesTab:()=>Rn(a),renderAdminSection:()=>us(s),adminSubnavButtons:()=>Kn(s),renderPortalDateTimeField:g=>Pe(o,g),getDtFieldCurrentValue:g=>ua(o,g),setDtFieldValue:(g,D)=>ma(o,g,D),positionDtPopovers:()=>ht(o),accessBadge:ia,formatImportResult:$t,closeImportProgress:()=>Is(n),closeFilesUploadProgress:()=>Ta(a),resetFilesTransferTree:y,stopImportElapsedTimer:u,stopFilesUploadElapsedTimer:b,unbindUserMenuOutside:f,bindUserMenuOutside:()=>$n(t,m),unbindFilesUploadMenuOutside:$,bindFilesUploadMenuOutside:()=>In(a),onLogin:g=>bn(g,v()),onShare:g=>Ns(n,g),onSaveEvent:g=>xs(n,g),onEditCal:g=>Ls(n,g),onCreateCal:g=>_s(n,g),onSaveContact:g=>rr(l,g),onCreateAb:g=>ir(l,g),onEditAb:g=>lr(l,g),onSaveTask:g=>Xs(i,g),onSaveNote:g=>Ks(r,g),bindColorPair:Nr,bindImportInput:()=>void 0,bindHolidaysToggle:()=>Rs(n),bindContactPhotoInput:()=>void 0,bindFilesDom:()=>Aa(a),bindAdminDom:()=>void 0,saveBlobAsFile:Mr,openInfoModal:g=>Ir(o,g),closeInfoModal:()=>Or(o),captureScroll:()=>Gt(e),restoreScroll:g=>Qt(e,g)},yr(o),fn(v())}let se="",T=null,A=!1,q=null,J=null,X="sqlite",rt=!1;async function ut(e,t={}){const a={Accept:"application/json",...t.headers};t.body&&(a["Content-Type"]="application/json"),se&&t.method&&t.method!=="GET"&&(a["X-CSRF-Token"]=se);const s=await fetch(`/api/install${e}`,{credentials:"same-origin",...t,headers:a});let n;try{n=await s.json()}catch{throw new Error(`Request failed (${s.status})`)}if(!s.ok)throw new Error(n.error||`Request failed (${s.status})`);return n&&typeof n=="object"&&"data"in n&&n.data!==void 0?n.data:n}async function Kt(){var e;T=await ut("/status"),se=T.csrfToken||se,((e=T.defaults)==null?void 0:e.backend)==="pgsql"?X="pgsql":X="sqlite"}function Ae(e,t,a){return`<label class="check-row"><input type="checkbox" name="${d(e)}" ${t?"checked":""} ${A?"disabled":""} /> ${d(a)}</label>`}function Lr(){const e=T==null?void 0:T.permissions;return`<section class="card">
  ...
  </section>`}function _r(){const e=T==null?void 0:T.defaults;return`<section class="card">
    ...
    <form class="stack" data-form="initialize">
      <label>Server timezone
        <select name="timezone" required ${A?"disabled":""}>
          ${Fa((e==null?void 0:e.timezone)||"UTC")}
        </select>
      </label>
      <h3 class="admin-subsection-title">DAV services</h3>
  ...
  </section>`}function Rr(){const e=T==null?void 0:T.defaults,t=(T==null?void 0:T.pdoDrivers)||[],a=t.includes("sqlite"),s=t.includes("pgsql");return`<section class="card">
    <h2>Database</h2>
  ...
  </section>`}function qr(){return`<section class="card">
  ...
  </section>`}function Br(){return`<section class="card">
  ...
  </section>`}function Vr(){return`<section class="card card-danger-zone">
  ...
  </section>`}function B(){const e=document.getElementById("app");if(!e)return;const t=(T==null?void 0:T.step)||"permissions";let a="";T?t==="permissions"?a=Lr():t==="initialize"?a=_r():t==="database"?a=Rr():t==="upgrade"?a=qr():t==="done"?a=Br():t==="locked"?a=Vr():a=`<section class="card"><p>Unknown step: ${d(t)}</p></section>`:a='<section class="card"><p class="muted">Loading installer…</p></section>',e.innerHTML=`
  ...
  `,Hr()}function Hr(){var t,a,s,n,r,i;const e=document.getElementById("app");e&&((t=e.querySelector('[data-action="reload"]'))==null||t.addEventListener("click",()=>{Kr()}),(a=e.querySelector('[data-action="backend-change"]'))==null||a.addEventListener("change",l=>{X=l.target.value==="pgsql"?"pgsql":"sqlite",B()}),(s=e.querySelector('[data-action="upgrade-toggle"]'))==null||s.addEventListener("change",l=>{rt=!!l.target.checked,B()}),(n=e.querySelector('[data-action="upgrade-run"]'))==null||n.addEventListener("click",()=>{Wr()}),(r=e.querySelector('[data-form="initialize"]'))==null||r.addEventListener("submit",l=>{l.preventDefault(),zr(l.target)}),(i=e.querySelector('[data-form="database"]'))==null||i.addEventListener("submit",l=>{l.preventDefault(),jr(l.target)}))}async function Kr(){A=!0,q=null,B();try{await Kt(),J=null}catch(e){q=e instanceof Error?e.message:"Failed to load installer status"}finally{A=!1,B()}}async function zr(e){const t=new FormData(e),a=n=>{var r;return!!((r=e.querySelector(`input[name="${n}"]`))!=null&&r.checked)},s={timezone:String(t.get("timezone")??"").trim(),cal_enabled:a("cal_enabled"),card_enabled:a("card_enabled"),tasks_enabled:a("tasks_enabled"),notes_enabled:a("notes_enabled"),files_enabled:a("files_enabled"),dav_auth_type:String(t.get("dav_auth_type")??"Digest"),invite_from:String(t.get("invite_from")??"").trim(),session_max_age_minutes:Number(t.get("session_max_age_minutes")??15),admin_password:String(t.get("admin_password")??""),admin_password_confirm:String(t.get("admin_password_confirm")??"")};A=!0,q=null,J=null,B();try{T=await ut("/initialize",{method:"POST",body:JSON.stringify(s)}),se=T.csrfToken||se,J="Server settings saved. Configure the database next.",h.event("install.initialize")}catch(n){q=n instanceof Error?n.message:"Initialize failed"}finally{A=!1,B()}}async function jr(e){const t=new FormData(e),a=String(t.get("backend")??X),s={backend:a,admin_password:String(t.get("admin_password")??""),admin_password_confirm:String(t.get("admin_password_confirm")??"")};a==="sqlite"?s.sqlite_file=String(t.get("sqlite_file")??"").trim():(s.pgsql_host=String(t.get("pgsql_host")??"").trim(),s.pgsql_dbname=String(t.get("pgsql_dbname")??"").trim(),s.pgsql_username=String(t.get("pgsql_username")??"").trim(),s.pgsql_password=String(t.get("pgsql_password")??"")),A=!0,q=null,J=null,B();try{T=await ut("/database",{method:"POST",body:JSON.stringify(s)}),se=T.csrfToken||se,J="Database configured. Installer is locked.",h.event("install.database"),T.completed||T.step}catch(n){q=n instanceof Error?n.message:"Database setup failed"}finally{A=!1,B()}}async function Wr(){if(rt){A=!0,q=null,J=null,B();try{const e=await ut("/upgrade",{method:"POST",body:JSON.stringify({confirm:!0})});J="Upgrade completed."+(e.messages&&e.messages.length?" "+e.messages.slice(0,3).join(" · "):""),h.event("install.upgrade"),await Kt()}catch(e){q=e instanceof Error?e.message:"Upgrade failed"}finally{A=!1,B()}}}async function Jr(e){document.title="AngaraDAV · Setup",document.body.classList.add("layout-install"),e.innerHTML='<section class="card"><p class="muted">Loading installer…</p></section>';try{await Kt()}catch(t){q=t instanceof Error?t.message:"Failed to load installer"}B()}const At=document.getElementById("app");if(!At)throw new Error("#app missing");const pa=window.location.pathname.replace(/\/+$/,"")||"/";pa==="/portal/install"||pa.endsWith("/portal/install")?Jr(At):xr(At);
