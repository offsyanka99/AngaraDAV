...
`)}function U(e){const t=e.titleId||(e.id?`${e.id}-title`:`modal-title-${Math.random().toString(36).slice(2,9)}`),a=e.id?` id="${d(e.id)}"`:"",s=e.className?` ${e.className}`:"",n=e.rootAttrs?` ${e.rootAttrs}`:"",r=`${Xa(e.size)}${e.cardClassName?` ${e.cardClassName}`:""}`,i=e.closeAction,l=e.lockBackdrop?"":` data-action="${d(i)}"`,o=e.hideClose?"":`<button type="button" class="modal-close info-modal-close" data-action="${d(i)}" aria-label="Close">×</button>`;let c="";e.footer!==void 0&&(c=typeof e.footer=="string"?e.footer:Et(e.footer));const m=c?`<footer class="cal-modal-footer">${c}</footer>`:"",p=`<div class="cal-modal-body">${e.body}</div>`;let u;return e.form?u=`<form class="stack"${e.formAttrs?` ${e.formAttrs}`:""}>
    ...
    <div class="info-modal" id="info-modal" hidden role="dialog" aria-modal="true" aria-labelledby="info-modal-title">
    ...
    </div>`}function dt(e,t,a={},s){const n=!!e.user&&e.activeTab==="admin"&&oe(e)&&Ue(e),l=`
      ...
      <footer class="site-footer">
        <div class="container footer-inner">
          ...
          <span class="footer-sep" aria-hidden="true">·</span>
          <a href="${d(Ga)}" target="_blank" rel="noopener noreferrer">Docs</a>
        </div>
      ...
      ${c}
      <p class="muted small" style="margin:0.75rem 0 0">After ${d(H(t.elapsedSec))}</p>`}const o=a?'<p class="muted small" style="margin:0">Please wait…</p>':Et([{label:"Close",action:"close-files-upload-progress",variant:"primary"}]);return U({title:s,titleId:"files-upload-progress-title",closeAction:"close-files-upload-progress",size:"sm",className:"import-progress-modal files-upload-progress-modal",cardClassName:"import-progress-card",rootAttrs:"data-files-upload-progress",hideClose:a,lockBackdrop:a,body:l,footer:o})}async function Jt(e,t,a,s){const n=a.replace(/\\/g,"/").split("/").map(i=>i.trim()).filter(Boolean);let r=t;for(const i of n){const l=ma(r,i);if(s.has(l)){r=l;continue}try{await h.filesMkdir(r,i),w.event("files.mkdir",{path:r,name:i,via:"upload-folder"})}catch(o){if(!(o instanceof O&&o.status===409))throw o}s.add(l),r=l}}function Dn(e,t){var s;const a=t==="files"?'input[type="file"][data-action="files-upload-pick-files"]':'input[type="file"][data-action="files-upload-pick-folder"]';(s=e.root.querySelector(a))==null||s.click()}async function Yt(e,t){if(e.state.busy||e.state.filesUploadProgress)return;e.state.filesUploadMenuOpen=!1,j(e),e.state.filesRenamePath=null,e.state.filesDeletePaths=null,z(e),e.state.filesMkdirOpen=!1;const a=t==="files"?vn:$n;try{const s=await a();if(s.kind==="cancel"){e.render();return}if(s.kind==="items"){if(s.items.length===0){e.setFlash("info",t==="folder"?"Folder is empty":"No files selected"),e.render();return}await Ft(e,s.items);return}e.render(),requestAnimationFrame(()=>{Dn(e,t)})}catch(s){e.setFlash("error",s instanceof Error?s.message:"Could not open picker"),e.render()}}function at(e,t){return`${e}\0${t}`}function Cn(e,t){return t.map(a=>{const s=a.file,n=(a.relativePath||s.name).replace(/\\/g,"/"),r=n.split("/").filter(Boolean),i=r.pop()||s.name,l=r.join("/"),o=ma(e,l);return{item:a,file:s,fileName:i,parentPath:o,displayName:n||i,relDir:l}})}function En(e){const t=new Set,a=[];for(const s of e){const n=at(s.parentPath,s.fileName);t.has(n)||(t.add(n),a.push(s))}return a}async function Tn(e,t){if(t.length===0)return[];const a=new Map;for(const n of t){const r=a.get(n.parentPath)??[];r.push(n),a.set(n.parentPath,r)}const s=[];for(const[n,r]of a){let i=new Map;try{const l=await h.filesList(n);i=new Map;for(const o of l.entries)(o.type==="file"||o.type==="dir")&&i.set(o.name,o.type)}catch{i=new Map}for(const l of r)i.has(l.fileName)&&s.push(l)}return s.sort((n,r)=>n.displayName.localeCompare(r.displayName)),s}const At=new WeakMap;function mt(e){e&&(At.delete(e.state),e.state.filesUploadConflict=null)}function ze(e,t){var m;const a=At.get(e.state),s=e.state.filesUploadConflict;if(t==="cancel"){mt(e),e.setFlash("info","Upload cancelled"),e.render();return}if(!a){e.state.filesUploadConflict=null,e.setFlash("error","Upload session expired — drop or choose the files again"),e.render();return}const n=new Set(((m=s==null?void 0:s.conflictKeys)!=null&&m.length?s.conflictKeys:a.conflictKeys)??[]);let r=a.planned,i=new Set,l=0;if(t==="overwrite")i=new Set(n);else{const p=[];for(const u of a.planned){const b=at(u.parentPath,u.fileName);n.has(b)?l+=1:p.push(u)}if(r=p,w.event("files.upload.skip_existing",{skipped:l,remaining:r.length,total:a.planned.length,conflictKeys:n.size}),r.length===0&&a.emptyDirs.length===0){mt(e),e.setFlash("info",l===1?"Nothing to upload — the selected file already exists":`Nothing to upload — all ${l} selected files already exist`),e.render();return}}const o=a.destBase,c=a.emptyDirs;mt(e),ka(e,r,c,o,i)}async function Ft(e,t){if(t.length===0||e.state.filesUploadProgress||e.state.filesUploadConflict)return;e.state.filesUploadMenuOpen=!1,j(e),e.state.filesUploadDropActive=!1;const a=t.filter(i=>i.file&&!i.isEmptyDir),s=t.filter(i=>i.isEmptyDir&&i.relativePath),n=e.state.filesPath,r=En(Cn(n,a));if(w.event("files.upload.plan",{destBase:n||"/",files:r.length,emptyDirs:s.length,sample:r.slice(0,5).map(i=>({display:i.displayName,parent:i.parentPath||"/",name:i.fileName}))}),r.length>0){e.state.busy=!0,e.clearFlash(),e.render();try{const i=await Tn(n,r);if(i.length>0){const l=i.map(o=>at(o.parentPath,o.fileName));At.set(e.state,{planned:r,emptyDirs:s,destBase:n,conflictKeys:l}),e.state.filesUploadConflict={names:i.map(o=>o.displayName),totalFiles:r.length,conflictCount:i.length,conflictKeys:l},w.event("files.upload.conflicts",{total:r.length,conflicts:i.length,names:i.slice(0,12).map(o=>o.displayName)}),e.state.busy=!1,e.render();return}}catch(i){e.state.busy=!1,e.setFlash("error",i instanceof Error?i.message:"Could not check existing files"),e.render();return}}await ka(e,r,s,n,new Set)}async function ka(e,t,a,s,n){var b,y;const r=t.reduce((f,$)=>f+($.file.size||0),0),i=Date.now(),l=t.length+a.length;e.state.filesUploadProgress={phase:"uploading",totalFiles:Math.max(t.length,1),completedFiles:0,failedFiles:0,currentName:((b=t[0])==null?void 0:b.displayName)||((y=a[0])==null?void 0:y.relativePath)||"",bytesTotal:r,bytesSent:0,startedAt:i,elapsedSec:0,resultMessage:null,errorSamples:[]},e.state.busy=!0,e.clearFlash(),Sn(e),e.render();let o=0;const c=[],m=new Set;let p=0,u=0;try{for(const k of a){const S=k.relativePath.replace(/\\/g,"/").replace(/^\/+|\/+$/g,"");if(S){e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,currentName:S+"/",elapsedSec:Math.floor((Date.now()-i)/1e3)},ge(e,e.state.filesUploadProgress));try{await Jt(e,s,S,m)}catch(v){c.push(`${S}/: ${v instanceof Error?v.message:"failed"}`)}}}for(const k of t){const{file:S,fileName:v,parentPath:g,displayName:D,relDir:P}=k;e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,currentName:D,bytesSent:p,elapsedSec:Math.floor((Date.now()-i)/1e3)},ge(e,e.state.filesUploadProgress));try{P&&await Jt(e,s,P,m);const F=n.has(at(g,v));await h.filesUpload(g,S,{replace:F,onProgress:(I,_)=>{if(!e.state.filesUploadProgress||e.state.filesUploadProgress.phase!=="uploading")return;const T=_>0?_:S.size;e.state.filesUploadProgress={...e.state.filesUploadProgress,currentName:D,bytesSent:p+Math.min(I,T||I),elapsedSec:Math.floor((Date.now()-i)/1e3)},ge(e,e.state.filesUploadProgress)}}),w.event("files.upload",{path:g,name:v,size:S.size,relativePath:D,replace:F}),o+=1,F&&(u+=1),p+=S.size||0,e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,completedFiles:o,failedFiles:c.length,bytesSent:p},ge(e,e.state.filesUploadProgress))}catch(F){const I=`${D}: ${F instanceof Error?F.message:"failed"}`;c.push(I),p+=S.size||0,e.state.filesUploadProgress&&(e.state.filesUploadProgress={...e.state.filesUploadProgress,completedFiles:o,failedFiles:c.length,bytesSent:p,errorSamples:c.slice(0,12)},ge(e,e.state.filesUploadProgress))}}await Z(e),$e(e);const f=Math.floor((Date.now()-i)/1e3),$=t.length;if(o>0&&c.length===0){let k=o===1?"Uploaded 1 file":`Uploaded ${o} files`;u>0&&(k+=u===1?" (1 overwritten)":` (${u} overwritten)`),e.state.filesUploadProgress={phase:"done",totalFiles:Math.max($,1),completedFiles:o,failedFiles:0,currentName:"",bytesTotal:r,bytesSent:r,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:[]},e.setFlash("success",k)}else if(o>0){const k=`Uploaded ${o}; ${c.length} failed. ${c[0]}`;e.state.filesUploadProgress={phase:"done",totalFiles:Math.max($,1),completedFiles:o,failedFiles:c.length,currentName:"",bytesTotal:r,bytesSent:r,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:c.slice(0,12)},e.setFlash("info",k)}else if(l>0&&c.length===0&&a.length>0){const k=a.length===1?"Created 1 empty folder":`Created ${a.length} empty folders`;e.state.filesUploadProgress={phase:"done",totalFiles:1,completedFiles:0,failedFiles:0,currentName:"",bytesTotal:0,bytesSent:0,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:[]},e.setFlash("success",k)}else{const k=c[0]||"Upload failed";e.state.filesUploadProgress={phase:"error",totalFiles:Math.max($,1),completedFiles:0,failedFiles:c.length,currentName:"",bytesTotal:r,bytesSent:0,startedAt:i,elapsedSec:f,resultMessage:k,errorSamples:c.slice(0,12)},e.setFlash("error",k)}}catch(f){$e(e);const $=f instanceof Error?f.message:"Upload failed";e.state.filesUploadProgress={phase:"error",totalFiles:Math.max(t.length,1),completedFiles:o,failedFiles:Math.max(c.length,1),currentName:"",bytesTotal:r,bytesSent:p,startedAt:i,elapsedSec:Math.floor((Date.now()-i)/1e3),resultMessage:$,errorSamples:c.length?c.slice(0,12):[$]},e.setFlash("error",$)}finally{e.state.busy=!1,e.render()}}function Gt(e,t,a){const s=t.files;if(!s||s.length===0)return;const n=fa(s,a);t.value="",Ft(e,n)}function Pn(e,t){const a=t?t.split("/").filter(Boolean):[];let s="";const n=[`<button type="button" class="files-crumb" data-action="files-nav" data-path="" ${e.state.busy?"disabled":""}>Home</button>`];for(const r of a){s=s?`${s}/${r}`:r;const i=s;n.push('<span class="files-crumb-sep" aria-hidden="true">/</span>'),n.push(`<button type="button" class="files-crumb" data-action="files-nav" data-path="${d(i)}" ${e.state.busy?"disabled":""}>${d(r)}</button>`)}return`<nav class="files-breadcrumb" aria-label="Folder path">${n.join("")}</nav>`}function An(e){const t=e.state.filesStatus;if(!t)return`<div class="card"><p class="muted">${e.state.filesLoading||e.state.busy?"Loading…":"Unable to load file storage status."}</p></div>`;if(!t.enabled)return`<div class="portal-grid portal-grid-files">
      <section class="card">
        ${M("Files","files","h1")}
        ...
        <p class="muted small">DAV path: <span class="mono">${d(t.davPath)}</span></p>
          ...
          <div class="bulk-bar-actions">
            ...
            <button type="button" class="btn btn-small btn-danger" data-action="files-bulk-delete" ${e.state.busy?"disabled":""}>Delete</button>
              ...
              <td class="files-col-mtime hide-sm">${d(wn(v.mtime))}</td>
    ...
    ${n}`}function xn(e){const t=e.state.adminUsersQuery.trim().toLowerCase();return t?e.state.adminUsers.filter(a=>a.username.toLowerCase().includes(t)||(a.displayname||"").toLowerCase().includes(t)||(a.email||"").toLowerCase().includes(t)):e.state.adminUsers}function Ln(e){return e.state.adminUserCreateOpen?U({id:"admin-user-create-modal",title:"Add user",titleId:"admin-user-create-title",closeAction:"admin-user-create-close",size:"sm",form:!0,formAttrs:'data-form="admin-user-create"',body:`
        ...
        <p class="muted small">Username <span class="mono">${d(t.username)}</span> cannot be changed. Leave password fields empty to keep the current password.</p>
          ...
          </label>`,footer:[{label:"Cancel",action:"admin-user-edit-close",variant:"ghost",disabled:e.state.busy},{label:"Save changes",type:"submit",variant:"primary",disabled:e.state.busy}]})}function Rn(e){if(!e.state.adminUserDeleteUsername)return"";const t=e.state.adminUserDeleteUsername,a=e.state.adminUserDetail&&e.state.adminUserDetail.username.toLowerCase()===t.toLowerCase()?e.state.adminUserDetail:e.state.adminUsers.find(n=>n.username.toLowerCase()===t.toLowerCase())??null,s=a?`${a.displayname||a.username} (${a.username})`:t;return U({id:"admin-user-delete-modal",title:"Delete user",titleId:"admin-user-delete-title",closeAction:"admin-user-delete-close",size:"sm",body:`
  ...
  ${i}${l}${o}`}function Bn(e){const t=ae(e,"users");if(t&&t.available===!1)return nt(e,"users");const a=xn(e),s=e.state.adminUsersLoading&&e.state.adminUsers.length===0?'<tr><td colspan="4" class="muted admin-table-empty">Loading users…</td></tr>':a.length===0?`<tr><td colspan="4" class="muted admin-table-empty">${e.state.adminUsersError?d(e.state.adminUsersError):e.state.adminUsersQuery.trim()?"No users match this filter.":"No users found."}</td></tr>`:a.map(n=>`<tr class="contact-table-row${e.state.adminSelectedUsername&&e.state.adminSelectedUsername.toLowerCase()===n.username.toLowerCase()?" is-selected":""}" data-action="admin-user-view" data-username="${d(n.username)}" tabindex="0" role="button">
    ...
    ${Yn(e)}`}function Yn(e){return e.state.adminResetModalOpen?U({id:"admin-reset-modal",title:"Reset to Default",titleId:"admin-reset-title",closeAction:"admin-reset-close",size:"sm",body:`
    ...
    ${es(e)}`}function es(e){if(!e.state.adminDbConfirmOpen)return"";const t=e.state.adminDbConfirmText.trim()==="CONFIRM";return U({id:"admin-db-confirm-modal",title:"Confirm database change",titleId:"admin-db-confirm-title",closeAction:"admin-db-confirm-close",size:"sm",body:`
    ...
    </div>`}function us(e=document){e.querySelectorAll(".dt-field.is-open").forEach(t=>{const a=t.querySelector(".dt-trigger"),s=t.querySelector(".dt-popover");if(!a||!s)return;const n=a.getBoundingClientRect(),r=8;s.style.position="fixed",s.style.visibility="hidden",s.style.top="0",s.style.left="0";const i=s.offsetWidth||320,l=s.offsetHeight||300;let o=n.bottom+6;o+l>window.innerHeight-r&&(o=Math.max(r,n.top-l-6));let c=n.left;c+i>window.innerWidth-r&&(c=Math.max(r,window.innerWidth-i-r)),c<r&&(c=r),s.style.top=`${Math.round(o)}px`,s.style.left=`${Math.round(c)}px`,s.style.right="auto",s.style.visibility="visible",s.style.zIndex="200"})}async function Mt(e,t){const a=await h.shares(t);e.state.shares=a.shares}function ms(e){const t=e.state.calendars.filter(s=>s.canShare);if(t.length===0)return null;const a=s=>{const n=s.uri.toLowerCase(),r=s.displayname.toLowerCase();return n==="default"||r==="default"||r==="default calendar"};return t.find(a)??t[0]??null}async function st(e){const t=e.state.selectedIds.filter(n=>e.state.calendars.some(r=>r.id===n));if(t.length===0){e.state.monthEvents=[];return}const{from:a,to:s}=ss(e.state.monthCursor.y,e.state.monthCursor.m);e.state.monthEventsLoading=!0,w.debug("loadMonthEvents",{selectedIds:t,from:a,to:s});try{const r=(await Promise.all(t.map(async i=>(await h.calendarEvents(i,a,s)).events.map(o=>({...o,instanceId:i}))))).flat();r.sort((i,l)=>{const o=i.start||"",c=l.start||"";return o!==c?o<c?-1:1:(i.summary||"").localeCompare(l.summary||"")}),e.state.monthEvents=r,w.event("monthEvents.loaded",{calendarIds:t,count:e.state.monthEvents.length,from:a,to:s})}catch(n){e.state.monthEvents=[],w.warn("loadMonthEvents failed",n instanceof Error?n.message:n)}finally{e.state.monthEventsLoading=!1}}function ps(e,t){const a=e.state.calendars.find(s=>s.id===t);return a!=null&&a.color?a.color.length>=7?a.color.slice(0,7):a.color:"#3B82F6"}function fs(e,t){e.state.selectedIds.includes(t)?(e.state.selectedIds=e.state.selectedIds.filter(a=>a!==t),e.state.selectedId===t&&(e.state.selectedId=e.state.selectedIds[0]??null)):(e.state.selectedIds=[...e.state.selectedIds,t],e.state.selectedId=t)}function bs(e,t,a){return new Date(t,a,1).toLocaleString(void 0,{month:"long",year:"numeric"})}function gs(e,t){const a=t.summary||"(No title)";if(t.allDay||/^\d{4}-\d{2}-\d{2}$/.test(t.start))return a;const s=new Date(t.start);return Number.isNaN(s.getTime())?a:`${s.toLocaleTimeString(void 0,e.timeFormatOpts())} ${a}`}function ys(e){const t=e.state.calendars.filter(S=>e.state.selectedIds.includes(S.id)),a=t.length===0?"No calendar selected":t.length===1?t[0].displayname:`${t.length} calendars`,s=e.state.monthCursor.y,n=e.state.monthCursor.m,r=new Date(s,n,1),i=e.localeWeekStart(),l=(r.getDay()-i+7)%7,o=new Date(s,n+1,0).getDate(),c=new Date(s,n,0).getDate(),p=N(new Date),u=e.localeDowLabels(),b=new Map;for(const S of e.state.monthEvents)for(const v of rs(S)){const g=b.get(v)??[];g.push(S),b.set(v,g)}const y=[],f=Math.ceil((l+o)/7)*7;for(let S=0;S<f;S++){let v,g=!0,D;S<l?(v=c-l+S+1,g=!1,D=new Date(s,n-1,v)):S>=l+o?(v=S-(l+o)+1,g=!1,D=new Date(s,n+1,v)):(v=S-l+1,D=new Date(s,n,v));const P=N(D),F=P===p,I=g?b.get(P)??[]:[],_=e.state.monthExpandDay===P?50:3,T=I.slice(0,_),x=I.length-T.length,V=T.map(pe=>{var Bt;const it=pe.instanceId,lt=gs(e,pe),Ra=ps(e,it),qt=((Bt=e.state.calendars.find(Ba=>Ba.id===it))==null?void 0:Bt.displayname)||"",qa=qt?`${lt} · ${qt}`:lt;return`<button type="button" class="month-event${pe.allDay?"":" is-timed"}" title="${d(qa)}" style="--ev-color:${d(Ra)}"
          data-action="open-event" data-instance="${it}" data-uri="${d(pe.uri)}" ${e.state.busy?"disabled":""}>${d(lt)}</button>`}).join(""),se=x>0?`<button type="button" class="month-event-more" data-action="open-event-day" data-day="${d(P)}" title="Show all events this day" ${e.state.busy?"disabled":""}>+${x} more</button>`:"",ue=!g&&(v===1||S===l+o)?D.toLocaleString(void 0,{month:"short",day:"numeric"}):String(v),me=e.state.selectedId!==null?e.state.calendars.find(pe=>pe.id===e.state.selectedId)??null:null,Me=!!(me&&!me.readOnly&&(me.canShare||me.access==="readwrite"));y.push(`<div class="month-cell${g?"":" is-outside"}${F?" is-today":""}${Me?" is-clickable":""}"${Me?` data-action="new-event-day" data-day="${d(P)}" role="button" tabindex="0" title="Add event on ${d(P)}"`:""}>
    ...
    <div class="month-cal-toolbar">
      ...
      <h2 class="month-cal-title">${d(bs(e,s,n))}</h2>
    ...
    ${e.renderEventModal()}`}function Ae(e){if(!e.state.editingContact)return;const t=e.root.querySelector('[data-form="contact"]');if(!t)return;const a=new FormData(t);e.state.editingContact.firstname=String(a.get("firstname")??""),e.state.editingContact.lastname=String(a.get("lastname")??""),e.state.editingContact.fullname=String(a.get("fullname")??""),e.state.editingContact.org=String(a.get("org")??""),e.state.editingContact.title=String(a.get("title")??""),e.state.editingContact.url=String(a.get("url")??""),e.state.editingContact.note=String(a.get("note")??"");const s=String(a.get("birthday")??"").trim();e.state.editingContact.birthday=s&&/^\d{4}-\d{2}-\d{2}/.test(s)?s.slice(0,10):null,e.state.editingContact.address={street:String(a.get("street")??""),city:String(a.get("city")??""),region:String(a.get("region")??""),postal:String(a.get("postal")??""),country:String(a.get("country")??"")};const n=[];let r=0;for(;a.has(`email_${r}`);)n.push(String(a.get(`email_${r}`)??"")),r++;n.length&&(e.state.editingContact.emails=n);const i=[];for(r=0;a.has(`phone_value_${r}`);)i.push({type:String(a.get(`phone_type_${r}`)??"other"),value:String(a.get(`phone_value_${r}`)??"")}),r++;i.length&&(e.state.editingContact.phones=i);const l=[];for(r=0;a.has(`custom_label_${r}`)||a.has(`custom_value_${r}`);)l.push({label:String(a.get(`custom_label_${r}`)??""),value:String(a.get(`custom_value_${r}`)??"")}),r++;e.state.editingContact.custom=l}function Fs(e,t){const a=new FormData(t),s=[];let n=0;for(;a.has(`email_${n}`);){const o=String(a.get(`email_${n}`)??"").trim();o&&s.push(o),n++}const r=[];for(n=0;a.has(`phone_value_${n}`);){const o=String(a.get(`phone_value_${n}`)??"").trim();o&&r.push({type:String(a.get(`phone_type_${n}`)??"other"),value:o}),n++}const i=[];for(n=0;a.has(`custom_label_${n}`)||a.has(`custom_value_${n}`);){const o=String(a.get(`custom_label_${n}`)??"").trim(),c=String(a.get(`custom_value_${n}`)??"").trim();(o||c)&&i.push({label:o,value:c}),n++}const l={firstname:String(a.get("firstname")??"").trim(),lastname:String(a.get("lastname")??"").trim(),fullname:String(a.get("fullname")??"").trim(),org:String(a.get("org")??"").trim(),title:String(a.get("title")??"").trim(),emails:s,phones:r,address:{street:String(a.get("street")??"").trim(),city:String(a.get("city")??"").trim(),region:String(a.get("region")??"").trim(),postal:String(a.get("postal")??"").trim(),country:String(a.get("country")??"").trim()},url:String(a.get("url")??"").trim(),note:String(a.get("note")??"").trim(),birthday:(()=>{const o=String(a.get("birthday")??"").trim();return o&&/^\d{4}-\d{2}-\d{2}/.test(o)?o.slice(0,10):null})(),custom:i};return e.state.removePhotoPending?l.removePhoto=!0:e.state.photoBase64Pending&&(l.photoBase64=e.state.photoBase64Pending),l}function Y(e){const{state:t,root:a}=e,s=a.querySelector('[data-form="edit-event"]');s&&t.editingEvent&&e.syncEditingEventFromForm(s);const n=a.querySelector('[data-form="task"]');n&&t.editingTask&&e.syncEditingTaskFromForm(n);const r=a.querySelector('[data-form="note"]');r&&t.editingNote&&e.syncEditingNoteFromForm(r),t.editingContact&&Ae(e.contactsHost)}async function Us(e,t,a,s){var c,m,p;const{state:n,root:r,render:i,setFlash:l,clearFlash:o}=e;if(t==="select-cal"||t==="toggle-cal"){const u=Number(a.dataset.id);if(!Number.isFinite(u))return!0;e.toggleCalendarSelected(u),n.busy=!0,o(),i();try{await e.loadMonthEvents()}catch(b){l("error",b instanceof Error?b.message:"Failed to load calendar")}finally{n.busy=!1,i()}return!0}if(t==="edit-cal"){const u=Number(a.dataset.id);if(!Number.isFinite(u)||!n.calendars.find(y=>y.id===u&&y.canShare))return!0;n.selectedId=u,n.selectedIds.includes(u)||(n.selectedIds=[...n.selectedIds,u]),n.calModalOpen=!0,n.deleteConfirmId=null,n.busy=!0,o(),i();try{await e.loadShares(u),await e.loadMonthEvents()}catch(y){l("error",y instanceof Error?y.message:"Failed to open calendar")}finally{n.busy=!1,i()}return!0}if(t==="close-cal-modal")return n.calModalOpen=!1,i(),!0;if(t==="open-create-cal-modal")return n.createCalModalOpen=!0,n.calModalOpen=!1,n.deleteConfirmId=null,o(),i(),!0;if(t==="close-create-cal-modal")return n.createCalModalOpen=!1,o(),i(),!0;if(t==="delete-cal"){const u=Number(a.dataset.id);return!Number.isFinite(u)||!n.calendars.find(y=>y.id===u&&y.canShare)||(n.deleteConfirmId=u,n.calModalOpen=!1,o(),i()),!0}if(t==="cancel-delete-cal")return n.deleteConfirmId=null,i(),!0;if(t==="confirm-delete-cal"){const u=Number(a.dataset.id),b=r.querySelector("#delete-cal-confirm");if(!Number.isFinite(u)||!(b!=null&&b.checked))return!0;n.busy=!0,o(),i();try{if(await h.deleteCalendar(u),n.selectedId===u&&(n.selectedId=null),n.selectedIds=n.selectedIds.filter(y=>y!==u),n.deleteConfirmId=null,n.calModalOpen=!1,n.shares=[],n.monthEvents=[],await e.loadHome(),n.selectedId===null){const y=e.pickDefaultCalendar();y?(n.selectedId=y.id,n.selectedIds.includes(y.id)||(n.selectedIds=[...n.selectedIds,y.id]),await e.loadMonthEvents()):n.selectedIds.length>0&&(n.selectedId=n.selectedIds[0],await e.loadMonthEvents())}l("success","Calendar deleted")}catch(y){l("error",y instanceof Error?y.message:"Delete failed")}finally{n.busy=!1,i()}return!0}if(t==="month-today"){const u=new Date;n.monthCursor={y:u.getFullYear(),m:u.getMonth()},n.monthExpandDay=null,n.busy=!0,i();try{await e.loadMonthEvents()}finally{n.busy=!1,i()}return!0}if(t==="month-prev"||t==="month-next"){const u=t==="month-prev"?-1:1,b=new Date(n.monthCursor.y,n.monthCursor.m+u,1);n.monthCursor={y:b.getFullYear(),m:b.getMonth()},n.monthExpandDay=null,n.busy=!0,i();try{await e.loadMonthEvents()}finally{n.busy=!1,i()}return!0}if(t==="open-event"){s.stopPropagation();const u=Number(a.dataset.instance),b=a.dataset.uri??"";if(!Number.isFinite(u)||!b)return!0;n.busy=!0,o(),i();try{const y=await h.getEvent(u,b);n.editingEvent={...y.event,repeat:y.event.repeat??e.defaultRepeat()},n.creatingEvent=!1,n.eventModalOpen=!0,n.eventDtPicker=null,n.calModalOpen=!1,n.deleteConfirmId=null}catch(y){l("error",y instanceof Error?y.message:"Failed to open event")}finally{n.busy=!1,i()}return!0}if(t==="open-event-day"){s.stopPropagation();const u=a.dataset.day??"";return n.monthExpandDay=n.monthExpandDay===u?null:u,i(),!0}if(t==="new-event-day"){const u=s.target;if((c=u==null?void 0:u.closest)!=null&&c.call(u,".month-event, .month-event-more"))return!0;const b=a.dataset.day??"";if(!/^\d{4}-\d{2}-\d{2}$/.test(b))return!0;if(n.selectedId===null)return l("error","Select a calendar first"),i(),!0;const y=n.calendars.find(f=>f.id===n.selectedId);return!y||y.readOnly||!(y.canShare||y.access==="readwrite")?(l("error","This calendar is read-only"),i(),!0):(n.creatingEvent=!0,n.editingEvent=e.blankEventForDay(b,n.selectedId),n.eventModalOpen=!0,n.eventDtPicker=null,n.calModalOpen=!1,n.deleteConfirmId=null,o(),i(),!0)}if(t==="close-event-modal")return n.eventModalOpen=!1,n.editingEvent=null,n.creatingEvent=!1,n.eventDtPicker=null,o(),i(),!0;if(t==="dt-open"){const u=a.dataset.dtField||"";if(!u)return!0;if(Y(e),((m=n.eventDtPicker)==null?void 0:m.field)===u)n.eventDtPicker=null;else{const b=a.dataset.dtDateOnly==="1",y=a.dataset.dtClear!=="0",f=a.dataset.dtName||u;let $=e.getDtFieldCurrentValue(u);!$&&(u==="due"||u==="dtstart"||u==="bulk-due")&&($=Te().start);const k=ye($||N(new Date)),[S,v]=k.date.split("-").map(Number);n.eventDtPicker={field:u,viewY:S,viewM:(v||1)-1,dateOnly:b,allowClear:y,name:f}}return i(),!0}if(t==="dt-month-prev"||t==="dt-month-next"){if(!n.eventDtPicker)return!0;Y(e);const u=t==="dt-month-prev"?-1:1,b=new Date(n.eventDtPicker.viewY,n.eventDtPicker.viewM+u,1);return n.eventDtPicker={...n.eventDtPicker,viewY:b.getFullYear(),viewM:b.getMonth()},i(),!0}if(t==="dt-set-month"){if(!n.eventDtPicker)return!0;Y(e);const b=Number(a.value);return!Number.isFinite(b)||b<0||b>11||(n.eventDtPicker={...n.eventDtPicker,viewM:b},i()),!0}if(t==="dt-set-year"){if(!n.eventDtPicker)return!0;Y(e);const b=Number(a.value);return!Number.isFinite(b)||b<1||b>9999||(n.eventDtPicker={...n.eventDtPicker,viewY:b},i()),!0}if(t==="dt-pick-day"){if(!n.eventDtPicker)return!0;const u=n.eventDtPicker.field,b=a.dataset.day??"";if(!/^\d{4}-\d{2}-\d{2}$/.test(b))return!0;Y(e);const y=n.eventDtPicker.dateOnly;if(y)e.setDtFieldValue(u,b),n.eventDtPicker=null;else{const f=e.getDtFieldCurrentValue(u),$=ye(f||Te(b).start).hm;e.setDtFieldValue(u,`${b}T${$}`),n.eventDtPicker={...n.eventDtPicker,viewY:Number(b.slice(0,4)),viewM:Number(b.slice(5,7))-1}}if(u==="start"&&n.editingEvent&&!y&&n.editingEvent.end){const f=new Date(String(n.editingEvent.start)),$=new Date(String(n.editingEvent.end));!Number.isNaN(f.getTime())&&!Number.isNaN($.getTime())&&$<=f&&e.setDtFieldValue("end",Q(new Date(f.getTime()+3600*1e3)))}return i(),!0}if(t==="dt-pick-time"){if(!n.eventDtPicker||n.eventDtPicker.dateOnly)return!0;const u=n.eventDtPicker.field,b=a.dataset.hm??"";if(!/^\d{2}:\d{2}$/.test(b))return!0;Y(e);const y=e.getDtFieldCurrentValue(u)||Te().start,$=`${ye(y).date}T${b}`;if(e.setDtFieldValue(u,$),u==="start"&&n.editingEvent){n.editingEvent={...n.editingEvent,allDay:!1};const k=n.editingEvent.end?ye(String(n.editingEvent.end)):null,S=new Date($);(!k||new Date(`${k.date}T${k.hm}`)<=S)&&e.setDtFieldValue("end",Q(new Date(S.getTime()+3600*1e3)))}return n.eventDtPicker=null,i(),!0}if(t==="dt-today"){if(!n.eventDtPicker)return!0;const u=n.eventDtPicker.field;Y(e);const b=N(new Date);if(n.eventDtPicker.dateOnly)e.setDtFieldValue(u,b);else{const y=Te(b);u==="start"?(e.setDtFieldValue("start",y.start),n.editingEvent&&!n.editingEvent.end&&e.setDtFieldValue("end",y.end)):u==="end"?e.setDtFieldValue("end",y.end):e.setDtFieldValue(u,y.start)}return n.eventDtPicker=null,i(),!0}if(t==="dt-clear"){if(!n.eventDtPicker||!n.eventDtPicker.allowClear)return!0;const u=n.eventDtPicker.field;return Y(e),e.setDtFieldValue(u,null),n.eventDtPicker=null,i(),!0}if(t==="event-allday-toggle"){if(!n.editingEvent)return!0;const u=r.querySelector('[data-form="edit-event"]'),b=a.checked;if(u){const y=new FormData(u),f=String(y.get("start")??n.editingEvent.start??""),$=String(y.get("end")??n.editingEvent.end??"")||null;let k=f,S=$;if(b){const v=ds(f,$);k=v.start,S=v.end}else{const v=f.slice(0,10),g=($||f).slice(0,10),D=Ot(v,g);k=D.start,S=D.end}n.editingEvent={...n.editingEvent,summary:String(y.get("summary")??n.editingEvent.summary),description:String(y.get("description")??n.editingEvent.description),location:String(y.get("location")??n.editingEvent.location),instanceId:Number(y.get("instanceId"))||n.editingEvent.instanceId,allDay:b,start:k,end:S,repeat:Ie(y)}}else n.editingEvent={...n.editingEvent,allDay:b};return n.eventDtPicker=null,i(),!0}if(t==="event-repeat-freq"||t==="event-repeat-end"){if(!n.editingEvent)return!0;const u=r.querySelector('[data-form="edit-event"]');if(!u)return!0;const b=new FormData(u),y=u.querySelector('input[name="allDay"]'),f=Ie(b);return n.editingEvent={...n.editingEvent,summary:String(b.get("summary")??n.editingEvent.summary),description:String(b.get("description")??n.editingEvent.description),location:String(b.get("location")??n.editingEvent.location),instanceId:Number(b.get("instanceId"))||n.editingEvent.instanceId,allDay:(y==null?void 0:y.checked)??n.editingEvent.allDay,start:String(b.get("start")??n.editingEvent.start??""),end:String(b.get("end")??n.editingEvent.end??"")||null,repeat:f,hasRrule:!!String(b.get("repeatFreq")??"").trim()},f.freq&&f.endMode==="until"&&((p=n.eventDtPicker)==null?void 0:p.field)==="end"&&(n.eventDtPicker=null),i(),!0}if(t==="delete-event"){if(!n.editingEvent||!n.editingEvent.canWrite||n.creatingEvent)return!0;const u=String(n.editingEvent.summary||"this event").trim()||"this event";return n.confirmDelete={scope:"event",title:"Delete event",message:`Delete “${u}”?`,detail:"CalDAV clients will sync the removal. This cannot be undone."},i(),!0}if(t==="revoke"){const u=a.dataset.href??"";return!u||n.selectedId===null||(n.confirmDelete={scope:"revoke-share",title:"Revoke share",message:"Revoke access for this user?",detail:"They will lose this calendar until you share it again.",href:u},i()),!0}if(t==="export-cal"){s.stopPropagation();const u=a.dataset.id,b=u!==void 0&&u!==""?Number(u):n.selectedId;if(b===null||Number.isNaN(b))return!0;n.busy=!0,o(),i();try{const{blob:y,filename:f}=await h.exportCalendar(b),$=await e.saveBlobAsFile(y,f);$==="cancelled"?l("info","Export cancelled"):$==="saved"?l("success",`Saved ${f}`):l("success",`Download started: ${f}`)}catch(y){l("error",y instanceof Error?y.message:"Export failed")}finally{n.busy=!1,i()}return!0}return!1}async function Oa(e){const t=await h.notes({q:e.state.noteSearch,sort:e.state.noteSort,order:e.state.noteOrder});e.state.notes=t.notes,e.state.noteCalendars=t.calendars,e.state.selectedNoteKey!==null&&!e.state.notes.some(a=>`${a.instanceId}|${a.uri}`===e.state.selectedNoteKey)&&(e.state.selectedNoteKey=null,e.state.creatingNote||(e.state.editingNote=null))}function L(e,t){return`${e}|${t}`}function Is(e){const t=e.state.notes.length===0?`<tr class="contacts-empty-row"><td colspan="3" class="muted">${e.state.noteSearch?"No notes match your search.":"No notes yet. Add one below."}</td></tr>`:e.state.notes.map(r=>{const i=L(r.instanceId,r.uri),l=!e.state.creatingNote&&i===e.state.selectedNoteKey?" is-selected":"",o=(r.description||"").replace(/\s+/g," ").slice(0,80);return`<tr class="contact-table-row${l}" data-action="select-note" data-instance="${r.instanceId}" data-uri="${d(r.uri)}" tabindex="0" role="button">
              ...
              <td class="col-note-date muted small">${d(ya(r.dtstart))}</td>
    ...
    <section class="stack items-edit-panel">
      ${n}
              ...
              <td class="col-task-due muted small">${d(ya(f.due))}</td>
    ...
    ${p&&!c?yr(e,s,i,l,m):""}
  </div>`}function na(e,t){var s,n,r,i,l,o,c,m;const{state:a}=e;return t==="start"?String(((s=a.editingEvent)==null?void 0:s.start)||""):t==="end"?String(((n=a.editingEvent)==null?void 0:n.end)||""):t==="until"?((i=(r=a.editingEvent)==null?void 0:r.repeat)==null?void 0:i.until)||ve((l=a.editingEvent)==null?void 0:l.start)||N(new Date):t==="due"?ke((o=a.editingTask)==null?void 0:o.due):t==="dtstart"?ke((c=a.editingNote)==null?void 0:c.dtstart):t==="bulk-due"?a.bulkDueValue:t==="birthday"?String(((m=a.editingContact)==null?void 0:m.birthday)||""):""}function sa(e,t,a){const{state:s}=e;if(t==="start"&&s.editingEvent){s.editingEvent={...s.editingEvent,start:a||""};return}if(t==="end"&&s.editingEvent){s.editingEvent={...s.editingEvent,end:a};return}if(t==="until"&&s.editingEvent){s.editingEvent={...s.editingEvent,repeat:{...s.editingEvent.repeat??e.defaultRepeat(),until:a,endMode:"until"}};return}if(t==="due"&&s.editingTask){if(a===null||a==="")s.editingTask={...s.editingTask,due:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(a))s.editingTask={...s.editingTask,due:new Date(a+"T00:00:00").toISOString()};else{const n=new Date((a.length===16,a));s.editingTask={...s.editingTask,due:Number.isNaN(n.getTime())?a:n.toISOString()}}return}if(t==="dtstart"&&s.editingNote){if(a===null||a==="")s.editingNote={...s.editingNote,dtstart:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(a))s.editingNote={...s.editingNote,dtstart:new Date(a+"T00:00:00").toISOString()};else{const n=new Date((a.length===16,a));s.editingNote={...s.editingNote,dtstart:Number.isNaN(n.getTime())?a:n.toISOString()}}return}if(t==="birthday"&&s.editingContact){s.editingContact={...s.editingContact,birthday:a&&/^\d{4}-\d{2}-\d{2}/.test(a)?a.slice(0,10):null};return}t==="bulk-due"&&(s.bulkDueValue=a||"")}function vr(e,t){const{root:a}=e,s=dn[t];if(!s)return;const n=a.querySelector("#info-modal"),r=a.querySelector("#info-modal-title"),i=a.querySelector("#info-modal-body");if(!n||!r||!i)return;r.textContent=s.title,i.innerHTML=s.paragraphs.map(o=>`<p>${d(o)}</p>`).join(""),n.hidden=!1,document.body.classList.add("info-modal-open");const l=n.querySelector(".info-modal-close");l==null||l.focus()}function $r(e){const{root:t}=e,a=t.querySelector("#info-modal");a&&(a.hidden=!0,document.body.classList.remove("info-modal-open"))}async function kr(e,t){const a=window;if(typeof a.showSaveFilePicker=="function")try{const i=await(await a.showSaveFilePicker({suggestedName:t})).createWritable();try{await i.write(e)}finally{await i.close()}return"saved"}catch(r){if(r instanceof DOMException&&r.name==="AbortError")return"cancelled"}const s=URL.createObjectURL(e),n=document.createElement("a");return n.href=s,n.download=t,n.rel="noopener",n.style.display="none",document.body.appendChild(n),n.click(),window.setTimeout(()=>{URL.revokeObjectURL(s),n.remove()},6e4),"started"}function wr(e){const t=e.querySelector('input[name="color_picker"]'),a=e.querySelector('input[name="color"]');!t||!a||(t.addEventListener("input",()=>{a.value=t.value.toUpperCase()}),a.addEventListener("change",()=>{let s=a.value.trim();s&&!s.startsWith("#")&&(s=`#${s}`),/^#[0-9A-Fa-f]{6}/.test(s)&&(t.value=s.slice(0,7),a.value=s.toUpperCase())}))}function hr(e){const t=Qa({activeTab:er(),adminPage:tr(),adminSelectedUsername:_t().adminUsername??null});let a,s,n,r,i,l,o;function c(g,D){ca(t,g,D)}function m(){en(t)}function p(){const g=Kt(e);t.user?nr(o):zt(e,t,(D,P)=>dt(t,D,P,{renderImportProgressModal:()=>Re(n),renderFilesUploadProgressModal:()=>_e(a)})),sr(o),jt(e,g),requestAnimationFrame(()=>{var D;gt(o),(D=e.querySelector(".dt-time.is-selected"))==null||D.scrollIntoView({block:"center"})})}function u(){ee(n)}function b(){$e(a)}function y(){z(a)}function f(){$t(t)}function $(){j(a)}function k(){tn(t,{stopImportElapsedTimer:u,stopFilesUploadElapsedTimer:b,resetFilesTransferTree:y,unbindUserMenuOutside:f,unbindFilesUploadMenuOutside:$})}function S(g){an(t,{message:g,clearSession:k,render:p})}function v(){return{state:t,render:p,handleSessionExpired:S,clearPortalSessionState:k,normalizeActiveTab:()=>bt(o),persistTab:pt,loadHome:()=>Se(o),loadAdminCapabilities:()=>ht(s),loadAdminDashboard:()=>Ye(s),loadAdminUsers:()=>de(s),loadAdminUserDetail:g=>K(s,g),loadAdminUserResources:g=>ce(s,g),loadAdminSystemSettings:()=>Ge(s),loadAdminDatabaseSettings:()=>Qe(s),adminPageMeta:g=>ae(s,g),setFlash:c,clearFlash:m}}a={state:t,root:e,render:p,setFlash:c,clearFlash:m},s={state:t,root:e,render:p,setFlash:c,clearFlash:m,userIsAdmin:()=>oe(t),adminUiEnabled:()=>Ue(t),persistTab:pt,activateTab:(g,D)=>aa(o,g,D),loadHome:()=>Se(o),normalizeActiveTab:()=>bt(o)},n={state:t,root:e,render:p,setFlash:c,clearFlash:m,localeWeekStart:()=>br(o),localeDowLabels:()=>gr(o),formatDtDisplay:(g,D)=>_a(o,g,D),timeFormatOpts:()=>fr(o),renderPortalDateTimeField:g=>De(o,g),getDtFieldCurrentValue:g=>na(o,g),setDtFieldValue:(g,D)=>sa(o,g,D),positionDtPopovers:()=>gt(o),renderFlashBanner:()=>yt(t),accessBadge:ea,formatImportResult:ft,loadHome:()=>Se(o),onImportContacts:g=>Js(l,g)},r={state:t,root:e,render:p,setFlash:c,clearFlash:m,renderPortalDateTimeField:g=>De(o,g)},i={state:t,root:e,render:p,setFlash:c,clearFlash:m,renderPortalDateTimeField:g=>De(o,g)},l={state:t,root:e,render:p,setFlash:c,clearFlash:m,renderPortalDateTimeField:g=>De(o,g),stopImportElapsedTimer:()=>ee(n),startImportElapsedTimer:()=>Ta(n),setImportPhase:(g,D)=>Pe(n,g,D),applyServerImportProgress:g=>Pa(n,g),readFileTextWithProgress:(g,D)=>Fa(n,g,D),formatImportResult:ft,loadHome:()=>Se(o)},o={state:t,root:e,render:p,setFlash:c,clearFlash:m,filesHost:a,adminHost:s,calendarsHost:n,notesHost:r,tasksHost:i,contactsHost:l,clearPortalSessionState:k,userIsAdmin:()=>oe(t),adminUiEnabled:()=>Ue(t),normalizeActiveTab:()=>bt(o),persistTab:pt,activateTab:(g,D)=>aa(o,g,D),activateAdminPage:(g,D)=>pr(o,g,D),loadHome:()=>Se(o),handleSessionExpired:S,loadFiles:()=>Z(a),loadShares:g=>Mt(n,g),loadMonthEvents:()=>st(n),loadContacts:g=>xt(l,g),loadTasks:()=>Xe(i),loadNotes:()=>Oa(r),loadAdminCapabilities:()=>ht(s),loadAdminDashboard:()=>Ye(s),loadAdminUsers:()=>de(s),loadAdminUserDetail:g=>K(s,g),loadAdminUserResources:g=>ce(s,g),loadAdminSystemSettings:()=>Ge(s),loadAdminDatabaseSettings:()=>Qe(s),adminPageMeta:g=>ae(s,g),pickDefaultCalendar:()=>ms(n),toggleCalendarSelected:g=>fs(n,g),blankEventForDay:(g,D)=>ks(n,g,D),defaultRepeat:()=>Nt(),itemKey:L,openContact:g=>zs(l,g),startNewContact:()=>Ks(l),emptyAddress:()=>Na(),syncEditingEventFromForm:g=>ws(n,g),syncEditingTaskFromForm:g=>qs(i,g),syncEditingNoteFromForm:g=>Os(r,g),runBulkTaskAction:g=>Bs(i,g),shell:(g,D)=>dt(t,g,D,{renderImportProgressModal:()=>Re(n),renderFilesUploadProgressModal:()=>_e(a)}),renderLogin:()=>zt(e,t,(g,D)=>dt(t,g,D,{renderImportProgressModal:()=>Re(n),renderFilesUploadProgressModal:()=>_e(a)})),renderFlashBanner:()=>yt(t),renderMonthGrid:()=>ys(n),renderEventModal:()=>$s(n),renderImportProgressModal:()=>Re(n),renderFilesUploadProgressModal:()=>_e(a),renderTasksTab:()=>Rs(i),renderNotesTab:()=>Is(r),renderFilesTab:()=>An(a),renderAdminSection:()=>ts(s),adminSubnavButtons:()=>Mn(s),renderPortalDateTimeField:g=>De(o,g),getDtFieldCurrentValue:g=>na(o,g),setDtFieldValue:(g,D)=>sa(o,g,D),positionDtPopovers:()=>gt(o),accessBadge:ea,formatImportResult:ft,closeImportProgress:()=>hs(n),closeFilesUploadProgress:()=>va(a),resetFilesTransferTree:y,stopImportElapsedTimer:u,stopFilesUploadElapsedTimer:b,unbindUserMenuOutside:f,bindUserMenuOutside:()=>un(t,p),unbindFilesUploadMenuOutside:$,bindFilesUploadMenuOutside:()=>hn(a),onLogin:g=>ln(g,v()),onShare:g=>Cs(n,g),onSaveEvent:g=>Es(n,g),onEditCal:g=>Ts(n,g),onCreateCal:g=>Ps(n,g),onSaveContact:g=>Ys(l,g),onCreateAb:g=>Gs(l,g),onEditAb:g=>Qs(l,g),onSaveTask:g=>Vs(i,g),onSaveNote:g=>Ms(r,g),bindColorPair:wr,bindImportInput:()=>void 0,bindHolidaysToggle:()=>As(n),bindContactPhotoInput:()=>void 0,bindFilesDom:()=>wa(a),bindAdminDom:()=>void 0,saveBlobAsFile:kr,openInfoModal:g=>vr(o,g),closeInfoModal:()=>$r(o),captureScroll:()=>Kt(e),restoreScroll:g=>jt(e,g)},ir(o),rn(v())}let ne="",E=null,A=!1,q=null,J=null,X="sqlite",Ze=!1;async function rt(e,t={}){const a={Accept:"application/json",...t.headers};t.body&&(a["Content-Type"]="application/json"),ne&&t.method&&t.method!=="GET"&&(a["X-CSRF-Token"]=ne);const s=await fetch(`/api/install${e}`,{credentials:"same-origin",...t,headers:a});let n;try{n=await s.json()}catch{throw new Error(`Request failed (${s.status})`)}if(!s.ok)throw new Error(n.error||`Request failed (${s.status})`);return n&&typeof n=="object"&&"data"in n&&n.data!==void 0?n.data:n}async function Rt(){var e;E=await rt("/status"),ne=E.csrfToken||ne,((e=E.defaults)==null?void 0:e.backend)==="pgsql"?X="pgsql":X="sqlite"}function Ce(e,t,a){return`<label class="check-row"><input type="checkbox" name="${d(e)}" ${t?"checked":""} ${A?"disabled":""} /> ${d(a)}</label>`}function Sr(){const e=E==null?void 0:E.permissions;return`<section class="card">
  ...
  </section>`}function Pr(){return`<section class="card card-danger-zone">
  ...
  </section>`}function B(){const e=document.getElementById("app");if(!e)return;const t=(E==null?void 0:E.step)||"permissions";let a="";E?t==="permissions"?a=Sr():t==="initialize"?a=Dr():t==="database"?a=Cr():t==="upgrade"?a=Er():t==="done"?a=Tr():t==="locked"?a=Pr():a=`<section class="card"><p>Unknown step: ${d(t)}</p></section>`:a='<section class="card"><p class="muted">Loading installer…</p></section>',e.innerHTML=`
  ...
  `,Ar()}function Ar(){var t,a,s,n,r,i;const e=document.getElementById("app");e&&((t=e.querySelector('[data-action="reload"]'))==null||t.addEventListener("click",()=>{Fr()}),(a=e.querySelector('[data-action="backend-change"]'))==null||a.addEventListener("change",l=>{X=l.target.value==="pgsql"?"pgsql":"sqlite",B()}),(s=e.querySelector('[data-action="upgrade-toggle"]'))==null||s.addEventListener("change",l=>{Ze=!!l.target.checked,B()}),(n=e.querySelector('[data-action="upgrade-run"]'))==null||n.addEventListener("click",()=>{Or()}),(r=e.querySelector('[data-form="initialize"]'))==null||r.addEventListener("submit",l=>{l.preventDefault(),Ur(l.target)}),(i=e.querySelector('[data-form="database"]'))==null||i.addEventListener("submit",l=>{l.preventDefault(),Ir(l.target)}))}async function Fr(){A=!0,q=null,B();try{await Rt(),J=null}catch(e){q=e instanceof Error?e.message:"Failed to load installer status"}finally{A=!1,B()}}async function Ur(e){const t=new FormData(e),a=n=>{var r;return!!((r=e.querySelector(`input[name="${n}"]`))!=null&&r.checked)},s={timezone:String(t.get("timezone")??"").trim(),cal_enabled:a("cal_enabled"),card_enabled:a("card_enabled"),tasks_enabled:a("tasks_enabled"),notes_enabled:a("notes_enabled"),files_enabled:a("files_enabled"),dav_auth_type:String(t.get("dav_auth_type")??"Digest"),invite_from:String(t.get("invite_from")??"").trim(),session_max_age_minutes:Number(t.get("session_max_age_minutes")??15),admin_password:String(t.get("admin_password")??""),admin_password_confirm:String(t.get("admin_password_confirm")??"")};A=!0,q=null,J=null,B();try{E=await rt("/initialize",{method:"POST",body:JSON.stringify(s)}),ne=E.csrfToken||ne,J="Server settings saved. Configure the database next.",w.event("install.initialize")}catch(n){q=n instanceof Error?n.message:"Initialize failed"}finally{A=!1,B()}}async function Ir(e){const t=new FormData(e),a=String(t.get("backend")??X),s={backend:a,admin_password:String(t.get("admin_password")??""),admin_password_confirm:String(t.get("admin_password_confirm")??"")};a==="sqlite"?s.sqlite_file=String(t.get("sqlite_file")??"").trim():(s.pgsql_host=String(t.get("pgsql_host")??"").trim(),s.pgsql_dbname=String(t.get("pgsql_dbname")??"").trim(),s.pgsql_username=String(t.get("pgsql_username")??"").trim(),s.pgsql_password=String(t.get("pgsql_password")??"")),A=!0,q=null,J=null,B();try{E=await rt("/database",{method:"POST",body:JSON.stringify(s)}),ne=E.csrfToken||ne,J="Database configured. Installer is locked.",w.event("install.database"),E.completed||E.step}catch(n){q=n instanceof Error?n.message:"Database setup failed"}finally{A=!1,B()}}async function Or(){if(Ze){A=!0,q=null,J=null,B();try{const e=await rt("/upgrade",{method:"POST",body:JSON.stringify({confirm:!0})});J="Upgrade completed."+(e.messages&&e.messages.length?" "+e.messages.slice(0,3).join(" · "):""),w.event("install.upgrade"),await Rt()}catch(e){q=e instanceof Error?e.message:"Upgrade failed"}finally{A=!1,B()}}}async function Mr(e){document.title="AngaraDAV · Setup",document.body.classList.add("layout-install"),e.innerHTML='<section class="card"><p class="muted">Loading installer…</p></section>';try{await Rt()}catch(t){q=t instanceof Error?t.message:"Failed to load installer"}B()}const Dt=document.getElementById("app");if(!Dt)throw new Error("#app missing");const ra=window.location.pathname.replace(/\/+$/,"")||"/";ra==="/portal/install"||ra.endsWith("/portal/install")?Mr(Dt):hr(Dt);
