...
`)}function De(s){const c=s.titleId||(s.id?`${s.id}-title`:`modal-title-${Math.random().toString(36).slice(2,9)}`),g=s.id?` id="${i(s.id)}"`:"",h=s.className?` ${s.className}`:"",w=s.rootAttrs?` ${s.rootAttrs}`:"",q=`${Xr(s.size)}${s.cardClassName?` ${s.cardClassName}`:""}`,U=s.closeAction,M=s.lockBackdrop?"":` data-action="${i(U)}"`,W=s.hideClose?"":`<button type="button" class="modal-close info-modal-close" data-action="${i(U)}" aria-label="Close">×</button>`;let ee="";s.footer!==void 0&&(ee=typeof s.footer=="string"?s.footer:fn(s.footer));const ie=ee?`<footer class="cal-modal-footer">${ee}</footer>`:"",se=`<div class="cal-modal-body">${s.body}</div>`;let te;return s.form?te=`<form class="stack"${s.formAttrs?` ${s.formAttrs}`:""}>
    ...
    <div class="info-modal" id="info-modal" hidden role="dialog" aria-modal="true" aria-labelledby="info-modal-title">
    ...
    </div>`}function ol(s){let c=null,g=null,h=al(),w=sl(),q=null,U=!1,M=null,W=null,ee=null,ie=[],se=!1,te=null,mt="",B=qs().adminUsername??null,R=null,G=!1,qe=null,ze=!1,Le=!1,pt=null,At=!1,Et=[],Nt=[],Da=!1,We=null,jt=null,st=null,Ht=null,$e=null,Wt=null,Ra=!1,Ca=null,ca=!1,ft=!1,Je="",Jt=null,Va=!1,Aa=null,Yt="sqlite",ua=!1,bt="",ma=null,Oe=!1,pa=null,ne=[],Kt=[],Ba=[],F=null,K=[],Gt=[],je=null,he=!1,Me=!1,Re=null,Ye=null,xt={y:new Date().getFullYear(),m:new Date().getMonth()},Qt=[],ms=!1,gt=!1,S=null,nt=!1,O=null,za="",Ea=null,Ue=[],V=null,$t=[],Xt="",ce=null,I=null,fe=!1,Ce=!1,rt=!1,Ee=null,He=null,Ke=!1,d=!1,z=null,ja=null,Os=!1,fa={timeFormat:"auto",weekStart:"auto",logLevel:"off"},Ge=null,Us=900,Na=null,Zt=el,ps=!1,Ha=!1;function fs(e){if(!e)return;const t=(e.timeFormat||"auto").toLowerCase(),a=(e.weekStart||"auto").toLowerCase();fa={timeFormat:t==="12h"||t==="24h"?t:"auto",weekStart:a==="monday"||a==="sunday"?a:"auto",logLevel:e.logLevel||"off"},Wr(fa.logLevel),typeof e.sessionIdleSeconds=="number"&&Number.isFinite(e.sessionIdleSeconds)&&e.sessionIdleSeconds>0&&(Us=Math.floor(e.sessionIdleSeconds)),typeof e.version=="string"&&e.version.trim()!==""&&(Zt=e.version.trim())}function bs(){Na!==null&&(clearTimeout(Na),Na=null)}function gs(){if(bs(),!c)return;const e=Math.max(30,Us)*1e3;Na=setTimeout(()=>{Na=null,Vs("Your session timed out. Please sign in again.")},e)}function Wa(){bs(),yt(),z=null,c=null,ne=[],Gt=[],F=null,K=[],Kt=[],Ue=[],V=null,$t=[],ce=null,I=null,fe=!1,Ce=!1,rt=!1,Me=!1,he=!1,Re=null,Ye=null,gt=!1,S=null,nt=!1,Qt=[],Ne=[],ga=[],_t=[],It=[],Pe=null,lt=null,j=null,re=null,Q=!1,Se=!1,ye=[],ys=null,Fe="",xe=[],ya=!1,ke=null,be=null,de=null,ht=!1,ue=[],Ee=null,He=null,Ke=!1,d=!1,Oe=!1,q=null,U=!1,M=null,W=null,ee=null,ie=[],se=!1,te=null,mt="",B=null,R=null,G=!1,qe=null,ze=!1,Le=!1,pt=null,At=!1,Et=[],Nt=[],Da=!1,We=null,jt=null,st=null,Ht=null,$e=null,Wt=null,Ra=!1,Ca=null,ca=!1,ft=!1,Je="",Jt=null,Va=!1,Aa=null,Yt="sqlite",ua=!1,bt="",ma=null,Ta()}function we(){return!!(c!=null&&c.isAdmin||(c==null?void 0:c.role)==="Admin")}function Tt(){return we()?W===null?!0:W.uiEnabled!==!1:!1}function Ve(e){const t=W==null?void 0:W.pages;return t?t.find(a=>a.id===e)??null:null}function ba(e){switch(e){case"full":return"Full";case"read-only":return"Read-only";case"coming-soon":return"Coming soon";case"deferred":return"Unavailable";default:return e}}function xa(e){return e==="full"||e==="read-only"?"badge-ok":e==="deferred"?"badge-off":"badge-soon"}function Ta(){pa&&(document.removeEventListener("click",pa,!0),pa=null)}function hn(){Ta(),pa=t=>{var l;const a=t.target;(l=a==null?void 0:a.closest)!=null&&l.call(a,".user-menu")||(Oe=!1,Ta(),m())};const e=pa;setTimeout(()=>{Oe&&pa===e&&document.addEventListener("click",e,!0)},0)}function Ps(){h==="admin"&&(!we()||!Tt())&&(h="calendars",w="overview",dt(h))}async function Fs(e,t={}){if(!we()){await Rs("calendars",t);return}h="admin",w=e,e!=="users"?(B=null,R=null,qe=null):t.username!==void 0&&(B=t.username,t.username||(R=null,qe=null)),Oe=!1,dt("admin",e,B),N.event("tab",{tab:"admin",adminPage:e,user:B}),t.clearFlash!==!1&&E(),d=!0,m();try{if(await hs(),!Tt()){h="calendars",dt("calendars"),f("info","Portal Administration UI is disabled.");return}const a=Ve(e);e==="overview"&&(a==null?void 0:a.available)!==!1?await Ja():e==="users"&&(a==null?void 0:a.available)!==!1?(await ea(),B&&(await wt(B),await ta(B))):e==="settings"&&(a==null?void 0:a.available)!==!1?await Ya():e==="database"&&(a==null?void 0:a.available)!==!1&&await Ka()}catch(a){N.warn("admin page load failed",a instanceof Error?a.message:a),f("error",a instanceof Error?a.message:"Failed to load")}finally{d=!1,m()}}async function hs(){var e;ee=null;try{W=(await A.adminCapabilities()).data,N.debug("admin.capabilities",{uiEnabled:W.uiEnabled,pages:((e=W.pages)==null?void 0:e.length)??0})}catch(t){ee=t instanceof Error?t.message:"Failed to load capabilities",W={uiEnabled:!0,portalAdminUrl:"/portal/#admin",pages:[{id:"overview",label:"Overview",status:"full",available:!0,portalUrl:"/portal/#admin",portalLabel:"Overview",summary:"Live counts and service flags."},{id:"settings",label:"System settings",status:"full",available:!0,portalUrl:"/portal/#admin/settings",portalLabel:"System settings",summary:"Edit system flags and admin password in the portal."},{id:"users",label:"Users",status:"full",available:!0,portalUrl:"/portal/#admin/users",portalLabel:"Users",summary:"Full DAV user CRUD plus calendars and address books."},{id:"database",label:"Database",status:"full",available:!0,portalUrl:"/portal/#admin/database",portalLabel:"Database",summary:"Connection settings; saves require typing CONFIRM."}]},N.warn("admin.capabilities fallback",ee)}}async function Ja(){U=!0,M=null;try{q=(await A.adminDashboard()).data,N.debug("admin.dashboard",{users:q.users,calendars:q.calendars})}catch(e){throw q=null,M=e instanceof Error?e.message:"Failed to load dashboard",e}finally{U=!1}}async function ea(){se=!0,te=null;try{ie=(await A.adminUsers()).users??[],N.debug("admin.users",{count:ie.length})}catch(e){throw ie=[],te=e instanceof Error?e.message:"Failed to load users",e}finally{se=!1}}async function wt(e){G=!0,qe=null;try{const t=await A.adminUser(e);R=t.user,B=t.user.username,N.debug("admin.user",{username:t.user.username})}catch(t){throw R=null,qe=t instanceof Error?t.message:"Failed to load user",t}finally{G=!1}}async function ta(e){Da=!0;try{const[t,a]=await Promise.all([A.adminUserCalendars(e),A.adminUserAddressBooks(e)]);Et=t.calendars??[],Nt=a.addressbooks??[]}catch(t){throw Et=[],Nt=[],t}finally{Da=!1}}async function Ya(){Ra=!0,Ca=null;try{Wt=(await A.adminSystemSettings()).data}catch(e){throw Wt=null,Ca=e instanceof Error?e.message:"Failed to load settings",e}finally{Ra=!1}}async function Ka(){Va=!0,Aa=null;try{const e=await A.adminDatabaseSettings();Jt=e.data,Yt=(e.data.backend||"sqlite").toLowerCase()==="pgsql"?"pgsql":"sqlite"}catch(e){throw Jt=null,Aa=e instanceof Error?e.message:"Failed to load database settings",e}finally{Va=!1}}async function yn(e){const t=new FormData(e),a=String(t.get("username")??"").trim(),l=String(t.get("displayname")??"").trim(),o=String(t.get("email")??"").trim(),p=String(t.get("password")??""),n=String(t.get("passwordConfirm")??"");if(!a||!l||!o||!p){f("error","Username, display name, email, and password are required"),m();return}if(p!==n){f("error","Password confirmation does not match"),m();return}d=!0,E(),m();try{const r=await A.adminCreateUser({username:a,displayname:l,email:o,password:p,passwordConfirm:n});N.event("admin.user.create",{username:r.user.username}),ze=!1,B=r.user.username,R=r.user,dt("admin","users",r.user.username),await ea(),f("success",`Created user “${r.user.username}”`)}catch(r){f("error",r instanceof Error?r.message:"Create failed")}finally{d=!1,m()}}async function vn(e){var u,b;if(!B)return;const t=B,a=new FormData(e),l=String(a.get("displayname")??"").trim(),o=String(a.get("description")??"").trim(),p=String(a.get("calendarcolor")??"").trim(),n=((u=e.querySelector('input[name="todos"]'))==null?void 0:u.checked)??!1,r=((b=e.querySelector('input[name="notes"]'))==null?void 0:b.checked)??!1;d=!0,E(),m();try{if(We==="create"){const y=String(a.get("uri")??"").trim().toLowerCase();await A.adminCreateUserCalendar(t,{uri:y,displayname:l,description:o,calendarcolor:p||void 0,todos:n,notes:r}),f("success",`Created calendar “${l}”`)}else{const y=Number(a.get("instanceId"));await A.adminUpdateUserCalendar(t,y,{displayname:l,description:o,calendarcolor:p,todos:n,notes:r}),f("success",`Updated calendar “${l}”`)}We=null,jt=null,await ta(t),await wt(t)}catch(y){f("error",y instanceof Error?y.message:"Save failed")}finally{d=!1,m()}}async function $n(e){if(!B)return;const t=B,a=new FormData(e),l=String(a.get("displayname")??"").trim(),o=String(a.get("description")??"").trim();d=!0,E(),m();try{if(st==="create"){const p=String(a.get("uri")??"").trim().toLowerCase();await A.adminCreateUserAddressBook(t,{uri:p,displayname:l,description:o}),f("success",`Created address book “${l}”`)}else{const p=Number(a.get("id"));await A.adminUpdateUserAddressBook(t,p,{displayname:l,description:o}),f("success",`Updated address book “${l}”`)}st=null,Ht=null,await ta(t),await wt(t)}catch(p){f("error",p instanceof Error?p.message:"Save failed")}finally{d=!1,m()}}function Ms(e){const t=new FormData(e),a=String(t.get("backend")??Yt).toLowerCase()==="pgsql"?"pgsql":"sqlite",l={backend:a};return a==="sqlite"?l.sqlite_file=String(t.get("sqlite_file")??"").trim():(l.pgsql_host=String(t.get("pgsql_host")??"").trim(),l.pgsql_dbname=String(t.get("pgsql_dbname")??"").trim(),l.pgsql_username=String(t.get("pgsql_username")??"").trim(),l.pgsql_password=String(t.get("pgsql_password")??"")),l}function wn(e){ma=Ms(e),bt="",ua=!0,E(),m()}async function Sn(e){if(e||(e=s.querySelector('[data-form="admin-database"]')),!e){f("error","Database form not found"),m();return}const t=Ms(e);d=!0,E(),m();try{const a=await A.adminTestDatabaseConnection(t);f("success",a.message||"Connection successful"),N.event("admin.database.test",{backend:a.backend})}catch(a){f("error",a instanceof Error?a.message:"Connection test failed")}finally{d=!1,m()}}async function kn(e){const t=new FormData(e),a=n=>{var r;return!!((r=e.querySelector(`input[name="${n}"]`))!=null&&r.checked)},l={cal_enabled:a("cal_enabled"),card_enabled:a("card_enabled"),tasks_enabled:a("tasks_enabled"),notes_enabled:a("notes_enabled"),files_enabled:a("files_enabled"),push_enabled:a("push_enabled"),portal_admin_ui_enabled:a("portal_admin_ui_enabled"),timezone:String(t.get("timezone")??"").trim(),invite_from:String(t.get("invite_from")??"").trim(),dav_auth_type:String(t.get("dav_auth_type")??"Digest"),files_storage_path:String(t.get("files_storage_path")??"").trim(),files_max_upload_mb:Number(t.get("files_max_upload_mb")??0),files_quota_mb:Number(t.get("files_quota_mb")??0),files_quarantine_days:Number(t.get("files_quarantine_days")??0),session_max_age_minutes:Number(t.get("session_max_age_minutes")??15),portal_log_level:String(t.get("portal_log_level")??"off"),portal_admin_users:String(t.get("portal_admin_users")??"").trim(),push_external_url:String(t.get("push_external_url")??"").trim(),push_log_level:String(t.get("push_log_level")??"off")},o=String(t.get("admin_password")??""),p=String(t.get("admin_password_confirm")??"");(o!==""||p!=="")&&(l.admin_password=o,l.admin_password_confirm=p),d=!0,E(),m();try{Wt=(await A.adminUpdateSystemSettings(l)).data,N.event("admin.settings.save"),f("success","System settings saved")}catch(n){f("error",n instanceof Error?n.message:"Save failed")}finally{d=!1,m()}}async function Dn(e){const t=new FormData(e),a=String(t.get("username")??"").trim(),l=String(t.get("displayname")??"").trim(),o=String(t.get("email")??"").trim(),p=String(t.get("password")??""),n=String(t.get("passwordConfirm")??"");if(!a){f("error","Username is required"),m();return}if(!l||!o){f("error","Display name and email are required"),m();return}if(p!==""||n!==""){if(p===""||n===""){f("error","Password and confirmation are required to change password"),m();return}if(p!==n){f("error","Password confirmation does not match"),m();return}}d=!0,E(),m();try{const r={displayname:l,email:o};p!==""&&(r.password=p,r.passwordConfirm=n);const u=await A.adminUpdateUser(a,r);N.event("admin.user.update",{username:u.user.username,passwordChanged:p!==""}),Le=!1,R=u.user,B=u.user.username,await ea(),f("success",p!==""?`Updated “${u.user.username}” (password changed)`:`Updated “${u.user.username}”`)}catch(r){f("error",r instanceof Error?r.message:"Update failed")}finally{d=!1,m()}}async function Rs(e,t={}){if(e==="admin"&&(!we()||!Tt())&&(we()&&W&&!W.uiEnabled&&f("info","Portal Administration UI is disabled (portal_admin_ui_enabled)."),e="calendars"),e==="admin"){await Fs(w||"overview",{...t,username:w==="users"?B:null});return}h=e,Oe=!1,dt(e),N.event("tab",{tab:e}),e!=="calendars"&&(he=!1,Re=null),e!=="contacts"&&(Ye=null),t.clearFlash!==!1&&E(),d=!0,m();try{e==="contacts"&&V!==null?await Ot(V):e==="calendars"?await Xe():e==="tasks"?await Ut():e==="notes"?await va():e==="files"&&await St()}catch(a){N.warn("tab load failed",a instanceof Error?a.message:a),f("error",a instanceof Error?a.message:"Failed to load")}finally{d=!1,m()}}async function St(){ya=!0;try{N.debug("loadFiles",{path:Fe});const[e,t]=await Promise.all([A.filesStatus(),A.filesList(Fe).catch(a=>{if(a instanceof Ie&&(a.status===503||a.status===404))return{path:Fe,entries:[]};throw a})]);if(ys=e,e.ready){Fe=t.path,xe=t.entries;const a=new Set(xe.map(l=>l.path));ue=ue.filter(l=>a.has(l))}else xe=[],ue=[];N.event("loadFiles",{path:Fe,count:xe.length,enabled:e.enabled,ready:e.ready})}finally{ya=!1}}function Vs(e){if(!ps){if(!c){bs();return}ps=!0;try{N.event("session.expired"),Wa(),Ha=!0,g={type:"info",message:e&&e.trim()?e:"Your session timed out. Please sign in again."},m()}finally{ps=!1}}}let Ne=[],ga=[],_t=[],It=[],Ga="",Qa="",qt="due",kt="asc",ha="dtstart",aa="desc",Pe=null,lt=null,j=null,re=null,Q=!1,Se=!1,ye=[],ys=null,Fe="",xe=[],ya=!1,ke=null,be=null,de=null,ht=!1,ue=[];function f(e,t){Ha&&e==="error"||(e!=="error"&&(Ha=!1),g={type:e,message:t})}function E(){g=null,Ha=!1}function Cn(e){const t=String(e.step||"");t==="upgrade"||t==="initialize"||t==="permissions"||t==="database"?(je={step:t,message:e.message||(t==="upgrade"?"Complete the upgrade wizard before signing in.":"Complete setup before signing in."),installUrl:e.installUrl||"/portal/install/",productVersion:e.productVersion,configuredVersion:e.configuredVersion??null},typeof e.productVersion=="string"&&e.productVersion.trim()!==""&&(Zt=e.productVersion.trim())):je=null}function An(e){if(!(e instanceof Ie)||e.status!==503)return!1;const t=typeof e.payload.code=="string"?e.payload.code:"";return t!=="upgrade_required"&&t!=="not_configured"&&t!=="admin_password_missing"?!1:(je={step:t==="upgrade_required"?"upgrade":"initialize",message:e.message,installUrl:typeof e.payload.installUrl=="string"?e.payload.installUrl:"/portal/install/",productVersion:typeof e.payload.productVersion=="string"?e.payload.productVersion:void 0,configuredVersion:typeof e.payload.configuredVersion=="string"?e.payload.configuredVersion:null},je.productVersion&&(Zt=je.productVersion),!0)}async function En(){var e,t,a,l;N.event("bootstrap.start"),Yr(o=>{Vs(/timed\s*out|session expired/i.test(o)?o:"Your session timed out. Please sign in again.")}),Kr(()=>{gs()});try{const o=await A.installStatus();Cn(o)}catch(o){N.debug("bootstrap: /api/install/status failed",o instanceof Error?o.message:o)}try{const o=await A.ui();fs(o.ui),typeof o.version=="string"&&o.version.trim()!==""?Zt=o.version.trim():o.ui&&typeof o.ui.version=="string"&&o.ui.version.trim()!==""&&(Zt=o.ui.version.trim()),je==null||je.step}catch(o){N.debug("bootstrap: /api/ui failed",o instanceof Error?o.message:o),An(o)}if(je&&je.step!=="done"&&je.step!=="locked"){Wa(),N.event("bootstrap.installGate",{step:je.step}),m();return}try{const o=await A.me();if(c=o.user,fs(o.ui),typeof o.version=="string"&&o.version.trim()!==""&&(Zt=o.version.trim()),N.event("bootstrap.session",{username:(c==null?void 0:c.username)??null}),gs(),we())try{await hs()}catch(p){N.warn("admin.capabilities bootstrap",p instanceof Error?p.message:p)}if(Ps(),dt(h,w),await Qe(),h==="admin"&&we()&&Tt())try{w==="overview"&&((e=Ve("overview"))==null?void 0:e.available)!==!1?await Ja():w==="users"&&((t=Ve("users"))==null?void 0:t.available)!==!1?(await ea(),B&&(await wt(B),await ta(B))):w==="settings"&&((a=Ve("settings"))==null?void 0:a.available)!==!1?await Ya():w==="database"&&((l=Ve("database"))==null?void 0:l.available)!==!1&&await Ka()}catch(p){N.warn("admin bootstrap load",p instanceof Error?p.message:p)}}catch(o){o instanceof Ie&&o.status===401?(Wa(),/timed\s*out|session expired/i.test(o.message)&&f("info",o.message),N.event("bootstrap.anonymous")):(N.error("bootstrap failed",o instanceof Error?o.message:o),f("error",o instanceof Error?o.message:"Failed to load"))}m()}async function Qe(){N.debug("loadHome");const[e,t,a]=await Promise.all([A.calendars(),A.directory().catch(()=>({users:[]})),A.addressbooks()]);if(ne=e.calendars,Kt=t.users,Ue=a.addressbooks,N.event("loadHome",{calendars:ne.length,addressBooks:Ue.length,directory:Kt.length}),Ba.length===0)try{Ba=(await A.holidayCountries()).countries}catch{Ba=[]}if(K=K.filter(l=>ne.some(o=>o.id===l)),F!==null&&!ne.some(l=>l.id===F)&&(F=null,Gt=[],he=!1,Re=null),K.length===0){const l=Bs();l?(K=[l.id],F=l.id):ne.length>0&&(K=[ne[0].id],F=ne[0].id)}F===null&&K.length>0&&(F=K[0]),F!==null&&he?await _a(F):F!==null&&(Gt=[]),h==="calendars"&&await Xe(),V!==null&&!Ue.some(l=>l.id===V)&&(V=null,$t=[],ce=null,I=null,fe=!1),Ye!==null&&!Ue.some(l=>l.id===Ye)&&(Ye=null),V===null&&Ue.length>0&&(V=Ue[0].id),V!==null&&h==="contacts"&&await Ot(V),h==="tasks"&&await Ut(),h==="notes"&&await va(),h==="files"&&await St()}async function _a(e){Gt=(await A.shares(e)).shares}function Bs(){const e=ne.filter(a=>a.canShare);if(e.length===0)return null;const t=a=>{const l=a.uri.toLowerCase(),o=a.displayname.toLowerCase();return l==="default"||o==="default"||o==="default calendar"};return e.find(t)??e[0]??null}function ge(e){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),l=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${l}`}function Nn(e,t){const a=new Date(e,t,1),l=new Date(e,t+1,0);return{from:ge(a),to:ge(l)}}function vs(e){if(/^\d{4}-\d{2}-\d{2}$/.test(e)){const[a,l,o]=e.split("-").map(Number);return new Date(a,l-1,o)}const t=new Date(e);if(Number.isNaN(t.getTime())){const[a,l,o]=e.slice(0,10).split("-").map(Number);return new Date(a,(l||1)-1,o||1)}return new Date(t.getFullYear(),t.getMonth(),t.getDate())}function xn(e){const t=vs(e.start);if(!e.end)return[ge(t)];let a=vs(e.end);if(!e.allDay&&!/^\d{4}-\d{2}-\d{2}$/.test(e.end)){const r=new Date(e.end);!Number.isNaN(r.getTime())&&r.getHours()===0&&r.getMinutes()===0&&r.getSeconds()===0&&r.getTime()>new Date(e.start).getTime()&&(a=new Date(a.getFullYear(),a.getMonth(),a.getDate()-1))}if(a<t)return[ge(t)];const l=[],o=new Date(t.getFullYear(),t.getMonth(),t.getDate()),p=new Date(a.getFullYear(),a.getMonth(),a.getDate());let n=0;for(;o<=p&&n++<370;)l.push(ge(o)),o.setDate(o.getDate()+1);return l.length?l:[ge(t)]}function $s(e,t){const a=e.slice(0,10),l=(t||a).slice(0,10);if(a===l){const $=qa(a);return{start:$.start,end:$.end}}const[o,p,n]=a.split("-").map(Number),[r,u,b]=l.split("-").map(Number),y=Lt(new Date(o,p-1,n,9,0,0,0)),v=Lt(new Date(r,u-1,b,17,0,0,0));return{start:y,end:v}}function Tn(e,t){const a=sa(e);let l=t?sa(t):a;if(t&&!/^\d{4}-\d{2}-\d{2}$/.test(t)){const o=new Date(t);if(!Number.isNaN(o.getTime())&&o.getHours()===0&&o.getMinutes()===0&&o.getTime()>new Date(e).getTime()){const p=vs(t);p.setDate(p.getDate()-1),l=ge(p)}}return{start:a,end:l}}async function Xe(){const e=K.filter(l=>ne.some(o=>o.id===l));if(e.length===0){Qt=[];return}const{from:t,to:a}=Nn(xt.y,xt.m);ms=!0,N.debug("loadMonthEvents",{selectedIds:e,from:t,to:a});try{const o=(await Promise.all(e.map(async p=>(await A.calendarEvents(p,t,a)).events.map(r=>({...r,instanceId:p}))))).flat();o.sort((p,n)=>{const r=p.start||"",u=n.start||"";return r!==u?r<u?-1:1:(p.summary||"").localeCompare(n.summary||"")}),Qt=o,N.event("monthEvents.loaded",{calendarIds:e,count:Qt.length,from:t,to:a})}catch(l){Qt=[],N.warn("loadMonthEvents failed",l instanceof Error?l.message:l)}finally{ms=!1}}function _n(e){const t=ne.find(a=>a.id===e);return t!=null&&t.color?t.color.length>=7?t.color.slice(0,7):t.color:"#3B82F6"}function In(e){K.includes(e)?(K=K.filter(t=>t!==e),F===e&&(F=K[0]??null)):(K=[...K,e],F=e)}function qn(e,t){return new Date(e,t,1).toLocaleString(void 0,{month:"long",year:"numeric"})}function Ln(e){const t=e.summary||"(No title)";if(e.allDay||/^\d{4}-\d{2}-\d{2}$/.test(e.start))return t;const a=new Date(e.start);return Number.isNaN(a.getTime())?t:`${a.toLocaleTimeString(void 0,ws())} ${t}`}function On(){const e=ne.filter(x=>K.includes(x.id)),t=e.length===0?"No calendar selected":e.length===1?e[0].displayname:`${e.length} calendars`,a=xt.y,l=xt.m,o=new Date(a,l,1),p=Ss(),n=(o.getDay()-p+7)%7,r=new Date(a,l+1,0).getDate(),u=new Date(a,l,0).getDate(),y=ge(new Date),v=zs(),$=new Map;for(const x of Qt)for(const Y of xn(x)){const H=$.get(Y)??[];H.push(x),$.set(Y,H)}const T=[],D=Math.ceil((n+r)/7)*7;for(let x=0;x<D;x++){let Y,H=!0,X;x<n?(Y=u-n+x+1,H=!1,X=new Date(a,l-1,Y)):x>=n+r?(Y=x-(n+r)+1,H=!1,X=new Date(a,l+1,Y)):(Y=x-n+1,X=new Date(a,l,Y));const pe=ge(X),Ae=pe===y,Te=H?$.get(pe)??[]:[],vt=Ea===pe?50:3,it=Te.slice(0,vt),Dt=Te.length-it.length,Be=it.map(J=>{var le;const Ze=J.instanceId,_e=Ln(J),et=_n(Ze),oa=((le=ne.find(tt=>tt.id===Ze))==null?void 0:le.displayname)||"",k=oa?`${_e} · ${oa}`:_e;return`<button type="button" class="month-event${J.allDay?"":" is-timed"}" title="${i(k)}" style="--ev-color:${i(et)}"
            data-action="open-event" data-instance="${Ze}" data-uri="${i(J.uri)}" ${d?"disabled":""}>${i(_e)}</button>`}).join(""),Rt=Dt>0?`<button type="button" class="month-event-more" data-action="open-event-day" data-day="${i(pe)}" title="Show all events this day" ${d?"disabled":""}>+${Dt} more</button>`:"",Vt=!H&&(Y===1||x===n+r)?X.toLocaleString(void 0,{month:"short",day:"numeric"}):String(Y),C=F!==null?ne.find(J=>J.id===F)??null:null,oe=!!(C&&!C.readOnly&&(C.canShare||C.access==="readwrite"));T.push(`<div class="month-cell${H?"":" is-outside"}${Ae?" is-today":""}${oe?" is-clickable":""}"${oe?` data-action="new-event-day" data-day="${i(pe)}" role="button" tabindex="0" title="Add event on ${i(pe)}"`:""}>
        <div class="month-daynum${Ae?" is-today-num":""}">${i(Vt)}</div>
        <div class="month-events">${Be}${Rt}</div>
      ...
      <div class="month-cal-toolbar">
        ...
        <h2 class="month-cal-title">${i(qn(a,l))}</h2>
      ...
      <button type="button" class="dt-trigger" data-action="dt-open" data-dt-field="${i(t)}"
        ...
        ${r?"disabled":""} aria-expanded="${b}">
        <span class="dt-trigger-text">${i(y)}</span>
        <span class="dt-trigger-icon" aria-hidden="true">▾</span>
      </button>
      ${b&&!r?Mn(t,o,p,u):""}
    </div>`}function ks(e){var t;return e==="start"?String((S==null?void 0:S.start)||""):e==="end"?String((S==null?void 0:S.end)||""):e==="until"?((t=S==null?void 0:S.repeat)==null?void 0:t.until)||sa(S==null?void 0:S.start)||ge(new Date):e==="due"?$a(j==null?void 0:j.due):e==="dtstart"?$a(re==null?void 0:re.dtstart):e==="bulk-due"?za:e==="birthday"?String((I==null?void 0:I.birthday)||""):""}function ot(e,t){if(e==="start"&&S){S={...S,start:t||""};return}if(e==="end"&&S){S={...S,end:t};return}if(e==="until"&&S){S={...S,repeat:{...S.repeat??Xa(),until:t,endMode:"until"}};return}if(e==="due"&&j){if(t===null||t==="")j={...j,due:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(t))j={...j,due:new Date(t+"T00:00:00").toISOString()};else{const a=new Date((t.length===16,t));j={...j,due:Number.isNaN(a.getTime())?t:a.toISOString()}}return}if(e==="dtstart"&&re){if(t===null||t==="")re={...re,dtstart:null};else if(/^\d{4}-\d{2}-\d{2}$/.test(t))re={...re,dtstart:new Date(t+"T00:00:00").toISOString()};else{const a=new Date((t.length===16,t));re={...re,dtstart:Number.isNaN(a.getTime())?t:a.toISOString()}}return}if(e==="birthday"&&I){I={...I,birthday:t&&/^\d{4}-\d{2}-\d{2}/.test(t)?t.slice(0,10):null};return}e==="bulk-due"&&(za=t||"")}function Mn(e,t,a,l){const o=Ia(t),p=(O==null?void 0:O.viewY)??Number(o.date.slice(0,4)),n=(O==null?void 0:O.viewM)??Number(o.date.slice(5,7))-1,r=Ss(),u=zs(),y=(new Date(p,n,1).getDay()-r+7)%7,v=new Date(p,n+1,0).getDate(),$=new Date(p,n,0).getDate(),T=o.date,D=o.hm,L=new Date(p,n,1).toLocaleString(void 0,{month:"long",year:"numeric"}),ae=[],x=Math.ceil((y+v)/7)*7;for(let H=0;H<x;H++){let X,pe,Ae=!1;H<y?(X=$-y+H+1,pe=new Date(p,n-1,X),Ae=!0):H>=y+v?(X=H-(y+v)+1,pe=new Date(p,n+1,X),Ae=!0):(X=H-y+1,pe=new Date(p,n,X));const Te=ge(pe),vt=Te===T,it=Te===ge(new Date);ae.push(`<button type="button" class="dt-day${Ae?" is-outside":""}${vt?" is-selected":""}${it?" is-today":""}" data-action="dt-pick-day" data-dt-field="${e}" data-day="${i(Te)}">${X}</button>`)}const Y=a?"":`<div class="dt-times" role="listbox" aria-label="Time">
          ${Fn().map(H=>{const X=(()=>{const[pe,Ae]=H.split(":").map(Number);return new Date(2e3,0,1,pe,Ae).toLocaleTimeString(void 0,ws())})();return`<button type="button" class="dt-time${H===D?" is-selected":""}" data-action="dt-pick-time" data-dt-field="${e}" data-hm="${H}" role="option" aria-selected="${H===D}">${i(X)}</button>`}).join("")}
            ...
            <fieldset class="event-repeat" ${p?"disabled":""}>
              ...
              ${a==="WEEKLY"?`<div class="event-byday" role="group" aria-label="Days of week">
                      ${u.map(T=>`<label class="checkbox event-byday-item">
                              <input type="checkbox" name="repeatByDay" value="${T.code}" ${b.has(T.code)?"checked":""} />
                              ${T.label}
                            </label>`).join("")}
                    </div>`:""}
    ...
    </div>`}function zn(e,t){const a=ne.find(l=>l.id===t);return{uri:"",instanceId:t,calendarId:(a==null?void 0:a.calendarId)??0,calendarName:(a==null?void 0:a.displayname)??"Calendar",calendarUri:(a==null?void 0:a.uri)??"",uid:"",summary:"",description:"",location:"",start:e,end:e,allDay:!0,hasRrule:!1,repeat:Xa(),readOnly:!1,canWrite:!0}}async function Ot(e){$t=(await A.contacts(e,Xt)).contacts,ce!==null&&!$t.some(a=>a.uri===ce)&&(ce=null,fe||(I=null,Ee=null,He=null,Ke=!1))}async function Ut(){const e=await A.tasks({q:Ga,sort:qt,order:kt});Ne=e.tasks,_t=e.calendars;const t=new Set(Ne.map(a=>me(a.instanceId,a.uri)));ye=ye.filter(a=>t.has(a)),Pe!==null&&!Ne.some(a=>`${a.instanceId}|${a.uri}`===Pe)&&(Pe=null,Q||(j=null))}async function va(){const e=await A.notes({q:Qa,sort:ha,order:aa});ga=e.notes,It=e.calendars,lt!==null&&!ga.some(t=>`${t.instanceId}|${t.uri}`===lt)&&(lt=null,Se||(re=null))}function me(e,t){return`${e}|${t}`}function Hs(e){if(!e)return"—";try{const t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleString(void 0,{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return e}}function $a(e){if(!e)return"";try{const t=new Date(e);if(Number.isNaN(t.getTime()))return"";const a=l=>String(l).padStart(2,"0");return`${t.getFullYear()}-${a(t.getMonth()+1)}-${a(t.getDate())}T${a(t.getHours())}:${a(t.getMinutes())}`}catch{return""}}function Pt(e,t,a,l,o,p=""){const n=a===t,r=n?l==="asc"?" ▲":" ▼":"";return`<th class="${`sortable-th${n?" is-sorted":""}${p?" "+p:""}`}" data-action="sort-${o}" data-sort="${i(t)}" role="columnheader" tabindex="0">${i(e)}${r}</th>`}async function jn(e){if(V===null)return;const t=await A.getContact(V,e);ce=e,fe=!1;const a=t.contact;I={...a,emails:Array.isArray(a.emails)?a.emails:[],phones:Array.isArray(a.phones)?a.phones:[],custom:Array.isArray(a.custom)?a.custom:[],address:a.address??Ws(),birthday:a.birthday??null},Ee=a.photoDataUri??(a.hasPhoto&&V!==null?`${A.contactPhotoUrl(V,e)}?t=${Date.now()}`:null),He=null,Ke=!1,Ce=!0}function Hn(){fe=!0,ce=null,Ce=!0,I={uri:"",displayname:"",firstname:"",lastname:"",fullname:"",org:"",title:"",emails:[""],phones:[{type:"cell",value:""}],address:{street:"",city:"",region:"",postal:"",country:""},birthday:null,url:"",note:"",custom:[],hasPhoto:!1,photoDataUri:null},Ee=null,He=null,Ke=!1}function Ws(){return{street:"",city:"",region:"",postal:"",country:""}}function Wn(e){return new Promise((t,a)=>{const l=new FileReader;l.onload=()=>{const o=String(l.result??""),p=o.indexOf(",");t(p>=0?o.slice(p+1):o)},l.onerror=()=>a(new Error("Failed to read photo file")),l.readAsDataURL(e)})}function Js(e,t={}){const a=!!c&&h==="admin"&&we()&&Tt(),p=`
      ...
      <span class="brand-text">Angara<span class="brand-dav">DAV</span><span class="brand-sep" aria-hidden="true"> · </span><span class="${a?"brand-portal brand-portal-admin":"brand-portal brand-portal-user"}">${i(a?"Administration Portal":"User Portal")}</span></span>`,n=c?i(c.displayname||c.username):"",r=Tt()?`<button type="button" class="user-menu-item${h==="admin"?" is-active":""}" role="menuitem" data-action="tab" data-tab="admin">
          ...
          <a class="brand" href="/portal/">${p}</a>
        </nav>`,$=!(he||Me||Re!==null||Ye!==null||gt||Ce||rt)?Ft():"",T=t.tabs&&t.tabs.trim()!==""?`<div class="tabs-bar" role="presentation">
      ...
      <footer class="site-footer">
        <div class="container footer-inner">
          ...
          <span class="footer-sep" aria-hidden="true">·</span>
          <a href="${i(tl)}" target="_blank" rel="noopener noreferrer">Docs</a>
        </div>
      ...
      ${Jn()}`}function Ft(){return g?ia(g.type,g.message,{dismissible:!0}):""}function Ys(e){return!Number.isFinite(e)||e<0?"":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:`${(e/(1024*1024)).toFixed(1)} MB`}function wa(e){const t=Math.max(0,Math.floor(e)),a=Math.floor(t/60),l=t%60;return a>0?`${a}m ${l}s`:`${l}s`}function yt(){ja!==null&&(clearInterval(ja),ja=null)}function Ks(){yt(),ja=setInterval(()=>{if(!z||z.phase==="done"||z.phase==="error"){yt();return}z={...z,elapsedSec:Math.floor((Date.now()-z.startedAt)/1e3)},z.phase==="processing"&&Xs(z)},1e3)}function Mt(e,t={}){z&&(z={...z,phase:e,elapsedSec:Math.floor((Date.now()-z.startedAt)/1e3),...t},m())}function Gs(){yt(),z=null,m()}function Qs(e){!z||z.phase==="done"||z.phase==="error"||(z={...z,phase:"processing",processPercent:e.percent,processCurrent:e.current,processTotal:e.total,processImported:e.imported,processUpdated:e.updated,processSkipped:e.skipped,elapsedSec:Math.floor((Date.now()-z.startedAt)/1e3)},Xs(z))}function Xs(e){const t=s.querySelector("[data-import-status-line]"),a=s.querySelector(".import-progress-bar"),l=s.querySelector(".import-progress-track"),o=s.querySelector("[data-import-counts]"),p=e.kind==="calendar"?"items":"contacts";let n;if(e.phase==="processing"&&e.processTotal>0)n=`Importing ${e.processCurrent.toLocaleString()} / ${e.processTotal.toLocaleString()} ${p} (${e.processPercent??0}%) · ${wa(e.elapsedSec)}`;else if(e.phase==="processing")n=`Importing on server… ${wa(e.elapsedSec)}`;else return;t&&(t.textContent=n),o&&(o.textContent=`${e.processImported} new · ${e.processUpdated} updated${e.processSkipped?` · ${e.processSkipped} skipped`:""}`),a&&e.processPercent!==null&&(a.classList.remove("is-indeterminate"),a.style.width=`${Math.min(100,Math.max(0,e.processPercent))}%`),l&&e.processPercent!==null&&(l.setAttribute("aria-valuenow",String(e.processPercent)),l.removeAttribute("aria-valuetext"))}function Jn(){if(!z)return"";const e=z,t=e.phase!=="done"&&e.phase!=="error",a=e.kind==="calendar"?"calendar (.ics)":"contacts (.vcf)",l=e.phase==="done"?"Import finished":e.phase==="error"?"Import failed":"Importing…",o=(()=>{const r=[{id:"reading",label:"Reading file"},{id:"uploading",label:"Uploading to server"},{id:"processing",label:"Importing on server"}],b={reading:0,uploading:1,processing:2,done:3,error:2}[e.phase]??0;return r.map((y,v)=>{let $="pending";return e.phase==="done"||v<b?$="done":v===b&&($=(e.phase==="error","active")),`<li class="import-step import-step-${$}"><span class="import-step-icon" aria-hidden="true">${$==="done"?"✓":$==="active"?"●":"○"}</span> ${i(y.label)}</li>`}).join("")})();let p="";if(t){let r=null;e.phase==="reading"&&e.readPercent!==null?r=Math.min(100,Math.max(0,e.readPercent)):e.phase==="processing"&&e.processPercent!==null&&(r=Math.min(100,Math.max(0,e.processPercent)));const u=r===null?"import-progress-bar is-indeterminate":"import-progress-bar",b=r!==null?` style="width:${r}%"`:"",y=e.kind==="calendar"?"items":"contacts";let v;e.phase==="reading"?v=e.readPercent!==null?`Reading file… ${e.readPercent}%`:"Reading file…":e.phase==="uploading"?v="Uploading to server…":e.processTotal>0?v=`Importing ${e.processCurrent.toLocaleString()} / ${e.processTotal.toLocaleString()} ${y} (${e.processPercent??0}%) · ${wa(e.elapsedSec)}`:v=`Importing on server… ${wa(e.elapsedSec)}`;const $=e.phase==="processing"&&e.processTotal>0?`<p class="muted small" data-import-counts style="margin:0 0 0.5rem">${e.processImported} new · ${e.processUpdated} updated${e.processSkipped?` · ${e.processSkipped} skipped`:""}</p>`:'<p class="muted small" data-import-counts style="margin:0 0 0.5rem;display:none"></p>';p=`
        ...
        <p class="muted small">Large imports can time out; try again — already-imported items update faster.</p>`;const n=t?'<p class="muted small" style="margin:0">Please wait…</p>':fn([{label:"Close",action:"close-import-progress",variant:"primary"}]);return De({title:l,titleId:"import-progress-title",closeAction:"close-import-progress",size:"sm",className:"import-progress-modal",cardClassName:"import-progress-card",rootAttrs:"data-import-progress",hideClose:t,lockBackdrop:t,body:p,footer:n})}function Zs(e,t){return new Promise((a,l)=>{const o=new FileReader;o.onprogress=p=>{p.lengthComputable&&p.total>0?t(Math.min(100,Math.round(p.loaded/p.total*100))):t(null)},o.onload=()=>a(String(o.result??"")),o.onerror=()=>l(o.error??new Error("Failed to read file")),o.readAsText(e)})}function en(){const e=je,t=e&&(e.step==="upgrade"||e.step==="initialize"||e.step==="permissions"||e.step==="database"),a=(e==null?void 0:e.installUrl)||"/portal/install/";let l="";if(t&&e){const p=e.step==="upgrade"?"Server upgrade required":"Setup incomplete",n=e.step==="upgrade"&&(e.configuredVersion||e.productVersion)?`<p class="muted small" style="margin:0.5rem 0 0">Configured <span class="mono">${i(String(e.configuredVersion||"—"))}</span>
        ...
        </p>`}const o=d||!!t;s.innerHTML=Js(`<div class="auth-wrap">
        <div class="card auth-card">
      ...
      </div>`,{auth:!0})}function Yn(){if(!c){en();return}const e=ne.filter(k=>k.canShare),t=ne.filter(k=>!k.canShare),a=ne.find(k=>k.id===F)??null,l=e.map(k=>{const le=K.includes(k.id),tt=le?" is-selected":"",Pa=k.id===F?" is-primary":"",Cs=k.color?`<span class="cal-swatch" style="background:${i(k.color)}"></span>`:'<span class="cal-swatch cal-swatch-empty"></span>',As=Ns(k.access)+(k.readOnly?'<span class="badge">read-only</span>':"")+(k.holidaysCountry?`<span class="badge badge-admin">holidays ${i(k.holidaysCountry)}</span>`:"");return`<div class="cal-row${tt}${Pa}" data-action="select-cal" data-id="${k.id}" role="button" tabindex="0" title="Toggle on the month grid">
          <label class="cal-row-check" title="Show events on the month grid" onclick="event.stopPropagation()">
            <input type="checkbox" data-action="toggle-cal" data-id="${k.id}" ${le?"checked":""} ${d?"disabled":""} />
          </label>
          ${Cs}
          <span class="cal-row-text">
            <span class="cal-row-title">${i(k.displayname)}</span>
            <span class="cal-row-badges">${As}</span>
        ...
        </div>`}).join(""),o=t.map(k=>{const le=K.includes(k.id),tt=le?" is-selected":"",Pa=k.id===F?" is-primary":"",Cs=k.color?`<span class="cal-swatch" style="background:${i(k.color)}"></span>`:'<span class="cal-swatch cal-swatch-empty"></span>',As=k.access==="readwrite"?"Shared with you · full access — check to show events; click to set as primary for new events":"Shared with you · read-only — check to show events";return`<div class="cal-row${tt}${Pa}" data-action="select-cal" data-id="${k.id}" role="button" tabindex="0" title="${i(As)}">
          <label class="cal-row-check" title="Show events on the month grid" onclick="event.stopPropagation()">
            <input type="checkbox" data-action="toggle-cal" data-id="${k.id}" ${le?"checked":""} ${d?"disabled":""} />
          </label>
          ${Cs}
          <span class="cal-row-text">
            <span class="cal-row-title">${i(k.displayname)}</span>
            <span class="cal-row-badges">${Ns(k.access)}</span>
            <span class="muted small">${k.access==="readwrite"?"Shared · full access":"Shared · read-only"}</span>
          </span>
          <span class="cal-row-actions">
            <button type="button" class="btn btn-small" data-action="export-cal" data-id="${k.id}" ${d?"disabled":""} title="Export as .ics">Export</button>
          </span>
        </div>`}).join(""),p=Kt.map(k=>`<option value="${i(k.username)}">${i(k.displayname)} (${i(k.username)})</option>`).join(""),n=Gt.length===0?'<tr><td colspan="3" class="muted">Not shared with anyone yet.</td></tr>':Gt.map(k=>`<tr>
                <td>
              ...
              </tr>`).join(""),r=a!=null&&a.color&&a.color.length>=7?a.color.slice(0,7):"#3B82F6",u=!!(a&&a.readOnly),b=he&&a&&a.canShare?De({id:"cal-edit-modal",title:"Calendar details",titleId:"cal-modal-title",closeAction:"close-cal-modal",body:`
                ${Ft()}
                <section>
                ...
                </section>`,footer:[{label:"Close",action:"close-cal-modal",variant:"ghost"}]}):"",y=Re!==null?ne.find(k=>k.id===Re&&k.canShare)??null:null,v=y?De({id:"cal-delete-modal",title:"Delete calendar",titleId:"cal-delete-title",closeAction:"cancel-delete-cal",size:"sm",body:`
              ${Ft()}
              ...
              <form class="stack" data-form="create-cal">
                ...
                <label class="holidays-country" id="holidays-country-wrap" hidden>
                  ...
                  <select name="holidayCountry" id="holiday-country">
                    ...
                    ${Ba.map(k=>`<option value="${i(k.code)}">${i(k.name)} (${i(k.code)})</option>`).join("")}
                  </select>
                </label>
                <label class="checkbox">
      ...
      ${b}
      ${v}
      ${Bn()}`,D=Ue.map(k=>`<div class="cal-row${k.id===V?" is-selected":""}" data-action="select-ab" data-id="${k.id}" role="button" tabindex="0">
          ...
          <span class="cal-row-actions">
            ...
            <button type="button" class="btn btn-small btn-danger" data-action="delete-ab" data-id="${k.id}" ${d?"disabled":""}>Delete</button>
        ...
        </div>`).join(""),L=Ue.find(k=>k.id===V)??null,ae=$t.length===0?`<tr class="contacts-empty-row"><td colspan="4" class="muted">${Xt?"No contacts match your search.":"No contacts yet. Add one or import a .vcf file."}</td></tr>`:$t.map(k=>{const le=!fe&&k.uri===ce?" is-selected":"",tt=i((k.displayname||"?").slice(0,1).toUpperCase()),Pa=k.hasPhoto&&V!==null?`<img class="contact-avatar" src="${i(A.contactPhotoUrl(V,k.uri))}" alt="" loading="lazy" data-avatar-fallback="${tt}" />`:`<span class="contact-avatar contact-avatar-fallback" aria-hidden="true">${tt}</span>`;return`<tr class="contact-table-row${le}" data-action="select-contact" data-uri="${i(k.uri)}" tabindex="0" role="button">
              ...
              </tr>`}).join(""),x=I,Y=Array.isArray(x==null?void 0:x.emails)&&x.emails.length>0?x.emails:[""],H=Array.isArray(x==null?void 0:x.phones)&&x.phones.length>0?x.phones:[{type:"cell",value:""}],X=(x==null?void 0:x.address)??Ws(),pe=Y.map((k,le)=>`<div class="multi-row" data-multi="email" data-idx="${le}">
          <input type="email" name="email_${le}" value="${i(k??"")}" placeholder="email@example.com" autocomplete="off" />
        ...
        </div>`).join(""),Ae=H.map((k,le)=>`<div class="multi-row multi-row-phone" data-multi="phone" data-idx="${le}">
          <select name="phone_type_${le}" aria-label="Phone type">
            ${["cell","work","home","other"].map(tt=>`<option value="${tt}" ${((k==null?void 0:k.type)??"other")===tt?"selected":""}>${tt}</option>`).join("")}
          </select>
          <input type="tel" name="phone_value_${le}" value="${i((k==null?void 0:k.value)??"")}" placeholder="+1…" autocomplete="off" />
          <button type="button" class="btn btn-ghost btn-small" data-action="remove-phone" data-idx="${le}" ${H.length<=1?"disabled":""} title="Remove">×</button>
        </div>`).join(""),Te=Array.isArray(x==null?void 0:x.custom)?x.custom:[],vt=Te.length===0?'<p class="muted small" style="margin:0 0 0.5rem">No custom fields yet. Labels and values can use any language (e.g. Супруг, 日本語).</p>':Te.map((k,le)=>`<div class="multi-row multi-row-custom" data-multi="custom" data-idx="${le}">
                <input type="text" name="custom_label_${le}" value="${i(k.label||"")}" placeholder="Label (any language)" maxlength="64" autocomplete="off" aria-label="Custom field label" />
                <input type="text" name="custom_value_${le}" value="${i(k.value||"")}" placeholder="Value" maxlength="2000" autocomplete="off" aria-label="Custom field value" />
            ...
            <div class="cal-modal-card cal-modal-card-wide">
              ...
              <div class="cal-modal-body">
                ...
                </section>`,footer:[{label:"Close",action:"close-ab-modal",variant:"ghost"}]}):"",Be=Ye!==null?Ue.find(k=>k.id===Ye)??null:null,Rt=Be?De({id:"ab-delete-modal",title:"Delete address book",titleId:"ab-delete-title",closeAction:"cancel-delete-ab",size:"sm",body:`
              ${Ft()}
      ...
      ${Rt}
      ${Dt}
      ${it}`,C=h==="calendars"?"my-calendars":h==="contacts"?"my-contacts":h==="tasks"?"tasks":h==="notes"?"notes":h==="files"?"files":"administration",oe=fr(),J=br(),Ze=Qn(),_e=cr(),et=h==="calendars"?T:h==="contacts"?Vt:h==="tasks"?oe:h==="notes"?J:h==="files"?Ze:_e,oa=h==="admin"?`<div class="tabs" role="tablist" aria-label="Administration sections">
          ${Xn()}
          ...
          <button type="button" class="info-btn tab-info" data-action="info"
            data-info="${C}"
            aria-label="About this tab" title="About this tab"><span aria-hidden="true">i</span></button>
        </div>`;s.innerHTML=Js(et,{tabs:oa}),document.body.classList.toggle("cal-modal-open",he||Me||Re!==null||Ye!==null||gt||Ce||rt||z!==null||ke!==null||be!==null||de!==null||ht||ze||Le||pt!==null||ca||ua||We!==null||st!==null||$e!==null),document.body.classList.toggle("layout-contacts",h==="contacts"),document.body.classList.toggle("layout-calendars",h==="calendars"),document.body.classList.toggle("layout-tasks",h==="tasks"||h==="notes"),document.body.classList.toggle("layout-files",h==="files"),document.body.classList.toggle("layout-admin",h==="admin")}function Kn(e){const t=e?e.split("/").filter(Boolean):[];let a="";const l=[`<button type="button" class="files-crumb" data-action="files-nav" data-path="" ${d?"disabled":""}>Home</button>`];for(const o of t){a=a?`${a}/${o}`:o;const p=a;l.push('<span class="files-crumb-sep" aria-hidden="true">/</span>'),l.push(`<button type="button" class="files-crumb" data-action="files-nav" data-path="${i(p)}" ${d?"disabled":""}>${i(o)}</button>`)}return`<nav class="files-breadcrumb" aria-label="Folder path">${l.join("")}</nav>`}function Sa(e){return!Number.isFinite(e)||e<0?"—":e<1024?`${e} B`:e<1024*1024?`${(e/1024).toFixed(1)} KB`:e<1024*1024*1024?`${(e/(1024*1024)).toFixed(1)} MB`:`${(e/(1024*1024*1024)).toFixed(2)} GB`}function Gn(e){if(!e)return"—";try{return new Date(e*1e3).toLocaleString()}catch{return"—"}}function Qn(){const e=ys;if(!e)return`<div class="card"><p class="muted">${ya||d?"Loading…":"Unable to load file storage status."}</p></div>`;if(!e.enabled)return`<div class="portal-grid portal-grid-files">
        <section class="card">
          ${ve("Files","files","h1")}
          ...
          <p class="muted small">DAV path: <span class="mono">${i(e.davPath)}</span></p>
      ...
      </div>`;const t=e.quotaBytes>0?`${Sa(e.usedBytes)} used · ${Sa(e.availableBytes)} free of ${Sa(e.quotaBytes)}`:`${Sa(e.usedBytes)} used · ${Sa(e.availableBytes)} free (no app quota)`,a=e.quotaBytes>0?Math.min(100,Math.round(100*e.usedBytes/e.quotaBytes)):0,l=ue.length,o=xe.length>0&&xe.every($=>ue.includes($.path)),p=l>0,n=l>0?`<div class="bulk-bar files-bulk-bar" role="toolbar" aria-label="Selected files">
            ...
            <div class="bulk-bar-actions">
              ...
              <button type="button" class="btn btn-small btn-danger" data-action="files-bulk-delete" ${d?"disabled":""}>Delete</button>
                    ...
                    </button>`:`<span class="files-name"><span class="files-icon" aria-hidden="true">${D}</span>${i($.name)}</span>`,ae=$.type==="dir"?"—":Sa($.size);return`<tr class="files-row${T?" is-checked":""}" data-path="${i($.path)}" data-type="${$.type}">
                ...
                <td class="files-col-mtime hide-sm">${i(Gn($.mtime))}</td>
              ...
              </tr>`}).join(""),u=ke!==null?(()=>{const $=xe.find(D=>D.path===ke),T=($==null?void 0:$.name)??"";return De({id:"files-rename-modal",title:"Rename",titleId:"files-rename-title",closeAction:"files-rename-close",size:"sm",form:!0,formAttrs:'data-form="files-rename" id="files-rename-form"',body:`
                    <input type="hidden" name="path" value="${i(ke)}" />
                    <label>New name
                      <input type="text" name="newName" value="${i(T)}" required maxlength="255" autocomplete="off" />
                    </label>`,footer:[{label:"Cancel",action:"files-rename-close",variant:"ghost"},{label:"Rename",type:"submit",variant:"primary",disabled:d}]})})():"",b=be!==null&&be.length>0?(()=>{const $=be,T=$.length>1,D=xe.find(x=>x.path===$[0]),L=T?`Delete ${$.length} items`:`Delete ${(D==null?void 0:D.type)==="dir"?"folder":"file"}`,ae=T?`<p style="margin:0 0 0.75rem">Delete <strong>${$.length}</strong> selected items? Folders are removed with their contents. This cannot be undone.</p>
      ...
      ${y}
      ${v}
    </div>`}function Za(e){const t=e.replace(/\\/g,"/").split("/").filter(Boolean);return t[t.length-1]||e}function Xn(){const e=["overview","settings","users","database"],t={overview:"Overview",settings:"System settings",users:"Users",database:"Database"},a=W==null?void 0:W.pages,l=new Map;if(a)for(const o of a)ds(o.id)&&l.set(o.id,o);return e.map(o=>{const p=l.get(o),n=(p==null?void 0:p.label)||t[o],r=(p==null?void 0:p.status)??(o==="overview"?"read-only":"full"),u=(p==null?void 0:p.available)===!1;return`<button type="button" role="tab" class="tab-btn${w===o?" is-active":""}${u?" is-gated":""}"
    ...
    </div>`}function Zn(){const e=Ve("overview");if(e&&e.available===!1)return es("overview");const t=`<p class="muted small admin-session-line">
      Signed in as <span class="mono">${i((c==null?void 0:c.username)??"")}</span>
      with role <span class="badge badge-admin">Admin</span>.
    </p>`;let a="",l="";if(U&&!q)l='<section class="card"><p class="muted">Loading overview…</p></section>';else if(M&&!q)l=`<section class="card">
        <p class="flash flash-error" style="margin-bottom:0.75rem">${i(M)}</p>
        <button type="button" class="btn btn-ghost btn-small" data-action="admin-refresh" ${d?"disabled":""}>Retry</button>
      </section>`;else if(q){const o=q,p=o.services,n=o.links??{},r=e?`<span class="badge ${xa(e.status)}">${i(ba(e.status))}</span>`:"",u=o.version?i(o.version):"—",b=o.git?i(o.git):"";a=`
      ...
      ${l}`}function er(){const e=mt.trim().toLowerCase();return e?ie.filter(t=>t.username.toLowerCase().includes(e)||(t.displayname||"").toLowerCase().includes(e)||(t.email||"").toLowerCase().includes(e)):ie}function tr(){return ze?De({id:"admin-user-create-modal",title:"Add user",titleId:"admin-user-create-title",closeAction:"admin-user-create-close",size:"sm",form:!0,formAttrs:'data-form="admin-user-create"',body:`
          ...
          <p class="muted small">Username <span class="mono">${i(e.username)}</span> cannot be changed. Leave password fields empty to keep the current password.</p>
            ...
            </label>`,footer:[{label:"Cancel",action:"admin-user-edit-close",variant:"ghost",disabled:d},{label:"Save changes",type:"submit",variant:"primary",disabled:d}]})}function sr(){if(!pt)return"";const e=pt,t=R&&R.username.toLowerCase()===e.toLowerCase()?R:ie.find(l=>l.username.toLowerCase()===e.toLowerCase())??null,a=t?`${t.displayname||t.username} (${t.username})`:e;return De({id:"admin-user-delete-modal",title:"Delete user",titleId:"admin-user-delete-title",closeAction:"admin-user-delete-close",size:"sm",body:`
      ...
      </section>`;if(!R)return"";const e=R,t=Da&&Et.length===0?'<tr><td colspan="5" class="muted">Loading calendars…</td></tr>':Et.length===0?'<tr><td colspan="5" class="muted">No calendars.</td></tr>':Et.map(u=>`<tr>
        ...
        </tr>`).join(""),l=jt!==null?Et.find(u=>u.instanceId===jt)??null:null,o=Ht!==null?Nt.find(u=>u.id===Ht)??null:null,p=We==="create"||We==="edit"&&l?De({title:We==="create"?"Add calendar":"Edit calendar",closeAction:"admin-cal-close",size:"sm",form:!0,formAttrs:'data-form="admin-cal"',body:`
    ...
    ${p}${n}${r}`}function rr(){const e=Ve("users");if(e&&e.available===!1)return es("users");const t=er(),a=se&&ie.length===0?'<tr><td colspan="4" class="muted admin-table-empty">Loading users…</td></tr>':t.length===0?`<tr><td colspan="4" class="muted admin-table-empty">${te?i(te):mt.trim()?"No users match this filter.":"No users found."}</td></tr>`:t.map(l=>`<tr class="contact-table-row${B&&B.toLowerCase()===l.username.toLowerCase()?" is-selected":""}" data-action="admin-user-view" data-username="${i(l.username)}" tabindex="0" role="button">
      ...
      ${tr()}
      ${ar()}
      ${sr()}`}function lr(){const e=Ve("settings");if(e&&e.available===!1)return es("settings");if(Ra&&!Wt)return'<section class="card"><p class="muted">Loading system settings…</p></section>';if(Ca&&!Wt)return`<section class="card">
      ...
      ${or()}`}function or(){return ca?De({id:"admin-reset-modal",title:"Reset to Default",titleId:"admin-reset-title",closeAction:"admin-reset-close",size:"sm",body:`
      ...
      ${dr()}`}function dr(){if(!ua)return"";const e=bt.trim()==="CONFIRM";return De({id:"admin-db-confirm-modal",title:"Confirm database change",titleId:"admin-db-confirm-title",closeAction:"admin-db-confirm-close",size:"sm",body:`
          ...
          </label>`,footer:[{label:"Cancel",action:"admin-db-confirm-close",variant:"ghost",disabled:d},{label:"Save database settings",action:"admin-db-confirm-save",variant:"danger",disabled:d||!e}]})}function cr(){return we()?Tt()?w==="users"?rr():w==="settings"?lr():w==="database"?ir():Zn():`<section class="card admin-coming-soon-card">
          <div class="admin-coming-soon-head">
          ...
          <p class="muted">
            ...
            (<span class="mono">system.portal_admin_ui_enabled</span>).
        ...
        </section>`:'<div class="card"><p class="muted">You do not have permission to view Administration.</p></div>'}function ur(e){const t=new Map;for(const b of e)b.uid&&t.set(b.uid,b);const a=new Map(e.map((b,y)=>[me(b.instanceId,b.uri),y])),l=new Map,o=[];for(const b of e){const y=b.parentUid;if(y&&t.has(y)&&y!==b.uid){const v=l.get(y)??[];v.push(b),l.set(y,v)}else o.push(b)}const p=(b,y)=>(a.get(me(b.instanceId,b.uri))??0)-(a.get(me(y.instanceId,y.uri))??0);o.sort(p);for(const[,b]of l)b.sort(p);const n=[],r=new Set,u=(b,y)=>{const v=b.uid||me(b.instanceId,b.uri);if(!r.has(v)){r.add(v),n.push({task:b,depth:Math.min(y,8)});for(const $ of l.get(b.uid)??[])u($,y+1);r.delete(v)}};for(const b of o)u(b,0);for(const b of e)n.some(y=>y.task===b)||n.push({task:b,depth:0});return n}function mr(e){const t=new Set([e]);if(!e)return t;let a=!0;for(;a;){a=!1;for(const l of Ne)l.parentUid&&t.has(l.parentUid)&&l.uid&&!t.has(l.uid)&&(t.add(l.uid),a=!0)}return t}function pr(e,t){const a=e.instanceId,l=t||!e.uid?new Set:mr(e.uid),o=Ne.filter(r=>r.uid&&r.instanceId===a&&!l.has(r.uid)&&r.uid!==e.uid),p=e.parentUid||"",n=['<option value="">None (top-level)</option>',...o.map(r=>`<option value="${i(r.uid)}" ${r.uid===p?"selected":""}>${i(r.summary||r.uid)}</option>`)];if(p&&!o.some(r=>r.uid===p)){const r=Ne.find(u=>u.uid===p);n.push(`<option value="${i(p)}" selected>${i((r==null?void 0:r.summary)||p)} (current)</option>`)}return n.join("")}function tn(){const e=new Set(ye);return Ne.filter(t=>e.has(me(t.instanceId,t.uri))&&t.canWrite&&!t.readOnly)}function fr(){const e=D=>({"NEEDS-ACTION":"To do","IN-PROCESS":"In progress",COMPLETED:"Done",CANCELLED:"Cancelled"})[D]||D,t=ur(Ne),a=Ne.filter(D=>D.canWrite&&!D.readOnly).map(D=>me(D.instanceId,D.uri)),l=a.length>0&&a.every(D=>ye.includes(D)),o=ye.length>0,n=tn().length,r=Ne.length===0?`<tr class="contacts-empty-row"><td colspan="6" class="muted">${Ga?"No tasks match your search.":"No tasks yet. Add one below."}</td></tr>`:t.map(({task:D,depth:L})=>{const ae=me(D.instanceId,D.uri),x=!Q&&ae===Pe?" is-selected":"",Y=ye.includes(ae),H=D.status==="COMPLETED"?"badge-ok":D.status==="CANCELLED"?"":"badge-admin",X=L>0?` style="--task-depth:${L}"`:"",pe=L>0?'<span class="task-subtask-marker" aria-hidden="true">↳</span>':"",Ae=D.canWrite&&!D.readOnly;return`<tr class="contact-table-row task-row${L>0?" is-subtask":""}${x}${Y?" is-checked":""}" data-action="select-task" data-instance="${D.instanceId}" data-uri="${i(D.uri)}" tabindex="0" role="button"${X}>
                ...
                <td class="col-task-due muted small">${i(Hs(D.due))}</td>
        ...
        title="${i(L)}" aria-label="${i(L)}" ${d||n===0?"disabled":""}>${u}</button>`,y=o?`<div class="bulk-bar" style="margin-top:0.75rem">
            <div class="bulk-bar-row">
              ...
              <div class="bulk-group bulk-group-due">
                ${na({field:"bulk-due",name:"bulkDue",label:"Due",value:za,dateOnly:!1,disabled:d||n===0,allowClear:!0})}
          ...
          </div>`:"",v=j,$=_t.map(D=>`<option value="${D.id}" ${v&&v.instanceId===D.id?"selected":""}>${i(D.displayname)}</option>`).join(""),T=v?`<div class="card">
          ...
          <table class="contacts-table">
            <thead>
              <tr>
                ...
                ${Pt("Title","summary",qt,kt,"task","col-task-title")}
                ${Pt("Status","status",qt,kt,"task","col-task-status")}
                ${Pt("Due","due",qt,kt,"task","col-task-due")}
                ${Pt("Calendar","calendar",qt,kt,"task","col-task-cal")}
                ${Pt("%","percent",qt,kt,"task","col-task-pct")}
              </tr>
            </thead>
            <tbody>${r}</tbody>
          </table>
      ...
      <section class="stack items-edit-panel">
        ${T}
    ...
    </div>`}function br(){const e=ga.length===0?`<tr class="contacts-empty-row"><td colspan="3" class="muted">${Qa?"No notes match your search.":"No notes yet. Add one below."}</td></tr>`:ga.map(o=>{const p=me(o.instanceId,o.uri),n=!Se&&p===lt?" is-selected":"",r=(o.description||"").replace(/\s+/g," ").slice(0,80);return`<tr class="contact-table-row${n}" data-action="select-note" data-instance="${o.instanceId}" data-uri="${i(o.uri)}" tabindex="0" role="button">
                ...
                <td class="col-note-date muted small">${i(Hs(o.dtstart))}</td>
            ...
            ${ve(Se?"New note":"Edit note","notes")}
            <form class="stack" data-form="note" style="margin-top:1rem">
              ...
              <label>Title
                <input type="text" name="summary" required maxlength="500" value="${i(t.summary)}" ${t.readOnly&&!Se?"readonly":""} />
              </label>
              ${na({field:"dtstart",name:"dtstart",label:"Date",value:$a(t.dtstart),dateOnly:!1,disabled:!!(t.readOnly&&!Se),allowClear:!0})}
              <label>Body
                <textarea name="description" rows="8" maxlength="20000" ${t.readOnly&&!Se?"readonly":""}>${i(t.description)}</textarea>
              </label>
              <div class="form-actions-row">
                ${Se||t.canWrite?`<button type="submit" class="btn btn-primary" ${d?"disabled":""}>${Se?"Create note":"Save note"}</button>`:""}
                ${!Se&&t.canWrite?`<button type="button" class="btn btn-danger" data-action="delete-note" ${d?"disabled":""}>Delete</button>`:Se?'<button type="button" class="btn btn-ghost" data-action="cancel-note">Cancel</button>':""}
              </div>
            </form>
    ...
    </div>`}function gr(){const e=s.querySelector(".contacts-table-wrap"),t=s.querySelector(".contacts-ab-list"),a=s.querySelector(".calendars-owned-list");return{windowX:window.scrollX,windowY:window.scrollY,tableTop:(e==null?void 0:e.scrollTop)??null,abListTop:(t==null?void 0:t.scrollTop)??null,calListTop:(a==null?void 0:a.scrollTop)??null}}function hr(e){requestAnimationFrame(()=>{requestAnimationFrame(()=>{if(window.scrollTo(e.windowX,e.windowY),e.tableTop!==null){const t=s.querySelector(".contacts-table-wrap");t&&(t.scrollTop=e.tableTop)}if(e.abListTop!==null){const t=s.querySelector(".contacts-ab-list");t&&(t.scrollTop=e.abListTop)}if(e.calListTop!==null){const t=s.querySelector(".calendars-owned-list");t&&(t.scrollTop=e.calListTop)}})})}function m(){const e=gr();c?Yn():en(),yr(),hr(e),requestAnimationFrame(()=>{var t;Rn(),(t=s.querySelector(".dt-time.is-selected"))==null||t.scrollIntoView({block:"center"})})}function an(e){const t=e.querySelector('input[name="color_picker"]'),a=e.querySelector('input[name="color"]');!t||!a||(t.addEventListener("input",()=>{a.value=t.value.toUpperCase()}),a.addEventListener("change",()=>{let l=a.value.trim();l&&!l.startsWith("#")&&(l=`#${l}`),/^#[0-9A-Fa-f]{6}/.test(l)&&(t.value=l.slice(0,7),a.value=l.toUpperCase())}))}function yr(){s.querySelectorAll("[data-action]").forEach(C=>{C.addEventListener("click",oe=>{const J=oe.target.closest("[data-action]");((J==null?void 0:J.dataset.action)==="info"||(J==null?void 0:J.dataset.action)==="info-close")&&(oe.preventDefault(),oe.stopPropagation()),qr(oe)})}),Ta(),Oe&&hn(),s.querySelectorAll("tr.contact-table-row[data-action], .cal-row[data-action], .month-cell[data-action]").forEach(C=>{C.addEventListener("keydown",oe=>{(oe.key==="Enter"||oe.key===" ")&&(oe.preventDefault(),C.click())})});const e=s.querySelector("#delete-cal-confirm"),t=s.querySelector("#delete-cal-submit");e==null||e.addEventListener("change",()=>{t&&(t.disabled=!e.checked||d)});const a=s.querySelector("#delete-ab-confirm"),l=s.querySelector("#delete-ab-submit");a==null||a.addEventListener("change",()=>{l&&(l.disabled=!a.checked||d)}),s.querySelectorAll("img.contact-avatar[data-avatar-fallback]").forEach(C=>{C.addEventListener("error",()=>{const oe=C.dataset.avatarFallback||"?",J=document.createElement("span");J.className="contact-avatar contact-avatar-fallback",J.setAttribute("aria-hidden","true"),J.textContent=oe,C.replaceWith(J)})}),Os||(document.addEventListener("keydown",C=>{if(C.key==="Escape"){if(z&&(z.phase==="done"||z.phase==="error")){Gs();return}if(!z){if(Oe){Oe=!1,Ta(),m();return}if(ke!==null||be!==null||de!==null||ht){ke=null,be=null,de=null,ht=!1,m();return}sn()}}}),Os=!0);const o=s.querySelector('[data-form="login"]');o==null||o.addEventListener("submit",C=>{C.preventDefault(),Dr(o)});const p=s.querySelector('[data-form="files-rename"]');p==null||p.addEventListener("submit",C=>{C.preventDefault(),Cr(p)});const n=s.querySelector('[data-form="files-transfer"]');n==null||n.addEventListener("submit",C=>{C.preventDefault(),Er(n)});const r=s.querySelector('[data-form="files-mkdir"]');r==null||r.addEventListener("submit",C=>{C.preventDefault(),Ar(r)}),ht&&requestAnimationFrame(()=>{var C;(C=r==null?void 0:r.querySelector('input[name="name"]'))==null||C.focus()}),s.querySelectorAll('input[type="file"][data-action="files-upload"]').forEach(C=>{C.addEventListener("change",()=>{Nr(C)})}),s.querySelectorAll('input[data-action="files-select-all"][data-indeterminate="1"]').forEach(C=>{C.indeterminate=!0});const u=s.querySelector('[data-form="share"]');u==null||u.addEventListener("submit",C=>{C.preventDefault(),xr(u)});const b=s.querySelector('[data-form="edit-cal"]');b&&(an(b),b.addEventListener("submit",C=>{C.preventDefault(),_r(b)}));const y=s.querySelector('[data-form="edit-event"]');y==null||y.addEventListener("submit",C=>{C.preventDefault(),Tr(y)}),s.querySelectorAll('select[data-action="event-repeat-freq"], select[data-action="event-repeat-end"]').forEach(C=>{C.addEventListener("change",()=>{if(!S)return;const oe=s.querySelector('[data-form="edit-event"]');if(!oe)return;const J=new FormData(oe),Ze=oe.querySelector('input[name="allDay"]'),_e=Ua(J);_e.endMode==="until"&&!_e.until&&(_e.until=sa(String(J.get("start")??S.start??""))||ge(new Date)),S={...S,summary:String(J.get("summary")??S.summary),description:String(J.get("description")??S.description),location:String(J.get("location")??S.location),instanceId:Number(J.get("instanceId"))||S.instanceId,allDay:(Ze==null?void 0:Ze.checked)??S.allDay,start:String(J.get("start")??S.start??""),end:String(J.get("end")??S.end??"")||null,repeat:_e,hasRrule:!!String(J.get("repeatFreq")??"").trim()},_e.freq&&_e.endMode==="until"&&(O==null?void 0:O.field)==="end"&&(O=null),m(),_e.endMode==="until"&&requestAnimationFrame(()=>{var oa;const et=s.querySelector('input[name="repeatUntil"]');et==null||et.focus();try{(oa=et==null?void 0:et.showPicker)==null||oa.call(et)}catch{}})})});const v=s.querySelector('[data-form="create-cal"]');v&&(an(v),v.addEventListener("submit",C=>{C.preventDefault(),Ir(v)}));const $=s.querySelector('[data-form="create-ab"]');$==null||$.addEventListener("submit",C=>{C.preventDefault(),Fr($)});const T=s.querySelector('[data-form="edit-ab"]');T==null||T.addEventListener("submit",C=>{C.preventDefault(),Mr(T)});const D=s.querySelector('[data-form="contact"]');D==null||D.addEventListener("submit",C=>{C.preventDefault(),Pr(D)});const L=s.querySelector('[data-form="task"]');if(L==null||L.addEventListener("submit",C=>{C.preventDefault(),$r(L)}),L){const C=L.querySelector('select[name="instanceId"]');C==null||C.addEventListener("change",()=>{if(!Q||!j)return;const oe=Number(C.value);if(!Number.isFinite(oe)||oe<=0)return;const J=new FormData(L),Ze=String(J.get("due")??"").trim();j={...j,instanceId:oe,parentUid:j.parentUid&&Ne.some(_e=>_e.uid===j.parentUid&&_e.instanceId===oe)?j.parentUid:null,summary:String(J.get("summary")??""),description:String(J.get("description")??""),status:String(J.get("status")??"NEEDS-ACTION"),due:Ze?new Date(Ze).toISOString():null,priority:Number(J.get("priority")??0),percent:Number(J.get("percent")??0)},m()})}const ae=s.querySelector('[data-form="note"]');ae==null||ae.addEventListener("submit",C=>{C.preventDefault(),wr(ae)});const x=s.querySelector('input[data-action="contact-search"]');x==null||x.addEventListener("input",()=>{Ge&&clearTimeout(Ge),Ge=setTimeout(()=>{Xt=x.value,V!==null&&(async()=>{try{await Ot(V),m()}catch(C){f("error",C instanceof Error?C.message:"Search failed"),m()}})()},250)});const Y=s.querySelector('input[data-action="task-search"]');Y==null||Y.addEventListener("input",()=>{Ge&&clearTimeout(Ge),Ge=setTimeout(()=>{Ga=Y.value,(async()=>{try{await Ut(),m()}catch(C){f("error",C instanceof Error?C.message:"Search failed"),m()}})()},250)});const H=s.querySelector('input[data-action="admin-users-search"]');H==null||H.addEventListener("input",()=>{Ge&&clearTimeout(Ge),Ge=setTimeout(()=>{mt=H.value,m()},150)});const X=s.querySelector('[data-form="admin-user-create"]');X==null||X.addEventListener("submit",C=>{C.preventDefault(),yn(X)});const pe=s.querySelector('[data-form="admin-user-edit"]');pe==null||pe.addEventListener("submit",C=>{C.preventDefault(),Dn(pe)});const Ae=s.querySelector('[data-form="admin-cal"]');Ae==null||Ae.addEventListener("submit",C=>{C.preventDefault(),vn(Ae)});const Te=s.querySelector('[data-form="admin-ab"]');Te==null||Te.addEventListener("submit",C=>{C.preventDefault(),$n(Te)});const vt=s.querySelector('[data-form="admin-settings"]');vt==null||vt.addEventListener("submit",C=>{C.preventDefault(),kn(vt)});const it=s.querySelector('[data-form="admin-database"]');it==null||it.addEventListener("submit",C=>{C.preventDefault(),wn(it)});const Dt=s.querySelector('select[data-action="admin-db-backend"]');Dt==null||Dt.addEventListener("change",()=>{Yt=Dt.value==="pgsql"?"pgsql":"sqlite",m()});const Be=s.querySelector('input[data-action="admin-db-confirm-input"]');Be==null||Be.addEventListener("input",()=>{bt=Be.value;const C=s.querySelector('[data-action="admin-db-confirm-save"]');C&&(C.disabled=d||bt.trim()!=="CONFIRM")});const Rt=s.querySelector('input[data-action="admin-reset-password"]');Rt==null||Rt.addEventListener("input",()=>{Je=Rt.value;const C=s.querySelector('[data-action="admin-reset-confirm"]');C&&(C.disabled=d||!ft||Je.trim()==="")});const Vt=s.querySelector('input[data-action="note-search"]');Vt==null||Vt.addEventListener("input",()=>{Ge&&clearTimeout(Ge),Ge=setTimeout(()=>{Qa=Vt.value,(async()=>{try{await va(),m()}catch(C){f("error",C instanceof Error?C.message:"Search failed"),m()}})()},250)}),Lr(),kr(),Sr()}async function vr(e){var o,p;const t=tn();if(t.length===0){f("error","No writable tasks selected"),m();return}const a=t.map(n=>({instanceId:n.instanceId,uri:n.uri}));if(e==="bulk-task-delete"){if(!confirm(`Delete ${t.length} task${t.length===1?"":"s"}? CalDAV clients will sync the removal.`))return;d=!0,E(),m();try{const n=await A.bulkTasks({op:"delete",items:a});ye=[],Pe&&t.some(r=>me(r.instanceId,r.uri)===Pe)&&(Pe=null,j=null,Q=!1),await Ut(),n.failed>0?f("error",`Deleted ${n.ok}, failed ${n.failed}${n.errors[0]?`: ${n.errors[0]}`:""}`):f("success",`Deleted ${n.ok} task${n.ok===1?"":"s"}`)}catch(n){f("error",n instanceof Error?n.message:"Bulk delete failed")}finally{d=!1,m()}return}let l={};if(e==="bulk-task-status"){const n=s.querySelector("#bulk-task-status"),r=((o=n==null?void 0:n.value)==null?void 0:o.trim())??"";if(!r){f("error","Choose a status to apply"),m();return}l={status:r}}else if(e==="bulk-task-due"){const n=za.trim();if(!n){f("error","Choose a due date to apply"),m();return}const r=/^\d{4}-\d{2}-\d{2}$/.test(n)?new Date(n+"T00:00:00"):new Date((n.length===16,n));if(Number.isNaN(r.getTime())){f("error","Invalid due date"),m();return}l={due:r.toISOString()}}else if(e==="bulk-task-clear-due")l={due:null};else if(e==="bulk-task-percent"){const n=s.querySelector("#bulk-task-percent"),r=((p=n==null?void 0:n.value)==null?void 0:p.trim())??"";if(r===""){f("error","Enter a percent complete (0–100)"),m();return}const u=Number(r);if(!Number.isFinite(u)||u<0||u>100){f("error","Percent must be between 0 and 100"),m();return}l={percent:Math.round(u)}}d=!0,E(),m();try{const n=await A.bulkTasks({op:"update",items:a,fields:l});if(await Ut(),j&&!Q){const u=me(j.instanceId,j.uri),b=Ne.find(y=>me(y.instanceId,y.uri)===u);b&&(j={...b})}const r=e==="bulk-task-status"?"status":e==="bulk-task-due"||e==="bulk-task-clear-due"?"due date":"percent";n.failed>0?f("error",`Updated ${r} on ${n.ok}, failed ${n.failed}${n.errors[0]?`: ${n.errors[0]}`:""}`):f("success",`Updated ${r} on ${n.ok} task${n.ok===1?"":"s"}`)}catch(n){f("error",n instanceof Error?n.message:"Bulk update failed")}finally{d=!1,m()}}async function $r(e){const t=new FormData(e),a=String(t.get("summary")??"").trim(),l=String(t.get("description")??"").trim(),o=String(t.get("status")??"NEEDS-ACTION"),p=String(t.get("due")??"").trim(),n=p?new Date(p).toISOString():null,r=Number(t.get("priority")??0),u=Number(t.get("percent")??0),b=String(t.get("parentUid")??"").trim(),y=b===""?null:b;d=!0,E(),m();try{if(Q){const v=Number(t.get("instanceId"));if(!Number.isFinite(v)||v<=0)throw new Error("Select a calendar");const $=await A.createTask({instanceId:v,summary:a,description:l,status:o,due:n,priority:r,percent:u,parentUid:y});Q=!1,Pe=me($.task.instanceId,$.task.uri),j=$.task,f("success",y?"Subtask created":"Task created")}else if(j){const v=await A.updateTask(j.instanceId,j.uri,{summary:a,description:l,status:o,due:n,priority:r,percent:u,parentUid:y});j=v.task,Pe=me(v.task.instanceId,v.task.uri),f("success","Task saved")}await Ut()}catch(v){f("error",v instanceof Error?v.message:"Save failed")}finally{d=!1,m()}}async function wr(e){const t=new FormData(e),a=String(t.get("summary")??"").trim(),l=String(t.get("description")??"").trim(),o=String(t.get("dtstart")??"").trim(),p=o?new Date(o).toISOString():null;d=!0,E(),m();try{if(Se){const n=Number(t.get("instanceId"));if(!Number.isFinite(n)||n<=0)throw new Error("Select a calendar");const r=await A.createNote({instanceId:n,summary:a,description:l,dtstart:p});Se=!1,lt=me(r.note.instanceId,r.note.uri),re=r.note,f("success","Note created")}else if(re){const n=await A.updateNote(re.instanceId,re.uri,{summary:a,description:l,dtstart:p});re=n.note,lt=me(n.note.instanceId,n.note.uri),f("success","Note saved")}await va()}catch(n){f("error",n instanceof Error?n.message:"Save failed")}finally{d=!1,m()}}function Sr(){const e=s.querySelector('input[data-action="contact-photo"]');e&&e.addEventListener("change",()=>{(async()=>{var a;const t=(a=e.files)==null?void 0:a[0];if(e.value="",!!t){if(t.size>2.5*1024*1024){f("error","Photo is too large (max ~2 MB)"),m();return}try{const l=await Wn(t);He=l,Ee=`data:${t.type||"image/jpeg"};base64,${l}`,Ke=!1,m()}catch(l){f("error",l instanceof Error?l.message:"Failed to read photo"),m()}}})()})}function kr(){const e=s.querySelector('[data-form="create-cal"]');if(!e)return;const t=e.querySelector('input[name="holidays"]'),a=e.querySelector("#holidays-country-wrap"),l=e.querySelector('input[name="displayname"]'),o=e.querySelector('input[name="readOnly"]');if(!t||!a)return;const p=()=>{const n=t.checked;a.hidden=!n,l&&(l.required=!n,n&&!l.value.trim()?l.placeholder="Auto: Holidays (XX)":n||(l.placeholder="Work")),n&&o&&(o.checked=!0)};t.addEventListener("change",p),p()}async function Dr(e){var o,p,n,r;const t=new FormData(e),a=String(t.get("username")??""),l=String(t.get("password")??"");d=!0,E(),m(),N.event("login.attempt",{username:a});try{const u=await A.login(a,l);if(c=u.user,fs(u.ui),N.event("login.ok",{username:(c==null?void 0:c.username)??a}),gs(),we())try{await hs()}catch(b){N.warn("admin.capabilities login",b instanceof Error?b.message:b)}if(Ps(),dt(h,w),await Qe(),h==="admin"&&we()&&Tt())try{w==="overview"&&((o=Ve("overview"))==null?void 0:o.available)!==!1?await Ja():w==="users"&&((p=Ve("users"))==null?void 0:p.available)!==!1?(await ea(),B&&(await wt(B),await ta(B))):w==="settings"&&((n=Ve("settings"))==null?void 0:n.available)!==!1?await Ya():w==="database"&&((r=Ve("database"))==null?void 0:r.available)!==!1&&await Ka()}catch(b){N.warn("admin login load",b instanceof Error?b.message:b)}f("success","Signed in")}catch(u){N.warn("login.failed",u instanceof Error?u.message:u),f("error",u instanceof Error?u.message:"Login failed")}finally{d=!1,m()}}async function Cr(e){const t=new FormData(e),a=String(t.get("path")??""),l=String(t.get("newName")??"").trim();if(!a||!l){f("error","Name is required"),m();return}d=!0,E(),m();try{await A.filesRename(a,l),N.event("files.rename",{path:a,newName:l}),ke=null,await St(),f("success",`Renamed to “${l}”`)}catch(o){f("error",o instanceof Error?o.message:"Rename failed")}finally{d=!1,m()}}async function Ar(e){const t=new FormData(e),a=String(t.get("name")??"").trim();if(!a){f("error","Folder name is required"),m();return}d=!0,E(),m();try{await A.filesMkdir(Fe,a),N.event("files.mkdir",{path:Fe,name:a}),ht=!1,await St(),f("success",`Created folder “${a}”`)}catch(l){f("error",l instanceof Error?l.message:"Could not create folder")}finally{d=!1,m()}}async function Er(e){if(!de||de.paths.length===0)return;const t=new FormData(e),a=String(t.get("toPath")??"").trim().replace(/^\/+|\/+$/g,""),l=String(t.get("newName")??"").trim(),o=de.op,p=[...de.paths],n=p.length>1;d=!0,E(),m();let r=0;const u=[];try{for(const y of p)try{if(o==="copy"){const v=Za(y),$=n||!l||l===v?void 0:l,T=await A.filesCopy(y,{to:a,newName:$});N.event("files.copy",{path:y,to:T.entry.path})}else{const v=Za(y),$=n||!l||l===v?void 0:l;await A.filesMove(y,a,$),N.event("files.move",{path:y,to:a})}r+=1}catch(v){u.push(`${Za(y)}: ${v instanceof Error?v.message:"failed"}`)}de=null,ue=[],await St();const b=o==="copy"?"Copied":"Moved";r>0&&u.length===0?f("success",r===1?`${b} 1 item`:`${b} ${r} items`):r>0?f("info",`${b} ${r}; ${u.length} failed. ${u[0]}`):f("error",u[0]||`${o==="copy"?"Copy":"Move"} failed`)}catch(b){f("error",b instanceof Error?b.message:"Operation failed")}finally{d=!1,m()}}async function Nr(e){const t=e.files;if(!t||t.length===0)return;const a=Array.from(t);e.value="",d=!0,E(),m();let l=0;const o=[];try{for(const p of a)try{await A.filesUpload(Fe,p,{replace:!0}),N.event("files.upload",{path:Fe,name:p.name,size:p.size}),l+=1}catch(n){o.push(`${p.name}: ${n instanceof Error?n.message:"failed"}`)}await St(),l>0&&o.length===0?f("success",l===1?"Uploaded 1 file":`Uploaded ${l} files`):l>0?f("info",`Uploaded ${l}; ${o.length} failed. ${o[0]}`):f("error",o[0]||"Upload failed")}catch(p){f("error",p instanceof Error?p.message:"Upload failed")}finally{d=!1,m()}}async function xr(e){if(F===null)return;const t=new FormData(e),a=String(t.get("username")??""),l=String(t.get("access")??"read");he=!0,d=!0,E(),m();try{await A.share(F,a,l),await _a(F),f("success",`Shared with ${a}`)}catch(o){f("error",o instanceof Error?o.message:"Share failed")}finally{d=!1,m()}}function Oa(e){if(!S)return;const t=new FormData(e),a=e.querySelector('input[name="allDay"]');S={...S,summary:String(t.get("summary")??S.summary),description:String(t.get("description")??S.description),location:String(t.get("location")??S.location),instanceId:Number(t.get("instanceId"))||S.instanceId,allDay:(a==null?void 0:a.checked)??S.allDay,start:String(t.get("start")??S.start??""),end:String(t.get("end")??S.end??"")||null,repeat:Ua(t),hasRrule:!!String(t.get("repeatFreq")??"").trim()}}function Ua(e){const t=String(e.get("repeatFreq")??"").trim().toUpperCase();if(!t)return{freq:"",interval:1,until:null,count:null,byDay:[],endMode:"never"};const a=Math.max(1,Math.min(99,Number(e.get("repeatInterval")??1)||1)),l=String(e.get("repeatEndMode")??"never"),o=l==="until"||l==="count"?l:"never";let p=null,n=null;if(o==="until"){const u=String(e.get("repeatUntil")??"").trim();p=u?u.slice(0,10):null}else if(o==="count"){const u=Number(e.get("repeatCount")??0);n=Number.isFinite(u)&&u>0?Math.min(999,Math.round(u)):10}const r=e.getAll("repeatByDay").map(u=>String(u).toUpperCase()).filter(Boolean);return{freq:t,interval:a,until:p,count:n,byDay:r,endMode:o}}async function Tr(e){if(!S||!S.canWrite)return;const t=new FormData(e),a=String(t.get("summary")??"").trim(),l=String(t.get("description")??"").trim(),o=String(t.get("location")??"").trim(),p=t.get("allDay")==="on",n=String(t.get("start")??"").trim(),r=String(t.get("end")??"").trim(),u=Number(t.get("instanceId"))||S.instanceId,b=Ua(t);if(!a){f("error","Title is required"),m();return}if(!n){f("error","Start is required"),m();return}let y,v;if(p)y=n.slice(0,10),v=r?r.slice(0,10):y;else if(/^\d{4}-\d{2}-\d{2}$/.test(n)){const L=$s(n,r||null);y=new Date(L.start).toISOString(),v=L.end?new Date(L.end).toISOString():null}else y=new Date(n).toISOString(),v=r?new Date(r).toISOString():null;const $=S.instanceId,T=S.uri,D=nt;d=!0,E(),gt=!0,m(),N.event(D?"event.create":"event.update",{instanceId:u,uri:D?null:T,allDay:p,summary:a});try{const L={summary:a,description:l,location:o,allDay:p,start:y,end:v,instanceId:u,repeat:b},ae=D?await A.createEvent(u,L):await A.updateEvent($,T,L);(F===null||ae.event.instanceId!==F)&&(F=ae.event.instanceId),await Xe(),gt=!1,S=null,nt=!1,O=null,N.event(D?"event.created":"event.saved",{uri:ae.event.uri,instanceId:ae.event.instanceId}),f("success",D?"Event created":"Event saved")}catch(L){N.warn("event.save failed",L instanceof Error?L.message:L),f("error",L instanceof Error?L.message:"Save failed")}finally{d=!1,m()}}async function _r(e){if(F===null)return;const t=new FormData(e),a=String(t.get("displayname")??"").trim(),l=String(t.get("description")??""),o=String(t.get("color")??"").trim();d=!0,E(),m();try{const p=await A.updateCalendar(F,{displayname:a,description:l,color:o});he=!0,await Qe(),F=p.calendar.id,await _a(F),await Xe(),f("success","Calendar updated")}catch(p){f("error",p instanceof Error?p.message:"Update failed")}finally{d=!1,m()}}async function Ir(e){const t=new FormData(e),a=String(t.get("displayname")??"").trim(),l=String(t.get("description")??""),o=String(t.get("color")??"").trim(),p=t.get("holidays")==="on",n=String(t.get("holidayCountry")??"").trim(),r=t.get("readOnly")==="on";if(Me=!0,p&&!n){f("error","Select a country for the holidays calendar"),m();return}if(!p&&!a){f("error","Display name is required"),m();return}d=!0,E(),m();try{const u=await A.createCalendar({displayname:a,description:l,color:o,holidays:p,holidayCountry:p?n:void 0,readOnly:r});F=u.calendar.id,K.includes(u.calendar.id)||(K=[...K,u.calendar.id]),Me=!1,await Qe();let b=`Created “${u.calendar.displayname}”`;const y=u.holidayImport??u.calendar.holidayImport;y&&(b+=`. Holidays imported: ${xs(y)}.`),r&&(b+=" Calendar is read-only."),f("success",b)}catch(u){Me=!0,f("error",u instanceof Error?u.message:"Create failed")}finally{d=!1,m()}}async function qr(e){var l,o,p;const t=e.target.closest("[data-action]");if(!t)return;const a=t.dataset.action;if(a&&N.debug(`action:${a}`,{id:t.dataset.id,tab:t.dataset.tab,uri:t.dataset.uri}),a==="close-import-progress"){z&&(z.phase==="done"||z.phase==="error")&&Gs();return}if(a==="logout"){d=!0,N.event("logout");try{await A.logout()}catch{}Wa(),E(),m();return}if(a==="select-cal"||a==="toggle-cal"){const n=Number(t.dataset.id);if(!Number.isFinite(n))return;In(n),d=!0,E(),m();try{await Xe()}catch(r){f("error",r instanceof Error?r.message:"Failed to load calendar")}finally{d=!1,m()}return}if(a==="edit-cal"){const n=Number(t.dataset.id);if(!Number.isFinite(n)||!ne.find(u=>u.id===n&&u.canShare))return;F=n,K.includes(n)||(K=[...K,n]),he=!0,Re=null,d=!0,E(),m();try{await _a(n),await Xe()}catch(u){f("error",u instanceof Error?u.message:"Failed to open calendar")}finally{d=!1,m()}return}if(a==="close-cal-modal"){he=!1,m();return}if(a==="open-create-cal-modal"){Me=!0,he=!1,Re=null,E(),m();return}if(a==="close-create-cal-modal"){Me=!1,E(),m();return}if(a==="delete-cal"){const n=Number(t.dataset.id);if(!Number.isFinite(n)||!ne.find(u=>u.id===n&&u.canShare))return;Re=n,he=!1,E(),m();return}if(a==="cancel-delete-cal"){Re=null,m();return}if(a==="confirm-delete-cal"){const n=Number(t.dataset.id),r=s.querySelector("#delete-cal-confirm");if(!Number.isFinite(n)||!(r!=null&&r.checked))return;d=!0,E(),m();try{if(await A.deleteCalendar(n),F===n&&(F=null),K=K.filter(u=>u!==n),Re=null,he=!1,Gt=[],Qt=[],await Qe(),F===null){const u=Bs();u?(F=u.id,K.includes(u.id)||(K=[...K,u.id]),await Xe()):K.length>0&&(F=K[0],await Xe())}f("success","Calendar deleted")}catch(u){f("error",u instanceof Error?u.message:"Delete failed")}finally{d=!1,m()}return}if(a==="month-today"){const n=new Date;xt={y:n.getFullYear(),m:n.getMonth()},Ea=null,d=!0,m();try{await Xe()}finally{d=!1,m()}return}if(a==="month-prev"||a==="month-next"){const n=a==="month-prev"?-1:1,r=new Date(xt.y,xt.m+n,1);xt={y:r.getFullYear(),m:r.getMonth()},Ea=null,d=!0,m();try{await Xe()}finally{d=!1,m()}return}if(a==="open-event"){e.stopPropagation();const n=Number(t.dataset.instance),r=t.dataset.uri??"";if(!Number.isFinite(n)||!r)return;d=!0,E(),m();try{const u=await A.getEvent(n,r);S={...u.event,repeat:u.event.repeat??Xa()},nt=!1,gt=!0,O=null,he=!1,Re=null}catch(u){f("error",u instanceof Error?u.message:"Failed to open event")}finally{d=!1,m()}return}if(a==="open-event-day"){e.stopPropagation();const n=t.dataset.day??"";Ea=Ea===n?null:n,m();return}if(a==="new-event-day"){const n=e.target;if((l=n==null?void 0:n.closest)!=null&&l.call(n,".month-event, .month-event-more"))return;const r=t.dataset.day??"";if(!/^\d{4}-\d{2}-\d{2}$/.test(r))return;if(F===null){f("error","Select a calendar first"),m();return}const u=ne.find(b=>b.id===F);if(!u||u.readOnly||!(u.canShare||u.access==="readwrite")){f("error","This calendar is read-only"),m();return}nt=!0,S=zn(r,F),gt=!0,O=null,he=!1,Re=null,E(),m();return}if(a==="close-event-modal"){gt=!1,S=null,nt=!1,O=null,E(),m();return}if(a==="dt-open"){const n=t.dataset.dtField||"";if(!n)return;const r=s.querySelector('[data-form="edit-event"]');if(r&&S&&Oa(r),(O==null?void 0:O.field)===n)O=null;else{const u=t.dataset.dtDateOnly==="1",b=t.dataset.dtClear!=="0",y=t.dataset.dtName||n;let v=ks(n);!v&&(n==="due"||n==="dtstart"||n==="bulk-due")&&(v=qa().start);const $=Ia(v||ge(new Date)),[T,D]=$.date.split("-").map(Number);O={field:n,viewY:T,viewM:(D||1)-1,dateOnly:u,allowClear:b,name:y}}m();return}if(a==="dt-month-prev"||a==="dt-month-next"){if(!O)return;const n=a==="dt-month-prev"?-1:1,r=new Date(O.viewY,O.viewM+n,1);O={...O,viewY:r.getFullYear(),viewM:r.getMonth()},m();return}if(a==="dt-pick-day"){if(!O)return;const n=O.field,r=t.dataset.day??"";if(!/^\d{4}-\d{2}-\d{2}$/.test(r))return;const u=s.querySelector('[data-form="edit-event"]');u&&S&&Oa(u);const b=O.dateOnly;if(b)ot(n,r),O=null;else{const y=ks(n),v=Ia(y||qa(r).start).hm;ot(n,`${r}T${v}`),O={...O,viewY:Number(r.slice(0,4)),viewM:Number(r.slice(5,7))-1}}if(n==="start"&&S&&!b&&S.end){const y=new Date(String(S.start)),v=new Date(String(S.end));!Number.isNaN(y.getTime())&&!Number.isNaN(v.getTime())&&v<=y&&ot("end",Lt(new Date(y.getTime()+3600*1e3)))}m();return}if(a==="dt-pick-time"){if(!O||O.dateOnly)return;const n=O.field,r=t.dataset.hm??"";if(!/^\d{2}:\d{2}$/.test(r))return;const u=s.querySelector('[data-form="edit-event"]');u&&S&&Oa(u);const b=ks(n)||qa().start,v=`${Ia(b).date}T${r}`;if(ot(n,v),n==="start"&&S){S={...S,allDay:!1};const $=S.end?Ia(String(S.end)):null,T=new Date(v);(!$||new Date(`${$.date}T${$.hm}`)<=T)&&ot("end",Lt(new Date(T.getTime()+3600*1e3)))}O=null,m();return}if(a==="dt-today"){if(!O)return;const n=O.field,r=s.querySelector('[data-form="edit-event"]');r&&S&&Oa(r);const u=ge(new Date);if(O.dateOnly)ot(n,u);else{const b=qa(u);n==="start"?(ot("start",b.start),S&&!S.end&&ot("end",b.end)):n==="end"?ot("end",b.end):ot(n,b.start)}O=null,m();return}if(a==="dt-clear"){if(!O||!O.allowClear)return;const n=O.field,r=s.querySelector('[data-form="edit-event"]');r&&S&&Oa(r),ot(n,null),O=null,m();return}if(a==="event-allday-toggle"){if(!S)return;const n=s.querySelector('[data-form="edit-event"]'),r=t.checked;if(n){const u=new FormData(n),b=String(u.get("start")??S.start??""),y=String(u.get("end")??S.end??"")||null;let v=b,$=y;if(r){const T=Tn(b,y);v=T.start,$=T.end}else{const T=b.slice(0,10),D=(y||b).slice(0,10),L=$s(T,D);v=L.start,$=L.end}S={...S,summary:String(u.get("summary")??S.summary),description:String(u.get("description")??S.description),location:String(u.get("location")??S.location),instanceId:Number(u.get("instanceId"))||S.instanceId,allDay:r,start:v,end:$,repeat:Ua(u)}}else S={...S,allDay:r};O=null,m();return}if(a==="event-repeat-freq"||a==="event-repeat-end"){if(!S)return;const n=s.querySelector('[data-form="edit-event"]');if(!n)return;const r=new FormData(n),u=n.querySelector('input[name="allDay"]'),b=Ua(r);S={...S,summary:String(r.get("summary")??S.summary),description:String(r.get("description")??S.description),location:String(r.get("location")??S.location),instanceId:Number(r.get("instanceId"))||S.instanceId,allDay:(u==null?void 0:u.checked)??S.allDay,start:String(r.get("start")??S.start??""),end:String(r.get("end")??S.end??"")||null,repeat:b,hasRrule:!!String(r.get("repeatFreq")??"").trim()},b.freq&&b.endMode==="until"&&(O==null?void 0:O.field)==="end"&&(O=null),m();return}if(a==="delete-event"){if(!S||!S.canWrite||nt||!confirm("Delete this event? CalDAV clients will sync the removal."))return;const n=S.instanceId,r=S.uri;d=!0,E(),m();try{await A.deleteEvent(n,r),gt=!1,S=null,await Xe(),f("success","Event deleted")}catch(u){f("error",u instanceof Error?u.message:"Delete failed")}finally{d=!1,m()}return}if(a==="info"){const n=t.dataset.info??"";Rr(n);return}if(a==="info-close"){sn();return}if(a==="flash-close"){E(),m();return}if(a==="user-menu-toggle"){e.stopPropagation(),Oe=!Oe,m();return}if(a==="user-menu-close"){Oe&&(Oe=!1,m());return}if(a==="tab"){const n=Is(t.dataset.tab);n&&(n==="admin"&&(w="overview"),await Rs(n));return}if(a==="admin-page"){const n=ds(t.dataset.adminPage);n&&await Fs(n);return}if(a==="admin-refresh"){if(!we()||h!=="admin")return;d=!0,E(),m();try{await Ja(),f("success","Overview refreshed")}catch(n){f("error",n instanceof Error?n.message:"Refresh failed")}finally{d=!1,m()}return}if(a==="admin-users-refresh"){if(!we()||h!=="admin")return;d=!0,E(),m();try{await ea(),B&&await wt(B),f("success","Users refreshed")}catch(n){f("error",n instanceof Error?n.message:"Refresh failed")}finally{d=!1,m()}return}if(a==="admin-user-view"){const n=t.dataset.username??"";if(!n||!we())return;d=!0,E(),B=n,w="users",dt("admin","users",n),m();try{await wt(n),await ta(n)}catch(r){f("error",r instanceof Error?r.message:"Failed to load user")}finally{d=!1,m()}return}if(a==="admin-user-close"){B=null,R=null,qe=null,Le=!1,dt("admin","users",null),m();return}if(a==="admin-user-create-open"){if(!we())return;ze=!0,Le=!1,pt=null,E(),m();return}if(a==="admin-user-create-close"){ze=!1,m();return}if(a==="admin-user-edit-open"){if(!we())return;const n=t.dataset.username??B??"";if(!n)return;d=!0,E(),ze=!1,pt=null,B=n,w="users",dt("admin","users",n),m();try{(!R||R.username.toLowerCase()!==n.toLowerCase())&&await wt(n),Le=!0}catch(r){f("error",r instanceof Error?r.message:"Failed to load user")}finally{d=!1,m()}return}if(a==="admin-user-edit-close"){Le=!1,m();return}if(a==="admin-user-delete-open"){if(!we())return;const n=t.dataset.username??B??"";if(!n)return;pt=n,At=!1,ze=!1,Le=!1,E(),m();return}if(a==="admin-user-delete-close"){pt=null,At=!1,m();return}if(a==="admin-user-delete-toggle"){At=!!t.checked,m();return}if(a==="admin-user-delete-confirm"){if(!we())return;const n=t.dataset.username??pt??"";if(!n||!At)return;d=!0,E(),m();try{await A.adminDeleteUser(n,!0),N.event("admin.user.delete",{username:n}),pt=null,At=!1,Le=!1,(B==null?void 0:B.toLowerCase())===n.toLowerCase()&&(B=null,R=null,Et=[],Nt=[],dt("admin","users",null)),await ea(),f("success",`Deleted user “${n}”`)}catch(r){f("error",r instanceof Error?r.message:"Delete failed")}finally{d=!1,m()}return}if(a==="admin-cal-create"){We="create",jt=null,m();return}if(a==="admin-cal-edit"){We="edit",jt=Number(t.dataset.id),m();return}if(a==="admin-cal-close"){We=null,jt=null,m();return}if(a==="admin-cal-delete"){$e={kind:"calendar",id:Number(t.dataset.id),label:t.dataset.label??"calendar"},m();return}if(a==="admin-ab-create"){st="create",Ht=null,m();return}if(a==="admin-ab-edit"){st="edit",Ht=Number(t.dataset.id),m();return}if(a==="admin-ab-close"){st=null,Ht=null,m();return}if(a==="admin-ab-delete"){$e={kind:"addressbook",id:Number(t.dataset.id),label:t.dataset.label??"address book",force:!1},m();return}if(a==="admin-ab-force-toggle"){($e==null?void 0:$e.kind)==="addressbook"&&($e={...$e,force:!!t.checked},m());return}if(a==="admin-resource-delete-close"){$e=null,m();return}if(a==="admin-resource-delete-confirm"){if(!B||!$e)return;const n=B,r=$e;d=!0,E(),m();try{r.kind==="calendar"?await A.adminDeleteUserCalendar(n,r.id,!0):await A.adminDeleteUserAddressBook(n,r.id,!0,!!r.force),$e=null,await ta(n),await wt(n),f("success","Deleted")}catch(u){f("error",u instanceof Error?u.message:"Delete failed")}finally{d=!1,m()}return}if(a==="admin-settings-refresh"){d=!0,E(),m();try{await Ya(),f("success","Settings reloaded")}catch(n){f("error",n instanceof Error?n.message:"Reload failed")}finally{d=!1,m()}return}if(a==="admin-reset-open"){ca=!0,ft=!1,Je="",E(),m();return}if(a==="admin-reset-close"){ca=!1,ft=!1,Je="",m();return}if(a==="admin-reset-toggle"){ft=!!t.checked,m();return}if(a==="admin-reset-password"){Je=t.value;const n=s.querySelector('[data-action="admin-reset-confirm"]');n&&(n.disabled=d||!ft||Je.trim()==="");return}if(a==="admin-reset-confirm"){if(!ft)return;if(Je.trim()===""){f("error","Re-enter your password to confirm Reset to Default"),m();return}d=!0,E(),m();try{const n=await A.adminResetToDefault(!0,Je);N.event("admin.settings.reset-to-default"),ca=!1,ft=!1,Je="";const r=n.redirectUrl&&n.redirectUrl.startsWith("/")?n.redirectUrl:"/portal/install/";window.location.assign(r);return}catch(n){f("error",n instanceof Error?n.message:"Reset failed"),d=!1,m()}return}if(a==="admin-database-refresh"){d=!0,E(),m();try{await Ka(),f("success","Database settings reloaded")}catch(n){f("error",n instanceof Error?n.message:"Reload failed")}finally{d=!1,m()}return}if(a==="admin-db-backend"){Yt=t.value==="pgsql"?"pgsql":"sqlite",m();return}if(a==="admin-db-test"){const n=t.closest("form");Sn(n);return}if(a==="admin-db-confirm-close"){ua=!1,bt="",ma=null,m();return}if(a==="admin-db-confirm-input"){bt=t.value,m();const r=s.querySelector('[data-action="admin-db-confirm-input"]');if(r){r.focus();const u=r.value.length;r.setSelectionRange(u,u)}return}if(a==="admin-db-confirm-save"){if(bt.trim()!=="CONFIRM"||!ma)return;d=!0,E(),m();try{const n={...ma,confirm:"CONFIRM"},r=await A.adminUpdateDatabaseSettings(n);Jt=r.data,ua=!1,bt="",ma=null,Yt=(r.data.backend||"sqlite").toLowerCase()==="pgsql"?"pgsql":"sqlite",N.event("admin.database.save",{backend:r.data.backend}),f("success","Database settings saved")}catch(n){f("error",n instanceof Error?n.message:"Database save failed")}finally{d=!1,m()}return}if(a==="files-nav"){Fe=t.dataset.path??"",ke=null,be=null,de=null,ht=!1,ue=[],d=!0,E(),m();try{await St()}catch(r){f("error",r instanceof Error?r.message:"Failed to open folder")}finally{d=!1,m()}return}if(a==="files-toggle"){e.stopPropagation();const n=t.dataset.path??"";if(!n)return;t.checked?ue.includes(n)||(ue=[...ue,n]):ue=ue.filter(u=>u!==n),m();return}if(a==="files-select-all"){e.stopPropagation(),ue=t.checked?xe.map(r=>r.path):[],m();return}if(a==="files-copy"){const n=t.dataset.path??"";if(!n)return;de={op:"copy",paths:[n]},ke=null,be=null,m();return}if(a==="files-move"){const n=t.dataset.path??"";if(!n)return;de={op:"move",paths:[n]},ke=null,be=null,m();return}if(a==="files-bulk-copy"){if(ue.length===0)return;de={op:"copy",paths:[...ue]},ke=null,be=null,m();return}if(a==="files-bulk-move"){if(ue.length===0)return;de={op:"move",paths:[...ue]},ke=null,be=null,m();return}if(a==="files-transfer-close"){de=null,m();return}if(a==="files-bulk-delete"){if(ue.length===0)return;be=[...ue],ke=null,de=null,m();return}if(a==="files-refresh"){d=!0,E(),m();try{await St(),f("success","Refreshed")}catch(n){f("error",n instanceof Error?n.message:"Refresh failed")}finally{d=!1,m()}return}if(a==="files-mkdir"){ht=!0,ke=null,be=null,de=null,E(),m();return}if(a==="files-mkdir-close"){ht=!1,m();return}if(a==="files-rename-open"){ke=t.dataset.path??null,be=null,de=null,m();return}if(a==="files-rename-close"){ke=null,m();return}if(a==="files-delete-open"){const n=t.dataset.path??"";be=n?[n]:null,ke=null,de=null,m();return}if(a==="files-delete-close"){be=null,m();return}if(a==="files-delete-confirm"){const n=be?[...be]:[];if(n.length===0)return;d=!0,E(),m();try{if(n.length===1)await A.filesDelete(n[0]),N.event("files.delete",{path:n[0]}),f("success","Deleted");else{const r=await A.filesBulk("delete",n);N.event("files.bulk-delete",{ok:r.ok,failed:r.failed}),r.failed===0?f("success",r.ok===1?"Deleted 1 item":`Deleted ${r.ok} items`):r.ok>0?f("info",`Deleted ${r.ok}; ${r.failed} failed. ${r.errors[0]||""}`):f("error",r.errors[0]||"Delete failed")}be=null,ue=[],await St()}catch(r){f("error",r instanceof Error?r.message:"Delete failed")}finally{d=!1,m()}return}if(a==="files-download"){N.event("files.download",{path:t.getAttribute("href")??""});return}if(a==="sort-task"||a==="sort-note"){const n=t.dataset.sort||"";if(!n)return;if(a==="sort-task"){qt===n?kt=kt==="asc"?"desc":"asc":(qt=n,kt=n==="due"||n==="summary"?"asc":"desc"),d=!0,m();try{await Ut()}catch(r){f("error",r instanceof Error?r.message:"Sort failed")}finally{d=!1,m()}}else{ha===n?aa=aa==="asc"?"desc":"asc":(ha=n,aa="asc"),d=!0,m();try{await va()}catch(r){f("error",r instanceof Error?r.message:"Sort failed")}finally{d=!1,m()}}return}if(a==="select-task"){if(e.target.closest("[data-stop-row], .task-check"))return;const n=Number(t.dataset.instance),r=t.dataset.uri??"";if(!Number.isFinite(n)||!r)return;const u=Ne.find(b=>b.instanceId===n&&b.uri===r)??null;Q=!1,Pe=me(n,r),j=u?{...u}:null,E(),m();return}if(a==="task-check"){e.preventDefault(),e.stopPropagation();const n=Number(t.dataset.instance),r=t.dataset.uri??"";if(!Number.isFinite(n)||!r)return;const u=me(n,r),b=Ne.find(y=>me(y.instanceId,y.uri)===u);if(!b||!b.canWrite||b.readOnly)return;ye.includes(u)?ye=ye.filter(y=>y!==u):ye=[...ye,u],m();return}if(a==="task-select-all"){e.preventDefault();const n=Ne.filter(u=>u.canWrite&&!u.readOnly);n.length>0&&n.every(u=>ye.includes(me(u.instanceId,u.uri)))?ye=[]:ye=n.map(u=>me(u.instanceId,u.uri)),m();return}if(a==="bulk-task-clear"){ye=[],m();return}if(a==="bulk-task-status"||a==="bulk-task-due"||a==="bulk-task-clear-due"||a==="bulk-task-percent"||a==="bulk-task-delete"){vr(a);return}if(a==="select-note"){const n=Number(t.dataset.instance),r=t.dataset.uri??"";if(!Number.isFinite(n)||!r)return;const u=ga.find(b=>b.instanceId===n&&b.uri===r)??null;Se=!1,lt=me(n,r),re=u?{...u}:null,E(),m();return}if(a==="new-task"){Q=!0,Pe=null,j={uri:"",instanceId:((o=_t[0])==null?void 0:o.id)??0,calendarId:0,calendarName:"",calendarUri:"",uid:"",parentUid:null,summary:"",description:"",status:"NEEDS-ACTION",due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},E(),m();return}if(a==="new-subtask"){if(!j||Q||!j.uid||!j.canWrite)return;const n=j;Q=!0,Pe=null,j={uri:"",instanceId:n.instanceId,calendarId:n.calendarId,calendarName:n.calendarName,calendarUri:n.calendarUri,uid:"",parentUid:n.uid,summary:"",description:"",status:"NEEDS-ACTION",due:null,priority:0,percent:0,completed:null,lastmodified:0,readOnly:!1,canWrite:!0},E(),m();return}if(a==="new-note"){Se=!0,lt=null,re={uri:"",instanceId:((p=It[0])==null?void 0:p.id)??0,calendarId:0,calendarName:"",calendarUri:"",summary:"",description:"",dtstart:new Date().toISOString(),lastmodified:0,readOnly:!1,canWrite:!0},E(),m();return}if(a==="cancel-task"){Q=!1,j=null,Pe=null,m();return}if(a==="cancel-note"){Se=!1,re=null,lt=null,m();return}if(a==="delete-task"){if(!j||Q||!confirm("Delete this task? CalDAV clients will sync the removal."))return;d=!0,E(),m();try{await A.deleteTask(j.instanceId,j.uri),Pe=null,j=null,await Ut(),f("success","Task deleted")}catch(n){f("error",n instanceof Error?n.message:"Delete failed")}finally{d=!1,m()}return}if(a==="delete-note"){if(!re||Se||!confirm("Delete this note? CalDAV clients will sync the removal."))return;d=!0,E(),m();try{await A.deleteNote(re.instanceId,re.uri),lt=null,re=null,await va(),f("success","Note deleted")}catch(n){f("error",n instanceof Error?n.message:"Delete failed")}finally{d=!1,m()}return}if(a==="select-ab"){const n=Number(t.dataset.id);if(!Number.isFinite(n))return;V=n,rt=!1,ce=null,I=null,fe=!1,Ce=!1,Xt="",$t=[],Ee=null,He=null,Ke=!1,E(),d=!0,m();try{await Ot(n)}catch(r){f("error",r instanceof Error?r.message:"Failed to load contacts")}finally{d=!1,m()}return}if(a==="edit-ab"){e.stopPropagation();const n=Number(t.dataset.id);if(!Number.isFinite(n)||!Ue.find(b=>b.id===n))return;const u=V!==n;V=n,rt=!0,Ce=!1,E(),u&&(ce=null,I=null,fe=!1,Xt="",$t=[],Ee=null,He=null,Ke=!1),d=!0,m();try{u&&await Ot(n)}catch(b){f("error",b instanceof Error?b.message:"Failed to open address book")}finally{d=!1,m()}return}if(a==="close-ab-modal"){rt=!1,m();return}if(a==="select-contact"){const n=t.dataset.uri??"";if(!n)return;E();try{await jn(n)}catch(r){f("error",r instanceof Error?r.message:"Failed to load contact")}m();return}if(a==="new-contact"){if(V===null)return;Hn(),E(),m();return}if(a==="cancel-contact"||a==="close-contact-modal"){fe=!1,Ce=!1,I=null,ce=null,Ee=null,He=null,Ke=!1,O=null,E(),m();return}if(a==="add-email"||a==="add-phone"||a==="add-custom"){if(!I)return;ts(),Array.isArray(I.emails)||(I.emails=[""]),Array.isArray(I.phones)||(I.phones=[{type:"cell",value:""}]),Array.isArray(I.custom)||(I.custom=[]),a==="add-email"?I.emails.length<10&&I.emails.push(""):a==="add-phone"?I.phones.length<10&&I.phones.push({type:"other",value:""}):I.custom.length<30&&I.custom.push({label:"",value:""}),m();return}if(a==="remove-email"){if(!I)return;ts();const n=Number(t.dataset.idx);if(!Number.isFinite(n))return;const r=Array.isArray(I.emails)?I.emails:[""];I.emails=r.filter((u,b)=>b!==n),I.emails.length===0&&(I.emails=[""]),m();return}if(a==="remove-phone"){if(!I)return;ts();const n=Number(t.dataset.idx);if(!Number.isFinite(n))return;const r=Array.isArray(I.phones)?I.phones:[{type:"cell",value:""}];I.phones=r.filter((u,b)=>b!==n),I.phones.length===0&&(I.phones=[{type:"cell",value:""}]),m();return}if(a==="remove-custom"){if(!I)return;ts();const n=Number(t.dataset.idx);if(!Number.isFinite(n))return;I.custom=(Array.isArray(I.custom)?I.custom:[]).filter((r,u)=>u!==n),m();return}if(a==="remove-photo"){Ee=null,He=null,Ke=!0,I&&(I.hasPhoto=!1),m();return}if(a==="delete-contact"){if(V===null||!ce||!confirm("Delete this contact? CardDAV clients will sync the removal."))return;d=!0,E(),Ce=!0,m();try{await A.deleteContact(V,ce),ce=null,I=null,fe=!1,Ce=!1,O=null,Ee=null,await Qe(),f("success","Contact deleted")}catch(n){f("error",n instanceof Error?n.message:"Delete failed")}finally{d=!1,m()}return}if(a==="delete-ab"){e.stopPropagation();const n=Number(t.dataset.id??V);if(!Number.isFinite(n)||!Ue.find(u=>u.id===n))return;Ye=n,rt=!1,Ce=!1,E(),m();return}if(a==="cancel-delete-ab"){Ye=null,m();return}if(a==="confirm-delete-ab"){const n=Number(t.dataset.id),r=s.querySelector("#delete-ab-confirm");if(!Number.isFinite(n)||!(r!=null&&r.checked))return;const u=Ue.find(y=>y.id===n);if(!u)return;const b=(u.cardCount??0)>0;d=!0,E(),m();try{await A.deleteAddressBook(n,b),V===n&&(V=null,$t=[],I=null,ce=null,fe=!1),Ye=null,rt=!1,Ce=!1,await Qe(),V===null&&Ue.length>0&&(V=Ue[0].id,await Ot(V)),f("success","Address book deleted")}catch(y){f("error",y instanceof Error?y.message:"Delete failed")}finally{d=!1,m()}return}if(a==="export-ab"){e.stopPropagation();const n=t.dataset.id,r=n!==void 0&&n!==""?Number(n):V;if(r===null||Number.isNaN(r))return;d=!0,E(),m();try{const{blob:u,filename:b}=await A.exportAddressBook(r),y=await Ds(u,b);y==="cancelled"?f("info","Export cancelled"):y==="saved"?f("success",`Saved ${b}`):f("success",`Download started: ${b}`)}catch(u){f("error",u instanceof Error?u.message:"Export failed")}finally{d=!1,m()}return}if(a==="export-contact"){if(V===null||!ce||fe)return;Ce=!0,d=!0,E(),m();try{const{blob:n,filename:r}=await A.exportContact(V,ce),u=await Ds(n,r);u==="cancelled"?f("info","Export cancelled"):u==="saved"?f("success",`Saved ${r}`):f("success",`Download started: ${r}`)}catch(n){f("error",n instanceof Error?n.message:"Export failed")}finally{d=!1,m()}return}if(a==="revoke"){const n=t.dataset.href??"";if(!n||F===null||!confirm("Revoke access for this user?"))return;he=!0,d=!0,E(),m();try{await A.revoke(F,n),await _a(F),f("success","Share revoked")}catch(r){f("error",r instanceof Error?r.message:"Revoke failed")}finally{d=!1,m()}return}if(a==="export-cal"){e.stopPropagation();const n=t.dataset.id,r=n!==void 0&&n!==""?Number(n):F;if(r===null||Number.isNaN(r))return;d=!0,E(),m();try{const{blob:u,filename:b}=await A.exportCalendar(r),y=await Ds(u,b);y==="cancelled"?f("info","Export cancelled"):y==="saved"?f("success",`Saved ${b}`):f("success",`Download started: ${b}`)}catch(u){f("error",u instanceof Error?u.message:"Export failed")}finally{d=!1,m()}}}async function Ds(e,t){const a=window;if(typeof a.showSaveFilePicker=="function")try{const n=await(await a.showSaveFilePicker({suggestedName:t})).createWritable();try{await n.write(e)}finally{await n.close()}return"saved"}catch(p){if(p instanceof DOMException&&p.name==="AbortError")return"cancelled"}const l=URL.createObjectURL(e),o=document.createElement("a");return o.href=l,o.download=t,o.rel="noopener",o.style.display="none",document.body.appendChild(o),o.click(),window.setTimeout(()=>{URL.revokeObjectURL(l),o.remove()},6e4),"started"}function Lr(){const e=s.querySelector('input[data-action="import-cal"]');e&&e.addEventListener("change",()=>{Vr(e)});const t=s.querySelector('input[data-action="import-create-cal"]');t&&t.addEventListener("change",()=>{Br(t)});const a=s.querySelector('input[data-action="import-ab"]');a&&a.addEventListener("change",()=>{Or(a)})}async function Or(e){var l;if(V===null)return;const t=(l=e.files)==null?void 0:l[0];if(e.value="",!t)return;const a=V;rt=!0,d=!0,E(),yt(),z={kind:"contacts",fileName:t.name,fileSizeLabel:Ys(t.size),phase:"reading",readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},Ks(),m();try{const o=await Zs(t,r=>{if(!z||z.phase!=="reading")return;z={...z,readPercent:r};const u=s.querySelector(".import-progress-bar"),b=s.querySelector("[data-import-status-line]");u&&r!==null&&(u.classList.remove("is-indeterminate"),u.style.width=`${r}%`),b&&r!==null&&(b.textContent=`Reading file… ${r}%`)});Mt("uploading",{readPercent:100}),Mt("processing",{processPercent:0}),N.event("import.contacts.start",{file:t.name,bytes:t.size,abId:a});const p=await A.importAddressBook(a,o,r=>{Qs(r)}),n=xs(p);await Qe(),V===a&&await Ot(a),yt(),Mt("done",{ok:!0,resultMessage:`${n} (from “${t.name}”)`}),f("success",`Import finished for “${t.name}”: ${n}.`)}catch(o){const p=o instanceof Error?o.message:"Import failed";yt(),Mt("error",{ok:!1,resultMessage:p}),f("error",p)}finally{d=!1,m()}}function ts(){if(!I)return;const e=s.querySelector('[data-form="contact"]');if(!e)return;const t=new FormData(e);I.firstname=String(t.get("firstname")??""),I.lastname=String(t.get("lastname")??""),I.fullname=String(t.get("fullname")??""),I.org=String(t.get("org")??""),I.title=String(t.get("title")??""),I.url=String(t.get("url")??""),I.note=String(t.get("note")??"");const a=String(t.get("birthday")??"").trim();I.birthday=a&&/^\d{4}-\d{2}-\d{2}/.test(a)?a.slice(0,10):null,I.address={street:String(t.get("street")??""),city:String(t.get("city")??""),region:String(t.get("region")??""),postal:String(t.get("postal")??""),country:String(t.get("country")??"")};const l=[];let o=0;for(;t.has(`email_${o}`);)l.push(String(t.get(`email_${o}`)??"")),o++;l.length&&(I.emails=l);const p=[];for(o=0;t.has(`phone_value_${o}`);)p.push({type:String(t.get(`phone_type_${o}`)??"other"),value:String(t.get(`phone_value_${o}`)??"")}),o++;p.length&&(I.phones=p);const n=[];for(o=0;t.has(`custom_label_${o}`)||t.has(`custom_value_${o}`);)n.push({label:String(t.get(`custom_label_${o}`)??""),value:String(t.get(`custom_value_${o}`)??"")}),o++;I.custom=n}function Ur(e){const t=new FormData(e),a=[];let l=0;for(;t.has(`email_${l}`);){const r=String(t.get(`email_${l}`)??"").trim();r&&a.push(r),l++}const o=[];for(l=0;t.has(`phone_value_${l}`);){const r=String(t.get(`phone_value_${l}`)??"").trim();r&&o.push({type:String(t.get(`phone_type_${l}`)??"other"),value:r}),l++}const p=[];for(l=0;t.has(`custom_label_${l}`)||t.has(`custom_value_${l}`);){const r=String(t.get(`custom_label_${l}`)??"").trim(),u=String(t.get(`custom_value_${l}`)??"").trim();(r||u)&&p.push({label:r,value:u}),l++}const n={firstname:String(t.get("firstname")??"").trim(),lastname:String(t.get("lastname")??"").trim(),fullname:String(t.get("fullname")??"").trim(),org:String(t.get("org")??"").trim(),title:String(t.get("title")??"").trim(),emails:a,phones:o,address:{street:String(t.get("street")??"").trim(),city:String(t.get("city")??"").trim(),region:String(t.get("region")??"").trim(),postal:String(t.get("postal")??"").trim(),country:String(t.get("country")??"").trim()},url:String(t.get("url")??"").trim(),note:String(t.get("note")??"").trim(),birthday:(()=>{const r=String(t.get("birthday")??"").trim();return r&&/^\d{4}-\d{2}-\d{2}/.test(r)?r.slice(0,10):null})(),custom:p};return Ke?n.removePhoto=!0:He&&(n.photoBase64=He),n}async function Pr(e){if(V===null)return;const t=Ur(e);d=!0,E(),Ce=!0,m();try{if(fe){const a=await A.createContact(V,t);fe=!1,ce=a.contact.uri,I=null,Ce=!1,Ee=null,He=null,Ke=!1,O=null,f("success","Contact created")}else ce&&(ce=(await A.updateContact(V,ce,t)).contact.uri,I=null,Ce=!1,Ee=null,He=null,Ke=!1,O=null,f("success","Contact saved"));try{await Qe()}catch(a){if(console.error(a),V!==null)try{await Ot(V)}catch{}}}catch(a){f("error",a instanceof Error?a.message:"Save failed")}finally{d=!1,m()}}async function Fr(e){const t=new FormData(e),a=String(t.get("displayname")??"").trim(),l=String(t.get("description")??"").trim();if(a){d=!0,E(),m();try{const o=await A.createAddressBook({displayname:a,description:l});V=o.addressbook.id,ce=null,I=null,fe=!1,Xt="",await Qe(),f("success",`Address book “${o.addressbook.displayname}” created`)}catch(o){f("error",o instanceof Error?o.message:"Create failed")}finally{d=!1,m()}}}async function Mr(e){if(V===null)return;const t=new FormData(e),a=String(t.get("displayname")??"").trim(),l=String(t.get("description")??"").trim();rt=!0,d=!0,E(),m();try{await A.updateAddressBook(V,{displayname:a,description:l}),await Qe(),f("success","Address book updated")}catch(o){f("error",o instanceof Error?o.message:"Update failed")}finally{d=!1,m()}}function Rr(e){const t=rl[e];if(!t)return;const a=s.querySelector("#info-modal"),l=s.querySelector("#info-modal-title"),o=s.querySelector("#info-modal-body");if(!a||!l||!o)return;l.textContent=t.title,o.innerHTML=t.paragraphs.map(n=>`<p>${i(n)}</p>`).join(""),a.hidden=!1,document.body.classList.add("info-modal-open");const p=a.querySelector(".info-modal-close");p==null||p.focus()}function sn(){const e=s.querySelector("#info-modal");e&&(e.hidden=!0,document.body.classList.remove("info-modal-open"))}async function Vr(e){var a;if(F===null)return;const t=(a=e.files)==null?void 0:a[0];e.value="",t&&(he=!0,await nn(F,t,{keepEditModalOpen:!0}))}async function Br(e){var b;const t=(b=e.files)==null?void 0:b[0];if(e.value="",!t)return;const a=s.querySelector('[data-form="create-cal"]'),l=a?new FormData(a):new FormData,o=l.get("holidays")==="on",p=l.get("readOnly")==="on";if(o){f("error","Turn off “Holidays calendar” to import a .ics file into a new calendar."),Me=!0,m();return}if(p){f("error","Turn off “Read-only” before importing — import cannot write to a read-only calendar."),Me=!0,m();return}let n=String(l.get("displayname")??"").trim();n||(n=t.name.replace(/\.ics$/i,"").trim()||"Imported calendar");const r=String(l.get("description")??""),u=String(l.get("color")??"").trim();d=!0,E(),Me=!0,m();try{const y=await A.createCalendar({displayname:n,description:r,color:u,readOnly:!1});F=y.calendar.id,Me=!1,await Qe(),f("success",`Created “${y.calendar.displayname}” — importing…`),await nn(y.calendar.id,t,{keepEditModalOpen:!1,successPrefix:`Calendar “${y.calendar.displayname}” created. `})}catch(y){const v=y instanceof Error?y.message:"Create or import failed";Me=!0,f("error",v),d=!1,m()}}async function nn(e,t,a={}){d=!0,E(),yt(),z={kind:"calendar",fileName:t.name,fileSizeLabel:Ys(t.size),phase:"reading",readPercent:0,processPercent:null,processCurrent:0,processTotal:0,processImported:0,processUpdated:0,processSkipped:0,startedAt:Date.now(),elapsedSec:0,resultMessage:null,ok:null},Ks(),m();try{const l=await Zs(t,n=>{if(!z||z.phase!=="reading")return;z={...z,readPercent:n};const r=s.querySelector(".import-progress-bar"),u=s.querySelector("[data-import-status-line]");r&&n!==null&&(r.classList.remove("is-indeterminate"),r.style.width=`${n}%`),u&&n!==null&&(u.textContent=`Reading file… ${n}%`)});Mt("uploading",{readPercent:100}),Mt("processing",{processPercent:0}),N.event("import.calendar.start",{file:t.name,bytes:t.size,calId:e});const o=await A.importCalendar(e,l,n=>{Qs(n)}),p=xs(o);F===e&&await Xe(),yt(),Mt("done",{ok:!0,resultMessage:`${p} (from “${t.name}”)`}),f("success",`${a.successPrefix||""}Import finished for “${t.name}”: ${p}.`)}catch(l){const o=l instanceof Error?l.message:"Import failed";yt(),Mt("error",{ok:!1,resultMessage:o}),f("error",o)}finally{a.keepEditModalOpen&&(he=!0),d=!1,m()}}En()}let zt="",P=null,Z=!1,ct=null,Ct=null,Bt="sqlite",cs=!1;async function us(s,c={}){const g={Accept:"application/json",...c.headers};c.body&&(g["Content-Type"]="application/json"),zt&&c.method&&c.method!=="GET"&&(g["X-CSRF-Token"]=zt);const h=await fetch(`/api/install${s}`,{credentials:"same-origin",...c,headers:g});let w;try{w=await h.json()}catch{throw new Error(`Request failed (${h.status})`)}if(!h.ok)throw new Error(w.error||`Request failed (${h.status})`);return w&&typeof w=="object"&&"data"in w&&w.data!==void 0?w.data:w}async function Ls(){var s;P=await us("/status"),zt=P.csrfToken||zt,((s=P.defaults)==null?void 0:s.backend)==="pgsql"?Bt="pgsql":Bt="sqlite"}function Fa(s,c,g){return`<label class="check-row"><input type="checkbox" name="${i(s)}" ${c?"checked":""} ${Z?"disabled":""} /> ${i(g)}</label>`}function il(){const s=P==null?void 0:P.permissions;return`<section class="card">
  ...
  </section>`}function dl(){const s=P==null?void 0:P.defaults;return`<section class="card">
    ...
    <form class="stack" data-form="initialize">
      <label>Server timezone
        <select name="timezone" required ${Z?"disabled":""}>
          ${pn((s==null?void 0:s.timezone)||"UTC")}
        </select>
      </label>
      <h3 class="admin-subsection-title">DAV services</h3>
      ${Fa("cal_enabled",(s==null?void 0:s.cal_enabled)!==!1,"Enable CalDAV")}
      ${Fa("card_enabled",(s==null?void 0:s.card_enabled)!==!1,"Enable CardDAV")}
      ${Fa("tasks_enabled",(s==null?void 0:s.tasks_enabled)!==!1,"Enable Tasks (VTODO)")}
      ${Fa("notes_enabled",!!(s!=null&&s.notes_enabled),"Enable Notes (VJOURNAL)")}
      ${Fa("files_enabled",!!(s!=null&&s.files_enabled),"Enable WebDAV file storage")}
      <label>WebDAV authentication type
  ...
  </section>`}function cl(){const s=P==null?void 0:P.defaults,c=(P==null?void 0:P.pdoDrivers)||[],g=c.includes("sqlite"),h=c.includes("pgsql");return`<section class="card">
    <h2>Database</h2>
  ...
  </section>`}function ml(){return`<section class="card">
  ...
  </section>`}function pl(){return`<section class="card card-danger-zone">
  ...
  </section>`}function ut(){const s=document.getElementById("app");if(!s)return;const c=(P==null?void 0:P.step)||"permissions";let g="";P?c==="permissions"?g=il():c==="initialize"?g=dl():c==="database"?g=cl():c==="upgrade"?g=ul():c==="done"?g=ml():c==="locked"?g=pl():g=`<section class="card"><p>Unknown step: ${i(c)}</p></section>`:g='<section class="card"><p class="muted">Loading installer…</p></section>',s.innerHTML=`
  ...
  `,fl()}function fl(){var c,g,h,w,q,U;const s=document.getElementById("app");s&&((c=s.querySelector('[data-action="reload"]'))==null||c.addEventListener("click",()=>{bl()}),(g=s.querySelector('[data-action="backend-change"]'))==null||g.addEventListener("change",M=>{Bt=M.target.value==="pgsql"?"pgsql":"sqlite",ut()}),(h=s.querySelector('[data-action="upgrade-toggle"]'))==null||h.addEventListener("change",M=>{cs=!!M.target.checked,ut()}),(w=s.querySelector('[data-action="upgrade-run"]'))==null||w.addEventListener("click",()=>{yl()}),(q=s.querySelector('[data-form="initialize"]'))==null||q.addEventListener("submit",M=>{M.preventDefault(),gl(M.target)}),(U=s.querySelector('[data-form="database"]'))==null||U.addEventListener("submit",M=>{M.preventDefault(),hl(M.target)}))}async function bl(){Z=!0,ct=null,ut();try{await Ls(),Ct=null}catch(s){ct=s instanceof Error?s.message:"Failed to load installer status"}finally{Z=!1,ut()}}async function gl(s){const c=new FormData(s),g=w=>{var q;return!!((q=s.querySelector(`input[name="${w}"]`))!=null&&q.checked)},h={timezone:String(c.get("timezone")??"").trim(),cal_enabled:g("cal_enabled"),card_enabled:g("card_enabled"),tasks_enabled:g("tasks_enabled"),notes_enabled:g("notes_enabled"),files_enabled:g("files_enabled"),dav_auth_type:String(c.get("dav_auth_type")??"Digest"),invite_from:String(c.get("invite_from")??"").trim(),session_max_age_minutes:Number(c.get("session_max_age_minutes")??15),admin_password:String(c.get("admin_password")??""),admin_password_confirm:String(c.get("admin_password_confirm")??"")};Z=!0,ct=null,Ct=null,ut();try{P=await us("/initialize",{method:"POST",body:JSON.stringify(h)}),zt=P.csrfToken||zt,Ct="Server settings saved. Configure the database next.",N.event("install.initialize")}catch(w){ct=w instanceof Error?w.message:"Initialize failed"}finally{Z=!1,ut()}}async function hl(s){const c=new FormData(s),g=String(c.get("backend")??Bt),h={backend:g,admin_password:String(c.get("admin_password")??""),admin_password_confirm:String(c.get("admin_password_confirm")??"")};g==="sqlite"?h.sqlite_file=String(c.get("sqlite_file")??"").trim():(h.pgsql_host=String(c.get("pgsql_host")??"").trim(),h.pgsql_dbname=String(c.get("pgsql_dbname")??"").trim(),h.pgsql_username=String(c.get("pgsql_username")??"").trim(),h.pgsql_password=String(c.get("pgsql_password")??"")),Z=!0,ct=null,Ct=null,ut();try{P=await us("/database",{method:"POST",body:JSON.stringify(h)}),zt=P.csrfToken||zt,Ct="Database configured. Installer is locked.",N.event("install.database"),P.completed||P.step}catch(w){ct=w instanceof Error?w.message:"Database setup failed"}finally{Z=!1,ut()}}async function yl(){if(cs){Z=!0,ct=null,Ct=null,ut();try{const s=await us("/upgrade",{method:"POST",body:JSON.stringify({confirm:!0})});Ct="Upgrade completed."+(s.messages&&s.messages.length?" "+s.messages.slice(0,3).join(" · "):""),N.event("install.upgrade"),await Ls()}catch(s){ct=s instanceof Error?s.message:"Upgrade failed"}finally{Z=!1,ut()}}}async function vl(s){document.title="AngaraDAV · Setup",document.body.classList.add("layout-install"),s.innerHTML='<section class="card"><p class="muted">Loading installer…</p></section>';try{await Ls()}catch(c){ct=c instanceof Error?c.message:"Failed to load installer"}ut()}const Ts=document.getElementById("app");if(!Ts)throw new Error("#app missing");const cn=window.location.pathname.replace(/\/+$/,"")||"/";cn==="/portal/install"||cn.endsWith("/portal/install")?vl(Ts):ol(Ts);
