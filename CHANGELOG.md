...
- **Config file name.** The live config file is `config/configuration.yaml` (template `config/configuration.yaml.dist`). The temporary installer step that renamed `config/baikal.yaml` has been removed.
